...
public class AppendixOnPageDayStatisticsMoneyData {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(taskPost, tasksReady, summary, resources, pages, nonIndexable, duplicateTags, links, waterfall, errors, pagesByResource, duplicateContent, rawHtml, instantPages, redirectChains, lighthouse, keywordDensity, pageScreenshot, contentParsing, contentParsingLive, refundMoney);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppendixOnPageDayStatisticsMoneyData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppendixOnPageDayStatisticsMoneyData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
