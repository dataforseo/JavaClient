...
public class MerchantGoogleProductSpecTaskPostRequestInfo {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(productId, priority, locationName, locationCode, locationCoordinate, languageName, languageCode, seDomain, additionalSpecifications, tag, postbackUrl, postbackData, pingbackUrl);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MerchantGoogleProductSpecTaskPostRequestInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MerchantGoogleProductSpecTaskPostRequestInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
