...
public class BusinessDataGoogleHotelSearchesTaskPostRequestInfo {
  ...
  **/
  ...
  public BusinessDataGoogleHotelSearchesTaskPostRequestInfo depth(Integer depth) {
   ...
   /**
   * parsing depth optional field number of results in Google Hotels default value: 20 organic results max value: 140 Note: your account will be billed per each 20 organic results regardless of paid listings in the response; thus, setting a depth above 20 may result in additional charges if Google Hotels return more than 20 results; if the specified depth is higher than the number of results in the response, the difference will be refunded automatically to your account balance
   * @return depth
  **/
  @javax.annotation.Nullable
  ...
  **/
  ...
  public BusinessDataGoogleHotelSearchesTaskPostRequestInfo addChildrenItem(String childrenItem) {
  ...
  **/
  ...
  public BusinessDataGoogleHotelSearchesTaskPostRequestInfo addStarsItem(String starsItem) {
    if (this.stars == null) {
  ...
  **/
  ...
  public BusinessDataGoogleHotelSearchesTaskPostRequestInfo minRating(Float minRating) {
  ...
  **/
  ...
  public BusinessDataGoogleHotelSearchesTaskPostRequestInfo addAmenitiesItem(String amenitiesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyword, businessDataGoogleHotelSearchesTaskPostRequestInfo.keyword) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keyword, priority, locationName, locationCode, locationCoordinate, languageName, languageCode, tag, postbackUrl, pingbackUrl, depth, checkIn, checkOut, currency, adults, children, stars, minRating, sortBy, minPrice, maxPrice, freeCancellation, isVacationRentals, amenities);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BusinessDataGoogleHotelSearchesTaskPostRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BusinessDataGoogleHotelSearchesTaskPostRequestInfo is not found in the empty JSON string", BusinessDataGoogleHotelSearchesTaskPostRequestInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BusinessDataGoogleHotelSearchesTaskPostRequestInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BusinessDataGoogleHotelSearchesTaskPostRequestInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("stars") != null && !jsonObj.get("stars").isJsonNull() && !jsonObj.get("stars").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `stars` to be an array in the JSON string but got `%s`", jsonObj.get("stars").toString()));
      }
 ...
 /**
  * Create an instance of BusinessDataGoogleHotelSearchesTaskPostRequestInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BusinessDataGoogleHotelSearchesTaskPostRequestInfo
  * @throws IOException if the JSON string is invalid with respect to BusinessDataGoogleHotelSearchesTaskPostRequestInfo
  */
 ...
 /**
  * Convert an instance of BusinessDataGoogleHotelSearchesTaskPostRequestInfo to an JSON string
  *
  * @return JSON string
  */
