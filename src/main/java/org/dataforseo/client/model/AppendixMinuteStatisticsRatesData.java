...
public class AppendixMinuteStatisticsRatesData {
  ...
  public AppendixMinuteStatisticsRatesData serp(AppendixSerpLimitsRatesDataInfo serp) {
    this.serp = serp;
    return this;
  }
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData total(Double total) {
    this.total = total;
    return this;
  }
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData totalSerp(Double totalSerp) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData keywordsData(AppendixKeywordsDatasRatesDataInfo keywordsData) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData totalKeywordsData(Double totalKeywordsData) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData appendix(AppendixAppendixsRatesDataInfo appendix) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData totalAppendix(Double totalAppendix) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData dataforseoLabs(AppendixDataforseoLabsLimitsRatesDataInfo dataforseoLabs) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData totalDataforseoLabs(Double totalDataforseoLabs) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData domainAnalytics(AppendixDomainAnalyticsLimitsRatesDataInfo domainAnalytics) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData totalDomainAnalytics(Double totalDomainAnalytics) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData merchant(AppendixMerchantLimitsRatesDataInfo merchant) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData totalMerchant(Double totalMerchant) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData onPage(AppendixOnPageLimitsRatesDataInfo onPage) {
    this.onPage = onPage;
    return this;
  }
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData totalOnPage(Double totalOnPage) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData businessData(AppendixBusinessDataStatisticsRatesDataInfo businessData) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData totalBusinessData(Double totalBusinessData) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData backlinks(AppendixBacklinksLimitsRatesDataInfo backlinks) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData totalBacklinks(Double totalBacklinks) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData appData(AppendixAppDataDayStatisticsRatesData appData) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData totalAppData(Double totalAppData) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData contentAnalysis(AppendixContentAnalysisLimitsRatesDataInfo contentAnalysis) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData totalContentAnalysis(Double totalContentAnalysis) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData contentGeneration(AppendixContentGenerationLimitsRatesDataInfo contentGeneration) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData totalContentGeneration(Double totalContentGeneration) {
  ...
  **/
  ...
  public AppendixMinuteStatisticsRatesData value(String value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AppendixMinuteStatisticsRatesData appendixMinuteStatisticsRatesData = (AppendixMinuteStatisticsRatesData) o;
    return Objects.equals(this.serp, appendixMinuteStatisticsRatesData.serp) &&
        Objects.equals(this.total, appendixMinuteStatisticsRatesData.total) &&
        Objects.equals(this.totalSerp, appendixMinuteStatisticsRatesData.totalSerp) &&
        Objects.equals(this.keywordsData, appendixMinuteStatisticsRatesData.keywordsData) &&
        Objects.equals(this.totalKeywordsData, appendixMinuteStatisticsRatesData.totalKeywordsData) &&
        Objects.equals(this.appendix, appendixMinuteStatisticsRatesData.appendix) &&
        Objects.equals(this.totalAppendix, appendixMinuteStatisticsRatesData.totalAppendix) &&
        Objects.equals(this.dataforseoLabs, appendixMinuteStatisticsRatesData.dataforseoLabs) &&
        Objects.equals(this.totalDataforseoLabs, appendixMinuteStatisticsRatesData.totalDataforseoLabs) &&
        Objects.equals(this.domainAnalytics, appendixMinuteStatisticsRatesData.domainAnalytics) &&
        Objects.equals(this.totalDomainAnalytics, appendixMinuteStatisticsRatesData.totalDomainAnalytics) &&
        Objects.equals(this.merchant, appendixMinuteStatisticsRatesData.merchant) &&
        Objects.equals(this.totalMerchant, appendixMinuteStatisticsRatesData.totalMerchant) &&
        Objects.equals(this.onPage, appendixMinuteStatisticsRatesData.onPage) &&
        Objects.equals(this.totalOnPage, appendixMinuteStatisticsRatesData.totalOnPage) &&
        Objects.equals(this.businessData, appendixMinuteStatisticsRatesData.businessData) &&
        Objects.equals(this.totalBusinessData, appendixMinuteStatisticsRatesData.totalBusinessData) &&
        Objects.equals(this.backlinks, appendixMinuteStatisticsRatesData.backlinks) &&
        Objects.equals(this.totalBacklinks, appendixMinuteStatisticsRatesData.totalBacklinks) &&
        Objects.equals(this.appData, appendixMinuteStatisticsRatesData.appData) &&
        Objects.equals(this.totalAppData, appendixMinuteStatisticsRatesData.totalAppData) &&
        Objects.equals(this.contentAnalysis, appendixMinuteStatisticsRatesData.contentAnalysis) &&
        Objects.equals(this.totalContentAnalysis, appendixMinuteStatisticsRatesData.totalContentAnalysis) &&
        Objects.equals(this.contentGeneration, appendixMinuteStatisticsRatesData.contentGeneration) &&
        Objects.equals(this.totalContentGeneration, appendixMinuteStatisticsRatesData.totalContentGeneration) &&
        Objects.equals(this.value, appendixMinuteStatisticsRatesData.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppendixMinuteStatisticsRatesData {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to AppendixMinuteStatisticsRatesData
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppendixMinuteStatisticsRatesData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppendixMinuteStatisticsRatesData is not found in the empty JSON string", AppendixMinuteStatisticsRatesData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppendixMinuteStatisticsRatesData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppendixMinuteStatisticsRatesData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppendixMinuteStatisticsRatesData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppendixMinuteStatisticsRatesData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppendixMinuteStatisticsRatesData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppendixMinuteStatisticsRatesData.class));

       return (TypeAdapter<T>) new TypeAdapter<AppendixMinuteStatisticsRatesData>() {
           @Override
           public void write(JsonWriter out, AppendixMinuteStatisticsRatesData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AppendixMinuteStatisticsRatesData read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AppendixMinuteStatisticsRatesData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppendixMinuteStatisticsRatesData
  * @throws IOException if the JSON string is invalid with respect to AppendixMinuteStatisticsRatesData
  */
  public static AppendixMinuteStatisticsRatesData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppendixMinuteStatisticsRatesData.class);
  }

 /**
  * Convert an instance of AppendixMinuteStatisticsRatesData to an JSON string
  *
  * @return JSON string
  */
