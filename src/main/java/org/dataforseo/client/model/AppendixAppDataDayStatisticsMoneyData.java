...
public class AppendixAppDataDayStatisticsMoneyData {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(appInfo, appList, appReviews, appSearches, errors, languages, locations, categories, tasksReady, appListings, refundMoney);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppendixAppDataDayStatisticsMoneyData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppendixAppDataDayStatisticsMoneyData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
