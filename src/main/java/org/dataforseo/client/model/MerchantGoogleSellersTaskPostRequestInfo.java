...
public class MerchantGoogleSellersTaskPostRequestInfo {
  ...
  **/
  ...
  public MerchantGoogleSellersTaskPostRequestInfo putAdditionalSpecificationsItem(String key, String additionalSpecificationsItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(productId, priority, locationName, locationCode, locationCoordinate, languageName, languageCode, seDomain, getShopsOnGoogle, additionalSpecifications, tag, postbackUrl, postbackData, pingbackUrl);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MerchantGoogleSellersTaskPostRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MerchantGoogleSellersTaskPostRequestInfo is not found in the empty JSON string", MerchantGoogleSellersTaskPostRequestInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MerchantGoogleSellersTaskPostRequestInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MerchantGoogleSellersTaskPostRequestInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
 ...
 /**
  * Create an instance of MerchantGoogleSellersTaskPostRequestInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MerchantGoogleSellersTaskPostRequestInfo
  * @throws IOException if the JSON string is invalid with respect to MerchantGoogleSellersTaskPostRequestInfo
  */
 ...
 /**
  * Convert an instance of MerchantGoogleSellersTaskPostRequestInfo to an JSON string
  *
  * @return JSON string
  */
