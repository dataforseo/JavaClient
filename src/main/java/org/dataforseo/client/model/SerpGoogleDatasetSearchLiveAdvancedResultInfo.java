...
public class SerpGoogleDatasetSearchLiveAdvancedResultInfo {
  ...
  **/
  ...
  public SerpGoogleDatasetSearchLiveAdvancedResultInfo items(List<BaseSerpElementItem> items) {
    this.items = items;
    return this;
  }

  public SerpGoogleDatasetSearchLiveAdvancedResultInfo addItemsItem(BaseSerpElementItem itemsItem) {
    if (this.items == null) {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SerpGoogleDatasetSearchLiveAdvancedResultInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SerpGoogleDatasetSearchLiveAdvancedResultInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
