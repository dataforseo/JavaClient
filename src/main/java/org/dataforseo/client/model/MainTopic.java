...
public class MainTopic {
  ...
  public MainTopic hTitle(String hTitle) {
    this.hTitle = hTitle;
    return this;
  }
  ...
  **/
  ...
  public MainTopic mainTitle(String mainTitle) {
  ...
  **/
  ...
  public MainTopic author(String author) {
    this.author = author;
    return this;
  }
  ...
  **/
  ...
  public MainTopic language(String language) {
  ...
  **/
  ...
  public MainTopic level(Integer level) {
    this.level = level;
    return this;
  }
  ...
  **/
  ...
  public MainTopic primaryContent(List<ContentItemInfo> primaryContent) {
    this.primaryContent = primaryContent;
    return this;
  }

  public MainTopic addPrimaryContentItem(ContentItemInfo primaryContentItem) {
  ...
  **/
  ...
  public MainTopic secondaryContent(List<ContentItemInfo> secondaryContent) {
    this.secondaryContent = secondaryContent;
    return this;
  }

  public MainTopic addSecondaryContentItem(ContentItemInfo secondaryContentItem) {
  ...
  **/
  ...
  public MainTopic tableContent(List<TableContent> tableContent) {
    this.tableContent = tableContent;
    return this;
  }

  public MainTopic addTableContentItem(TableContent tableContentItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MainTopic mainTopic = (MainTopic) o;
    return Objects.equals(this.hTitle, mainTopic.hTitle) &&
        Objects.equals(this.mainTitle, mainTopic.mainTitle) &&
        Objects.equals(this.author, mainTopic.author) &&
        Objects.equals(this.language, mainTopic.language) &&
        Objects.equals(this.level, mainTopic.level) &&
        Objects.equals(this.primaryContent, mainTopic.primaryContent) &&
        Objects.equals(this.secondaryContent, mainTopic.secondaryContent) &&
        Objects.equals(this.tableContent, mainTopic.tableContent);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to MainTopic
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MainTopic.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MainTopic is not found in the empty JSON string", MainTopic.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MainTopic.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MainTopic` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MainTopic.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MainTopic' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MainTopic> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MainTopic.class));

       return (TypeAdapter<T>) new TypeAdapter<MainTopic>() {
           @Override
           public void write(JsonWriter out, MainTopic value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MainTopic read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of MainTopic given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MainTopic
  * @throws IOException if the JSON string is invalid with respect to MainTopic
  */
  public static MainTopic fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MainTopic.class);
  }

 /**
  * Convert an instance of MainTopic to an JSON string
  *
  * @return JSON string
  */
