...
public class SerpYoutubeVideoCommentsTaskGetAdvancedResultInfo {
  ...
  **/
  ...
  public SerpYoutubeVideoCommentsTaskGetAdvancedResultInfo items(List<BaseSerpElementItem> items) {
    this.items = items;
    return this;
  }

  public SerpYoutubeVideoCommentsTaskGetAdvancedResultInfo addItemsItem(BaseSerpElementItem itemsItem) {
    if (this.items == null) {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SerpYoutubeVideoCommentsTaskGetAdvancedResultInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SerpYoutubeVideoCommentsTaskGetAdvancedResultInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
