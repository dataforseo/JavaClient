...
public class AiOverviewReference {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, aiOverviewReference.type) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, source, domain, url, title, text);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AiOverviewReference.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AiOverviewReference is not found in the empty JSON string", AiOverviewReference.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AiOverviewReference.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AiOverviewReference` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
 ...
 /**
  * Create an instance of AiOverviewReference given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AiOverviewReference
  * @throws IOException if the JSON string is invalid with respect to AiOverviewReference
  */
 ...
 /**
  * Convert an instance of AiOverviewReference to an JSON string
  *
  * @return JSON string
  */
