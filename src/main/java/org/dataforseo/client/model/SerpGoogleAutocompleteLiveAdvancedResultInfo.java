...
public class SerpGoogleAutocompleteLiveAdvancedResultInfo {
  ...
  **/
  ...
  public SerpGoogleAutocompleteLiveAdvancedResultInfo items(List<BaseSerpElementItem> items) {
    this.items = items;
    return this;
  }

  public SerpGoogleAutocompleteLiveAdvancedResultInfo addItemsItem(BaseSerpElementItem itemsItem) {
    if (this.items == null) {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SerpGoogleAutocompleteLiveAdvancedResultInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SerpGoogleAutocompleteLiveAdvancedResultInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
