...
public class BusinessDataGoogleHotelInfoTaskPostRequestInfo {
  ...
  **/
  ...
  public BusinessDataGoogleHotelInfoTaskPostRequestInfo addChildrenItem(String childrenItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keyword, priority, locationName, locationCode, locationCoordinate, languageName, languageCode, tag, postbackUrl, pingbackUrl, hotelIdentifier, checkIn, checkOut, currency, adults, children, postbackData);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BusinessDataGoogleHotelInfoTaskPostRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BusinessDataGoogleHotelInfoTaskPostRequestInfo is not found in the empty JSON string", BusinessDataGoogleHotelInfoTaskPostRequestInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BusinessDataGoogleHotelInfoTaskPostRequestInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BusinessDataGoogleHotelInfoTaskPostRequestInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
 ...
 /**
  * Create an instance of BusinessDataGoogleHotelInfoTaskPostRequestInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BusinessDataGoogleHotelInfoTaskPostRequestInfo
  * @throws IOException if the JSON string is invalid with respect to BusinessDataGoogleHotelInfoTaskPostRequestInfo
  */
 ...
 /**
  * Convert an instance of BusinessDataGoogleHotelInfoTaskPostRequestInfo to an JSON string
  *
  * @return JSON string
  */
