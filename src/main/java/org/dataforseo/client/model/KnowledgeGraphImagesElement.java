...
public class KnowledgeGraphImagesElement {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, knowledgeGraphImagesElement.type) &&
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KnowledgeGraphImagesElement.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KnowledgeGraphImagesElement is not found in the empty JSON string", KnowledgeGraphImagesElement.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KnowledgeGraphImagesElement.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KnowledgeGraphImagesElement` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
 ...
 /**
  * Create an instance of KnowledgeGraphImagesElement given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of KnowledgeGraphImagesElement
  * @throws IOException if the JSON string is invalid with respect to KnowledgeGraphImagesElement
  */
 ...
 /**
  * Convert an instance of KnowledgeGraphImagesElement to an JSON string
  *
  * @return JSON string
  */
