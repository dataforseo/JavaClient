...
public class AppendixBusinessDataDayStatisticsMoneyData {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(google, locations, languages, errors, yelp, socialMedia, tripadvisor, trustpilot, businessListings, tasksReady, refundMoney);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppendixBusinessDataDayStatisticsMoneyData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppendixBusinessDataDayStatisticsMoneyData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
