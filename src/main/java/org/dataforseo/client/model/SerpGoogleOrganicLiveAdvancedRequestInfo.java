...
public class SerpGoogleOrganicLiveAdvancedRequestInfo {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyword, serpGoogleOrganicLiveAdvancedRequestInfo.keyword) &&
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SerpGoogleOrganicLiveAdvancedRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SerpGoogleOrganicLiveAdvancedRequestInfo is not found in the empty JSON string", SerpGoogleOrganicLiveAdvancedRequestInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SerpGoogleOrganicLiveAdvancedRequestInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SerpGoogleOrganicLiveAdvancedRequestInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
 ...
 /**
  * Create an instance of SerpGoogleOrganicLiveAdvancedRequestInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SerpGoogleOrganicLiveAdvancedRequestInfo
  * @throws IOException if the JSON string is invalid with respect to SerpGoogleOrganicLiveAdvancedRequestInfo
  */
 ...
 /**
  * Convert an instance of SerpGoogleOrganicLiveAdvancedRequestInfo to an JSON string
  *
  * @return JSON string
  */
