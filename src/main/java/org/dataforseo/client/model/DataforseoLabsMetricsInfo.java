...
public class DataforseoLabsMetricsInfo {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pos1, pos23, pos410, pos1120, pos2130, pos3140, pos4150, pos5160, pos6170, pos7180, pos8190, pos91100, etv, impressionsEtv, count, estimatedPaidTrafficCost, isNew, isUp, isDown, isLost, clickstreamEtv, clickstreamGenderDistribution, clickstreamAgeDistribution);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataforseoLabsMetricsInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataforseoLabsMetricsInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
