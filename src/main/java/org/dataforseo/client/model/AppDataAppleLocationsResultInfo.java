...
public class AppDataAppleLocationsResultInfo {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppDataAppleLocationsResultInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppDataAppleLocationsResultInfo is not found in the empty JSON string", AppDataAppleLocationsResultInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppDataAppleLocationsResultInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppDataAppleLocationsResultInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
 ...
 /**
  * Create an instance of AppDataAppleLocationsResultInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppDataAppleLocationsResultInfo
  * @throws IOException if the JSON string is invalid with respect to AppDataAppleLocationsResultInfo
  */
 ...
 /**
  * Convert an instance of AppDataAppleLocationsResultInfo to an JSON string
  *
  * @return JSON string
  */
