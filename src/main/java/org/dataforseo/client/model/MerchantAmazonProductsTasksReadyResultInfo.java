...
public class MerchantAmazonProductsTasksReadyResultInfo {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, merchantAmazonProductsTasksReadyResultInfo.id) &&
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MerchantAmazonProductsTasksReadyResultInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MerchantAmazonProductsTasksReadyResultInfo is not found in the empty JSON string", MerchantAmazonProductsTasksReadyResultInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MerchantAmazonProductsTasksReadyResultInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MerchantAmazonProductsTasksReadyResultInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
 ...
 /**
  * Create an instance of MerchantAmazonProductsTasksReadyResultInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MerchantAmazonProductsTasksReadyResultInfo
  * @throws IOException if the JSON string is invalid with respect to MerchantAmazonProductsTasksReadyResultInfo
  */
 ...
 /**
  * Convert an instance of MerchantAmazonProductsTasksReadyResultInfo to an JSON string
  *
  * @return JSON string
  */
