...
public class ContentAnalysisRatingDistributionLiveRequestInfo {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keyword, keywordFields, pageType, internalListLimit, searchMode, positiveConnotationThreshold, sentimentsConnotationThreshold, initialDatasetFilters, tag);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentAnalysisRatingDistributionLiveRequestInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContentAnalysisRatingDistributionLiveRequestInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
