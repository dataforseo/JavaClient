...
public class KeywordsDataGoogleAdsKeywordsForKeywordsTaskPostRequestInfo {
  ...
  public KeywordsDataGoogleAdsKeywordsForKeywordsTaskPostRequestInfo addKeywordsItem(String keywordsItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keywords, locationName, locationCode, locationCoordinate, languageName, languageCode, searchPartners, dateFrom, dateTo, includeAdultKeywords, sortBy, postbackUrl, pingbackUrl, tag, target);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KeywordsDataGoogleAdsKeywordsForKeywordsTaskPostRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KeywordsDataGoogleAdsKeywordsForKeywordsTaskPostRequestInfo is not found in the empty JSON string", KeywordsDataGoogleAdsKeywordsForKeywordsTaskPostRequestInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KeywordsDataGoogleAdsKeywordsForKeywordsTaskPostRequestInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KeywordsDataGoogleAdsKeywordsForKeywordsTaskPostRequestInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
 ...
 /**
  * Create an instance of KeywordsDataGoogleAdsKeywordsForKeywordsTaskPostRequestInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of KeywordsDataGoogleAdsKeywordsForKeywordsTaskPostRequestInfo
  * @throws IOException if the JSON string is invalid with respect to KeywordsDataGoogleAdsKeywordsForKeywordsTaskPostRequestInfo
  */
 ...
 /**
  * Convert an instance of KeywordsDataGoogleAdsKeywordsForKeywordsTaskPostRequestInfo to an JSON string
  *
  * @return JSON string
  */
