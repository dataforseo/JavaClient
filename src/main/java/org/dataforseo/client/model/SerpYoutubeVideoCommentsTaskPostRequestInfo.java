...
public class SerpYoutubeVideoCommentsTaskPostRequestInfo {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.videoId, serpYoutubeVideoCommentsTaskPostRequestInfo.videoId) &&
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SerpYoutubeVideoCommentsTaskPostRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SerpYoutubeVideoCommentsTaskPostRequestInfo is not found in the empty JSON string", SerpYoutubeVideoCommentsTaskPostRequestInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SerpYoutubeVideoCommentsTaskPostRequestInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SerpYoutubeVideoCommentsTaskPostRequestInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
 ...
 /**
  * Create an instance of SerpYoutubeVideoCommentsTaskPostRequestInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SerpYoutubeVideoCommentsTaskPostRequestInfo
  * @throws IOException if the JSON string is invalid with respect to SerpYoutubeVideoCommentsTaskPostRequestInfo
  */
 ...
 /**
  * Convert an instance of SerpYoutubeVideoCommentsTaskPostRequestInfo to an JSON string
  *
  * @return JSON string
  */
