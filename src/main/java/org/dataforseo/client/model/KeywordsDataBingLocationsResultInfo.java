...
public class KeywordsDataBingLocationsResultInfo {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.locationCode, keywordsDataBingLocationsResultInfo.locationCode) &&
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KeywordsDataBingLocationsResultInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KeywordsDataBingLocationsResultInfo is not found in the empty JSON string", KeywordsDataBingLocationsResultInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KeywordsDataBingLocationsResultInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KeywordsDataBingLocationsResultInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
 ...
 /**
  * Create an instance of KeywordsDataBingLocationsResultInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of KeywordsDataBingLocationsResultInfo
  * @throws IOException if the JSON string is invalid with respect to KeywordsDataBingLocationsResultInfo
  */
 ...
 /**
  * Convert an instance of KeywordsDataBingLocationsResultInfo to an JSON string
  *
  * @return JSON string
  */
