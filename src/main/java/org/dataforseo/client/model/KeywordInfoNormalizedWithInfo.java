...
public class KeywordInfoNormalizedWithInfo {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(lastUpdatedTime, searchVolume, monthlySearches);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KeywordInfoNormalizedWithInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KeywordInfoNormalizedWithInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
