...
public class AppendixSerpDayStatisticsMoneyData {
  ...
  public AppendixSerpDayStatisticsMoneyData taskPost(Double taskPost) {
  ...
  **/
  ...
  public AppendixSerpDayStatisticsMoneyData taskGet(AppendixFunctionTypeInfo taskGet) {
  ...
  **/
  ...
  public AppendixSerpDayStatisticsMoneyData tasksReady(Double tasksReady) {
  ...
  **/
  ...
  public AppendixSerpDayStatisticsMoneyData locations(Double locations) {
  ...
  **/
  ...
  public AppendixSerpDayStatisticsMoneyData languages(Double languages) {
  ...
  **/
  ...
  public AppendixSerpDayStatisticsMoneyData live(AppendixFunctionTypeInfo live) {
    this.live = live;
    return this;
  }
  ...
  **/
  ...
  public AppendixSerpDayStatisticsMoneyData errors(Double errors) {
    this.errors = errors;
    return this;
  }
  ...
  **/
  ...
  public AppendixSerpDayStatisticsMoneyData tasksFixed(Double tasksFixed) {
  ...
  **/
  ...
  public AppendixSerpDayStatisticsMoneyData jobs(AppendixJobsSerpLimitsRatesDataInfo jobs) {
    this.jobs = jobs;
    return this;
  }
  ...
  **/
  ...
  public AppendixSerpDayStatisticsMoneyData screenshot(Double screenshot) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AppendixSerpDayStatisticsMoneyData appendixSerpDayStatisticsMoneyData = (AppendixSerpDayStatisticsMoneyData) o;
    return Objects.equals(this.taskPost, appendixSerpDayStatisticsMoneyData.taskPost) &&
        Objects.equals(this.taskGet, appendixSerpDayStatisticsMoneyData.taskGet) &&
        Objects.equals(this.tasksReady, appendixSerpDayStatisticsMoneyData.tasksReady) &&
        Objects.equals(this.locations, appendixSerpDayStatisticsMoneyData.locations) &&
        Objects.equals(this.languages, appendixSerpDayStatisticsMoneyData.languages) &&
        Objects.equals(this.live, appendixSerpDayStatisticsMoneyData.live) &&
        Objects.equals(this.errors, appendixSerpDayStatisticsMoneyData.errors) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(taskPost, taskGet, tasksReady, locations, languages, live, errors, tasksFixed, jobs, screenshot, aiSummary, refundMoney);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppendixSerpDayStatisticsMoneyData {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to AppendixSerpDayStatisticsMoneyData
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppendixSerpDayStatisticsMoneyData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppendixSerpDayStatisticsMoneyData is not found in the empty JSON string", AppendixSerpDayStatisticsMoneyData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppendixSerpDayStatisticsMoneyData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppendixSerpDayStatisticsMoneyData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppendixSerpDayStatisticsMoneyData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppendixSerpDayStatisticsMoneyData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppendixSerpDayStatisticsMoneyData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppendixSerpDayStatisticsMoneyData.class));

       return (TypeAdapter<T>) new TypeAdapter<AppendixSerpDayStatisticsMoneyData>() {
           @Override
           public void write(JsonWriter out, AppendixSerpDayStatisticsMoneyData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AppendixSerpDayStatisticsMoneyData read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AppendixSerpDayStatisticsMoneyData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppendixSerpDayStatisticsMoneyData
  * @throws IOException if the JSON string is invalid with respect to AppendixSerpDayStatisticsMoneyData
  */
  public static AppendixSerpDayStatisticsMoneyData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppendixSerpDayStatisticsMoneyData.class);
  }

 /**
  * Convert an instance of AppendixSerpDayStatisticsMoneyData to an JSON string
  *
  * @return JSON string
  */
