...
public class AppendixKeywordsDatasRatesDataInfo {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keywordsForKeywords, keywordsForSite, searchVolume, adTrafficByKeywords, languages, locations, tasksReady, explore, categories, errors, bing, keywordPerformance, locationsAndLanguages, googleAds, dataforseoTrends, clickstreamData);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppendixKeywordsDatasRatesDataInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppendixKeywordsDatasRatesDataInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
