...
public class OnPageResourcesRequestInfo {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, url, limit, offset, filters, relevantPagesFilters, orderBy, tag);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OnPageResourcesRequestInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OnPageResourcesRequestInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
