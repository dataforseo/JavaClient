...
public class BusinessDataGoogleLocationsResultInfo {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BusinessDataGoogleLocationsResultInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BusinessDataGoogleLocationsResultInfo is not found in the empty JSON string", BusinessDataGoogleLocationsResultInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BusinessDataGoogleLocationsResultInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BusinessDataGoogleLocationsResultInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
 ...
 /**
  * Create an instance of BusinessDataGoogleLocationsResultInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BusinessDataGoogleLocationsResultInfo
  * @throws IOException if the JSON string is invalid with respect to BusinessDataGoogleLocationsResultInfo
  */
 ...
 /**
  * Convert an instance of BusinessDataGoogleLocationsResultInfo to an JSON string
  *
  * @return JSON string
  */
