...
public class KeywordsDataBingSearchVolumeTaskPostRequestInfo {
  ...
  public KeywordsDataBingSearchVolumeTaskPostRequestInfo addKeywordsItem(String keywordsItem) {
   ...
   /**
   * keywords required field The maximum number of keywords you can specify: 200 The maximum number of characters for each keyword: 100 the specified keywords will be converted to lowercase, data will be provided in a separate array
   * @return keywords
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keywords, keywordsDataBingSearchVolumeTaskPostRequestInfo.keywords) &&
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KeywordsDataBingSearchVolumeTaskPostRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KeywordsDataBingSearchVolumeTaskPostRequestInfo is not found in the empty JSON string", KeywordsDataBingSearchVolumeTaskPostRequestInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KeywordsDataBingSearchVolumeTaskPostRequestInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KeywordsDataBingSearchVolumeTaskPostRequestInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
 ...
 /**
  * Create an instance of KeywordsDataBingSearchVolumeTaskPostRequestInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of KeywordsDataBingSearchVolumeTaskPostRequestInfo
  * @throws IOException if the JSON string is invalid with respect to KeywordsDataBingSearchVolumeTaskPostRequestInfo
  */
 ...
 /**
  * Convert an instance of KeywordsDataBingSearchVolumeTaskPostRequestInfo to an JSON string
  *
  * @return JSON string
  */
