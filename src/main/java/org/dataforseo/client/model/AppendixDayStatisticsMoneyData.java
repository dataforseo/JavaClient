...
import org.dataforseo.client.model.AppendixAppDataDayStatisticsMoneyData;
...
import org.dataforseo.client.model.AppendixBusinessDataDayStatisticsMoneyData;
...
import org.dataforseo.client.model.AppendixKeywordsDataDayStatisticsMoneyData;
import org.dataforseo.client.model.AppendixMerchantLimitsRatesDataInfo;
import org.dataforseo.client.model.AppendixOnPageDayStatisticsMoneyData;
import org.dataforseo.client.model.AppendixSerpDayStatisticsMoneyData;
...
public class AppendixDayStatisticsMoneyData {
  ...
  private AppendixKeywordsDataDayStatisticsMoneyData keywordsData;
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData total(Double total) {
    this.total = total;
    return this;
  }
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData totalSerp(Double totalSerp) {
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData keywordsData(AppendixKeywordsDataDayStatisticsMoneyData keywordsData) {
  ...
  **/
  @javax.annotation.Nullable
  public AppendixKeywordsDataDayStatisticsMoneyData getKeywordsData() {
    return keywordsData;
  }

  public void setKeywordsData(AppendixKeywordsDataDayStatisticsMoneyData keywordsData) {
    this.keywordsData = keywordsData;
  }


  public AppendixDayStatisticsMoneyData totalKeywordsData(Double totalKeywordsData) {
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData totalAppendix(Double totalAppendix) {
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData dataforseoLabs(AppendixDataforseoLabsDayStatisticsRatesData dataforseoLabs) {
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData totalDataforseoLabs(Double totalDataforseoLabs) {
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData domainAnalytics(AppendixDomainAnalyticsLimitsRatesDataInfo domainAnalytics) {
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData totalDomainAnalytics(Double totalDomainAnalytics) {
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData merchant(AppendixMerchantLimitsRatesDataInfo merchant) {
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData totalMerchant(Double totalMerchant) {
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData totalOnPage(Double totalOnPage) {
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData totalBusinessData(Double totalBusinessData) {
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData backlinks(AppendixBacklinksDayStatisticsRatesData backlinks) {
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData totalBacklinks(Double totalBacklinks) {
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData totalAppData(Double totalAppData) {
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData contentAnalysis(AppendixContentAnalysisLimitsRatesDataInfo contentAnalysis) {
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData totalContentAnalysis(Double totalContentAnalysis) {
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData contentGeneration(AppendixContentGenerationLimitsRatesDataInfo contentGeneration) {
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData totalContentGeneration(Double totalContentGeneration) {
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData value(String value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData totalTrafficAnalytics(Double totalTrafficAnalytics) {
  ...
  **/
  ...
  public AppendixDayStatisticsMoneyData totalReviews(Double totalReviews) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AppendixDayStatisticsMoneyData appendixDayStatisticsMoneyData = (AppendixDayStatisticsMoneyData) o;
    return Objects.equals(this.serp, appendixDayStatisticsMoneyData.serp) &&
        Objects.equals(this.total, appendixDayStatisticsMoneyData.total) &&
        Objects.equals(this.totalSerp, appendixDayStatisticsMoneyData.totalSerp) &&
        Objects.equals(this.keywordsData, appendixDayStatisticsMoneyData.keywordsData) &&
        Objects.equals(this.totalKeywordsData, appendixDayStatisticsMoneyData.totalKeywordsData) &&
        Objects.equals(this.appendix, appendixDayStatisticsMoneyData.appendix) &&
        Objects.equals(this.totalAppendix, appendixDayStatisticsMoneyData.totalAppendix) &&
        Objects.equals(this.dataforseoLabs, appendixDayStatisticsMoneyData.dataforseoLabs) &&
        Objects.equals(this.totalDataforseoLabs, appendixDayStatisticsMoneyData.totalDataforseoLabs) &&
        Objects.equals(this.domainAnalytics, appendixDayStatisticsMoneyData.domainAnalytics) &&
        Objects.equals(this.totalDomainAnalytics, appendixDayStatisticsMoneyData.totalDomainAnalytics) &&
        Objects.equals(this.merchant, appendixDayStatisticsMoneyData.merchant) &&
        Objects.equals(this.totalMerchant, appendixDayStatisticsMoneyData.totalMerchant) &&
        Objects.equals(this.onPage, appendixDayStatisticsMoneyData.onPage) &&
        Objects.equals(this.totalOnPage, appendixDayStatisticsMoneyData.totalOnPage) &&
        Objects.equals(this.businessData, appendixDayStatisticsMoneyData.businessData) &&
        Objects.equals(this.totalBusinessData, appendixDayStatisticsMoneyData.totalBusinessData) &&
        Objects.equals(this.backlinks, appendixDayStatisticsMoneyData.backlinks) &&
        Objects.equals(this.totalBacklinks, appendixDayStatisticsMoneyData.totalBacklinks) &&
        Objects.equals(this.appData, appendixDayStatisticsMoneyData.appData) &&
        Objects.equals(this.totalAppData, appendixDayStatisticsMoneyData.totalAppData) &&
        Objects.equals(this.contentAnalysis, appendixDayStatisticsMoneyData.contentAnalysis) &&
        Objects.equals(this.totalContentAnalysis, appendixDayStatisticsMoneyData.totalContentAnalysis) &&
        Objects.equals(this.contentGeneration, appendixDayStatisticsMoneyData.contentGeneration) &&
        Objects.equals(this.totalContentGeneration, appendixDayStatisticsMoneyData.totalContentGeneration) &&
        Objects.equals(this.value, appendixDayStatisticsMoneyData.value) &&
        Objects.equals(this.totalTrafficAnalytics, appendixDayStatisticsMoneyData.totalTrafficAnalytics) &&
        Objects.equals(this.totalReviews, appendixDayStatisticsMoneyData.totalReviews) &&
        Objects.equals(this.reviews, appendixDayStatisticsMoneyData.reviews);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppendixDayStatisticsMoneyData {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to AppendixDayStatisticsMoneyData
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppendixDayStatisticsMoneyData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppendixDayStatisticsMoneyData is not found in the empty JSON string", AppendixDayStatisticsMoneyData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppendixDayStatisticsMoneyData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppendixDayStatisticsMoneyData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("keywords_data") != null && !jsonObj.get("keywords_data").isJsonNull()) {
        AppendixKeywordsDataDayStatisticsMoneyData.validateJsonElement(jsonObj.get("keywords_data"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppendixDayStatisticsMoneyData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppendixDayStatisticsMoneyData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppendixDayStatisticsMoneyData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppendixDayStatisticsMoneyData.class));

       return (TypeAdapter<T>) new TypeAdapter<AppendixDayStatisticsMoneyData>() {
           @Override
           public void write(JsonWriter out, AppendixDayStatisticsMoneyData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AppendixDayStatisticsMoneyData read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AppendixDayStatisticsMoneyData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppendixDayStatisticsMoneyData
  * @throws IOException if the JSON string is invalid with respect to AppendixDayStatisticsMoneyData
  */
  public static AppendixDayStatisticsMoneyData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppendixDayStatisticsMoneyData.class);
  }

 /**
  * Convert an instance of AppendixDayStatisticsMoneyData to an JSON string
  *
  * @return JSON string
  */
