...
public class DomainAnalyticsErrorsRequestInfo {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.limit, domainAnalyticsErrorsRequestInfo.limit) &&
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DomainAnalyticsErrorsRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainAnalyticsErrorsRequestInfo is not found in the empty JSON string", DomainAnalyticsErrorsRequestInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DomainAnalyticsErrorsRequestInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DomainAnalyticsErrorsRequestInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
 ...
 /**
  * Create an instance of DomainAnalyticsErrorsRequestInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DomainAnalyticsErrorsRequestInfo
  * @throws IOException if the JSON string is invalid with respect to DomainAnalyticsErrorsRequestInfo
  */
 ...
 /**
  * Convert an instance of DomainAnalyticsErrorsRequestInfo to an JSON string
  *
  * @return JSON string
  */
