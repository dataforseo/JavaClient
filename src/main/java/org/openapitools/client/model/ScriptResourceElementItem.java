...
public class ScriptResourceElementItem extends BaseOnPageResourceItemInfo {
  ...
  **/
  ...
  public ScriptResourceElementItem statusCode(Integer statusCode) {
  ...
  **/
  ...
  public ScriptResourceElementItem location(String location) {
  ...
  **/
  ...
  public ScriptResourceElementItem url(String url) {
    this.url = url;
    return this;
  }
  ...
  **/
  ...
  public ScriptResourceElementItem size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public ScriptResourceElementItem encodedSize(Integer encodedSize) {
  ...
  **/
  ...
  public ScriptResourceElementItem totalTransferSize(Long totalTransferSize) {
  ...
  **/
  ...
  public ScriptResourceElementItem fetchTime(String fetchTime) {
  ...
  **/
  ...
  public ScriptResourceElementItem fetchTiming(FetchTiming fetchTiming) {
  ...
  **/
  ...
  public ScriptResourceElementItem cacheControl(CacheControl cacheControl) {
  ...
  **/
  ...
  public ScriptResourceElementItem checks(Map<String, Boolean> checks) {
    this.checks = checks;
    return this;
  }

  public ScriptResourceElementItem putChecksItem(String key, Boolean checksItem) {
    if (this.checks == null) {
  ...
  **/
  ...
  public ScriptResourceElementItem mediaType(String mediaType) {
  ...
  **/
  ...
  public ScriptResourceElementItem acceptType(String acceptType) {
  ...
  **/
  ...
  public ScriptResourceElementItem server(String server) {
    this.server = server;
    return this;
  }
  ...
  **/
  ...
  public ScriptResourceElementItem lastModified(LastModified lastModified) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ScriptResourceElementItem scriptResourceElementItem = (ScriptResourceElementItem) o;
    return Objects.equals(this.meta, scriptResourceElementItem.meta) &&
        Objects.equals(this.statusCode, scriptResourceElementItem.statusCode) &&
        Objects.equals(this.location, scriptResourceElementItem.location) &&
        Objects.equals(this.url, scriptResourceElementItem.url) &&
        Objects.equals(this.size, scriptResourceElementItem.size) &&
        Objects.equals(this.encodedSize, scriptResourceElementItem.encodedSize) &&
        Objects.equals(this.totalTransferSize, scriptResourceElementItem.totalTransferSize) &&
        Objects.equals(this.fetchTime, scriptResourceElementItem.fetchTime) &&
  ...
  public String toString() {
    ...
    sb.append("class ScriptResourceElementItem {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ScriptResourceElementItem
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScriptResourceElementItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScriptResourceElementItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScriptResourceElementItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScriptResourceElementItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScriptResourceElementItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScriptResourceElementItem.class));

       return (TypeAdapter<T>) new TypeAdapter<ScriptResourceElementItem>() {
           @Override
           public void write(JsonWriter out, ScriptResourceElementItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScriptResourceElementItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ScriptResourceElementItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ScriptResourceElementItem
  * @throws IOException if the JSON string is invalid with respect to ScriptResourceElementItem
  */
  public static ScriptResourceElementItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScriptResourceElementItem.class);
  }

 /**
  * Convert an instance of ScriptResourceElementItem to an JSON string
  *
  * @return JSON string
  */
