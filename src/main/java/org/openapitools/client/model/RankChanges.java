...
public class RankChanges {
  ...
  **/
  ...
  public RankChanges isNew(Boolean isNew) {
   ...
   /**
   * element was previously present in SERP if the value is true, previously collected SERP didn’t contain this element
   * @return isNew
  **/
  @javax.annotation.Nullable
  ...
  public RankChanges isUp(Boolean isUp) {
   ...
   /**
   * rank of this element went up if the value is true, position of the element in SERP is higher compared to the previous check
   * @return isUp
  **/
  @javax.annotation.Nullable
  ...
  public RankChanges isDown(Boolean isDown) {
   ...
   /**
   * rank of this element went down if the value is true, position of the element in SERP is lower compared to the previous check
   * @return isDown
  **/
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.previousRankAbsolute, rankChanges.previousRankAbsolute) &&
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RankChanges.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RankChanges is not found in the empty JSON string", RankChanges.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RankChanges.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RankChanges` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
 ...
 /**
  * Create an instance of RankChanges given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RankChanges
  * @throws IOException if the JSON string is invalid with respect to RankChanges
  */
 ...
 /**
  * Convert an instance of RankChanges to an JSON string
  *
  * @return JSON string
  */
