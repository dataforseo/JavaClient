...
* microdata value specified on a target web page
  ...
  private MessageInfo testResults;

  public MicrodataFieldsInfo testResults(MessageInfo testResults) {
...
* sub-type microdata test results that contain detected errors and related messages
   ...
   */
  @javax.annotation.Nullable
  public MessageInfo getTestResults() {
    return testResults;
  }

  public void setTestResults(MessageInfo testResults) {
    this.testResults = testResults;
  }
...
* an array of objects containing data fields related to the certain microdata type
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.name, microdataFieldsInfo.name) &&
