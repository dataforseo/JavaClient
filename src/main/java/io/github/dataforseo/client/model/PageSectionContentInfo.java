...
* you can find more information about content priority calculation in this help center article
  ...
  public PageSectionContentInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.primaryContent, pageSectionContentInfo.primaryContent) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PageSectionContentInfo>() {
           ...
           public PageSectionContentInfo read(JsonReader in) throws IOException {
             ...
             PageSectionContentInfo instance = thisAdapter.fromJsonTree(jsonObj);
