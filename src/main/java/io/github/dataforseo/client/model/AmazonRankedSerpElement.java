...
public class AmazonRankedSerpElement  {
  ...
  private AmazonInfo serpItem;

  public AmazonRankedSerpElement serpItem(AmazonInfo serpItem) {
...
* the list of supported SERP elements can be found below
   ...
   */
  @javax.annotation.Nullable
  public AmazonInfo getSerpItem() {
    return serpItem;
  }

  public void setSerpItem(AmazonInfo serpItem) {
    this.serpItem = serpItem;
  }
...
* 2020-09-12T00:07:43.0733218Z
  ...
  public AmazonRankedSerpElement putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.seType, amazonRankedSerpElement.seType) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AmazonRankedSerpElement>() {
           ...
           public AmazonRankedSerpElement read(JsonReader in) throws IOException {
             ...
             AmazonRankedSerpElement instance = thisAdapter.fromJsonTree(jsonObj);
