...
public class SerpGoogleFinanceQuoteTaskPostRequestInfo {
   ...
   * @return the SerpGoogleFinanceQuoteTaskPostRequestInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyword, serpGoogleFinanceQuoteTaskPostRequestInfo.keyword) &&
        ...
        Objects.equals(this.additionalProperties, serpGoogleFinanceQuoteTaskPostRequestInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keyword, locationName, locationCode, languageName, languageCode, priority, device, os, window, tag, postbackUrl, postbackData, pingbackUrl, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SerpGoogleFinanceQuoteTaskPostRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SerpGoogleFinanceQuoteTaskPostRequestInfo is not found in the empty JSON string", SerpGoogleFinanceQuoteTaskPostRequestInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of SerpGoogleFinanceQuoteTaskPostRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SerpGoogleFinanceQuoteTaskPostRequestInfo
   * @throws IOException if the JSON string is invalid with respect to SerpGoogleFinanceQuoteTaskPostRequestInfo
   */
  ...
  /**
   * Convert an instance of SerpGoogleFinanceQuoteTaskPostRequestInfo to an JSON string
   *
   * @return JSON string
   */
