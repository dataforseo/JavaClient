...
public class GoogleShoppingSerpMerchantSerpElementItem extends BaseMerchantSerpElementItem {
   ...
   * @return the GoogleShoppingSerpMerchantSerpElementItem instance itself
   */
  public GoogleShoppingSerpMerchantSerpElementItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.xpath, googleShoppingSerpMerchantSerpElementItem.xpath) &&
        ...
        Objects.equals(this.additionalProperties, googleShoppingSerpMerchantSerpElementItem.additionalProperties) &&
        super.equals(o);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("shopping_url") != null && !jsonObj.get("shopping_url").isJsonNull()) && !jsonObj.get("shopping_url").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `shopping_url` to be a primitive type in the JSON string but got `%s`", jsonObj.get("shopping_url").toString()));
      }
      ...
      // validate the optional field `shop_rating`
      if (jsonObj.get("shop_rating") != null && !jsonObj.get("shop_rating").isJsonNull()) {
        RatingElement.validateJsonElement(jsonObj.get("shop_rating"));
      }
      // ensure the optional json data is an array if present
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GoogleShoppingSerpMerchantSerpElementItem>() {
           ...
           public GoogleShoppingSerpMerchantSerpElementItem read(JsonReader in) throws IOException {
             ...
             GoogleShoppingSerpMerchantSerpElementItem instance = thisAdapter.fromJsonTree(jsonObj);
