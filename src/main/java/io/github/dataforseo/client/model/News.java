...
public class News {
  ...
  private List<BaseGoogleFinanceSerpElementItem> quotes;
  ...
  public News timestamp(String timestamp) {
  ...
  public News quotes(List<BaseGoogleFinanceSerpElementItem> quotes) {
    this.quotes = quotes;
    return this;
  }

  public News addQuotesItem(BaseGoogleFinanceSerpElementItem quotesItem) {
    if (this.quotes == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<BaseGoogleFinanceSerpElementItem> getQuotes() {
    return quotes;
  }

  public void setQuotes(List<BaseGoogleFinanceSerpElementItem> quotes) {
    this.quotes = quotes;
  }
  ...
  public boolean equals(Object o) {
    ...
    News news = (News) o;
    return Objects.equals(this.type, news.type) &&
        ...
        Objects.equals(this.quotes, news.quotes)&&
      ...
      if (jsonObj.get("quotes") != null && !jsonObj.get("quotes").isJsonNull()) {
        ...
        if (jsonArrayquotes != null) {
          ...
          for (int i = 0; i < jsonArrayquotes.size(); i++) {
            BaseGoogleFinanceSerpElementItem.validateJsonElement(jsonArrayquotes.get(i));
          };
        }
      }
  }
