...
public class BacklinksPageIntersectionLiveRequestInfo {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(targets, excludeTargets, backlinksStatusType, filters, orderBy, offset, limit, internalListLimit, includeSubdomains, includeIndirectLinks, excludeInternalBacklinks, intersectionMode, tag, additionalProperties);
  }
