...
public class BusinessDataGoogleHotelInfoLiveAdvancedResultInfo  {
  ...
  /**
   * <em>identifier received in a POST array</em><br>this field will contain the <code>hotel_identifier</code> parameter specified when setting a task;<br>example:<br><code>CgoI-KWyzenM_MV3EAE</code>
