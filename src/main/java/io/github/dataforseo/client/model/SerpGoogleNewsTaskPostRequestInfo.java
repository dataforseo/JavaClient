...
* learn more on our Help Center
  ...
  @Override
  public int hashCode() {
  return Objects.hash(keyword, url, priority, locationName, locationCode, locationCoordinate, languageName, languageCode, os, calculateRectangles, browserScreenWidth, browserScreenHeight, browserScreenResolutionRatio, seDomain, depth, maxCrawlPages, searchParam, tag, postbackUrl, postbackData, pingbackUrl);
  }
