...
public class ImagesSerpElementItem  extends BaseSerpApiElementItem  {
  ...
  /**
   * <em>contains keywords and images related to the specified search term</em><br><strong>Note:</strong> this array is deprecated and always returns <code>null</code>
   * @deprecated
  ...
  public ImagesSerpElementItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.rankGroup, imagesSerpElementItem.rankGroup) &&
  ...
  @Override
  public int hashCode() {
  return Objects.hash(rankGroup, rankAbsolute, title, url, items, relatedImageSearches);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ImagesSerpElementItem>() {
           ...
           public ImagesSerpElementItem read(JsonReader in) throws IOException {
             ...
             ImagesSerpElementItem instance = thisAdapter.fromJsonTree(jsonObj);
