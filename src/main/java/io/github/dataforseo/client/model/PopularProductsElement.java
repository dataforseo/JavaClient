...
public class PopularProductsElement  {
  ...
  public static final String SERIALIZED_NAME_MORE_SELLERS = "more_sellers";
  @SerializedName(SERIALIZED_NAME_MORE_SELLERS)
  private Boolean moreSellers;

  public PopularProductsElement moreSellers(Boolean moreSellers) {
    this.moreSellers = moreSellers;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public Boolean getMoreSellers() {
    return moreSellers;
  }

  public void setMoreSellers(Boolean moreSellers) {
    this.moreSellers = moreSellers;
  }
