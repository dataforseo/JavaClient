...
* represents the list of related topics with the biggest increase in search frequency since the last time period
  ...
  public TrendsTopicListDataInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.top, trendsTopicListDataInfo.top) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TrendsTopicListDataInfo>() {
           ...
           public TrendsTopicListDataInfo read(JsonReader in) throws IOException {
             ...
             TrendsTopicListDataInfo instance = thisAdapter.fromJsonTree(jsonObj);
