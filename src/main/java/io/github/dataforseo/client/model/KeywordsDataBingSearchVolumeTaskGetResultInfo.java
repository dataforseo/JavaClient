...
* if there is no data, then the value is null
  ...
  public KeywordsDataBingSearchVolumeTaskGetResultInfo competition(Double competition) {
...
* if there is no data the value is null
  ...
  public KeywordsDataBingSearchVolumeTaskGetResultInfo cpc(Double cpc) {
    this.cpc = cpc;
    return this;
  }
...
* our API doesn’t return categories for this endpoint: the parameter will always equal null
  ...
  public KeywordsDataBingSearchVolumeTaskGetResultInfo monthlySearches(List<MonthlySearchesInfo> monthlySearches) {
...
* if there is no data then the value is null
  ...
  public KeywordsDataBingSearchVolumeTaskGetResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.keyword, keywordsDataBingSearchVolumeTaskGetResultInfo.keyword) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<KeywordsDataBingSearchVolumeTaskGetResultInfo>() {
           ...
           public KeywordsDataBingSearchVolumeTaskGetResultInfo read(JsonReader in) throws IOException {
             ...
             KeywordsDataBingSearchVolumeTaskGetResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
