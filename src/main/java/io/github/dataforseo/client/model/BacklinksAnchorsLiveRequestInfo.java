...
public class BacklinksAnchorsLiveRequestInfo  {
  ...
  public BacklinksAnchorsLiveRequestInfo target(String target) {
    this.target = target;
    return this;
  }

  /**
   * <em>domain, subdomain or webpage to get anchors for</em><br><strong>required field</strong><br>a domain or a subdomain should be specified without <code>https://</code> and <code>www.</code><br>a page should be specified with absolute URL (including <code>http://</code> or <code>https://</code>)
   * @return target
   */
  ...
  public BacklinksAnchorsLiveRequestInfo limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public BacklinksAnchorsLiveRequestInfo offset(Integer offset) {
    this.offset = offset;
    return this;
  }
  ...
  public BacklinksAnchorsLiveRequestInfo internalListLimit(Integer internalListLimit) {
  ...
  public BacklinksAnchorsLiveRequestInfo backlinksStatusType(String backlinksStatusType) {
  ...
  public BacklinksAnchorsLiveRequestInfo filters(List<Object> filters) {
  ...
  public BacklinksAnchorsLiveRequestInfo orderBy(List<String> orderBy) {
  ...
  public BacklinksAnchorsLiveRequestInfo backlinksFilters(List<Object> backlinksFilters) {
  ...
  public BacklinksAnchorsLiveRequestInfo includeSubdomains(Boolean includeSubdomains) {
  ...
  public BacklinksAnchorsLiveRequestInfo includeIndirectLinks(Boolean includeIndirectLinks) {
  ...
  public BacklinksAnchorsLiveRequestInfo excludeInternalBacklinks(Boolean excludeInternalBacklinks) {
  ...
  public BacklinksAnchorsLiveRequestInfo rankScale(String rankScale) {
  ...
  public BacklinksAnchorsLiveRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public BacklinksAnchorsLiveRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BacklinksAnchorsLiveRequestInfo backlinksAnchorsLiveRequestInfo = (BacklinksAnchorsLiveRequestInfo) o;
    return

        Objects.equals(this.target, backlinksAnchorsLiveRequestInfo.target) &&
        Objects.equals(this.limit, backlinksAnchorsLiveRequestInfo.limit) &&
        Objects.equals(this.offset, backlinksAnchorsLiveRequestInfo.offset) &&
        Objects.equals(this.internalListLimit, backlinksAnchorsLiveRequestInfo.internalListLimit) &&
        Objects.equals(this.backlinksStatusType, backlinksAnchorsLiveRequestInfo.backlinksStatusType) &&
        Objects.equals(this.filters, backlinksAnchorsLiveRequestInfo.filters) &&
        Objects.equals(this.orderBy, backlinksAnchorsLiveRequestInfo.orderBy) &&
        Objects.equals(this.backlinksFilters, backlinksAnchorsLiveRequestInfo.backlinksFilters) &&
        Objects.equals(this.includeSubdomains, backlinksAnchorsLiveRequestInfo.includeSubdomains) &&
        Objects.equals(this.includeIndirectLinks, backlinksAnchorsLiveRequestInfo.includeIndirectLinks) &&
        Objects.equals(this.excludeInternalBacklinks, backlinksAnchorsLiveRequestInfo.excludeInternalBacklinks) &&
        Objects.equals(this.rankScale, backlinksAnchorsLiveRequestInfo.rankScale) &&
        Objects.equals(this.tag, backlinksAnchorsLiveRequestInfo.tag);  
  ...
  public String toString() {
    ...
    sb.append("class BacklinksAnchorsLiveRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BacklinksAnchorsLiveRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BacklinksAnchorsLiveRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BacklinksAnchorsLiveRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BacklinksAnchorsLiveRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BacklinksAnchorsLiveRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<BacklinksAnchorsLiveRequestInfo>() {
           @Override
           public void write(JsonWriter out, BacklinksAnchorsLiveRequestInfo value) throws IOException {
           ...
           @Override
           public BacklinksAnchorsLiveRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             BacklinksAnchorsLiveRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static BacklinksAnchorsLiveRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BacklinksAnchorsLiveRequestInfo.class);
  }
