...
public class AppendixOnPageDayStatisticsMoneyData {
  ...
  public AppendixOnPageDayStatisticsMoneyData() {
  }

  public AppendixOnPageDayStatisticsMoneyData taskPost(Double taskPost) {
  ...
  public AppendixOnPageDayStatisticsMoneyData tasksReady(Double tasksReady) {
  ...
  public AppendixOnPageDayStatisticsMoneyData summary(Double summary) {
  ...
  public AppendixOnPageDayStatisticsMoneyData resources(Double resources) {
  ...
  public AppendixOnPageDayStatisticsMoneyData pages(Double pages) {
    this.pages = pages;
    return this;
  }
  ...
  public AppendixOnPageDayStatisticsMoneyData nonIndexable(Double nonIndexable) {
  ...
  public AppendixOnPageDayStatisticsMoneyData duplicateTags(Double duplicateTags) {
  ...
  public AppendixOnPageDayStatisticsMoneyData links(Double links) {
    this.links = links;
    return this;
  }
  ...
  public AppendixOnPageDayStatisticsMoneyData waterfall(Double waterfall) {
  ...
  public AppendixOnPageDayStatisticsMoneyData errors(Double errors) {
    this.errors = errors;
    return this;
  }
  ...
  public AppendixOnPageDayStatisticsMoneyData pagesByResource(Double pagesByResource) {
  ...
  public AppendixOnPageDayStatisticsMoneyData duplicateContent(Double duplicateContent) {
  ...
  public AppendixOnPageDayStatisticsMoneyData rawHtml(Double rawHtml) {
  ...
  public AppendixOnPageDayStatisticsMoneyData instantPages(Double instantPages) {
  ...
  public AppendixOnPageDayStatisticsMoneyData redirectChains(Double redirectChains) {
  ...
  public AppendixOnPageDayStatisticsMoneyData lighthouse(AppendixInfo lighthouse) {
  ...
  public AppendixOnPageDayStatisticsMoneyData keywordDensity(Double keywordDensity) {
  ...
  public AppendixOnPageDayStatisticsMoneyData pageScreenshot(Double pageScreenshot) {
  ...
  public AppendixOnPageDayStatisticsMoneyData contentParsing(Double contentParsing) {
  ...
  public AppendixOnPageDayStatisticsMoneyData contentParsingLive(Double contentParsingLive) {
  ...
  public AppendixOnPageDayStatisticsMoneyData refundMoney(Double refundMoney) {
   ...
   * @return the AppendixOnPageDayStatisticsMoneyData instance itself
   */
  public AppendixOnPageDayStatisticsMoneyData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AppendixOnPageDayStatisticsMoneyData appendixOnPageDayStatisticsMoneyData = (AppendixOnPageDayStatisticsMoneyData) o;
    return Objects.equals(this.taskPost, appendixOnPageDayStatisticsMoneyData.taskPost) &&
        Objects.equals(this.tasksReady, appendixOnPageDayStatisticsMoneyData.tasksReady) &&
        Objects.equals(this.summary, appendixOnPageDayStatisticsMoneyData.summary) &&
        Objects.equals(this.resources, appendixOnPageDayStatisticsMoneyData.resources) &&
        Objects.equals(this.pages, appendixOnPageDayStatisticsMoneyData.pages) &&
        Objects.equals(this.nonIndexable, appendixOnPageDayStatisticsMoneyData.nonIndexable) &&
        Objects.equals(this.duplicateTags, appendixOnPageDayStatisticsMoneyData.duplicateTags) &&
        Objects.equals(this.links, appendixOnPageDayStatisticsMoneyData.links) &&
        Objects.equals(this.waterfall, appendixOnPageDayStatisticsMoneyData.waterfall) &&
        Objects.equals(this.errors, appendixOnPageDayStatisticsMoneyData.errors) &&
        Objects.equals(this.pagesByResource, appendixOnPageDayStatisticsMoneyData.pagesByResource) &&
        Objects.equals(this.duplicateContent, appendixOnPageDayStatisticsMoneyData.duplicateContent) &&
        Objects.equals(this.rawHtml, appendixOnPageDayStatisticsMoneyData.rawHtml) &&
        Objects.equals(this.instantPages, appendixOnPageDayStatisticsMoneyData.instantPages) &&
        Objects.equals(this.redirectChains, appendixOnPageDayStatisticsMoneyData.redirectChains) &&
        Objects.equals(this.lighthouse, appendixOnPageDayStatisticsMoneyData.lighthouse) &&
        Objects.equals(this.keywordDensity, appendixOnPageDayStatisticsMoneyData.keywordDensity) &&
        Objects.equals(this.pageScreenshot, appendixOnPageDayStatisticsMoneyData.pageScreenshot) &&
        Objects.equals(this.contentParsing, appendixOnPageDayStatisticsMoneyData.contentParsing) &&
        Objects.equals(this.contentParsingLive, appendixOnPageDayStatisticsMoneyData.contentParsingLive) &&
        Objects.equals(this.refundMoney, appendixOnPageDayStatisticsMoneyData.refundMoney)&&
        Objects.equals(this.additionalProperties, appendixOnPageDayStatisticsMoneyData.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(taskPost, tasksReady, summary, resources, pages, nonIndexable, duplicateTags, links, waterfall, errors, pagesByResource, duplicateContent, rawHtml, instantPages, redirectChains, lighthouse, keywordDensity, pageScreenshot, contentParsing, contentParsingLive, refundMoney, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppendixOnPageDayStatisticsMoneyData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppendixOnPageDayStatisticsMoneyData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppendixOnPageDayStatisticsMoneyData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppendixOnPageDayStatisticsMoneyData is not found in the empty JSON string", AppendixOnPageDayStatisticsMoneyData.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppendixOnPageDayStatisticsMoneyData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppendixOnPageDayStatisticsMoneyData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppendixOnPageDayStatisticsMoneyData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppendixOnPageDayStatisticsMoneyData.class));

       return (TypeAdapter<T>) new TypeAdapter<AppendixOnPageDayStatisticsMoneyData>() {
           @Override
           public void write(JsonWriter out, AppendixOnPageDayStatisticsMoneyData value) throws IOException {
           ...
           @Override
           public AppendixOnPageDayStatisticsMoneyData read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AppendixOnPageDayStatisticsMoneyData instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AppendixOnPageDayStatisticsMoneyData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppendixOnPageDayStatisticsMoneyData
   * @throws IOException if the JSON string is invalid with respect to AppendixOnPageDayStatisticsMoneyData
   */
  public static AppendixOnPageDayStatisticsMoneyData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppendixOnPageDayStatisticsMoneyData.class);
  }

  /**
   * Convert an instance of AppendixOnPageDayStatisticsMoneyData to an JSON string
   *
   * @return JSON string
   */
