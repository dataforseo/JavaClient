...
public class AppendixGoogleBusinessDataPriceDataInfo  {
  ...
  public AppendixGoogleBusinessDataPriceDataInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.live, appendixGoogleBusinessDataPriceDataInfo.live) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AppendixGoogleBusinessDataPriceDataInfo>() {
           ...
           public AppendixGoogleBusinessDataPriceDataInfo read(JsonReader in) throws IOException {
             ...
             AppendixGoogleBusinessDataPriceDataInfo instance = thisAdapter.fromJsonTree(jsonObj);
