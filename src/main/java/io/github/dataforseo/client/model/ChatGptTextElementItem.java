...
public class ChatGptTextElementItem  extends BaseChatGptLlmScraperElementItem  {
  ...
  public ChatGptTextElementItem markdown(String markdown) {
...
* content of the result formatted in the markdown markup language
  ...
  public ChatGptTextElementItem sources(List<ChatGptSource> sources) {
...
* contains information on brands mentioned in the text
  ...
  public ChatGptTextElementItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ChatGptTextElementItem chatGptTextElementItem = (ChatGptTextElementItem) o;
    return
  ...
  public String toString() {
    ...
    sb.append("class ChatGptTextElementItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChatGptTextElementItem
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChatGptTextElementItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChatGptTextElementItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChatGptTextElementItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChatGptTextElementItem.class));

       return (TypeAdapter<T>) new TypeAdapter<ChatGptTextElementItem>() {
           @Override
           public void write(JsonWriter out, ChatGptTextElementItem value) throws IOException {
           ...
           @Override
           public ChatGptTextElementItem read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ChatGptTextElementItem instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static ChatGptTextElementItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChatGptTextElementItem.class);
  }
