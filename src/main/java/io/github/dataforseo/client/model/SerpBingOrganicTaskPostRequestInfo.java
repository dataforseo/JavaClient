...
public class SerpBingOrganicTaskPostRequestInfo {
   ...
   * @return the SerpBingOrganicTaskPostRequestInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, serpBingOrganicTaskPostRequestInfo.url) &&
        ...
        Objects.equals(this.additionalProperties, serpBingOrganicTaskPostRequestInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(url, keyword, priority, locationName, locationCode, locationCoordinate, languageName, languageCode, device, os, depth, maxCrawlPages, calculateRectangles, browserScreenWidth, browserScreenHeight, browserScreenResolutionRatio, searchParam, tag, postbackUrl, postbackData, pingbackUrl, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SerpBingOrganicTaskPostRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SerpBingOrganicTaskPostRequestInfo is not found in the empty JSON string", SerpBingOrganicTaskPostRequestInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of SerpBingOrganicTaskPostRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SerpBingOrganicTaskPostRequestInfo
   * @throws IOException if the JSON string is invalid with respect to SerpBingOrganicTaskPostRequestInfo
   */
  ...
  /**
   * Convert an instance of SerpBingOrganicTaskPostRequestInfo to an JSON string
   *
   * @return JSON string
   */
