...
public class Values {
   ...
   * @return the Values instance itself
   */
  public Values putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.geoId, values.geoId) &&
        ...
        Objects.equals(this.additionalProperties, values.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Values>() {
           ...
           public Values read(JsonReader in) throws IOException {
             ...
             Values instance = thisAdapter.fromJsonTree(jsonObj);
