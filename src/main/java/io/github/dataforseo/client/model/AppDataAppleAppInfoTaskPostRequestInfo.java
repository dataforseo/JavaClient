...
public class AppDataAppleAppInfoTaskPostRequestInfo  {
  ...
  /**
   * <em>id of the app</em><br><strong>required field</strong><br>ID of the mobile application on App Store;<br>you can find the ID in the URL of every app listed on App Store;<br>example:<br>in the URL `https://apps.apple.com/us/app/id<strong>835599320</strong>`<br>the id is `835599320`
   * @return appId
   */
