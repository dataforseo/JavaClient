...
public class DataforseoLabsGoogleRelatedKeywordsLiveRequestInfo {
  ...
  /**
   * keyword required field UTF-8 encoding the keywords will be converted to lowercase format
   * @return keyword
   */
   ...
   * @return the DataforseoLabsGoogleRelatedKeywordsLiveRequestInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyword, dataforseoLabsGoogleRelatedKeywordsLiveRequestInfo.keyword) &&
        ...
        Objects.equals(this.additionalProperties, dataforseoLabsGoogleRelatedKeywordsLiveRequestInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keyword, locationName, locationCode, languageName, languageCode, depth, includeSeedKeyword, includeSerpInfo, includeClickstreamData, ignoreSynonyms, replaceWithCoreKeyword, filters, orderBy, limit, offset, tag, additionalProperties);
  }
