...
public class OnPageContentParsingLiveRequestInfo {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(url, customUserAgent, customJs, browserPreset, browserScreenWidth, browserScreenHeight, browserScreenScaleFactor, storeRawHtml, disableCookiePopup, acceptLanguage, enableJavascript, enableBrowserRendering, enableXhr, switchPool, ipPoolForScan, additionalProperties);
  }
