...
* learn more about tokens on our help center
  ...
  public ContentGenerationGenerateMetaTagsLiveRequestInfo creativityIndex(Double creativityIndex) {
...
* you will find the specified tag value in the data object of the response
  ...
  public ContentGenerationGenerateMetaTagsLiveRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.text, contentGenerationGenerateMetaTagsLiveRequestInfo.text) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContentGenerationGenerateMetaTagsLiveRequestInfo>() {
           ...
           public ContentGenerationGenerateMetaTagsLiveRequestInfo read(JsonReader in) throws IOException {
             ...
             ContentGenerationGenerateMetaTagsLiveRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
