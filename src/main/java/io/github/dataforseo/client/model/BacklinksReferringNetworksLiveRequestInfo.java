...
public class BacklinksReferringNetworksLiveRequestInfo  {
  ...
  public BacklinksReferringNetworksLiveRequestInfo target(String target) {
    this.target = target;
    return this;
  }

  /**
   * <em>domain, subdomain or webpage to get referring networks for</em><br><strong>required field</strong><br>a domain or a subdomain should be specified without <code>https://</code> and <code>www.</code><br>a page should be specified with absolute URL (including <code>http://</code> or <code>https://</code>)
   * @return target
   */
  ...
  public static final String SERIALIZED_NAME_NETWORK_ADDRESS_TYPE = "network_address_type";
  @SerializedName(SERIALIZED_NAME_NETWORK_ADDRESS_TYPE)
  private String networkAddressType;

  public BacklinksReferringNetworksLiveRequestInfo networkAddressType(String networkAddressType) {
    this.networkAddressType = networkAddressType;
    return this;
  }

  /**
   * <em>indicates the type of network to get data for</em><br>optional field<br>possible values: <code>ip</code>, <code>subnet</code><br>default value: <code>ip</code>
  ...
  public void setNetworkAddressType(String networkAddressType) {
    this.networkAddressType = networkAddressType;
  }
  ...
  public BacklinksReferringNetworksLiveRequestInfo limit(Integer limit) {
    this.limit = limit;
    return this;
  }

  /**
   * <em>the maximum number of returned networks</em><br>optional field<br>default value: <code>100</code><br>maximum value: <code>1000</code>
   * @return limit
   */
  @javax.annotation.Nullable
  ...
  public BacklinksReferringNetworksLiveRequestInfo offset(Integer offset) {
    this.offset = offset;
    return this;
  }

  /**
   * <em>offset in the results array of returned networks</em><br>optional field<br>default value: <code>0</code><br>if you specify the <code>10</code> value, the first ten domains in the results array will be omitted and the data will be provided for the successive pages
   * @return offset
   */
  @javax.annotation.Nullable
  ...
  public BacklinksReferringNetworksLiveRequestInfo internalListLimit(Integer internalListLimit) {
  ...
  public BacklinksReferringNetworksLiveRequestInfo backlinksStatusType(String backlinksStatusType) {
  ...
  public BacklinksReferringNetworksLiveRequestInfo filters(List<Object> filters) {
  ...
  public BacklinksReferringNetworksLiveRequestInfo orderBy(List<String> orderBy) {
  ...
  public BacklinksReferringNetworksLiveRequestInfo backlinksFilters(List<Object> backlinksFilters) {
  ...
  public BacklinksReferringNetworksLiveRequestInfo includeSubdomains(Boolean includeSubdomains) {
  ...
  public BacklinksReferringNetworksLiveRequestInfo includeIndirectLinks(Boolean includeIndirectLinks) {
  ...
  public BacklinksReferringNetworksLiveRequestInfo excludeInternalBacklinks(Boolean excludeInternalBacklinks) {
    this.excludeInternalBacklinks = excludeInternalBacklinks;
    return this;
  }

  /**
   * <em>indicates whether the backlinks from subdomains of the <code>target</code> are excluded</em><br>optional field<br>if set to <code>false</code>, the backlinks from subdomains of the <code>target</code> will be ommited and you won't receive the same domain in the response;<br>default value: <code>true</code>
  ...
  public BacklinksReferringNetworksLiveRequestInfo rankScale(String rankScale) {
  ...
  public BacklinksReferringNetworksLiveRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public BacklinksReferringNetworksLiveRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BacklinksReferringNetworksLiveRequestInfo backlinksReferringNetworksLiveRequestInfo = (BacklinksReferringNetworksLiveRequestInfo) o;
    return

        Objects.equals(this.target, backlinksReferringNetworksLiveRequestInfo.target) &&
        Objects.equals(this.networkAddressType, backlinksReferringNetworksLiveRequestInfo.networkAddressType) &&
        Objects.equals(this.limit, backlinksReferringNetworksLiveRequestInfo.limit) &&
        Objects.equals(this.offset, backlinksReferringNetworksLiveRequestInfo.offset) &&
        Objects.equals(this.internalListLimit, backlinksReferringNetworksLiveRequestInfo.internalListLimit) &&
        Objects.equals(this.backlinksStatusType, backlinksReferringNetworksLiveRequestInfo.backlinksStatusType) &&
        Objects.equals(this.filters, backlinksReferringNetworksLiveRequestInfo.filters) &&
        Objects.equals(this.orderBy, backlinksReferringNetworksLiveRequestInfo.orderBy) &&
        Objects.equals(this.backlinksFilters, backlinksReferringNetworksLiveRequestInfo.backlinksFilters) &&
        Objects.equals(this.includeSubdomains, backlinksReferringNetworksLiveRequestInfo.includeSubdomains) &&
        Objects.equals(this.includeIndirectLinks, backlinksReferringNetworksLiveRequestInfo.includeIndirectLinks) &&
        Objects.equals(this.excludeInternalBacklinks, backlinksReferringNetworksLiveRequestInfo.excludeInternalBacklinks) &&
        Objects.equals(this.rankScale, backlinksReferringNetworksLiveRequestInfo.rankScale) &&
        Objects.equals(this.tag, backlinksReferringNetworksLiveRequestInfo.tag);  
  ...
  @Override
  public int hashCode() {
  return Objects.hash(target, networkAddressType, limit, offset, internalListLimit, backlinksStatusType, filters, orderBy, backlinksFilters, includeSubdomains, includeIndirectLinks, excludeInternalBacklinks, rankScale, tag);
  }
  ...
  public String toString() {
    ...
    sb.append("class BacklinksReferringNetworksLiveRequestInfo {\n");

    sb.append("    target: ").append(toIndentedString(target)).append("\n");
    sb.append("    networkAddressType: ").append(toIndentedString(networkAddressType)).append("\n");
  ...
  static {
    ...
    openapiFields.add("network_address_type");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BacklinksReferringNetworksLiveRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BacklinksReferringNetworksLiveRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BacklinksReferringNetworksLiveRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BacklinksReferringNetworksLiveRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BacklinksReferringNetworksLiveRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<BacklinksReferringNetworksLiveRequestInfo>() {
           @Override
           public void write(JsonWriter out, BacklinksReferringNetworksLiveRequestInfo value) throws IOException {
           ...
           @Override
           public BacklinksReferringNetworksLiveRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             BacklinksReferringNetworksLiveRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static BacklinksReferringNetworksLiveRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BacklinksReferringNetworksLiveRequestInfo.class);
  }
