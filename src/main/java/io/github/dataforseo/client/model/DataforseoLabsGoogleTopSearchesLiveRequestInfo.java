...
public class DataforseoLabsGoogleTopSearchesLiveRequestInfo  {
  ...
  public DataforseoLabsGoogleTopSearchesLiveRequestInfo locationName(String locationName) {
...
* United Kingdom
  ...
  public DataforseoLabsGoogleTopSearchesLiveRequestInfo locationCode(Integer locationCode) {
...
* 2840
  ...
  public DataforseoLabsGoogleTopSearchesLiveRequestInfo languageName(String languageName) {
...
* English
  ...
  public DataforseoLabsGoogleTopSearchesLiveRequestInfo languageCode(String languageCode) {
...
* en
  ...
  public DataforseoLabsGoogleTopSearchesLiveRequestInfo includeSerpInfo(Boolean includeSerpInfo) {
...
* learn more about how clickstream-based metrics are calculated in this help center article
  ...
  public DataforseoLabsGoogleTopSearchesLiveRequestInfo ignoreSynonyms(Boolean ignoreSynonyms) {
...
* default value: false
  ...
  public DataforseoLabsGoogleTopSearchesLiveRequestInfo filters(List<Object> filters) {
...
* for more information about filters, please refer to Dataforseo Labs – Filters or this help center guide
  ...
  public DataforseoLabsGoogleTopSearchesLiveRequestInfo orderBy(List<String> orderBy) {
...
* ['keyword_info.search_volume,desc','keyword_info.cpc,desc']
  ...
  public DataforseoLabsGoogleTopSearchesLiveRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
...
* you will find the specified tag value in the data object of the response
  ...
  public DataforseoLabsGoogleTopSearchesLiveRequestInfo limit(Integer limit) {
    this.limit = limit;
    return this;
  }
...
* maximum value: 1000
  ...
  public DataforseoLabsGoogleTopSearchesLiveRequestInfo offset(Integer offset) {
    this.offset = offset;
    return this;
  }
...
* if you specify the 10 value, the first ten keywords in the results array will be omitted and the data will be provided for the successive keywords
  ...
  public DataforseoLabsGoogleTopSearchesLiveRequestInfo offsetToken(String offsetToken) {
...
* Note: if the offset_token is specified in the request, all other parameters except limit will not be taken into account when processing a task.
  ...
  public DataforseoLabsGoogleTopSearchesLiveRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DataforseoLabsGoogleTopSearchesLiveRequestInfo dataforseoLabsGoogleTopSearchesLiveRequestInfo = (DataforseoLabsGoogleTopSearchesLiveRequestInfo) o;
    return

        Objects.equals(this.locationName, dataforseoLabsGoogleTopSearchesLiveRequestInfo.locationName) &&
        Objects.equals(this.locationCode, dataforseoLabsGoogleTopSearchesLiveRequestInfo.locationCode) &&
        ...
        Objects.equals(this.tag, dataforseoLabsGoogleTopSearchesLiveRequestInfo.tag) &&
        Objects.equals(this.limit, dataforseoLabsGoogleTopSearchesLiveRequestInfo.limit) &&
        Objects.equals(this.offset, dataforseoLabsGoogleTopSearchesLiveRequestInfo.offset) &&
        Objects.equals(this.offsetToken, dataforseoLabsGoogleTopSearchesLiveRequestInfo.offsetToken);  
  ...
  public String toString() {
    ...
    sb.append("class DataforseoLabsGoogleTopSearchesLiveRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataforseoLabsGoogleTopSearchesLiveRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataforseoLabsGoogleTopSearchesLiveRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataforseoLabsGoogleTopSearchesLiveRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataforseoLabsGoogleTopSearchesLiveRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataforseoLabsGoogleTopSearchesLiveRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<DataforseoLabsGoogleTopSearchesLiveRequestInfo>() {
           @Override
           public void write(JsonWriter out, DataforseoLabsGoogleTopSearchesLiveRequestInfo value) throws IOException {
           ...
           @Override
           public DataforseoLabsGoogleTopSearchesLiveRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DataforseoLabsGoogleTopSearchesLiveRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static DataforseoLabsGoogleTopSearchesLiveRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataforseoLabsGoogleTopSearchesLiveRequestInfo.class);
  }
