...
* you will find the specified tag value in the data object of the response
  ...
  public SerpGoogleEventsLiveAdvancedRequestInfo putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SerpGoogleEventsLiveAdvancedRequestInfo>() {
           ...
           public SerpGoogleEventsLiveAdvancedRequestInfo read(JsonReader in) throws IOException {
             ...
             SerpGoogleEventsLiveAdvancedRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
