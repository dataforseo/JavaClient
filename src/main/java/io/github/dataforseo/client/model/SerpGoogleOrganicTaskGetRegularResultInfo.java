...
public class SerpGoogleOrganicTaskGetRegularResultInfo  {
  ...
  public SerpGoogleOrganicTaskGetRegularResultInfo keyword(String keyword) {
  ...
  public SerpGoogleOrganicTaskGetRegularResultInfo type(String type) {
    this.type = type;
    return this;
  }
  ...
  public SerpGoogleOrganicTaskGetRegularResultInfo seDomain(String seDomain) {
  ...
  public SerpGoogleOrganicTaskGetRegularResultInfo locationCode(Integer locationCode) {
  ...
  public SerpGoogleOrganicTaskGetRegularResultInfo languageCode(String languageCode) {
  ...
  public SerpGoogleOrganicTaskGetRegularResultInfo checkUrl(String checkUrl) {
  ...
  public SerpGoogleOrganicTaskGetRegularResultInfo datetime(String datetime) {
  ...
  public SerpGoogleOrganicTaskGetRegularResultInfo spell(SpellInfo spell) {
    this.spell = spell;
    return this;
  }

  /**
   * <em>autocorrection of the search engine</em><br>if the search engine provided results for a keyword that was corrected, we will specify the keyword corrected by the search engine and the type of autocorrection;<br>if there is none, the value is <code>null</code>
   * @return spell
   */
  @javax.annotation.Nullable
  ...
  /**
   * <em>search refinement chips</em><br>if there are none, the value is <code>null</code>
  ...
  public SerpGoogleOrganicTaskGetRegularResultInfo seResultsCount(Long seResultsCount) {
  ...
  public SerpGoogleOrganicTaskGetRegularResultInfo pagesCount(Long pagesCount) {
  ...
  public SerpGoogleOrganicTaskGetRegularResultInfo itemsCount(Long itemsCount) {
  ...
  public SerpGoogleOrganicTaskGetRegularResultInfo items(List<BaseSerpApiElementItem> items) {
    this.items = items;
    return this;
  }
  ...
  public SerpGoogleOrganicTaskGetRegularResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SerpGoogleOrganicTaskGetRegularResultInfo serpGoogleOrganicTaskGetRegularResultInfo = (SerpGoogleOrganicTaskGetRegularResultInfo) o;
    return

        Objects.equals(this.keyword, serpGoogleOrganicTaskGetRegularResultInfo.keyword) &&
        Objects.equals(this.type, serpGoogleOrganicTaskGetRegularResultInfo.type) &&
        Objects.equals(this.seDomain, serpGoogleOrganicTaskGetRegularResultInfo.seDomain) &&
        Objects.equals(this.locationCode, serpGoogleOrganicTaskGetRegularResultInfo.locationCode) &&
        Objects.equals(this.languageCode, serpGoogleOrganicTaskGetRegularResultInfo.languageCode) &&
        ...
        Objects.equals(this.pagesCount, serpGoogleOrganicTaskGetRegularResultInfo.pagesCount) &&
        Objects.equals(this.itemsCount, serpGoogleOrganicTaskGetRegularResultInfo.itemsCount) &&
        Objects.equals(this.items, serpGoogleOrganicTaskGetRegularResultInfo.items);  
  ...
  public String toString() {
    ...
    sb.append("class SerpGoogleOrganicTaskGetRegularResultInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SerpGoogleOrganicTaskGetRegularResultInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SerpGoogleOrganicTaskGetRegularResultInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SerpGoogleOrganicTaskGetRegularResultInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SerpGoogleOrganicTaskGetRegularResultInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SerpGoogleOrganicTaskGetRegularResultInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SerpGoogleOrganicTaskGetRegularResultInfo>() {
           @Override
           public void write(JsonWriter out, SerpGoogleOrganicTaskGetRegularResultInfo value) throws IOException {
           ...
           @Override
           public SerpGoogleOrganicTaskGetRegularResultInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SerpGoogleOrganicTaskGetRegularResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static SerpGoogleOrganicTaskGetRegularResultInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SerpGoogleOrganicTaskGetRegularResultInfo.class);
  }
