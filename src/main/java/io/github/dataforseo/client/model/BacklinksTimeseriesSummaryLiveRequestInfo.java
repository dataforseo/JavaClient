...
public class BacklinksTimeseriesSummaryLiveRequestInfo  {
  ...
  /**
   * <em>starting date of the time range</em><br>optional field<br>this field indicates the date which will be used as a threshold for summary data;<p>minimum value: <code>2019-01-30</code><br>maximum value shouldn't exceed the date specified in the <code>date_to</code><br>date format: <code>'yyyy-mm-dd'</code><br>example:<br><code>'2021-01-01'</code>
   * @return dateFrom
   */
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.target, backlinksTimeseriesSummaryLiveRequestInfo.target) &&
  ...
  @Override
  public int hashCode() {
  return Objects.hash(target, dateFrom, dateTo, groupRange, includeSubdomains, rankScale, tag);
  }
