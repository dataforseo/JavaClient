...
public class AppendixRatesData  {
  ...
  public AppendixRatesData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.limits, appendixRatesData.limits) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AppendixRatesData>() {
           ...
           public AppendixRatesData read(JsonReader in) throws IOException {
             ...
             AppendixRatesData instance = thisAdapter.fromJsonTree(jsonObj);
