...
public class AppsInfo  {
  ...
  public AppsInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.appId, appsInfo.appId) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AppsInfo>() {
           ...
           public AppsInfo read(JsonReader in) throws IOException {
             ...
             AppsInfo instance = thisAdapter.fromJsonTree(jsonObj);
