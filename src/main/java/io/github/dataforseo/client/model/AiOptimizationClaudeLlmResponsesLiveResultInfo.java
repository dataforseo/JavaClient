...
public class AiOptimizationClaudeLlmResponsesLiveResultInfo  {
  ...
  public AiOptimizationClaudeLlmResponsesLiveResultInfo modelName(String modelName) {
  ...
  public AiOptimizationClaudeLlmResponsesLiveResultInfo inputTokens(Integer inputTokens) {
  ...
  public AiOptimizationClaudeLlmResponsesLiveResultInfo outputTokens(Integer outputTokens) {
  ...
  public AiOptimizationClaudeLlmResponsesLiveResultInfo reasoningTokens(Integer reasoningTokens) {
  ...
  public AiOptimizationClaudeLlmResponsesLiveResultInfo webSearch(Boolean webSearch) {
  ...
  public AiOptimizationClaudeLlmResponsesLiveResultInfo moneySpent(Double moneySpent) {
  ...
  public AiOptimizationClaudeLlmResponsesLiveResultInfo datetime(String datetime) {
  ...
  public AiOptimizationClaudeLlmResponsesLiveResultInfo items(List<BaseAiOptimizationLlmResponseElementItem> items) {
    this.items = items;
    return this;
  }
  ...
  public AiOptimizationClaudeLlmResponsesLiveResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiOptimizationClaudeLlmResponsesLiveResultInfo aiOptimizationClaudeLlmResponsesLiveResultInfo = (AiOptimizationClaudeLlmResponsesLiveResultInfo) o;
    return

        Objects.equals(this.modelName, aiOptimizationClaudeLlmResponsesLiveResultInfo.modelName) &&
        Objects.equals(this.inputTokens, aiOptimizationClaudeLlmResponsesLiveResultInfo.inputTokens) &&
        Objects.equals(this.outputTokens, aiOptimizationClaudeLlmResponsesLiveResultInfo.outputTokens) &&
        Objects.equals(this.reasoningTokens, aiOptimizationClaudeLlmResponsesLiveResultInfo.reasoningTokens) &&
  ...
  public String toString() {
    ...
    sb.append("class AiOptimizationClaudeLlmResponsesLiveResultInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiOptimizationClaudeLlmResponsesLiveResultInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiOptimizationClaudeLlmResponsesLiveResultInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiOptimizationClaudeLlmResponsesLiveResultInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiOptimizationClaudeLlmResponsesLiveResultInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiOptimizationClaudeLlmResponsesLiveResultInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AiOptimizationClaudeLlmResponsesLiveResultInfo>() {
           @Override
           public void write(JsonWriter out, AiOptimizationClaudeLlmResponsesLiveResultInfo value) throws IOException {
           ...
           @Override
           public AiOptimizationClaudeLlmResponsesLiveResultInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiOptimizationClaudeLlmResponsesLiveResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AiOptimizationClaudeLlmResponsesLiveResultInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiOptimizationClaudeLlmResponsesLiveResultInfo.class);
  }
