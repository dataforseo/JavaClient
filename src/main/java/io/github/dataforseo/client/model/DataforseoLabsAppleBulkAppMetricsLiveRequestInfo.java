...
public class DataforseoLabsAppleBulkAppMetricsLiveRequestInfo  {
  ...
  /**
   * <em>ids of the apps</em><br><strong>required field</strong><br>IDs of mobile applications on App Store;<br>you can find the ID in the URL of every app listed on App Store;<br>example:<br>in the URL <code>https://apps.apple.com/us/app/id835599320</code><br>the id is <code>835599320</code>;<br>the maximum number of IDs you can specify in this field is <code>1000</code>
   * @return appIds
   */
