...
public class KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo  {
  ...
  public KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo keywords(List<String> keywords) {
  ...
  public KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo bid(Double bid) {
    this.bid = bid;
    return this;
  }
  ...
  public KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo match(String match) {
    this.match = match;
    return this;
  }
  ...
  public KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo locationName(String locationName) {
  ...
  public KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo locationCode(Integer locationCode) {
  ...
  public KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo locationCoordinate(String locationCoordinate) {
  ...
  public KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo languageName(String languageName) {
  ...
  public KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo languageCode(String languageCode) {
  ...
  public KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo dateFrom(String dateFrom) {
  ...
  public KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo dateTo(String dateTo) {
    this.dateTo = dateTo;
    return this;
  }
  ...
  public KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo dateInterval(String dateInterval) {
  ...
  public KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo sortBy(String sortBy) {
    this.sortBy = sortBy;
    return this;
  }

  /**
   * <em>results sorting parameters</em><br>optional field<br>Use these parameters to sort the results by <code>relevance</code>, <code>average_cpc</code>, <code>cost</code>, or <code>clicks</code> in the descending order<br>default value: <code>relevance</code>
   * @return sortBy
   */
  @javax.annotation.Nullable
  ...
  public KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo postbackUrl(String postbackUrl) {
  ...
  public KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo pingbackUrl(String pingbackUrl) {
  ...
  public KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo keywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo = (KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo) o;
    return
        ...
        Objects.equals(this.languageName, keywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo.languageName) &&
        Objects.equals(this.languageCode, keywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo.languageCode) &&
        Objects.equals(this.dateFrom, keywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo.dateFrom) &&
        Objects.equals(this.dateTo, keywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo.dateTo) &&
        Objects.equals(this.dateInterval, keywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo.dateInterval) &&
        Objects.equals(this.sortBy, keywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo.sortBy) &&
        Objects.equals(this.postbackUrl, keywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo.postbackUrl) &&
        Objects.equals(this.pingbackUrl, keywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo.pingbackUrl) &&
        Objects.equals(this.tag, keywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo.tag);  
  ...
  public String toString() {
    ...
    sb.append("class KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo>() {
           @Override
           public void write(JsonWriter out, KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo value) throws IOException {
           ...
           @Override
           public KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostRequestInfo.class);
  }
