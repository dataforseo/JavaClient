...
public class AiOptimizationChatGptLlmResponsesLiveRequestInfo  {
  ...
  public AiOptimizationChatGptLlmResponsesLiveRequestInfo userPrompt(String userPrompt) {
...
* you can specify up to 500 characters in the user_prompt field
  ...
  public AiOptimizationChatGptLlmResponsesLiveRequestInfo modelName(String modelName) {
...
* you can receive the list of available LLM models by making a separate request to the https://api.dataforseo.com/v3/ai_optimization/chat_gpt/llm_responses/models
  ...
  public AiOptimizationChatGptLlmResponsesLiveRequestInfo maxOutputTokens(Integer maxOutputTokens) {
...
* Note: when web_search is set to true, the output token count may exceed the specified max_output_tokens limit
  ...
  public AiOptimizationChatGptLlmResponsesLiveRequestInfo temperature(Double temperature) {
...
* Note: not supported in o4-mini, o3-mini, o1-pro, o1 models
  ...
  public AiOptimizationChatGptLlmResponsesLiveRequestInfo topP(Double topP) {
    this.topP = topP;
    return this;
  }
...
* Note: not supported in o4-mini, o3-mini, o1-pro, o1 models
  ...
  public AiOptimizationChatGptLlmResponsesLiveRequestInfo webSearch(Boolean webSearch) {
...
* Note: refer to the Models endpoint for a list of models that support web_search;
  ...
  public AiOptimizationChatGptLlmResponsesLiveRequestInfo forceWebSearch(Boolean forceWebSearch) {
...
* Note: even if the parameter is set to true, there is no guarantee web sources will be cited in the response
  ...
  public AiOptimizationChatGptLlmResponsesLiveRequestInfo webSearchCountryIsoCode(String webSearchCountryIsoCode) {
...
* Note: not supported in o3-mini, o1-pro, o1 models
  ...
  public AiOptimizationChatGptLlmResponsesLiveRequestInfo webSearchCity(String webSearchCity) {
...
* Note #2: not supported in o3-mini, o1-pro, o1 models
  ...
  public AiOptimizationChatGptLlmResponsesLiveRequestInfo systemMessage(String systemMessage) {
...
* you can specify up to 500 characters in the system_message field
  ...
  public AiOptimizationChatGptLlmResponsesLiveRequestInfo messageChain(List<LlmMessageChainItem> messageChain) {
...
* 'message_chain': [{'role':'user','message':'Hello, what’s up?'},{'role':'ai','message':'Hello! I’m doing well, thank you. How can I assist you today?'}]
  ...
  public AiOptimizationChatGptLlmResponsesLiveRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
...
* you will find the specified tag value in the data object of the response
  ...
  public AiOptimizationChatGptLlmResponsesLiveRequestInfo() {
  }
  ...
  public AiOptimizationChatGptLlmResponsesLiveRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiOptimizationChatGptLlmResponsesLiveRequestInfo aiOptimizationChatGptLlmResponsesLiveRequestInfo = (AiOptimizationChatGptLlmResponsesLiveRequestInfo) o;
    return

        Objects.equals(this.userPrompt, aiOptimizationChatGptLlmResponsesLiveRequestInfo.userPrompt) &&
        Objects.equals(this.modelName, aiOptimizationChatGptLlmResponsesLiveRequestInfo.modelName) &&
        Objects.equals(this.maxOutputTokens, aiOptimizationChatGptLlmResponsesLiveRequestInfo.maxOutputTokens) &&
        Objects.equals(this.temperature, aiOptimizationChatGptLlmResponsesLiveRequestInfo.temperature) &&
        Objects.equals(this.topP, aiOptimizationChatGptLlmResponsesLiveRequestInfo.topP) &&
        Objects.equals(this.webSearch, aiOptimizationChatGptLlmResponsesLiveRequestInfo.webSearch) &&
        Objects.equals(this.forceWebSearch, aiOptimizationChatGptLlmResponsesLiveRequestInfo.forceWebSearch) &&
        Objects.equals(this.webSearchCountryIsoCode, aiOptimizationChatGptLlmResponsesLiveRequestInfo.webSearchCountryIsoCode) &&
        Objects.equals(this.webSearchCity, aiOptimizationChatGptLlmResponsesLiveRequestInfo.webSearchCity) &&
        Objects.equals(this.systemMessage, aiOptimizationChatGptLlmResponsesLiveRequestInfo.systemMessage) &&
        Objects.equals(this.messageChain, aiOptimizationChatGptLlmResponsesLiveRequestInfo.messageChain) &&
        Objects.equals(this.tag, aiOptimizationChatGptLlmResponsesLiveRequestInfo.tag);  
  ...
  public String toString() {
    ...
    sb.append("class AiOptimizationChatGptLlmResponsesLiveRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiOptimizationChatGptLlmResponsesLiveRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiOptimizationChatGptLlmResponsesLiveRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiOptimizationChatGptLlmResponsesLiveRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiOptimizationChatGptLlmResponsesLiveRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiOptimizationChatGptLlmResponsesLiveRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AiOptimizationChatGptLlmResponsesLiveRequestInfo>() {
           @Override
           public void write(JsonWriter out, AiOptimizationChatGptLlmResponsesLiveRequestInfo value) throws IOException {
           ...
           @Override
           public AiOptimizationChatGptLlmResponsesLiveRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiOptimizationChatGptLlmResponsesLiveRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AiOptimizationChatGptLlmResponsesLiveRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiOptimizationChatGptLlmResponsesLiveRequestInfo.class);
  }
