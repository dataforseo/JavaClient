...
public class BingPaidSerpElementItem  extends BaseBingSerpApiElementItem  {
  ...
  public BingPaidSerpElementItem domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public BingPaidSerpElementItem title(String title) {
    this.title = title;
    return this;
  }
  ...
  public BingPaidSerpElementItem description(String description) {
  ...
  public BingPaidSerpElementItem url(String url) {
    this.url = url;
    return this;
  }
  ...
  public BingPaidSerpElementItem breadcrumb(String breadcrumb) {
  ...
  public BingPaidSerpElementItem websiteName(String websiteName) {
  ...
  public BingPaidSerpElementItem isImage(Boolean isImage) {
  ...
  public BingPaidSerpElementItem isVideo(Boolean isVideo) {
  ...
  public BingPaidSerpElementItem images(List<AiModeImagesElementInfo> images) {
    this.images = images;
    return this;
  }
  ...
  public BingPaidSerpElementItem highlighted(List<String> highlighted) {
  ...
  public BingPaidSerpElementItem extra(Map<String, String> extra) {
    this.extra = extra;
    return this;
  }
  ...
  public BingPaidSerpElementItem descriptionRows(List<String> descriptionRows) {
...
* if there is none, equals null
  ...
  public BingPaidSerpElementItem links(List<AdLinkElement> links) {
    this.links = links;
    return this;
  }
  ...
  public BingPaidSerpElementItem price(PriceInfo price) {
    this.price = price;
    return this;
  }
...
* the popularity rate based on reviews and displayed in SERP
  ...
  public BingPaidSerpElementItem() {
  }
  ...
  public BingPaidSerpElementItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BingPaidSerpElementItem bingPaidSerpElementItem = (BingPaidSerpElementItem) o;
    return

        Objects.equals(this.domain, bingPaidSerpElementItem.domain) &&
        Objects.equals(this.title, bingPaidSerpElementItem.title) &&
        Objects.equals(this.description, bingPaidSerpElementItem.description) &&
        Objects.equals(this.url, bingPaidSerpElementItem.url) &&
        Objects.equals(this.breadcrumb, bingPaidSerpElementItem.breadcrumb) &&
        ...
        Objects.equals(this.descriptionRows, bingPaidSerpElementItem.descriptionRows) &&
        Objects.equals(this.links, bingPaidSerpElementItem.links) &&
        Objects.equals(this.price, bingPaidSerpElementItem.price) &&
        Objects.equals(this.rating, bingPaidSerpElementItem.rating) && 
        super.equals(o);
  ...
  public String toString() {
    ...
    sb.append("class BingPaidSerpElementItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BingPaidSerpElementItem
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BingPaidSerpElementItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BingPaidSerpElementItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BingPaidSerpElementItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BingPaidSerpElementItem.class));

       return (TypeAdapter<T>) new TypeAdapter<BingPaidSerpElementItem>() {
           @Override
           public void write(JsonWriter out, BingPaidSerpElementItem value) throws IOException {
           ...
           @Override
           public BingPaidSerpElementItem read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             BingPaidSerpElementItem instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static BingPaidSerpElementItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BingPaidSerpElementItem.class);
  }
