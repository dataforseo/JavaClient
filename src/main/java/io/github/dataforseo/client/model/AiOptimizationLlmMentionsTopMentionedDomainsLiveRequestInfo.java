...
public class AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo  {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo target(List<BaseAiOptimizationLLmMentionsTargetElement> target) {
    this.target = target;
    return this;
  }
...
* target array with a domain entity
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo locationName(String locationName) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo locationCode(Integer locationCode) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo languageName(String languageName) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo languageCode(String languageCode) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo platform(String platform) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo linksScope(String linksScope) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo filters(List<Object> filters) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo initialDatasetFilters(List<Object> initialDatasetFilters) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo internalListLimit(Integer internalListLimit) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo orderBy(List<String> orderBy) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo offset(Integer offset) {
    this.offset = offset;
    return this;
  }
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo includeDomains(List<String> includeDomains) {
    this.includeDomains = includeDomains;
    return this;
  }

  /**
   * <em>array of domains to include in the response</em><br>optional field<br>if specified, only the listed domains will be returned in the <code>items</code> array<br>example:<br><code>'include_domains': ['en.wikipedia.org']</code>
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo excludeDomains(List<String> excludeDomains) {
    this.excludeDomains = excludeDomains;
    return this;
  }

  /**
   * <em>array of domains to exclude from the response</em><br>optional field<br>if specified, the listed domains will be omitted from the <code>items</code> array<br>example:<br><code>'exclude_domains': ['en.wikipedia.org']</code>
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo() {
  }
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo aiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo = (AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo) o;
    return

        Objects.equals(this.target, aiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo.target) &&
        Objects.equals(this.locationName, aiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo.locationName) &&
        Objects.equals(this.locationCode, aiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo.locationCode) &&
        Objects.equals(this.languageName, aiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo.languageName) &&
        Objects.equals(this.languageCode, aiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo.languageCode) &&
        Objects.equals(this.platform, aiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo.platform) &&
        Objects.equals(this.linksScope, aiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo.linksScope) &&
        Objects.equals(this.filters, aiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo.filters) &&
        Objects.equals(this.initialDatasetFilters, aiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo.initialDatasetFilters) &&
        Objects.equals(this.limit, aiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo.limit) &&
        Objects.equals(this.internalListLimit, aiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo.internalListLimit) &&
        Objects.equals(this.orderBy, aiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo.orderBy) &&
        Objects.equals(this.offset, aiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo.offset) &&
        Objects.equals(this.includeDomains, aiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo.includeDomains) &&
        Objects.equals(this.excludeDomains, aiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo.excludeDomains) &&
        Objects.equals(this.tag, aiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo.tag);  
  ...
  public String toString() {
    ...
    sb.append("class AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo>() {
           @Override
           public void write(JsonWriter out, AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo value) throws IOException {
           ...
           @Override
           public AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo.class);
  }
