...
* learn more about the metric in this help center article
  ...
  public KeywordsDataGoogleAdsSearchVolumeLiveResultInfo lowTopOfPageBid(Double lowTopOfPageBid) {
...
* the value may differ depending on the location specified in a POST request
  ...
  public KeywordsDataGoogleAdsSearchVolumeLiveResultInfo cpc(Double cpc) {
    this.cpc = cpc;
    return this;
  }
...
* indicates the amount paid (USD) for each click on the ad displayed for a given keyword
  ...
  public KeywordsDataGoogleAdsSearchVolumeLiveResultInfo monthlySearches(List<MonthlySearchesInfo> monthlySearches) {
...
* if there is no data then the value is null
  ...
  public KeywordsDataGoogleAdsSearchVolumeLiveResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.keyword, keywordsDataGoogleAdsSearchVolumeLiveResultInfo.keyword) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<KeywordsDataGoogleAdsSearchVolumeLiveResultInfo>() {
           ...
           public KeywordsDataGoogleAdsSearchVolumeLiveResultInfo read(JsonReader in) throws IOException {
             ...
             KeywordsDataGoogleAdsSearchVolumeLiveResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
