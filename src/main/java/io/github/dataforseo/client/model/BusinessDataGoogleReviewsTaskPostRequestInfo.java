...
public class BusinessDataGoogleReviewsTaskPostRequestInfo  {
  ...
  /**
   * <em>results sorting parameters</em><br>optional field<br>you can use this field to sort the results<br>possible types of sorting:<br><code>newest</code> – sort by newest first<br><code>highest_rating</code> – sort by highest rating<br><code>lowest_rating</code> – sort by lowest rating<br><code>relevant</code> – sort by relevance<br>default value: <code>relevant</code>
   * @return sortBy
   */
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.keyword, businessDataGoogleReviewsTaskPostRequestInfo.keyword) &&
  ...
  @Override
  public int hashCode() {
  return Objects.hash(keyword, cid, placeId, priority, locationName, locationCode, locationCoordinate, languageName, languageCode, depth, sortBy, tag, postbackUrl, pingbackUrl);
  }
