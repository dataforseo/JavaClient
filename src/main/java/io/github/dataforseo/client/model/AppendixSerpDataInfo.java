...
public class AppendixSerpDataInfo {
   ...
   * @return the AppendixSerpDataInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.taskPost, appendixSerpDataInfo.taskPost) &&
        ...
        Objects.equals(this.additionalProperties, appendixSerpDataInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(taskPost, taskGet, tasksReady, locations, languages, live, errors, tasksFixed, jobs, screenshot, tasksReadyQueue, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppendixSerpDataInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppendixSerpDataInfo is not found in the empty JSON string", AppendixSerpDataInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of AppendixSerpDataInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppendixSerpDataInfo
   * @throws IOException if the JSON string is invalid with respect to AppendixSerpDataInfo
   */
  ...
  /**
   * Convert an instance of AppendixSerpDataInfo to an JSON string
   *
   * @return JSON string
   */
