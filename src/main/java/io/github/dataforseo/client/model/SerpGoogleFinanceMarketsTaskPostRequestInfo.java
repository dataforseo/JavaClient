...
public class SerpGoogleFinanceMarketsTaskPostRequestInfo  {
  ...
  public SerpGoogleFinanceMarketsTaskPostRequestInfo locationCode(Integer locationCode) {
  ...
  public SerpGoogleFinanceMarketsTaskPostRequestInfo languageCode(String languageCode) {
  ...
  public SerpGoogleFinanceMarketsTaskPostRequestInfo device(String device) {
    this.device = device;
    return this;
  }
  ...
  public SerpGoogleFinanceMarketsTaskPostRequestInfo pingbackUrl(String pingbackUrl) {
  ...
  public SerpGoogleFinanceMarketsTaskPostRequestInfo postbackUrl(String postbackUrl) {
  ...
  public SerpGoogleFinanceMarketsTaskPostRequestInfo postbackData(String postbackData) {
  ...
  public SerpGoogleFinanceMarketsTaskPostRequestInfo priority(Integer priority) {
  ...
  public SerpGoogleFinanceMarketsTaskPostRequestInfo locationName(String locationName) {
  ...
  public SerpGoogleFinanceMarketsTaskPostRequestInfo languageName(String languageName) {
  ...
  public SerpGoogleFinanceMarketsTaskPostRequestInfo os(String os) {
    this.os = os;
    return this;
  }
  ...
  public SerpGoogleFinanceMarketsTaskPostRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public SerpGoogleFinanceMarketsTaskPostRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SerpGoogleFinanceMarketsTaskPostRequestInfo serpGoogleFinanceMarketsTaskPostRequestInfo = (SerpGoogleFinanceMarketsTaskPostRequestInfo) o;
    return

        Objects.equals(this.locationCode, serpGoogleFinanceMarketsTaskPostRequestInfo.locationCode) &&
        Objects.equals(this.languageCode, serpGoogleFinanceMarketsTaskPostRequestInfo.languageCode) &&
        Objects.equals(this.device, serpGoogleFinanceMarketsTaskPostRequestInfo.device) &&
        Objects.equals(this.pingbackUrl, serpGoogleFinanceMarketsTaskPostRequestInfo.pingbackUrl) &&
        Objects.equals(this.postbackUrl, serpGoogleFinanceMarketsTaskPostRequestInfo.postbackUrl) &&
        Objects.equals(this.postbackData, serpGoogleFinanceMarketsTaskPostRequestInfo.postbackData) &&
        Objects.equals(this.priority, serpGoogleFinanceMarketsTaskPostRequestInfo.priority) &&
        Objects.equals(this.locationName, serpGoogleFinanceMarketsTaskPostRequestInfo.locationName) &&
        Objects.equals(this.languageName, serpGoogleFinanceMarketsTaskPostRequestInfo.languageName) &&
        Objects.equals(this.os, serpGoogleFinanceMarketsTaskPostRequestInfo.os) &&
        Objects.equals(this.tag, serpGoogleFinanceMarketsTaskPostRequestInfo.tag) &&
        Objects.equals(this.marketType, serpGoogleFinanceMarketsTaskPostRequestInfo.marketType);  
  ...
  @Override
  public int hashCode() {
  return Objects.hash(locationCode, languageCode, device, pingbackUrl, postbackUrl, postbackData, priority, locationName, languageName, os, tag, marketType);
  }
  ...
  public String toString() {
    ...
    sb.append("class SerpGoogleFinanceMarketsTaskPostRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SerpGoogleFinanceMarketsTaskPostRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SerpGoogleFinanceMarketsTaskPostRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SerpGoogleFinanceMarketsTaskPostRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SerpGoogleFinanceMarketsTaskPostRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SerpGoogleFinanceMarketsTaskPostRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SerpGoogleFinanceMarketsTaskPostRequestInfo>() {
           @Override
           public void write(JsonWriter out, SerpGoogleFinanceMarketsTaskPostRequestInfo value) throws IOException {
           ...
           @Override
           public SerpGoogleFinanceMarketsTaskPostRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SerpGoogleFinanceMarketsTaskPostRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static SerpGoogleFinanceMarketsTaskPostRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SerpGoogleFinanceMarketsTaskPostRequestInfo.class);
  }
