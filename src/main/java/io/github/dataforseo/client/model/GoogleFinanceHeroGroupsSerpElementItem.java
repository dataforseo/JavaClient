...
public class GoogleFinanceHeroGroupsSerpElementItem extends BaseGoogleFinanceSerpElementItem {
   ...
   * @return the GoogleFinanceHeroGroupsSerpElementItem instance itself
   */
  public GoogleFinanceHeroGroupsSerpElementItem putAdditionalProperty(String key, Object value) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleFinanceHeroGroupsSerpElementItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleFinanceHeroGroupsSerpElementItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleFinanceHeroGroupsSerpElementItem is not found in the empty JSON string", GoogleFinanceHeroGroupsSerpElementItem.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleFinanceHeroGroupsSerpElementItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleFinanceHeroGroupsSerpElementItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleFinanceHeroGroupsSerpElementItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleFinanceHeroGroupsSerpElementItem.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleFinanceHeroGroupsSerpElementItem>() {
           @Override
           public void write(JsonWriter out, GoogleFinanceHeroGroupsSerpElementItem value) throws IOException {
           ...
           @Override
           public GoogleFinanceHeroGroupsSerpElementItem read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             GoogleFinanceHeroGroupsSerpElementItem instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of GoogleFinanceHeroGroupsSerpElementItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleFinanceHeroGroupsSerpElementItem
   * @throws IOException if the JSON string is invalid with respect to GoogleFinanceHeroGroupsSerpElementItem
   */
  public static GoogleFinanceHeroGroupsSerpElementItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleFinanceHeroGroupsSerpElementItem.class);
  }

  /**
   * Convert an instance of GoogleFinanceHeroGroupsSerpElementItem to an JSON string
   *
   * @return JSON string
   */
