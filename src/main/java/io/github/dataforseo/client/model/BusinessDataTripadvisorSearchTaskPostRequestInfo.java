...
public class BusinessDataTripadvisorSearchTaskPostRequestInfo {
  ...
  /**
   * parsing depth optional field number of search results to be returned from the API response we strongly recommend setting the parsing depth in the multiples of thirty because our systems processes thirty search results in a row; default value: 30; maximum value: 210
   * @return depth
   */
  @javax.annotation.Nullable
   ...
   * @return the BusinessDataTripadvisorSearchTaskPostRequestInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyword, businessDataTripadvisorSearchTaskPostRequestInfo.keyword) &&
        ...
        Objects.equals(this.additionalProperties, businessDataTripadvisorSearchTaskPostRequestInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keyword, locationName, locationCode, priority, depth, tag, postbackUrl, pingbackUrl, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BusinessDataTripadvisorSearchTaskPostRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BusinessDataTripadvisorSearchTaskPostRequestInfo is not found in the empty JSON string", BusinessDataTripadvisorSearchTaskPostRequestInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of BusinessDataTripadvisorSearchTaskPostRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BusinessDataTripadvisorSearchTaskPostRequestInfo
   * @throws IOException if the JSON string is invalid with respect to BusinessDataTripadvisorSearchTaskPostRequestInfo
   */
  ...
  /**
   * Convert an instance of BusinessDataTripadvisorSearchTaskPostRequestInfo to an JSON string
   *
   * @return JSON string
   */
