...
public class DataforseoLabsGoogleKeywordIdeasLiveRequestInfo {
  ...
  public DataforseoLabsGoogleKeywordIdeasLiveRequestInfo addKeywordsItem(String keywordsItem) {
  ...
  /**
   * keywords required field UTF-8 encoding The maximum number of keywords you can specify: 200. The minimum number of characters for each keyword: 3. The keywords will be converted to lowercase format learn more about rules and limitations of keyword and keywords fields in DataForSEO APIs in this Help Center article
   * @return keywords
   */
  ...
  public DataforseoLabsGoogleKeywordIdeasLiveRequestInfo addFiltersItem(Object filtersItem) {
  ...
  public DataforseoLabsGoogleKeywordIdeasLiveRequestInfo addOrderByItem(String orderByItem) {
   ...
   * @return the DataforseoLabsGoogleKeywordIdeasLiveRequestInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keywords, dataforseoLabsGoogleKeywordIdeasLiveRequestInfo.keywords) &&
        ...
        Objects.equals(this.additionalProperties, dataforseoLabsGoogleKeywordIdeasLiveRequestInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keywords, locationName, locationCode, languageName, languageCode, closelyVariants, ignoreSynonyms, includeSerpInfo, includeClickstreamData, limit, offset, offsetToken, filters, orderBy, tag, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataforseoLabsGoogleKeywordIdeasLiveRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataforseoLabsGoogleKeywordIdeasLiveRequestInfo is not found in the empty JSON string", DataforseoLabsGoogleKeywordIdeasLiveRequestInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of DataforseoLabsGoogleKeywordIdeasLiveRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DataforseoLabsGoogleKeywordIdeasLiveRequestInfo
   * @throws IOException if the JSON string is invalid with respect to DataforseoLabsGoogleKeywordIdeasLiveRequestInfo
   */
  ...
  /**
   * Convert an instance of DataforseoLabsGoogleKeywordIdeasLiveRequestInfo to an JSON string
   *
   * @return JSON string
   */
