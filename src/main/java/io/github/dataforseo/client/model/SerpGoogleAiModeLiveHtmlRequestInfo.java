...
* https://www.google.co.uk/search?q=%20rank%20tracker%20api&hl=en&gl=GB&uule=w+CAIQIFISCXXeIa8LoNhHEZkq1d1aOpZS
  ...
  public SerpGoogleAiModeLiveHtmlRequestInfo keyword(String keyword) {
...
* Note: queries containing the ‘cache:’ parameter are not supported and will return a validation error
  ...
  public SerpGoogleAiModeLiveHtmlRequestInfo locationName(String locationName) {
...
* London,England,United Kingdom
  ...
  public SerpGoogleAiModeLiveHtmlRequestInfo locationCode(Integer locationCode) {
...
* 2840
  ...
  public SerpGoogleAiModeLiveHtmlRequestInfo locationCoordinate(String locationCoordinate) {
...
* 53.476225,-2.243572,200
  ...
  public SerpGoogleAiModeLiveHtmlRequestInfo languageName(String languageName) {
...
* Note: currently, the only supported value is English
  ...
  public SerpGoogleAiModeLiveHtmlRequestInfo languageCode(String languageCode) {
...
* Note: currently, the only supported value is en
  ...
  public SerpGoogleAiModeLiveHtmlRequestInfo device(String device) {
    this.device = device;
    return this;
  }
...
* default value: desktop
  ...
  public SerpGoogleAiModeLiveHtmlRequestInfo os(String os) {
    this.os = os;
    return this;
  }
...
* google.co.uk, google.com.au, google.de, etc.
  ...
  public SerpGoogleAiModeLiveHtmlRequestInfo depth(Integer depth) {
    this.depth = depth;
    return this;
  }
...
* if the specified depth is higher than the number of results in the response, the difference will be refunded automatically to your account balance
  ...
  public SerpGoogleAiModeLiveHtmlRequestInfo maxCrawlPages(Integer maxCrawlPages) {
...
* learn more at our help center
  ...
  public SerpGoogleAiModeLiveHtmlRequestInfo searchParam(String searchParam) {
...
* default value: false
  ...
  public SerpGoogleAiModeLiveHtmlRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
...
* you will find the specified tag value in the data object of the response
  ...
  public SerpGoogleAiModeLiveHtmlRequestInfo() {
  }
  ...
  public SerpGoogleAiModeLiveHtmlRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.locationCoordinate, serpGoogleAiModeLiveHtmlRequestInfo.locationCoordinate) &&
        Objects.equals(this.languageName, serpGoogleAiModeLiveHtmlRequestInfo.languageName) &&
  ...
  @Override
  public int hashCode() {
  return Objects.hash(url, keyword, locationName, locationCode, locationCoordinate, languageName, languageCode, device, os, seDomain, depth, maxCrawlPages, searchParam, loadAsyncAiOverview, expandAiOverview, tag);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SerpGoogleAiModeLiveHtmlRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SerpGoogleAiModeLiveHtmlRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SerpGoogleAiModeLiveHtmlRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SerpGoogleAiModeLiveHtmlRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SerpGoogleAiModeLiveHtmlRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SerpGoogleAiModeLiveHtmlRequestInfo>() {
           @Override
           public void write(JsonWriter out, SerpGoogleAiModeLiveHtmlRequestInfo value) throws IOException {
           ...
           @Override
           public SerpGoogleAiModeLiveHtmlRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SerpGoogleAiModeLiveHtmlRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static SerpGoogleAiModeLiveHtmlRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SerpGoogleAiModeLiveHtmlRequestInfo.class);
  }
