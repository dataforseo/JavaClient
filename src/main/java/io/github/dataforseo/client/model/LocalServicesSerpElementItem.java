...
* always equals 0 for desktop
  ...
  public LocalServicesSerpElementItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.rankGroup, localServicesSerpElementItem.rankGroup) &&
  ...
  @Override
  public int hashCode() {
  return Objects.hash(rankGroup, rankAbsolute, title, url, domain, items);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LocalServicesSerpElementItem>() {
           ...
           public LocalServicesSerpElementItem read(JsonReader in) throws IOException {
             ...
             LocalServicesSerpElementItem instance = thisAdapter.fromJsonTree(jsonObj);
