...
public class AppendixMinuteStatisticsMoneyData {
  ...
  public AppendixMinuteStatisticsMoneyData serp(AppendixSerpLimitsRatesDataInfo serp) {
    this.serp = serp;
    return this;
  }
  ...
  public AppendixMinuteStatisticsMoneyData total(Double total) {
    this.total = total;
    return this;
  }
  ...
  public AppendixMinuteStatisticsMoneyData totalSerp(Double totalSerp) {
  ...
  public AppendixMinuteStatisticsMoneyData keywordsData(AppendixKeywordsDataDayStatisticsRatesData keywordsData) {
  ...
  public AppendixMinuteStatisticsMoneyData totalKeywordsData(Double totalKeywordsData) {
  ...
  public AppendixMinuteStatisticsMoneyData appendix(AppendixAppendixsRatesDataInfo appendix) {
  ...
  public AppendixMinuteStatisticsMoneyData totalAppendix(Double totalAppendix) {
  ...
  public AppendixMinuteStatisticsMoneyData dataforseoLabs(AppendixDataforseoLabsLimitsRatesDataInfo dataforseoLabs) {
  ...
  public AppendixMinuteStatisticsMoneyData totalDataforseoLabs(Double totalDataforseoLabs) {
  ...
  public AppendixMinuteStatisticsMoneyData domainAnalytics(AppendixDomainAnalyticsLimitsRatesDataInfo domainAnalytics) {
  ...
  public AppendixMinuteStatisticsMoneyData totalDomainAnalytics(Double totalDomainAnalytics) {
  ...
  public AppendixMinuteStatisticsMoneyData merchant(AppendixMerchantLimitsRatesDataInfo merchant) {
  ...
  public AppendixMinuteStatisticsMoneyData totalMerchant(Double totalMerchant) {
  ...
  public AppendixMinuteStatisticsMoneyData onPage(AppendixOnPageLimitsRatesDataInfo onPage) {
    this.onPage = onPage;
    return this;
  }
  ...
  public AppendixMinuteStatisticsMoneyData totalOnPage(Double totalOnPage) {
  ...
  public AppendixMinuteStatisticsMoneyData businessData(AppendixBusinessDataStatisticsMoneyDataInfo businessData) {
  ...
  public AppendixMinuteStatisticsMoneyData totalBusinessData(Double totalBusinessData) {
  ...
  public AppendixMinuteStatisticsMoneyData backlinks(AppendixBacklinksLimitsRatesDataInfo backlinks) {
  ...
  public AppendixMinuteStatisticsMoneyData totalBacklinks(Double totalBacklinks) {
  ...
  public AppendixMinuteStatisticsMoneyData appData(AppendixAppDataLimitsRatesDataInfo appData) {
  ...
  public AppendixMinuteStatisticsMoneyData totalAppData(Double totalAppData) {
  ...
  public AppendixMinuteStatisticsMoneyData contentAnalysis(AppendixContentAnalysisLimitsRatesDataInfo contentAnalysis) {
  ...
  public AppendixMinuteStatisticsMoneyData totalContentAnalysis(Double totalContentAnalysis) {
  ...
  public AppendixMinuteStatisticsMoneyData contentGeneration(AppendixContentGenerationLimitsRatesDataInfo contentGeneration) {
  ...
  public AppendixMinuteStatisticsMoneyData totalContentGeneration(Double totalContentGeneration) {
  ...
  public AppendixMinuteStatisticsMoneyData value(String value) {
    this.value = value;
    return this;
  }
   ...
   * @return the AppendixMinuteStatisticsMoneyData instance itself
   */
  public AppendixMinuteStatisticsMoneyData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AppendixMinuteStatisticsMoneyData appendixMinuteStatisticsMoneyData = (AppendixMinuteStatisticsMoneyData) o;
    return Objects.equals(this.serp, appendixMinuteStatisticsMoneyData.serp) &&
        Objects.equals(this.total, appendixMinuteStatisticsMoneyData.total) &&
        Objects.equals(this.totalSerp, appendixMinuteStatisticsMoneyData.totalSerp) &&
        Objects.equals(this.keywordsData, appendixMinuteStatisticsMoneyData.keywordsData) &&
        Objects.equals(this.totalKeywordsData, appendixMinuteStatisticsMoneyData.totalKeywordsData) &&
        Objects.equals(this.appendix, appendixMinuteStatisticsMoneyData.appendix) &&
        Objects.equals(this.totalAppendix, appendixMinuteStatisticsMoneyData.totalAppendix) &&
        Objects.equals(this.dataforseoLabs, appendixMinuteStatisticsMoneyData.dataforseoLabs) &&
        Objects.equals(this.totalDataforseoLabs, appendixMinuteStatisticsMoneyData.totalDataforseoLabs) &&
        Objects.equals(this.domainAnalytics, appendixMinuteStatisticsMoneyData.domainAnalytics) &&
        Objects.equals(this.totalDomainAnalytics, appendixMinuteStatisticsMoneyData.totalDomainAnalytics) &&
        Objects.equals(this.merchant, appendixMinuteStatisticsMoneyData.merchant) &&
        Objects.equals(this.totalMerchant, appendixMinuteStatisticsMoneyData.totalMerchant) &&
        Objects.equals(this.onPage, appendixMinuteStatisticsMoneyData.onPage) &&
        Objects.equals(this.totalOnPage, appendixMinuteStatisticsMoneyData.totalOnPage) &&
        Objects.equals(this.businessData, appendixMinuteStatisticsMoneyData.businessData) &&
        Objects.equals(this.totalBusinessData, appendixMinuteStatisticsMoneyData.totalBusinessData) &&
        Objects.equals(this.backlinks, appendixMinuteStatisticsMoneyData.backlinks) &&
        Objects.equals(this.totalBacklinks, appendixMinuteStatisticsMoneyData.totalBacklinks) &&
        Objects.equals(this.appData, appendixMinuteStatisticsMoneyData.appData) &&
        Objects.equals(this.totalAppData, appendixMinuteStatisticsMoneyData.totalAppData) &&
        Objects.equals(this.contentAnalysis, appendixMinuteStatisticsMoneyData.contentAnalysis) &&
        Objects.equals(this.totalContentAnalysis, appendixMinuteStatisticsMoneyData.totalContentAnalysis) &&
        Objects.equals(this.contentGeneration, appendixMinuteStatisticsMoneyData.contentGeneration) &&
        Objects.equals(this.totalContentGeneration, appendixMinuteStatisticsMoneyData.totalContentGeneration) &&
        Objects.equals(this.value, appendixMinuteStatisticsMoneyData.value)&&
        Objects.equals(this.additionalProperties, appendixMinuteStatisticsMoneyData.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppendixMinuteStatisticsMoneyData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppendixMinuteStatisticsMoneyData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppendixMinuteStatisticsMoneyData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppendixMinuteStatisticsMoneyData is not found in the empty JSON string", AppendixMinuteStatisticsMoneyData.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppendixMinuteStatisticsMoneyData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppendixMinuteStatisticsMoneyData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppendixMinuteStatisticsMoneyData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppendixMinuteStatisticsMoneyData.class));

       return (TypeAdapter<T>) new TypeAdapter<AppendixMinuteStatisticsMoneyData>() {
           @Override
           public void write(JsonWriter out, AppendixMinuteStatisticsMoneyData value) throws IOException {
           ...
           @Override
           public AppendixMinuteStatisticsMoneyData read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AppendixMinuteStatisticsMoneyData instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AppendixMinuteStatisticsMoneyData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppendixMinuteStatisticsMoneyData
   * @throws IOException if the JSON string is invalid with respect to AppendixMinuteStatisticsMoneyData
   */
  public static AppendixMinuteStatisticsMoneyData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppendixMinuteStatisticsMoneyData.class);
  }

  /**
   * Convert an instance of AppendixMinuteStatisticsMoneyData to an JSON string
   *
   * @return JSON string
   */
