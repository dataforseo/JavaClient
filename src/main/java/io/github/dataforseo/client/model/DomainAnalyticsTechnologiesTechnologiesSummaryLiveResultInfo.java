...
* contains keywords found in the websites’ titles, descriptions or meta keywords, and number of websites using each keyword
  ...
  public DomainAnalyticsTechnologiesTechnologiesSummaryLiveResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.countries, domainAnalyticsTechnologiesTechnologiesSummaryLiveResultInfo.countries) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DomainAnalyticsTechnologiesTechnologiesSummaryLiveResultInfo>() {
           ...
           public DomainAnalyticsTechnologiesTechnologiesSummaryLiveResultInfo read(JsonReader in) throws IOException {
             ...
             DomainAnalyticsTechnologiesTechnologiesSummaryLiveResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
