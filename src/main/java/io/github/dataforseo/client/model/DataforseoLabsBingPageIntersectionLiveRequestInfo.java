...
public class DataforseoLabsBingPageIntersectionLiveRequestInfo  {
  ...
  public DataforseoLabsBingPageIntersectionLiveRequestInfo pages(Map<String, String> pages) {
    this.pages = pages;
    return this;
  }
...
* Note: this endpoint will not provide results if the number of intersecting keywords exceeds 10 million
  ...
  public DataforseoLabsBingPageIntersectionLiveRequestInfo excludePages(List<String> excludePages) {
...
* ]
  ...
  public DataforseoLabsBingPageIntersectionLiveRequestInfo locationName(String locationName) {
...
* United States
  ...
  public DataforseoLabsBingPageIntersectionLiveRequestInfo locationCode(Integer locationCode) {
...
* 2840
  ...
  public DataforseoLabsBingPageIntersectionLiveRequestInfo languageName(String languageName) {
...
* English
  ...
  public DataforseoLabsBingPageIntersectionLiveRequestInfo languageCode(String languageCode) {
...
* en
  ...
  public DataforseoLabsBingPageIntersectionLiveRequestInfo itemTypes(List<String> itemTypes) {
...
* ['organic', 'paid', 'featured_snippet', 'local_pack']
  ...
  public DataforseoLabsBingPageIntersectionLiveRequestInfo ignoreSynonyms(Boolean ignoreSynonyms) {
...
* default value: false
  ...
  public DataforseoLabsBingPageIntersectionLiveRequestInfo limit(Integer limit) {
    this.limit = limit;
    return this;
  }
...
* maximum value: 1000
  ...
  public DataforseoLabsBingPageIntersectionLiveRequestInfo offset(Integer offset) {
    this.offset = offset;
    return this;
  }
...
* if you specify 10 here, the first ten keywords in the results array will be omitted and the data will be provided for the successive keywords
  ...
  public DataforseoLabsBingPageIntersectionLiveRequestInfo includeSubdomains(Boolean includeSubdomains) {
...
* default value: true
  ...
  public DataforseoLabsBingPageIntersectionLiveRequestInfo intersectionMode(String intersectionMode) {
...
* by default, results are based on the intersect mode if you specify only pages array. If you specify exclude_pages as well, results are based on the union mode
  ...
  public DataforseoLabsBingPageIntersectionLiveRequestInfo includeSerpInfo(Boolean includeSerpInfo) {
...
* default value: false
  ...
  public DataforseoLabsBingPageIntersectionLiveRequestInfo filters(List<Object> filters) {
...
* for more information about filters, please refer to Dataforseo Labs – Filters or this help center guide
  ...
  public DataforseoLabsBingPageIntersectionLiveRequestInfo orderBy(List<String> orderBy) {
...
* ['intersection_result.1.rank_group,asc','intersection_result.2.rank_absolute,asc']
  ...
  public DataforseoLabsBingPageIntersectionLiveRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
...
* you will find the specified tag value in the data object of the response
  ...
  public DataforseoLabsBingPageIntersectionLiveRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DataforseoLabsBingPageIntersectionLiveRequestInfo dataforseoLabsBingPageIntersectionLiveRequestInfo = (DataforseoLabsBingPageIntersectionLiveRequestInfo) o;
    return

        Objects.equals(this.pages, dataforseoLabsBingPageIntersectionLiveRequestInfo.pages) &&
        Objects.equals(this.excludePages, dataforseoLabsBingPageIntersectionLiveRequestInfo.excludePages) &&
        Objects.equals(this.locationName, dataforseoLabsBingPageIntersectionLiveRequestInfo.locationName) &&
        Objects.equals(this.locationCode, dataforseoLabsBingPageIntersectionLiveRequestInfo.locationCode) &&
        Objects.equals(this.languageName, dataforseoLabsBingPageIntersectionLiveRequestInfo.languageName) &&
        Objects.equals(this.languageCode, dataforseoLabsBingPageIntersectionLiveRequestInfo.languageCode) &&
        Objects.equals(this.itemTypes, dataforseoLabsBingPageIntersectionLiveRequestInfo.itemTypes) &&
        Objects.equals(this.ignoreSynonyms, dataforseoLabsBingPageIntersectionLiveRequestInfo.ignoreSynonyms) &&
        Objects.equals(this.limit, dataforseoLabsBingPageIntersectionLiveRequestInfo.limit) &&
        Objects.equals(this.offset, dataforseoLabsBingPageIntersectionLiveRequestInfo.offset) &&
        Objects.equals(this.includeSubdomains, dataforseoLabsBingPageIntersectionLiveRequestInfo.includeSubdomains) &&
        Objects.equals(this.intersectionMode, dataforseoLabsBingPageIntersectionLiveRequestInfo.intersectionMode) &&
        Objects.equals(this.includeSerpInfo, dataforseoLabsBingPageIntersectionLiveRequestInfo.includeSerpInfo) &&
        Objects.equals(this.filters, dataforseoLabsBingPageIntersectionLiveRequestInfo.filters) &&
        Objects.equals(this.orderBy, dataforseoLabsBingPageIntersectionLiveRequestInfo.orderBy) &&
        Objects.equals(this.tag, dataforseoLabsBingPageIntersectionLiveRequestInfo.tag);  
  ...
  @Override
  public int hashCode() {
  return Objects.hash(pages, excludePages, locationName, locationCode, languageName, languageCode, itemTypes, ignoreSynonyms, limit, offset, includeSubdomains, intersectionMode, includeSerpInfo, filters, orderBy, tag);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataforseoLabsBingPageIntersectionLiveRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataforseoLabsBingPageIntersectionLiveRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataforseoLabsBingPageIntersectionLiveRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataforseoLabsBingPageIntersectionLiveRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataforseoLabsBingPageIntersectionLiveRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataforseoLabsBingPageIntersectionLiveRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<DataforseoLabsBingPageIntersectionLiveRequestInfo>() {
           @Override
           public void write(JsonWriter out, DataforseoLabsBingPageIntersectionLiveRequestInfo value) throws IOException {
           ...
           @Override
           public DataforseoLabsBingPageIntersectionLiveRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DataforseoLabsBingPageIntersectionLiveRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static DataforseoLabsBingPageIntersectionLiveRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataforseoLabsBingPageIntersectionLiveRequestInfo.class);
  }
