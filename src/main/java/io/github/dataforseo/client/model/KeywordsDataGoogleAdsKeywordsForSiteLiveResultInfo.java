...
public class KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo  {
  ...
  public KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo keyword(String keyword) {
  ...
  public KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo languageCode(String languageCode) {
  ...
  public KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo searchPartners(Boolean searchPartners) {
  ...
  public KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo competition(String competition) {
  ...
  public KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo lowTopOfPageBid(Double lowTopOfPageBid) {
  ...
  public KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo highTopOfPageBid(Double highTopOfPageBid) {
  ...
  public KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo cpc(Double cpc) {
    this.cpc = cpc;
    return this;
  }
  ...
  public KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo monthlySearches(List<MonthlySearchesInfo> monthlySearches) {
  ...
  public KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.keyword, keywordsDataGoogleAdsKeywordsForSiteLiveResultInfo.keyword) &&
        ...
        Objects.equals(this.competition, keywordsDataGoogleAdsKeywordsForSiteLiveResultInfo.competition) &&
        Objects.equals(this.competitionIndex, keywordsDataGoogleAdsKeywordsForSiteLiveResultInfo.competitionIndex) &&
        Objects.equals(this.searchVolume, keywordsDataGoogleAdsKeywordsForSiteLiveResultInfo.searchVolume) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo>() {
           @Override
           public void write(JsonWriter out, KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo value) throws IOException {
           ...
           @Override
           public KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KeywordsDataGoogleAdsKeywordsForSiteLiveResultInfo.class);
  }
