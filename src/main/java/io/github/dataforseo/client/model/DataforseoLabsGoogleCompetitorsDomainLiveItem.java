...
public class DataforseoLabsGoogleCompetitorsDomainLiveItem  {
  ...
  public DataforseoLabsGoogleCompetitorsDomainLiveItem seType(String seType) {
    this.seType = seType;
    return this;
  }
  ...
  public DataforseoLabsGoogleCompetitorsDomainLiveItem domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public DataforseoLabsGoogleCompetitorsDomainLiveItem avgPosition(Float avgPosition) {
...
* the value for a given domain may differ when combined with different target websites
  ...
  public DataforseoLabsGoogleCompetitorsDomainLiveItem sumPosition(Integer sumPosition) {
...
* the value for a given domain may differ when combined with different target websites
  ...
  public DataforseoLabsGoogleCompetitorsDomainLiveItem intersections(Integer intersections) {
  ...
  public DataforseoLabsGoogleCompetitorsDomainLiveItem fullDomainMetrics(Map<String, DataforseoLabsMetricsInfo> fullDomainMetrics) {
...
* full overview of ranking and traffic data relevant to all keywords that the provided domain is ranking for
  ...
  public DataforseoLabsGoogleCompetitorsDomainLiveItem metrics(Map<String, DataforseoLabsMetricsInfo> metrics) {
...
* note: in this array ranking and traffic data is provided for the target considering the keywords target shares in search with the competitor’s domain
  ...
  public DataforseoLabsGoogleCompetitorsDomainLiveItem competitorMetrics(Map<String, DataforseoLabsMetricsInfo> competitorMetrics) {
...
* note: in this array ranking and traffic data is provided for the returned competitor’s domain
  ...
  public DataforseoLabsGoogleCompetitorsDomainLiveItem() {
  }
  ...
  public DataforseoLabsGoogleCompetitorsDomainLiveItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DataforseoLabsGoogleCompetitorsDomainLiveItem dataforseoLabsGoogleCompetitorsDomainLiveItem = (DataforseoLabsGoogleCompetitorsDomainLiveItem) o;
    return

        Objects.equals(this.seType, dataforseoLabsGoogleCompetitorsDomainLiveItem.seType) &&
        Objects.equals(this.domain, dataforseoLabsGoogleCompetitorsDomainLiveItem.domain) &&
        Objects.equals(this.avgPosition, dataforseoLabsGoogleCompetitorsDomainLiveItem.avgPosition) &&
        Objects.equals(this.sumPosition, dataforseoLabsGoogleCompetitorsDomainLiveItem.sumPosition) &&
        Objects.equals(this.intersections, dataforseoLabsGoogleCompetitorsDomainLiveItem.intersections) &&
        Objects.equals(this.fullDomainMetrics, dataforseoLabsGoogleCompetitorsDomainLiveItem.fullDomainMetrics) &&
        Objects.equals(this.metrics, dataforseoLabsGoogleCompetitorsDomainLiveItem.metrics) &&
        Objects.equals(this.competitorMetrics, dataforseoLabsGoogleCompetitorsDomainLiveItem.competitorMetrics);  
  ...
  public String toString() {
    ...
    sb.append("class DataforseoLabsGoogleCompetitorsDomainLiveItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataforseoLabsGoogleCompetitorsDomainLiveItem
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataforseoLabsGoogleCompetitorsDomainLiveItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataforseoLabsGoogleCompetitorsDomainLiveItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataforseoLabsGoogleCompetitorsDomainLiveItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataforseoLabsGoogleCompetitorsDomainLiveItem.class));

       return (TypeAdapter<T>) new TypeAdapter<DataforseoLabsGoogleCompetitorsDomainLiveItem>() {
           @Override
           public void write(JsonWriter out, DataforseoLabsGoogleCompetitorsDomainLiveItem value) throws IOException {
           ...
           @Override
           public DataforseoLabsGoogleCompetitorsDomainLiveItem read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DataforseoLabsGoogleCompetitorsDomainLiveItem instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static DataforseoLabsGoogleCompetitorsDomainLiveItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataforseoLabsGoogleCompetitorsDomainLiveItem.class);
  }
