...
* example: 'en-US', 'fr'
  ...
  public OnPageAlternateLinkItem putAdditionalProperty(String key, Object value) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to OnPageAlternateLinkItem
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OnPageAlternateLinkItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OnPageAlternateLinkItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OnPageAlternateLinkItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OnPageAlternateLinkItem.class));

       return (TypeAdapter<T>) new TypeAdapter<OnPageAlternateLinkItem>() {
           @Override
           public void write(JsonWriter out, OnPageAlternateLinkItem value) throws IOException {
           ...
           @Override
           public OnPageAlternateLinkItem read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             OnPageAlternateLinkItem instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static OnPageAlternateLinkItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OnPageAlternateLinkItem.class);
  }
