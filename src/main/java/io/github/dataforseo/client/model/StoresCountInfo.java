...
public class StoresCountInfo  {
  ...
  public StoresCountInfo count(Integer count) {
    this.count = count;
    return this;
  }

  /**
   * <em>number of stores that offer the product</em>
   * @return count
   */
  ...
  /**
   * <em>text displayed on the Google Shopping page</em>
  ...
  public StoresCountInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.count, storesCountInfo.count) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StoresCountInfo>() {
           ...
           public StoresCountInfo read(JsonReader in) throws IOException {
             ...
             StoresCountInfo instance = thisAdapter.fromJsonTree(jsonObj);
