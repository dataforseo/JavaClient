...
public class SerpApiPeopleAlsoAskAiOverviewExpandedElementItem  extends BaseSerpApiPeopleAlsoAskExpandedElementItem  {
  ...
  public SerpApiPeopleAlsoAskAiOverviewExpandedElementItem references(List<AiModeAiOverviewReferenceInfo> references) {
  ...
  /**
   * <em>indicates whether the element is loaded asynchronously</em><br>if <code>true</code>, the <code>people_also_ask_ai_overview_expanded_element</code> element is loaded asynchronously;<br>if <code>false</code>, the <code>people_also_ask_ai_overview_expanded_element</code> element is loaded from cache
  ...
  public SerpApiPeopleAlsoAskAiOverviewExpandedElementItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SerpApiPeopleAlsoAskAiOverviewExpandedElementItem serpApiPeopleAlsoAskAiOverviewExpandedElementItem = (SerpApiPeopleAlsoAskAiOverviewExpandedElementItem) o;
    return
  ...
  public String toString() {
    ...
    sb.append("class SerpApiPeopleAlsoAskAiOverviewExpandedElementItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SerpApiPeopleAlsoAskAiOverviewExpandedElementItem
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SerpApiPeopleAlsoAskAiOverviewExpandedElementItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SerpApiPeopleAlsoAskAiOverviewExpandedElementItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SerpApiPeopleAlsoAskAiOverviewExpandedElementItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SerpApiPeopleAlsoAskAiOverviewExpandedElementItem.class));

       return (TypeAdapter<T>) new TypeAdapter<SerpApiPeopleAlsoAskAiOverviewExpandedElementItem>() {
           @Override
           public void write(JsonWriter out, SerpApiPeopleAlsoAskAiOverviewExpandedElementItem value) throws IOException {
           ...
           @Override
           public SerpApiPeopleAlsoAskAiOverviewExpandedElementItem read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SerpApiPeopleAlsoAskAiOverviewExpandedElementItem instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static SerpApiPeopleAlsoAskAiOverviewExpandedElementItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SerpApiPeopleAlsoAskAiOverviewExpandedElementItem.class);
  }
