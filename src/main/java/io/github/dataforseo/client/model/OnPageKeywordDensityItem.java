...
* number of times the keyword appears on the website (or webpage if you specified a url)
  ...
  public OnPageKeywordDensityItem density(Double density) {
...
* calculated as a ratio of frequency to the total count of keywords with the set keyword_length on the web page or website
  ...
  public OnPageKeywordDensityItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.keyword, onPageKeywordDensityItem.keyword) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OnPageKeywordDensityItem>() {
           ...
           public OnPageKeywordDensityItem read(JsonReader in) throws IOException {
             ...
             OnPageKeywordDensityItem instance = thisAdapter.fromJsonTree(jsonObj);
