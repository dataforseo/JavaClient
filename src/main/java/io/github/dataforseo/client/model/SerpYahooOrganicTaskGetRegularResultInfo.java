...
public class SerpYahooOrganicTaskGetRegularResultInfo  {
  ...
  public SerpYahooOrganicTaskGetRegularResultInfo keyword(String keyword) {
  ...
  public SerpYahooOrganicTaskGetRegularResultInfo type(String type) {
    this.type = type;
    return this;
  }
  ...
  public SerpYahooOrganicTaskGetRegularResultInfo seDomain(String seDomain) {
  ...
  public SerpYahooOrganicTaskGetRegularResultInfo locationCode(Integer locationCode) {
  ...
  public SerpYahooOrganicTaskGetRegularResultInfo languageCode(String languageCode) {
  ...
  public SerpYahooOrganicTaskGetRegularResultInfo checkUrl(String checkUrl) {
  ...
  public SerpYahooOrganicTaskGetRegularResultInfo datetime(String datetime) {
  ...
  public SerpYahooOrganicTaskGetRegularResultInfo spell(SpellInfo spell) {
    this.spell = spell;
    return this;
  }
  ...
  public SerpYahooOrganicTaskGetRegularResultInfo refinementChips(RefinementChipsInfo refinementChips) {
  ...
  public SerpYahooOrganicTaskGetRegularResultInfo itemTypes(List<String> itemTypes) {
  ...
  public SerpYahooOrganicTaskGetRegularResultInfo seResultsCount(Long seResultsCount) {
  ...
  public SerpYahooOrganicTaskGetRegularResultInfo itemsCount(Long itemsCount) {
  ...
  public SerpYahooOrganicTaskGetRegularResultInfo items(List<BaseSerpApiElementItem> items) {
    this.items = items;
    return this;
  }
  ...
  public SerpYahooOrganicTaskGetRegularResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SerpYahooOrganicTaskGetRegularResultInfo serpYahooOrganicTaskGetRegularResultInfo = (SerpYahooOrganicTaskGetRegularResultInfo) o;
    return

        Objects.equals(this.keyword, serpYahooOrganicTaskGetRegularResultInfo.keyword) &&
        Objects.equals(this.type, serpYahooOrganicTaskGetRegularResultInfo.type) &&
        Objects.equals(this.seDomain, serpYahooOrganicTaskGetRegularResultInfo.seDomain) &&
        Objects.equals(this.locationCode, serpYahooOrganicTaskGetRegularResultInfo.locationCode) &&
        Objects.equals(this.languageCode, serpYahooOrganicTaskGetRegularResultInfo.languageCode) &&
        Objects.equals(this.checkUrl, serpYahooOrganicTaskGetRegularResultInfo.checkUrl) &&
        Objects.equals(this.datetime, serpYahooOrganicTaskGetRegularResultInfo.datetime) &&
        Objects.equals(this.spell, serpYahooOrganicTaskGetRegularResultInfo.spell) &&
  ...
  public String toString() {
    ...
    sb.append("class SerpYahooOrganicTaskGetRegularResultInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SerpYahooOrganicTaskGetRegularResultInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SerpYahooOrganicTaskGetRegularResultInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SerpYahooOrganicTaskGetRegularResultInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SerpYahooOrganicTaskGetRegularResultInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SerpYahooOrganicTaskGetRegularResultInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SerpYahooOrganicTaskGetRegularResultInfo>() {
           @Override
           public void write(JsonWriter out, SerpYahooOrganicTaskGetRegularResultInfo value) throws IOException {
           ...
           @Override
           public SerpYahooOrganicTaskGetRegularResultInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SerpYahooOrganicTaskGetRegularResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static SerpYahooOrganicTaskGetRegularResultInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SerpYahooOrganicTaskGetRegularResultInfo.class);
  }
