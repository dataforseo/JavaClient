...
public class Categories  {
  ...
  public Categories url(String url) {
    this.url = url;
    return this;
  }
  ...
  public Categories putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.category, categories.category) &&
        Objects.equals(this.url, categories.url);  
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Categories>() {
           ...
           public Categories read(JsonReader in) throws IOException {
             ...
             Categories instance = thisAdapter.fromJsonTree(jsonObj);
