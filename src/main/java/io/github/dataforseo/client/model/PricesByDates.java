...
public class PricesByDates {
  ...
  public PricesByDates price(BigDecimal price) {
    this.price = price;
    return this;
  }
   ...
   * @return the PricesByDates instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.price, pricesByDates.price) &&
        ...
        Objects.equals(this.additionalProperties, pricesByDates.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(price, currency, checkInDate, checkOutDate, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PricesByDates.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PricesByDates is not found in the empty JSON string", PricesByDates.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("check_in_date") != null && !jsonObj.get("check_in_date").isJsonNull()) && !jsonObj.get("check_in_date").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `check_in_date` to be a primitive type in the JSON string but got `%s`", jsonObj.get("check_in_date").toString()));
      }
      if ((jsonObj.get("check_out_date") != null && !jsonObj.get("check_out_date").isJsonNull()) && !jsonObj.get("check_out_date").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `check_out_date` to be a primitive type in the JSON string but got `%s`", jsonObj.get("check_out_date").toString()));
      }
  }
  ...
  /**
   * Create an instance of PricesByDates given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PricesByDates
   * @throws IOException if the JSON string is invalid with respect to PricesByDates
   */
  ...
  /**
   * Convert an instance of PricesByDates to an JSON string
   *
   * @return JSON string
   */
