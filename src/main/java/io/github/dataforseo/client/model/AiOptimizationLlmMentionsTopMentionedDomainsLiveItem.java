...
public class AiOptimizationLlmMentionsTopMentionedDomainsLiveItem  {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveItem domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveItem location(List<AggregatedMetricsItemInfo> location) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveItem language(List<AggregatedMetricsItemInfo> language) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveItem platform(List<AggregatedMetricsItemInfo> platform) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveItem sourcesDomain(List<AggregatedMetricsItemInfo> sourcesDomain) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveItem searchResultsDomain(List<AggregatedMetricsItemInfo> searchResultsDomain) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveItem brandEntitiesTitle(List<AggregatedMetricsItemInfo> brandEntitiesTitle) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveItem brandEntitiesCategory(List<AggregatedMetricsItemInfo> brandEntitiesCategory) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveItem total(AggregatedMetricsInfoTotalInfo total) {
    this.total = total;
    return this;
  }
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveItem() {
  }
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiveItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiOptimizationLlmMentionsTopMentionedDomainsLiveItem aiOptimizationLlmMentionsTopMentionedDomainsLiveItem = (AiOptimizationLlmMentionsTopMentionedDomainsLiveItem) o;
    return

        Objects.equals(this.domain, aiOptimizationLlmMentionsTopMentionedDomainsLiveItem.domain) &&
        Objects.equals(this.location, aiOptimizationLlmMentionsTopMentionedDomainsLiveItem.location) &&
        Objects.equals(this.language, aiOptimizationLlmMentionsTopMentionedDomainsLiveItem.language) &&
        Objects.equals(this.platform, aiOptimizationLlmMentionsTopMentionedDomainsLiveItem.platform) &&
        Objects.equals(this.sourcesDomain, aiOptimizationLlmMentionsTopMentionedDomainsLiveItem.sourcesDomain) &&
        Objects.equals(this.searchResultsDomain, aiOptimizationLlmMentionsTopMentionedDomainsLiveItem.searchResultsDomain) &&
        Objects.equals(this.brandEntitiesTitle, aiOptimizationLlmMentionsTopMentionedDomainsLiveItem.brandEntitiesTitle) &&
        Objects.equals(this.brandEntitiesCategory, aiOptimizationLlmMentionsTopMentionedDomainsLiveItem.brandEntitiesCategory) &&
        Objects.equals(this.total, aiOptimizationLlmMentionsTopMentionedDomainsLiveItem.total);  
  ...
  @Override
  public int hashCode() {
  return Objects.hash(domain, location, language, platform, sourcesDomain, searchResultsDomain, brandEntitiesTitle, brandEntitiesCategory, total);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiOptimizationLlmMentionsTopMentionedDomainsLiveItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiOptimizationLlmMentionsTopMentionedDomainsLiveItem
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiOptimizationLlmMentionsTopMentionedDomainsLiveItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiOptimizationLlmMentionsTopMentionedDomainsLiveItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiOptimizationLlmMentionsTopMentionedDomainsLiveItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiOptimizationLlmMentionsTopMentionedDomainsLiveItem.class));

       return (TypeAdapter<T>) new TypeAdapter<AiOptimizationLlmMentionsTopMentionedDomainsLiveItem>() {
           @Override
           public void write(JsonWriter out, AiOptimizationLlmMentionsTopMentionedDomainsLiveItem value) throws IOException {
           ...
           @Override
           public AiOptimizationLlmMentionsTopMentionedDomainsLiveItem read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiOptimizationLlmMentionsTopMentionedDomainsLiveItem instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AiOptimizationLlmMentionsTopMentionedDomainsLiveItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiOptimizationLlmMentionsTopMentionedDomainsLiveItem.class);
  }
