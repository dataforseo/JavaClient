...
public class DataforseoLabsGoogleKeywordOverviewLiveItem {
   ...
   * @return the DataforseoLabsGoogleKeywordOverviewLiveItem instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.seType, dataforseoLabsGoogleKeywordOverviewLiveItem.seType) &&
        ...
        Objects.equals(this.additionalProperties, dataforseoLabsGoogleKeywordOverviewLiveItem.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(seType, keyword, locationCode, languageCode, searchPartners, keywordInfo, keywordInfoNormalizedWithBing, keywordInfoNormalizedWithClickstream, clickstreamKeywordInfo, keywordProperties, serpInfo, avgBacklinksInfo, searchIntentInfo, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataforseoLabsGoogleKeywordOverviewLiveItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataforseoLabsGoogleKeywordOverviewLiveItem is not found in the empty JSON string", DataforseoLabsGoogleKeywordOverviewLiveItem.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of DataforseoLabsGoogleKeywordOverviewLiveItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DataforseoLabsGoogleKeywordOverviewLiveItem
   * @throws IOException if the JSON string is invalid with respect to DataforseoLabsGoogleKeywordOverviewLiveItem
   */
  ...
  /**
   * Convert an instance of DataforseoLabsGoogleKeywordOverviewLiveItem to an JSON string
   *
   * @return JSON string
   */
