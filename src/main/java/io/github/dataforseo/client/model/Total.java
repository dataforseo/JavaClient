...
public class Total  {
  ...
  public Total location(List<GroupElement> location) {
...
* array of objects containing mention metrics segmented by geographical location
  ...
  public Total language(List<GroupElement> language) {
...
* array of objects containing mention metrics segmented by content language
  ...
  public Total platform(List<GroupElement> platform) {
...
* array of group elements containing mention metrics segmented by AI platform
  ...
  public Total sourcesDomain(List<GroupElement> sourcesDomain) {
...
* array of objects containing data on top domains that are cited as sources in LLM responses
  ...
  public Total searchResultsDomain(List<GroupElement> searchResultsDomain) {
...
* array of objects containing data on top domains that appear in search results related to LLM queries
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.location, total.location) &&
        Objects.equals(this.language, total.language) &&
        Objects.equals(this.platform, total.platform) &&
        Objects.equals(this.sourcesDomain, total.sourcesDomain) &&
        Objects.equals(this.searchResultsDomain, total.searchResultsDomain);  
  ...
  @Override
  public int hashCode() {
  return Objects.hash(location, language, platform, sourcesDomain, searchResultsDomain);
  }
