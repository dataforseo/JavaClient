...
public class SerpGoogleAutocompleteTaskPostRequestInfo  {
  ...
  public SerpGoogleAutocompleteTaskPostRequestInfo keyword(String keyword) {
  ...
  public SerpGoogleAutocompleteTaskPostRequestInfo locationCode(Integer locationCode) {
  ...
  public SerpGoogleAutocompleteTaskPostRequestInfo languageCode(String languageCode) {
  ...
  public SerpGoogleAutocompleteTaskPostRequestInfo cursorPointer(Integer cursorPointer) {
  ...
  public SerpGoogleAutocompleteTaskPostRequestInfo postbackUrl(String postbackUrl) {
  ...
  public SerpGoogleAutocompleteTaskPostRequestInfo postbackData(String postbackData) {
  ...
  public SerpGoogleAutocompleteTaskPostRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SerpGoogleAutocompleteTaskPostRequestInfo serpGoogleAutocompleteTaskPostRequestInfo = (SerpGoogleAutocompleteTaskPostRequestInfo) o;
    return
   ...
   * @throws IOException if the JSON Element is invalid with respect to SerpGoogleAutocompleteTaskPostRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SerpGoogleAutocompleteTaskPostRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SerpGoogleAutocompleteTaskPostRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SerpGoogleAutocompleteTaskPostRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SerpGoogleAutocompleteTaskPostRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SerpGoogleAutocompleteTaskPostRequestInfo>() {
           @Override
           public void write(JsonWriter out, SerpGoogleAutocompleteTaskPostRequestInfo value) throws IOException {
           ...
           @Override
           public SerpGoogleAutocompleteTaskPostRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SerpGoogleAutocompleteTaskPostRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static SerpGoogleAutocompleteTaskPostRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SerpGoogleAutocompleteTaskPostRequestInfo.class);
  }
