...
public class SerpGoogleAutocompleteTaskPostRequestInfo {
  ...
  /**
   * return URL for sending task results optional field once the task is completed, we will send a POST request with its results compressed in the gzip format to the postback_url you specified you can use the ‘$id’ string as a $id variable and ‘$tag’ as urlencoded $tag variable. We will set the necessary values before sending the request example: http://your-server.com/postbackscript?id&#x3D;$id http://your-server.com/postbackscript?id&#x3D;$id&amp;tag&#x3D;$tag Note: special symbols in postback_url will be url-encoded; i.e., the # symbol will be encoded into %23 learn more on our Help Center
   * @return postbackUrl
   */
  @javax.annotation.Nullable
   ...
   * @return the SerpGoogleAutocompleteTaskPostRequestInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyword, serpGoogleAutocompleteTaskPostRequestInfo.keyword) &&
        ...
        Objects.equals(this.additionalProperties, serpGoogleAutocompleteTaskPostRequestInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keyword, priority, locationName, locationCode, languageName, languageCode, cursorPointer, client, tag, postbackUrl, postbackData, pingbackUrl, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SerpGoogleAutocompleteTaskPostRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SerpGoogleAutocompleteTaskPostRequestInfo is not found in the empty JSON string", SerpGoogleAutocompleteTaskPostRequestInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of SerpGoogleAutocompleteTaskPostRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SerpGoogleAutocompleteTaskPostRequestInfo
   * @throws IOException if the JSON string is invalid with respect to SerpGoogleAutocompleteTaskPostRequestInfo
   */
  ...
  /**
   * Convert an instance of SerpGoogleAutocompleteTaskPostRequestInfo to an JSON string
   *
   * @return JSON string
   */
