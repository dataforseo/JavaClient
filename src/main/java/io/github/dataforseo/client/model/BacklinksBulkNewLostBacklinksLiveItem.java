...
* number of lost backlinks of the target
  ...
  public BacklinksBulkNewLostBacklinksLiveItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.target, backlinksBulkNewLostBacklinksLiveItem.target) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BacklinksBulkNewLostBacklinksLiveItem>() {
           ...
           public BacklinksBulkNewLostBacklinksLiveItem read(JsonReader in) throws IOException {
             ...
             BacklinksBulkNewLostBacklinksLiveItem instance = thisAdapter.fromJsonTree(jsonObj);
