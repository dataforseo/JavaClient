...
public class KeywordInfo  {
  ...
  /**
   * <em>competition</em><br>represents the relative amount of competition associated with the given keyword. This value is based on Google Ads data and can be between 0 and 1 (inclusive)
   * @return competition
   */
  @javax.annotation.Nullable
  ...
  /**
   * <em>cost-per-click</em><br>represents the average cost per click (USD) historically paid for the keyword
   * @return cpc
   */
  @javax.annotation.Nullable
  ...
  /**
   * <em>product and service categories</em><br>you can download the <a href='https://cdn.dataforseo.com/v3/categories/categories_dataforseo_labs_2023_10_25.csv'>full list of possible categories</a>
   * @return categories
   */
  @javax.annotation.Nullable
  ...
  /**
   * <em>search volume trend changes</em><br>represents search volume change in percent compared to the previous period
