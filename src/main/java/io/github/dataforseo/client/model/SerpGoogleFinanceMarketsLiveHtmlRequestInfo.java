...
public class SerpGoogleFinanceMarketsLiveHtmlRequestInfo  {
  ...
  public SerpGoogleFinanceMarketsLiveHtmlRequestInfo locationCode(Integer locationCode) {
  ...
  public SerpGoogleFinanceMarketsLiveHtmlRequestInfo languageCode(String languageCode) {
  ...
  public SerpGoogleFinanceMarketsLiveHtmlRequestInfo device(String device) {
    this.device = device;
    return this;
  }

  /**
   * <p><em>device type</em><p>optional field<p>possible value: <code>desktop</code></p>
   * @return device
   */
  @javax.annotation.Nullable
  ...
  public SerpGoogleFinanceMarketsLiveHtmlRequestInfo os(String os) {
    this.os = os;
    return this;
  }
  ...
  public SerpGoogleFinanceMarketsLiveHtmlRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public SerpGoogleFinanceMarketsLiveHtmlRequestInfo putAdditionalProperty(String key, Object value) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to SerpGoogleFinanceMarketsLiveHtmlRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SerpGoogleFinanceMarketsLiveHtmlRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SerpGoogleFinanceMarketsLiveHtmlRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SerpGoogleFinanceMarketsLiveHtmlRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SerpGoogleFinanceMarketsLiveHtmlRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SerpGoogleFinanceMarketsLiveHtmlRequestInfo>() {
           @Override
           public void write(JsonWriter out, SerpGoogleFinanceMarketsLiveHtmlRequestInfo value) throws IOException {
           ...
           @Override
           public SerpGoogleFinanceMarketsLiveHtmlRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SerpGoogleFinanceMarketsLiveHtmlRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static SerpGoogleFinanceMarketsLiveHtmlRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SerpGoogleFinanceMarketsLiveHtmlRequestInfo.class);
  }
