...
* contains separate arrays with timing for each resource found on the page
  ...
  public OnPageWaterfallItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.pageUrl, onPageWaterfallItem.pageUrl) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OnPageWaterfallItem>() {
           ...
           public OnPageWaterfallItem read(JsonReader in) throws IOException {
             ...
             OnPageWaterfallItem instance = thisAdapter.fromJsonTree(jsonObj);
