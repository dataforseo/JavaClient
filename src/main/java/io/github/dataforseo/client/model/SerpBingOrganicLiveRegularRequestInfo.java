...
* example.com/example-page* – returns results for all domain’s URLs that start with the specified string
  ...
  public SerpBingOrganicLiveRegularRequestInfo stopCrawlOnMatch(List<String> stopCrawlOnMatch) {
...
* example: dataforseo.com
  ...
  public SerpBingOrganicLiveRegularRequestInfo matchType(List<String> matchType) {
...
* you will find the specified tag value in the data object of the response
  ...
  @Override
  public int hashCode() {
  return Objects.hash(url, keyword, locationName, locationCode, locationCoordinate, languageName, languageCode, device, os, depth, maxCrawlPages, target, stopCrawlOnMatch, matchValue, matchType, searchParam, tag);
  }
