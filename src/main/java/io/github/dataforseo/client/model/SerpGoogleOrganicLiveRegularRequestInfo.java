...
* you will find the specified tag value in the data object of the response
  ...
  public SerpGoogleOrganicLiveRegularRequestInfo putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SerpGoogleOrganicLiveRegularRequestInfo>() {
           ...
           public SerpGoogleOrganicLiveRegularRequestInfo read(JsonReader in) throws IOException {
             ...
             SerpGoogleOrganicLiveRegularRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
