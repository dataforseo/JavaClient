...
public class AiOptimizationChatGptLlmScraperTasksReadyResultInfo  {
  ...
  public AiOptimizationChatGptLlmScraperTasksReadyResultInfo id(String id) {
    this.id = id;
    return this;
  }
...
* unique task identifier in our system in the UUID format
  ...
  public AiOptimizationChatGptLlmScraperTasksReadyResultInfo se(String se) {
    this.se = se;
    return this;
  }
...
* example: llm_scraper
  ...
  public AiOptimizationChatGptLlmScraperTasksReadyResultInfo datePosted(String datePosted) {
  ...
  public AiOptimizationChatGptLlmScraperTasksReadyResultInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
...
* if the Regular function is not supported in the specified endpoint, the value will be null
  ...
  public AiOptimizationChatGptLlmScraperTasksReadyResultInfo endpointAdvanced(String endpointAdvanced) {
...
* if the Advanced function is not supported in the specified endpoint, the value will be null
  ...
  public AiOptimizationChatGptLlmScraperTasksReadyResultInfo endpointHtml(String endpointHtml) {
...
* if the HTML function is not supported in the specified endpoint, the value will be null
  ...
  public AiOptimizationChatGptLlmScraperTasksReadyResultInfo() {
  }
  ...
  public AiOptimizationChatGptLlmScraperTasksReadyResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiOptimizationChatGptLlmScraperTasksReadyResultInfo aiOptimizationChatGptLlmScraperTasksReadyResultInfo = (AiOptimizationChatGptLlmScraperTasksReadyResultInfo) o;
    return
  ...
  public String toString() {
    ...
    sb.append("class AiOptimizationChatGptLlmScraperTasksReadyResultInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiOptimizationChatGptLlmScraperTasksReadyResultInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiOptimizationChatGptLlmScraperTasksReadyResultInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiOptimizationChatGptLlmScraperTasksReadyResultInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiOptimizationChatGptLlmScraperTasksReadyResultInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiOptimizationChatGptLlmScraperTasksReadyResultInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AiOptimizationChatGptLlmScraperTasksReadyResultInfo>() {
           @Override
           public void write(JsonWriter out, AiOptimizationChatGptLlmScraperTasksReadyResultInfo value) throws IOException {
           ...
           @Override
           public AiOptimizationChatGptLlmScraperTasksReadyResultInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiOptimizationChatGptLlmScraperTasksReadyResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AiOptimizationChatGptLlmScraperTasksReadyResultInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiOptimizationChatGptLlmScraperTasksReadyResultInfo.class);
  }
