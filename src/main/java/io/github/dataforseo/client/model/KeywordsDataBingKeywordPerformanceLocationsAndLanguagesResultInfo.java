...
* contains locations supported in combination with a specific language
  ...
  public KeywordsDataBingKeywordPerformanceLocationsAndLanguagesResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.languageName, keywordsDataBingKeywordPerformanceLocationsAndLanguagesResultInfo.languageName) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<KeywordsDataBingKeywordPerformanceLocationsAndLanguagesResultInfo>() {
           ...
           public KeywordsDataBingKeywordPerformanceLocationsAndLanguagesResultInfo read(JsonReader in) throws IOException {
             ...
             KeywordsDataBingKeywordPerformanceLocationsAndLanguagesResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
