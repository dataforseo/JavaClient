...
public class DatasetDescription  {
  ...
  public DatasetDescription text(String text) {
    this.text = text;
    return this;
  }
  ...
  public DatasetDescription links(List<LinkElement> links) {
    this.links = links;
    return this;
  }
  ...
  public DatasetDescription putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.text, datasetDescription.text) &&
        Objects.equals(this.links, datasetDescription.links);  
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DatasetDescription>() {
           ...
           public DatasetDescription read(JsonReader in) throws IOException {
             ...
             DatasetDescription instance = thisAdapter.fromJsonTree(jsonObj);
