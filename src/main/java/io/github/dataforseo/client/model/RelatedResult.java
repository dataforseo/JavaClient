...
public class RelatedResult {
  ...
  public RelatedResult rating(BusinessDataRatingInfo rating) {
    this.rating = rating;
    return this;
  }
   ...
   * @return the RelatedResult instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, relatedResult.type) &&
        ...
        Objects.equals(this.additionalProperties, relatedResult.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, xpath, domain, title, url, cacheUrl, relatedSearchUrl, breadcrumb, websiteName, isImage, isVideo, description, preSnippet, extendedSnippet, images, ampVersion, rating, price, highlighted, aboutThisResult, timestamp, additionalProperties);
  }
