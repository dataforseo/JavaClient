...
public class SerpGoogleSearchByImageTaskPostRequestInfo {
   ...
   * @return the SerpGoogleSearchByImageTaskPostRequestInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.imageUrl, serpGoogleSearchByImageTaskPostRequestInfo.imageUrl) &&
        ...
        Objects.equals(this.additionalProperties, serpGoogleSearchByImageTaskPostRequestInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(imageUrl, priority, maxCrawlPages, locationName, locationCode, locationCoordinate, languageName, languageCode, seDomain, calculateRectangles, browserScreenWidth, browserScreenHeight, browserScreenResolutionRatio, searchParam, tag, postbackUrl, postbackData, pingbackUrl, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SerpGoogleSearchByImageTaskPostRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SerpGoogleSearchByImageTaskPostRequestInfo is not found in the empty JSON string", SerpGoogleSearchByImageTaskPostRequestInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of SerpGoogleSearchByImageTaskPostRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SerpGoogleSearchByImageTaskPostRequestInfo
   * @throws IOException if the JSON string is invalid with respect to SerpGoogleSearchByImageTaskPostRequestInfo
   */
  ...
  /**
   * Convert an instance of SerpGoogleSearchByImageTaskPostRequestInfo to an JSON string
   *
   * @return JSON string
   */
