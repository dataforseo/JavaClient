...
public class BaseGoogleFinanceSerpElementItem {
  ...
  public BaseGoogleFinanceSerpElementItem type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BaseGoogleFinanceSerpElementItem baseGoogleFinanceSerpElementItem = (BaseGoogleFinanceSerpElementItem) o;
    return Objects.equals(this.type, baseGoogleFinanceSerpElementItem.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class BaseGoogleFinanceSerpElementItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BaseGoogleFinanceSerpElementItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BaseGoogleFinanceSerpElementItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BaseGoogleFinanceSerpElementItem is not found in the empty JSON string", BaseGoogleFinanceSerpElementItem.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of BaseGoogleFinanceSerpElementItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BaseGoogleFinanceSerpElementItem
   * @throws IOException if the JSON string is invalid with respect to BaseGoogleFinanceSerpElementItem
   */
  public static BaseGoogleFinanceSerpElementItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BaseGoogleFinanceSerpElementItem.class);
  }

  /**
   * Convert an instance of BaseGoogleFinanceSerpElementItem to an JSON string
   *
   * @return JSON string
   */
