...
* you can find the full list of general informational messages here
  ...
  public SerpTasksReadyResponseInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.version, serpTasksReadyResponseInfo.version) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SerpTasksReadyResponseInfo>() {
           ...
           public SerpTasksReadyResponseInfo read(JsonReader in) throws IOException {
             ...
             SerpTasksReadyResponseInfo instance = thisAdapter.fromJsonTree(jsonObj);
