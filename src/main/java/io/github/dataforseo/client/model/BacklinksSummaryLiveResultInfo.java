...
public class BacklinksSummaryLiveResultInfo  {
  ...
  /**
   * <em>date and time when our crawler found the backlink for the <code>target</code> for the first time</em><br>in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”<br>example:<br><code>2019-11-15 12:57:46 +00:00</code>
   * @return firstSeen
   */
  @javax.annotation.Nullable
  ...
  /**
   * <em>date and time when the backlink was lost</em><br>indicates the date and time when our crawler visited the target and it responded with a 4xx or 5xx status code or when its last backlink was removed<br>in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”<br>example:<br><code>2019-11-15 12:57:46 +00:00</code>
   * @return lostDate
   */
  @javax.annotation.Nullable
  ...
  /**
   * <code>target</code> rank<br>learn more about the metric and how it is calculated in <a href='https://dataforseo.com/help-center/what_is_rank_in_backlinks_api' rel='noopener noreferrer' target='_blank'>this help center article</a>
   * @return rank
   */
  @javax.annotation.Nullable
  ...
  /**
   * <em>spam score of the backlinks</em><br>displays the total spam score of all backlinks pointing to the <code>target</code> domain, subdomain, or webpage;<br>to learn more about how the metric is calculated, refer to <a href='https://dataforseo.com/help-center/what-is-spam-score-and-how-is-it-calculated' rel='noopener noreferrer' target='_blank'>this Help Center page</a>
  ...
  /**
   * <em>number of broken pages</em><br>number of pages on the <code>target</code> that respond with 4xx or 5xx status codes<p>note that the number of broken pages includes pages on the <code>target</code> discovered by following external links, but it may also include pages discovered by following the target's sitemap
   * @return brokenPages
   */
  @javax.annotation.Nullable
  ...
  /**
   * <em>indicates the number of referring domains</em><br>referring domains include subdomains that are counted as separate domains for this metric
  ...
  /**
   * <em>indicates the number of referring main domains</em>
  ...
  /**
   * <em>indicates the number of pages pointing to the target</em>
  ...
  /**
   * <em>link attributes of the referring links</em><br>indicates link attributes of the referring links and link count per each attribute<br>example values:<br><code>nofollow</code>, <code>noopener</code>, <code>noreferrer</code>, <code>external</code>, <code>ugc</code>, <code>sponsored</code>
  ...
  public BacklinksSummaryLiveResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.target, backlinksSummaryLiveResultInfo.target) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BacklinksSummaryLiveResultInfo>() {
           ...
           public BacklinksSummaryLiveResultInfo read(JsonReader in) throws IOException {
             ...
             BacklinksSummaryLiveResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
