...
public class DataforseoLabsAmazonRelatedKeywordsLiveRequestInfo {
  ...
  /**
   * keyword required field UTF-8 encoding a keyword should be at least 3 characters long; the keywords should be specified in the lowercase format learn more about rules and limitations of keyword and keywords fields in DataForSEO APIs in this Help Center article
   * @return keyword
   */
   ...
   * @return the DataforseoLabsAmazonRelatedKeywordsLiveRequestInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyword, dataforseoLabsAmazonRelatedKeywordsLiveRequestInfo.keyword) &&
        ...
        Objects.equals(this.additionalProperties, dataforseoLabsAmazonRelatedKeywordsLiveRequestInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keyword, locationName, locationCode, languageName, languageCode, depth, includeSeedKeyword, ignoreSynonyms, limit, offset, tag, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataforseoLabsAmazonRelatedKeywordsLiveRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataforseoLabsAmazonRelatedKeywordsLiveRequestInfo is not found in the empty JSON string", DataforseoLabsAmazonRelatedKeywordsLiveRequestInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of DataforseoLabsAmazonRelatedKeywordsLiveRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DataforseoLabsAmazonRelatedKeywordsLiveRequestInfo
   * @throws IOException if the JSON string is invalid with respect to DataforseoLabsAmazonRelatedKeywordsLiveRequestInfo
   */
  ...
  /**
   * Convert an instance of DataforseoLabsAmazonRelatedKeywordsLiveRequestInfo to an JSON string
   *
   * @return JSON string
   */
