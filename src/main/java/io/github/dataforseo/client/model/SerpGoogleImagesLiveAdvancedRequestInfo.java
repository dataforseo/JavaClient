...
public class SerpGoogleImagesLiveAdvancedRequestInfo  {
  ...
  public SerpGoogleImagesLiveAdvancedRequestInfo keyword(String keyword) {
  ...
  public SerpGoogleImagesLiveAdvancedRequestInfo locationCode(Integer locationCode) {
  ...
  public SerpGoogleImagesLiveAdvancedRequestInfo languageCode(String languageCode) {
  ...
  public SerpGoogleImagesLiveAdvancedRequestInfo locationName(String locationName) {
  ...
  public SerpGoogleImagesLiveAdvancedRequestInfo languageName(String languageName) {
  ...
  public SerpGoogleImagesLiveAdvancedRequestInfo os(String os) {
    this.os = os;
    return this;
  }
  ...
  public SerpGoogleImagesLiveAdvancedRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public SerpGoogleImagesLiveAdvancedRequestInfo maxCrawlPages(Integer maxCrawlPages) {
  ...
  public SerpGoogleImagesLiveAdvancedRequestInfo searchParam(String searchParam) {
  ...
  public SerpGoogleImagesLiveAdvancedRequestInfo url(String url) {
    this.url = url;
    return this;
  }
  ...
  public SerpGoogleImagesLiveAdvancedRequestInfo locationCoordinate(String locationCoordinate) {
  ...
  public SerpGoogleImagesLiveAdvancedRequestInfo seDomain(String seDomain) {
    this.seDomain = seDomain;
    return this;
  }

  /**
   * <p><em>search engine domain</em><p>optional field<p>We choose the relevant search engine domain automatically according to the location and language you specify. However, you can set a custom search engine domain in this field<p>example:<p><code><code></code></code><em>google.co.uk</em>, <code><code></code></code><em>google.com.au</em>, <code><code></code></code><em>google.de</em>, etc.</p>
   * @return seDomain
   */
  @javax.annotation.Nullable
  ...
  public SerpGoogleImagesLiveAdvancedRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SerpGoogleImagesLiveAdvancedRequestInfo serpGoogleImagesLiveAdvancedRequestInfo = (SerpGoogleImagesLiveAdvancedRequestInfo) o;
    return

        Objects.equals(this.keyword, serpGoogleImagesLiveAdvancedRequestInfo.keyword) &&
        Objects.equals(this.locationCode, serpGoogleImagesLiveAdvancedRequestInfo.locationCode) &&
        Objects.equals(this.languageCode, serpGoogleImagesLiveAdvancedRequestInfo.languageCode) &&
        Objects.equals(this.depth, serpGoogleImagesLiveAdvancedRequestInfo.depth) &&
        Objects.equals(this.locationName, serpGoogleImagesLiveAdvancedRequestInfo.locationName) &&
        Objects.equals(this.languageName, serpGoogleImagesLiveAdvancedRequestInfo.languageName) &&
        Objects.equals(this.os, serpGoogleImagesLiveAdvancedRequestInfo.os) &&
        Objects.equals(this.tag, serpGoogleImagesLiveAdvancedRequestInfo.tag) &&
        Objects.equals(this.maxCrawlPages, serpGoogleImagesLiveAdvancedRequestInfo.maxCrawlPages) &&
        Objects.equals(this.searchParam, serpGoogleImagesLiveAdvancedRequestInfo.searchParam) &&
        Objects.equals(this.url, serpGoogleImagesLiveAdvancedRequestInfo.url) &&
        Objects.equals(this.locationCoordinate, serpGoogleImagesLiveAdvancedRequestInfo.locationCoordinate) &&
        Objects.equals(this.seDomain, serpGoogleImagesLiveAdvancedRequestInfo.seDomain);  
  ...
  public String toString() {
    ...
    sb.append("class SerpGoogleImagesLiveAdvancedRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SerpGoogleImagesLiveAdvancedRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SerpGoogleImagesLiveAdvancedRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SerpGoogleImagesLiveAdvancedRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SerpGoogleImagesLiveAdvancedRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SerpGoogleImagesLiveAdvancedRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SerpGoogleImagesLiveAdvancedRequestInfo>() {
           @Override
           public void write(JsonWriter out, SerpGoogleImagesLiveAdvancedRequestInfo value) throws IOException {
           ...
           @Override
           public SerpGoogleImagesLiveAdvancedRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SerpGoogleImagesLiveAdvancedRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static SerpGoogleImagesLiveAdvancedRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SerpGoogleImagesLiveAdvancedRequestInfo.class);
  }
