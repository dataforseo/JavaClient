...
public class GoogleReviewsSearchBusinessDataSerpElementItem extends BaseBusinessDataSerpElementItem {
   ...
   * @return the GoogleReviewsSearchBusinessDataSerpElementItem instance itself
   */
  public GoogleReviewsSearchBusinessDataSerpElementItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.position, googleReviewsSearchBusinessDataSerpElementItem.position) &&
        ...
        Objects.equals(this.additionalProperties, googleReviewsSearchBusinessDataSerpElementItem.additionalProperties) &&
        super.equals(o);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(position, xpath, reviewText, originalReviewText, timeAgo, timestamp, rating, reviewsCount, photosCount, localGuide, profileName, profileUrl, reviewUrl, profileImageUrl, ownerAnswer, originalOwnerAnswer, ownerTimeAgo, ownerTimestamp, reviewId, images, reviewHighlights, super.hashCode(), additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GoogleReviewsSearchBusinessDataSerpElementItem>() {
           ...
           public GoogleReviewsSearchBusinessDataSerpElementItem read(JsonReader in) throws IOException {
             ...
             GoogleReviewsSearchBusinessDataSerpElementItem instance = thisAdapter.fromJsonTree(jsonObj);
