...
public class BingOrganicSerpElementItem  extends BaseBingSerpApiElementItem  {
  ...
  public BingOrganicSerpElementItem domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public BingOrganicSerpElementItem title(String title) {
    this.title = title;
    return this;
  }
  ...
  public BingOrganicSerpElementItem description(String description) {
  ...
  public BingOrganicSerpElementItem url(String url) {
    this.url = url;
    return this;
  }
  ...
  public BingOrganicSerpElementItem breadcrumb(String breadcrumb) {
  ...
  public BingOrganicSerpElementItem cacheUrl(String cacheUrl) {
  ...
  public BingOrganicSerpElementItem relatedSearchUrl(String relatedSearchUrl) {
...
* URL to a new search for the same keyword(s) on related sites
  ...
  public BingOrganicSerpElementItem websiteName(String websiteName) {
  ...
  public BingOrganicSerpElementItem isImage(Boolean isImage) {
  ...
  public BingOrganicSerpElementItem isVideo(Boolean isVideo) {
  ...
  public BingOrganicSerpElementItem isFeaturedSnippet(Boolean isFeaturedSnippet) {
  ...
  public BingOrganicSerpElementItem isMalicious(Boolean isMalicious) {
  ...
  public BingOrganicSerpElementItem isWebStory(Boolean isWebStory) {
  ...
  public BingOrganicSerpElementItem preSnippet(String preSnippet) {
  ...
  public BingOrganicSerpElementItem extendedSnippet(String extendedSnippet) {
  ...
  public BingOrganicSerpElementItem images(List<AiModeImagesElementInfo> images) {
    this.images = images;
    return this;
  }
  ...
  public BingOrganicSerpElementItem ampVersion(Boolean ampVersion) {
...
* the popularity rate based on reviews and displayed in SERP
  ...
  public BingOrganicSerpElementItem price(PriceInfo price) {
    this.price = price;
    return this;
  }
...
* contains the pricing details of the product or service featured in the result
  ...
  public BingOrganicSerpElementItem highlighted(List<String> highlighted) {
  ...
  public BingOrganicSerpElementItem links(List<LinkElement> links) {
    this.links = links;
    return this;
  }
...
* if there are none, equals null
  ...
  public BingOrganicSerpElementItem faq(FaqBox faq) {
    this.faq = faq;
    return this;
  }
...
* if there are none, equals null
  ...
  public BingOrganicSerpElementItem extendedPeopleAlsoSearch(List<String> extendedPeopleAlsoSearch) {
...
* Note: extension appears in SERP upon clicking on the result and then bouncing back to search results
  ...
  public BingOrganicSerpElementItem aboutThisResult(AboutThisResultElement aboutThisResult) {
...
* note: about_this_result feature is not available in Bing search engine, that’s why it always equals null
  ...
  public BingOrganicSerpElementItem relatedResult(List<RelatedResult> relatedResult) {
...
* note: related_result feature is not available in Bing search engine, that’s why it always equals null
  ...
  public BingOrganicSerpElementItem timestamp(String timestamp) {
...
* 2019-11-15 12:57:46 +00:00
  ...
  public BingOrganicSerpElementItem() {
  }
  ...
  public BingOrganicSerpElementItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BingOrganicSerpElementItem bingOrganicSerpElementItem = (BingOrganicSerpElementItem) o;
    return

        Objects.equals(this.domain, bingOrganicSerpElementItem.domain) &&
        Objects.equals(this.title, bingOrganicSerpElementItem.title) &&
        Objects.equals(this.description, bingOrganicSerpElementItem.description) &&
        Objects.equals(this.url, bingOrganicSerpElementItem.url) &&
        Objects.equals(this.breadcrumb, bingOrganicSerpElementItem.breadcrumb) &&
        Objects.equals(this.cacheUrl, bingOrganicSerpElementItem.cacheUrl) &&
        Objects.equals(this.relatedSearchUrl, bingOrganicSerpElementItem.relatedSearchUrl) &&
        Objects.equals(this.websiteName, bingOrganicSerpElementItem.websiteName) &&
        Objects.equals(this.isImage, bingOrganicSerpElementItem.isImage) &&
        Objects.equals(this.isVideo, bingOrganicSerpElementItem.isVideo) &&
        ...
        Objects.equals(this.ampVersion, bingOrganicSerpElementItem.ampVersion) &&
        Objects.equals(this.rating, bingOrganicSerpElementItem.rating) &&
        Objects.equals(this.price, bingOrganicSerpElementItem.price) &&
        Objects.equals(this.highlighted, bingOrganicSerpElementItem.highlighted) &&
        Objects.equals(this.links, bingOrganicSerpElementItem.links) &&
        Objects.equals(this.faq, bingOrganicSerpElementItem.faq) &&
        Objects.equals(this.extendedPeopleAlsoSearch, bingOrganicSerpElementItem.extendedPeopleAlsoSearch) &&
        Objects.equals(this.aboutThisResult, bingOrganicSerpElementItem.aboutThisResult) &&
        Objects.equals(this.relatedResult, bingOrganicSerpElementItem.relatedResult) &&
        Objects.equals(this.timestamp, bingOrganicSerpElementItem.timestamp) && 
        super.equals(o);
  ...
  public String toString() {
    ...
    sb.append("class BingOrganicSerpElementItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BingOrganicSerpElementItem
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BingOrganicSerpElementItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BingOrganicSerpElementItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BingOrganicSerpElementItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BingOrganicSerpElementItem.class));

       return (TypeAdapter<T>) new TypeAdapter<BingOrganicSerpElementItem>() {
           @Override
           public void write(JsonWriter out, BingOrganicSerpElementItem value) throws IOException {
           ...
           @Override
           public BingOrganicSerpElementItem read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             BingOrganicSerpElementItem instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static BingOrganicSerpElementItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BingOrganicSerpElementItem.class);
  }
