...
public class ContentGenerationGenerateSubTopicsLiveResultInfo  {
  ...
  public ContentGenerationGenerateSubTopicsLiveResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.inputTokens, contentGenerationGenerateSubTopicsLiveResultInfo.inputTokens) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ContentGenerationGenerateSubTopicsLiveResultInfo>() {
           ...
           public ContentGenerationGenerateSubTopicsLiveResultInfo read(JsonReader in) throws IOException {
             ...
             ContentGenerationGenerateSubTopicsLiveResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
