...
public class BacklinksDomainPagesSummaryLiveItem  {
  ...
  /**
   * <em>date and time when our crawler found a backlink to this page for the first time</em><br>in the UTC format: 'yyyy-mm-dd hh-mm-ss +00:00'<br>example:<br><code>2019-11-15 12:57:46 +00:00</code>
   * @return firstSeen
   */
  @javax.annotation.Nullable
  ...
  /**
   * <em>number of broken backlinks</em><br>number of broken backlinks pointing to the page
  ...
  /**
   * <em>indicates the number domains referring to the page</em>
  ...
  /**
   * <em>indicates the number of pages pointing to the relevant <code>url</code></em>
  ...
  public BacklinksDomainPagesSummaryLiveItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.type, backlinksDomainPagesSummaryLiveItem.type) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BacklinksDomainPagesSummaryLiveItem>() {
           ...
           public BacklinksDomainPagesSummaryLiveItem read(JsonReader in) throws IOException {
             ...
             BacklinksDomainPagesSummaryLiveItem instance = thisAdapter.fromJsonTree(jsonObj);
