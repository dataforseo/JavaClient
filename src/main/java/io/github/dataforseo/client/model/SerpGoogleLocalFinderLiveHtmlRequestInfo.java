...
public class SerpGoogleLocalFinderLiveHtmlRequestInfo  {
  ...
  public SerpGoogleLocalFinderLiveHtmlRequestInfo keyword(String keyword) {
...
* if you need to use the “+” character for your keyword, please specify it as “%2B”
  ...
  public SerpGoogleLocalFinderLiveHtmlRequestInfo locationCode(Integer locationCode) {
...
* 2840
  ...
  public SerpGoogleLocalFinderLiveHtmlRequestInfo languageCode(String languageCode) {
...
* example:en
  ...
  public SerpGoogleLocalFinderLiveHtmlRequestInfo depth(Integer depth) {
    this.depth = depth;
    return this;
  }
...
* possible values for mobile: 2, 2.5, 3, 3.5, 4, 4.5
  ...
  public SerpGoogleLocalFinderLiveHtmlRequestInfo timeFilter(String timeFilter) {
...
* example: 'tuesday;18'
  ...
  public SerpGoogleLocalFinderLiveHtmlRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SerpGoogleLocalFinderLiveHtmlRequestInfo serpGoogleLocalFinderLiveHtmlRequestInfo = (SerpGoogleLocalFinderLiveHtmlRequestInfo) o;
    return
   ...
   * @throws IOException if the JSON Element is invalid with respect to SerpGoogleLocalFinderLiveHtmlRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SerpGoogleLocalFinderLiveHtmlRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SerpGoogleLocalFinderLiveHtmlRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SerpGoogleLocalFinderLiveHtmlRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SerpGoogleLocalFinderLiveHtmlRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SerpGoogleLocalFinderLiveHtmlRequestInfo>() {
           @Override
           public void write(JsonWriter out, SerpGoogleLocalFinderLiveHtmlRequestInfo value) throws IOException {
           ...
           @Override
           public SerpGoogleLocalFinderLiveHtmlRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SerpGoogleLocalFinderLiveHtmlRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static SerpGoogleLocalFinderLiveHtmlRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SerpGoogleLocalFinderLiveHtmlRequestInfo.class);
  }
