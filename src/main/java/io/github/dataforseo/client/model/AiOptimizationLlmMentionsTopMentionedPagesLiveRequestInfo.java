...
public class AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo  {
  ...
  public AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo target(List<BaseAiOptimizationLLmMentionsTargetElement> target) {
    this.target = target;
    return this;
  }
...
* target array with a domain entity
  ...
  public AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo locationName(String locationName) {
  ...
  public AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo locationCode(Integer locationCode) {
  ...
  public AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo languageName(String languageName) {
  ...
  public AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo languageCode(String languageCode) {
  ...
  public AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo platform(String platform) {
  ...
  public AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo linksScope(String linksScope) {
  ...
  public AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo filters(List<Object> filters) {
  ...
  public AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo initialDatasetFilters(List<Object> initialDatasetFilters) {
  ...
  public AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo internalListLimit(Integer internalListLimit) {
  ...
  public AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo orderBy(List<String> orderBy) {
  ...
  public AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo offset(Integer offset) {
    this.offset = offset;
    return this;
  }
  ...
  public AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo includePages(List<String> includePages) {
    this.includePages = includePages;
    return this;
  }

  /**
   * <em>array of pages to include in the response</em><br>optional field<br>if specified, only the listed pages will be returned in the <code>items</code> array<br>example:<br><code>'include_pages': ['https://example.page/']</code>
   * @return includePages
   */
  @javax.annotation.Nullable
  ...
  public AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo excludePages(List<String> excludePages) {
    this.excludePages = excludePages;
    return this;
  }

  /**
   * <em>array of pages to exclude from the response</em><br>optional field<br>if specified, the listed pages will be omitted from the <code>items</code> array<br>example:<br><code>'exclude_pages': ['https://example.page/']</code>
   * @return excludePages
   */
  @javax.annotation.Nullable
  ...
  public AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo() {
  }
  ...
  public AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo aiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo = (AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo) o;
    return

        Objects.equals(this.target, aiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo.target) &&
        Objects.equals(this.locationName, aiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo.locationName) &&
        Objects.equals(this.locationCode, aiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo.locationCode) &&
        Objects.equals(this.languageName, aiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo.languageName) &&
        Objects.equals(this.languageCode, aiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo.languageCode) &&
        Objects.equals(this.platform, aiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo.platform) &&
        Objects.equals(this.linksScope, aiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo.linksScope) &&
        Objects.equals(this.filters, aiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo.filters) &&
        Objects.equals(this.initialDatasetFilters, aiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo.initialDatasetFilters) &&
        Objects.equals(this.limit, aiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo.limit) &&
        Objects.equals(this.internalListLimit, aiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo.internalListLimit) &&
        Objects.equals(this.orderBy, aiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo.orderBy) &&
        Objects.equals(this.offset, aiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo.offset) &&
        Objects.equals(this.includePages, aiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo.includePages) &&
        Objects.equals(this.excludePages, aiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo.excludePages) &&
        Objects.equals(this.tag, aiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo.tag);  
  ...
  public String toString() {
    ...
    sb.append("class AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo>() {
           @Override
           public void write(JsonWriter out, AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo value) throws IOException {
           ...
           @Override
           public AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo.class);
  }
