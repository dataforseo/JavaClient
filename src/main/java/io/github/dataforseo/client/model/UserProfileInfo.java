...
public class UserProfileInfo  {
  ...
  public UserProfileInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.name, userProfileInfo.name) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserProfileInfo>() {
           ...
           public UserProfileInfo read(JsonReader in) throws IOException {
             ...
             UserProfileInfo instance = thisAdapter.fromJsonTree(jsonObj);
