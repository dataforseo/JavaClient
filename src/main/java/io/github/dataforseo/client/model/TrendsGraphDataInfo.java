...
public class TrendsGraphDataInfo  {
  ...
  /**
   * <em>start date of the corresponding time range</em><br>in the UTC format: 'yyyy-mm-dd'
   * @return dateFrom
   */
  ...
  /**
   * <em>end date of the corresponding time range</em><br>in the UTC format: 'yyyy-mm-dd'
   * @return dateTo
   */
  @javax.annotation.Nullable
  ...
  /**
   * <em>a point in time in the <a href='https://en.wikipedia.org/wiki/Unix_time'>Unix time format</a></em>
   * @return timestamp
   */
  @javax.annotation.Nullable
  ...
  /**
   * <em>indicates whether the data is unavailable<em><br>if <code>true<code> the data on the graph in the Google Trends interface is missing and thus labelled with a dotted line
   * @return missingData
   */
  @javax.annotation.Nullable
