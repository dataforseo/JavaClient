...
public class AppendixAppendixDayStatisticsRatesData {
   ...
   * @return the AppendixAppendixDayStatisticsRatesData instance itself
   */
  public AppendixAppendixDayStatisticsRatesData putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AppendixAppendixDayStatisticsRatesData>() {
           ...
           public AppendixAppendixDayStatisticsRatesData read(JsonReader in) throws IOException {
             ...
             AppendixAppendixDayStatisticsRatesData instance = thisAdapter.fromJsonTree(jsonObj);
