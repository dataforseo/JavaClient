...
public class YoutubeCommentSerpElementItem extends BaseYoutubeSerpElementItem {
   ...
   * @return the YoutubeCommentSerpElementItem instance itself
   */
  public YoutubeCommentSerpElementItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authorName, youtubeCommentSerpElementItem.authorName) &&
        ...
        Objects.equals(this.additionalProperties, youtubeCommentSerpElementItem.additionalProperties) &&
        super.equals(o);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authorName, authorThumbnail, authorUrl, text, publicationDate, timestamp, likesCount, replyCount, super.hashCode(), additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<YoutubeCommentSerpElementItem>() {
           ...
           public YoutubeCommentSerpElementItem read(JsonReader in) throws IOException {
             ...
             YoutubeCommentSerpElementItem instance = thisAdapter.fromJsonTree(jsonObj);
