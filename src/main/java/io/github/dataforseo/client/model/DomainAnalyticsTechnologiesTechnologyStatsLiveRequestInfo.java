...
public class DomainAnalyticsTechnologiesTechnologyStatsLiveRequestInfo  {
  ...
  /**
   * <em>target technology</em><br><strong>required field</strong><br>you can find the full list of technologies you can specify here <a href='/v3/domain_analytics/technologies/technologies' target='_blank' rel='noopener noreferrer'>on this page</a><br>example:<br><code>'Salesforce'</code>
   * @return technology
   */
  ...
  /**
   * <em>starting date of the time range</em><br>optional field<br>minimum value: <code>2022-10-31</code><br>if you don't specify this field, the minimum value will be used by default<br>date format: <code>'yyyy-mm-dd'</code><br>example:<br><code>'2023-06-01'</code>
   * @return dateFrom
   */
  @javax.annotation.Nullable
  ...
  /**
   * <em>ending date of the time range</em><br>optional field<br>if you don't specify this field, the today's date will be used by default<br>date format: <code>'yyyy-mm-dd'</code><br>example:<br><code>'2023-01-15'</code>
   * @return dateTo
   */
  @javax.annotation.Nullable
