...
public class AppDataAppleAppListTasksReadyResultInfo  {
  ...
  public AppDataAppleAppListTasksReadyResultInfo id(String id) {
    this.id = id;
    return this;
  }
...
* unique task identifier in our system in the UUID format
  ...
  public AppDataAppleAppListTasksReadyResultInfo se(String se) {
    this.se = se;
    return this;
  }
  ...
  public AppDataAppleAppListTasksReadyResultInfo datePosted(String datePosted) {
  ...
  public AppDataAppleAppListTasksReadyResultInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public AppDataAppleAppListTasksReadyResultInfo endpointAdvanced(String endpointAdvanced) {
  ...
  public AppDataAppleAppListTasksReadyResultInfo endpointHtml(String endpointHtml) {
...
* if HTML tasks are not supported in the specified endpoint, the value will be null
  ...
  public AppDataAppleAppListTasksReadyResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.id, appDataAppleAppListTasksReadyResultInfo.id) &&
        ...
        Objects.equals(this.endpointHtml, appDataAppleAppListTasksReadyResultInfo.endpointHtml);  
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppDataAppleAppListTasksReadyResultInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppDataAppleAppListTasksReadyResultInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppDataAppleAppListTasksReadyResultInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppDataAppleAppListTasksReadyResultInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppDataAppleAppListTasksReadyResultInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AppDataAppleAppListTasksReadyResultInfo>() {
           @Override
           public void write(JsonWriter out, AppDataAppleAppListTasksReadyResultInfo value) throws IOException {
           ...
           @Override
           public AppDataAppleAppListTasksReadyResultInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AppDataAppleAppListTasksReadyResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AppDataAppleAppListTasksReadyResultInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppDataAppleAppListTasksReadyResultInfo.class);
  }
