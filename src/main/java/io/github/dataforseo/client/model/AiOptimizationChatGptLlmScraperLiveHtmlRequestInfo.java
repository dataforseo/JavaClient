...
public class AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo  {
  ...
  public AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo keyword(String keyword) {
  ...
  public AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo languageCode(String languageCode) {
  ...
  public AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo forceWebSearch(Boolean forceWebSearch) {
  ...
  public AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo expandCitations(Boolean expandCitations) {
    this.expandCitations = expandCitations;
    return this;
  }

  /**
   * <em>return expanded citation bar in HTML results</em><br>optional field<br>to enable this parameter, <code>force_web_search</code> must also be enabled;<br>when enabled, the endpoint will return HTML data from the expanded citation bar;<br>default value: <code>false</code>
  ...
  public AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo() {
  }
  ...
  public AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo aiOptimizationChatGptLlmScraperLiveHtmlRequestInfo = (AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo) o;
    return
        ...
        Objects.equals(this.expandCitations, aiOptimizationChatGptLlmScraperLiveHtmlRequestInfo.expandCitations) &&
        Objects.equals(this.tag, aiOptimizationChatGptLlmScraperLiveHtmlRequestInfo.tag);  
  ...
  public String toString() {
    ...
    sb.append("class AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo>() {
           @Override
           public void write(JsonWriter out, AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo value) throws IOException {
           ...
           @Override
           public AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiOptimizationChatGptLlmScraperLiveHtmlRequestInfo.class);
  }
