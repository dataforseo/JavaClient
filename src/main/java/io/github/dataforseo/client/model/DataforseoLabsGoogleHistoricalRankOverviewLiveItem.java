...
public class DataforseoLabsGoogleHistoricalRankOverviewLiveItem  {
  ...
  public DataforseoLabsGoogleHistoricalRankOverviewLiveItem metrics(Map<String, DataforseoLabsMetricsInfo> metrics) {
  ...
  public DataforseoLabsGoogleHistoricalRankOverviewLiveItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.seType, dataforseoLabsGoogleHistoricalRankOverviewLiveItem.seType) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DataforseoLabsGoogleHistoricalRankOverviewLiveItem>() {
           ...
           public DataforseoLabsGoogleHistoricalRankOverviewLiveItem read(JsonReader in) throws IOException {
             ...
             DataforseoLabsGoogleHistoricalRankOverviewLiveItem instance = thisAdapter.fromJsonTree(jsonObj);
