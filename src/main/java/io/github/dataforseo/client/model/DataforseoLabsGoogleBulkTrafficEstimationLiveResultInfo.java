...
public class DataforseoLabsGoogleBulkTrafficEstimationLiveResultInfo {
  ...
  public DataforseoLabsGoogleBulkTrafficEstimationLiveResultInfo items(List<DataforseoLabsBBulkTrafficEstimationLiveItem> items) {
    this.items = items;
    return this;
  }

  public DataforseoLabsGoogleBulkTrafficEstimationLiveResultInfo addItemsItem(DataforseoLabsBBulkTrafficEstimationLiveItem itemsItem) {
    if (this.items == null) {
