...
public class SerpBingOrganicTasksFixedResultInfo  {
  ...
  public SerpBingOrganicTasksFixedResultInfo id(String id) {
    this.id = id;
    return this;
  }
  ...
  public SerpBingOrganicTasksFixedResultInfo se(String se) {
    this.se = se;
    return this;
  }
  ...
  public SerpBingOrganicTasksFixedResultInfo seType(String seType) {
    this.seType = seType;
    return this;
  }
  ...
  public SerpBingOrganicTasksFixedResultInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public SerpBingOrganicTasksFixedResultInfo endpointRegular(String endpointRegular) {
  ...
  public SerpBingOrganicTasksFixedResultInfo endpointAdvanced(String endpointAdvanced) {
  ...
  public SerpBingOrganicTasksFixedResultInfo endpointHtml(String endpointHtml) {
  ...
  public SerpBingOrganicTasksFixedResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SerpBingOrganicTasksFixedResultInfo serpBingOrganicTasksFixedResultInfo = (SerpBingOrganicTasksFixedResultInfo) o;
    return
        ...
        Objects.equals(this.endpointHtml, serpBingOrganicTasksFixedResultInfo.endpointHtml);  
  ...
  public String toString() {
    ...
    sb.append("class SerpBingOrganicTasksFixedResultInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SerpBingOrganicTasksFixedResultInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SerpBingOrganicTasksFixedResultInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SerpBingOrganicTasksFixedResultInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SerpBingOrganicTasksFixedResultInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SerpBingOrganicTasksFixedResultInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SerpBingOrganicTasksFixedResultInfo>() {
           @Override
           public void write(JsonWriter out, SerpBingOrganicTasksFixedResultInfo value) throws IOException {
           ...
           @Override
           public SerpBingOrganicTasksFixedResultInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SerpBingOrganicTasksFixedResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static SerpBingOrganicTasksFixedResultInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SerpBingOrganicTasksFixedResultInfo.class);
  }
