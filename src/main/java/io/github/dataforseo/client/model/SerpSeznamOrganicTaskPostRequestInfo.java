...
public class SerpSeznamOrganicTaskPostRequestInfo {
  ...
  /**
   * page crawl limit optional field number of search results pages to crawl max value: 10 Note: the max_crawl_pages and depth parameters complement each other; learn more at our help center
   ...
   * @return the SerpSeznamOrganicTaskPostRequestInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyword, serpSeznamOrganicTaskPostRequestInfo.keyword) &&
        ...
        Objects.equals(this.additionalProperties, serpSeznamOrganicTaskPostRequestInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keyword, locationName, locationCode, languageName, languageCode, url, priority, depth, maxCrawlPages, device, os, seDomain, searchParam, calculateRectangles, tag, postbackUrl, postbackData, pingbackUrl, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SerpSeznamOrganicTaskPostRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SerpSeznamOrganicTaskPostRequestInfo is not found in the empty JSON string", SerpSeznamOrganicTaskPostRequestInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of SerpSeznamOrganicTaskPostRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SerpSeznamOrganicTaskPostRequestInfo
   * @throws IOException if the JSON string is invalid with respect to SerpSeznamOrganicTaskPostRequestInfo
   */
  ...
  /**
   * Convert an instance of SerpSeznamOrganicTaskPostRequestInfo to an JSON string
   *
   * @return JSON string
   */
