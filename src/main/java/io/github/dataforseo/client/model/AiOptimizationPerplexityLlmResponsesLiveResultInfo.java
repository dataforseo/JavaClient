...
public class AiOptimizationPerplexityLlmResponsesLiveResultInfo  {
  ...
  public AiOptimizationPerplexityLlmResponsesLiveResultInfo modelName(String modelName) {
  ...
  public AiOptimizationPerplexityLlmResponsesLiveResultInfo inputTokens(Integer inputTokens) {
  ...
  public AiOptimizationPerplexityLlmResponsesLiveResultInfo outputTokens(Integer outputTokens) {
  ...
  public AiOptimizationPerplexityLlmResponsesLiveResultInfo webSearch(Boolean webSearch) {
    this.webSearch = webSearch;
    return this;
  }

  /**
   * <em>indicates if web search was used</em><br><strong>Note:</strong> web search is enabled by default in Perplexity Sonar models
   * @return webSearch
   */
  @javax.annotation.Nullable
  ...
  public AiOptimizationPerplexityLlmResponsesLiveResultInfo moneySpent(Double moneySpent) {
    this.moneySpent = moneySpent;
    return this;
  }

  /**
   * <em>cost of AI tokens, USD</em><br>the price charged by the third-party AI model provider for according to its <a href='https://docs.perplexity.ai/guides/pricing' target='_blank'>Pricing</a>
   * @return moneySpent
   */
  @javax.annotation.Nullable
  ...
  public AiOptimizationPerplexityLlmResponsesLiveResultInfo datetime(String datetime) {
  ...
  public AiOptimizationPerplexityLlmResponsesLiveResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiOptimizationPerplexityLlmResponsesLiveResultInfo aiOptimizationPerplexityLlmResponsesLiveResultInfo = (AiOptimizationPerplexityLlmResponsesLiveResultInfo) o;
    return
  ...
  public String toString() {
    ...
    sb.append("class AiOptimizationPerplexityLlmResponsesLiveResultInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiOptimizationPerplexityLlmResponsesLiveResultInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiOptimizationPerplexityLlmResponsesLiveResultInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiOptimizationPerplexityLlmResponsesLiveResultInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiOptimizationPerplexityLlmResponsesLiveResultInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiOptimizationPerplexityLlmResponsesLiveResultInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AiOptimizationPerplexityLlmResponsesLiveResultInfo>() {
           @Override
           public void write(JsonWriter out, AiOptimizationPerplexityLlmResponsesLiveResultInfo value) throws IOException {
           ...
           @Override
           public AiOptimizationPerplexityLlmResponsesLiveResultInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiOptimizationPerplexityLlmResponsesLiveResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AiOptimizationPerplexityLlmResponsesLiveResultInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiOptimizationPerplexityLlmResponsesLiveResultInfo.class);
  }
