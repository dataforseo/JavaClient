...
public class ProductConsiderationsExpandedElement {
   ...
   * @return the ProductConsiderationsExpandedElement instance itself
   */
  public ProductConsiderationsExpandedElement putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, productConsiderationsExpandedElement.type) &&
        ...
        Objects.equals(this.additionalProperties, productConsiderationsExpandedElement.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, title, featuredTitle, breadcrumb, snippet, domain, url, timestamp, relatedSearches, aboutThisResult, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProductConsiderationsExpandedElement>() {
           ...
           public ProductConsiderationsExpandedElement read(JsonReader in) throws IOException {
             ...
             ProductConsiderationsExpandedElement instance = thisAdapter.fromJsonTree(jsonObj);
