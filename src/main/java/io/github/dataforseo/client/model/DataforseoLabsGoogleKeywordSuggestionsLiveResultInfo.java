...
public class DataforseoLabsGoogleKeywordSuggestionsLiveResultInfo  {
  ...
  /**
   * <em>keyword data for the seed keyword</em><br>fields in this object are identical to those of the <code>items</code> array
  ...
  public DataforseoLabsGoogleKeywordSuggestionsLiveResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.seType, dataforseoLabsGoogleKeywordSuggestionsLiveResultInfo.seType) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DataforseoLabsGoogleKeywordSuggestionsLiveResultInfo>() {
           ...
           public DataforseoLabsGoogleKeywordSuggestionsLiveResultInfo read(JsonReader in) throws IOException {
             ...
             DataforseoLabsGoogleKeywordSuggestionsLiveResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
