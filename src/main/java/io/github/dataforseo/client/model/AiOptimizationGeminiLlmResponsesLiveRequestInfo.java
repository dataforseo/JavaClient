...
public class AiOptimizationGeminiLlmResponsesLiveRequestInfo  {
  ...
  public AiOptimizationGeminiLlmResponsesLiveRequestInfo userPrompt(String userPrompt) {
...
* you can specify up to 500 characters in the user_prompt field
  ...
  public AiOptimizationGeminiLlmResponsesLiveRequestInfo modelName(String modelName) {
...
* you can receive the list of available LLM models by making a separate request to the https://api.dataforseo.com/v3/ai_optimization/gemini/llm_responses/models
  ...
  public AiOptimizationGeminiLlmResponsesLiveRequestInfo maxOutputTokens(Integer maxOutputTokens) {
...
* Note: when web_search is set to true, the output token count may exceed the specified max_output_tokens limit
  ...
  public AiOptimizationGeminiLlmResponsesLiveRequestInfo temperature(Double temperature) {
...
* default value: 1.3
  ...
  public AiOptimizationGeminiLlmResponsesLiveRequestInfo topP(Double topP) {
    this.topP = topP;
    return this;
  }
...
* default value: 0.9
  ...
  public AiOptimizationGeminiLlmResponsesLiveRequestInfo webSearch(Boolean webSearch) {
...
* The cost of the parameter can be calculated on the Pricing page
  ...
  public AiOptimizationGeminiLlmResponsesLiveRequestInfo systemMessage(String systemMessage) {
...
* you can specify up to 500 characters in the system_message field
  ...
  public AiOptimizationGeminiLlmResponsesLiveRequestInfo messageChain(List<LlmMessageChainItem> messageChain) {
...
* 'message_chain': [{'role':'user','message':'Hello, what’s up?'},{'role':'ai','message':'Hello! I’m doing well, thank you. How can I assist you today?'}]
  ...
  public AiOptimizationGeminiLlmResponsesLiveRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
...
* you will find the specified tag value in the data object of the response
  ...
  public AiOptimizationGeminiLlmResponsesLiveRequestInfo() {
  }
  ...
  public AiOptimizationGeminiLlmResponsesLiveRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiOptimizationGeminiLlmResponsesLiveRequestInfo aiOptimizationGeminiLlmResponsesLiveRequestInfo = (AiOptimizationGeminiLlmResponsesLiveRequestInfo) o;
    return

        Objects.equals(this.userPrompt, aiOptimizationGeminiLlmResponsesLiveRequestInfo.userPrompt) &&
        Objects.equals(this.modelName, aiOptimizationGeminiLlmResponsesLiveRequestInfo.modelName) &&
        Objects.equals(this.maxOutputTokens, aiOptimizationGeminiLlmResponsesLiveRequestInfo.maxOutputTokens) &&
        Objects.equals(this.temperature, aiOptimizationGeminiLlmResponsesLiveRequestInfo.temperature) &&
        Objects.equals(this.topP, aiOptimizationGeminiLlmResponsesLiveRequestInfo.topP) &&
  ...
  public String toString() {
    ...
    sb.append("class AiOptimizationGeminiLlmResponsesLiveRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiOptimizationGeminiLlmResponsesLiveRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiOptimizationGeminiLlmResponsesLiveRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiOptimizationGeminiLlmResponsesLiveRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiOptimizationGeminiLlmResponsesLiveRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiOptimizationGeminiLlmResponsesLiveRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AiOptimizationGeminiLlmResponsesLiveRequestInfo>() {
           @Override
           public void write(JsonWriter out, AiOptimizationGeminiLlmResponsesLiveRequestInfo value) throws IOException {
           ...
           @Override
           public AiOptimizationGeminiLlmResponsesLiveRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiOptimizationGeminiLlmResponsesLiveRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AiOptimizationGeminiLlmResponsesLiveRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiOptimizationGeminiLlmResponsesLiveRequestInfo.class);
  }
