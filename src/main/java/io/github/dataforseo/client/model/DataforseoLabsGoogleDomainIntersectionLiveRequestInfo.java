...
public class DataforseoLabsGoogleDomainIntersectionLiveRequestInfo {
  ...
  public DataforseoLabsGoogleDomainIntersectionLiveRequestInfo addItemTypesItem(String itemTypesItem) {
  ...
  public DataforseoLabsGoogleDomainIntersectionLiveRequestInfo addFiltersItem(Object filtersItem) {
  ...
  public DataforseoLabsGoogleDomainIntersectionLiveRequestInfo addOrderByItem(String orderByItem) {
   ...
   * @return the DataforseoLabsGoogleDomainIntersectionLiveRequestInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.target1, dataforseoLabsGoogleDomainIntersectionLiveRequestInfo.target1) &&
        ...
        Objects.equals(this.additionalProperties, dataforseoLabsGoogleDomainIntersectionLiveRequestInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(target1, target2, locationName, locationCode, languageName, languageCode, intersections, itemTypes, includeSerpInfo, includeClickstreamData, limit, offset, filters, orderBy, tag, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataforseoLabsGoogleDomainIntersectionLiveRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataforseoLabsGoogleDomainIntersectionLiveRequestInfo is not found in the empty JSON string", DataforseoLabsGoogleDomainIntersectionLiveRequestInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of DataforseoLabsGoogleDomainIntersectionLiveRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DataforseoLabsGoogleDomainIntersectionLiveRequestInfo
   * @throws IOException if the JSON string is invalid with respect to DataforseoLabsGoogleDomainIntersectionLiveRequestInfo
   */
  ...
  /**
   * Convert an instance of DataforseoLabsGoogleDomainIntersectionLiveRequestInfo to an JSON string
   *
   * @return JSON string
   */
