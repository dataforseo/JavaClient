...
public class SerpGoogleNewsLiveAdvancedRequestInfo  {
  ...
  public SerpGoogleNewsLiveAdvancedRequestInfo keyword(String keyword) {
...
* London,England,United Kingdom
  ...
  public SerpGoogleNewsLiveAdvancedRequestInfo locationCode(Integer locationCode) {
...
* 53.476225,-2.243572,200
  ...
  public SerpGoogleNewsLiveAdvancedRequestInfo languageName(String languageName) {
...
* en
  ...
  public SerpGoogleNewsLiveAdvancedRequestInfo os(String os) {
    this.os = os;
    return this;
  }
...
* default value: windows
  ...
  public SerpGoogleNewsLiveAdvancedRequestInfo calculateRectangles(Boolean calculateRectangles) {
...
* Note: if set to true, the charge per task will be multiplied by 2
  ...
  public SerpGoogleNewsLiveAdvancedRequestInfo browserScreenWidth(Long browserScreenWidth) {
...
* Note: to use this parameter, set calculate_rectangles to true
  ...
  public SerpGoogleNewsLiveAdvancedRequestInfo browserScreenHeight(Integer browserScreenHeight) {
...
* Note: to use this parameter, set calculate_rectangles to true
  ...
  public SerpGoogleNewsLiveAdvancedRequestInfo browserScreenResolutionRatio(Integer browserScreenResolutionRatio) {
...
* Note: to use this parameter, set calculate_rectangles to true
  ...
  public SerpGoogleNewsLiveAdvancedRequestInfo seDomain(String seDomain) {
...
* Get the list of available parameters and additional details here.
  ...
  public SerpGoogleNewsLiveAdvancedRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SerpGoogleNewsLiveAdvancedRequestInfo serpGoogleNewsLiveAdvancedRequestInfo = (SerpGoogleNewsLiveAdvancedRequestInfo) o;
    return
   ...
   * @throws IOException if the JSON Element is invalid with respect to SerpGoogleNewsLiveAdvancedRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SerpGoogleNewsLiveAdvancedRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SerpGoogleNewsLiveAdvancedRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SerpGoogleNewsLiveAdvancedRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SerpGoogleNewsLiveAdvancedRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SerpGoogleNewsLiveAdvancedRequestInfo>() {
           @Override
           public void write(JsonWriter out, SerpGoogleNewsLiveAdvancedRequestInfo value) throws IOException {
           ...
           @Override
           public SerpGoogleNewsLiveAdvancedRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SerpGoogleNewsLiveAdvancedRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static SerpGoogleNewsLiveAdvancedRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SerpGoogleNewsLiveAdvancedRequestInfo.class);
  }
