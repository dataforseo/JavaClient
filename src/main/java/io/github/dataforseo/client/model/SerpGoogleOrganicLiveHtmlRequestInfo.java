...
public class SerpGoogleOrganicLiveHtmlRequestInfo {
   ...
   * @return the SerpGoogleOrganicLiveHtmlRequestInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, serpGoogleOrganicLiveHtmlRequestInfo.url) &&
        ...
        Objects.equals(this.additionalProperties, serpGoogleOrganicLiveHtmlRequestInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(url, keyword, locationName, locationCode, locationCoordinate, languageName, languageCode, device, os, seDomain, depth, maxCrawlPages, searchParam, loadAsyncAiOverview, expandAiOverview, tag, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SerpGoogleOrganicLiveHtmlRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SerpGoogleOrganicLiveHtmlRequestInfo is not found in the empty JSON string", SerpGoogleOrganicLiveHtmlRequestInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of SerpGoogleOrganicLiveHtmlRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SerpGoogleOrganicLiveHtmlRequestInfo
   * @throws IOException if the JSON string is invalid with respect to SerpGoogleOrganicLiveHtmlRequestInfo
   */
  ...
  /**
   * Convert an instance of SerpGoogleOrganicLiveHtmlRequestInfo to an JSON string
   *
   * @return JSON string
   */
