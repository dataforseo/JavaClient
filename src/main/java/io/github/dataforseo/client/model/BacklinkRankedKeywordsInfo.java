...
public class BacklinkRankedKeywordsInfo  {
  ...
  public BacklinkRankedKeywordsInfo pageFromKeywordsCountTop3(Long pageFromKeywordsCountTop3) {
  ...
  public BacklinkRankedKeywordsInfo pageFromKeywordsCountTop10(Long pageFromKeywordsCountTop10) {
  ...
  public BacklinkRankedKeywordsInfo pageFromKeywordsCountTop100(Long pageFromKeywordsCountTop100) {
  ...
  public BacklinkRankedKeywordsInfo() {
  }
  ...
  public BacklinkRankedKeywordsInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BacklinkRankedKeywordsInfo backlinkRankedKeywordsInfo = (BacklinkRankedKeywordsInfo) o;
    return

        Objects.equals(this.pageFromKeywordsCountTop3, backlinkRankedKeywordsInfo.pageFromKeywordsCountTop3) &&
        Objects.equals(this.pageFromKeywordsCountTop10, backlinkRankedKeywordsInfo.pageFromKeywordsCountTop10) &&
        Objects.equals(this.pageFromKeywordsCountTop100, backlinkRankedKeywordsInfo.pageFromKeywordsCountTop100);  
  ...
  public String toString() {
    ...
    sb.append("class BacklinkRankedKeywordsInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BacklinkRankedKeywordsInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BacklinkRankedKeywordsInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BacklinkRankedKeywordsInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BacklinkRankedKeywordsInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BacklinkRankedKeywordsInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<BacklinkRankedKeywordsInfo>() {
           @Override
           public void write(JsonWriter out, BacklinkRankedKeywordsInfo value) throws IOException {
           ...
           @Override
           public BacklinkRankedKeywordsInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             BacklinkRankedKeywordsInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static BacklinkRankedKeywordsInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BacklinkRankedKeywordsInfo.class);
  }
