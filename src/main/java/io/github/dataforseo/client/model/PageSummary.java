...
public class PageSummary  {
  ...
  public PageSummary firstSeen(String firstSeen) {
  ...
  public PageSummary lostDate(String lostDate) {
  ...
  /**
   * <em>average spam score of the backlinks pointing to the page</em><br>learn more about how the metric is calculated on <a href='https://dataforseo.com/help-center/what-is-spam-score-and-how-is-it-calculated' rel='noopener noreferrer' target='_blank'>this help center page</a>
  ...
  /**
   * <em>number of broken backlinks</em><br>number of broken backlinks pointing to the <code>page</code>
  ...
  /**
   * <em>number of domains pointing at least one nofollow link to the <code>page</code></em>
  ...
  public PageSummary referringMainDomainsNofollow(Long referringMainDomainsNofollow) {
    this.referringMainDomainsNofollow = referringMainDomainsNofollow;
    return this;
  }

  /**
   * <em>number of main domains pointing at least one nofollow link to the <code>page</code></em>
  ...
  /**
   * <em>indicates the number of pages pointing to the <code>page</code></em>
  ...
  /**
   * <em>number of referring pages pointing at least one nofollow link to the <code>page</code></em>
  ...
  public PageSummary referringLinksTld(Map<String, Long> referringLinksTld) {
  ...
  public PageSummary referringLinksTypes(Map<String, Long> referringLinksTypes) {
  ...
  public PageSummary referringLinksAttributes(Map<String, Long> referringLinksAttributes) {
  ...
  public PageSummary referringLinksPlatformTypes(Map<String, Long> referringLinksPlatformTypes) {
  ...
  public PageSummary referringLinksSemanticLocations(Map<String, Long> referringLinksSemanticLocations) {
  ...
  public PageSummary referringLinksCountries(Map<String, Long> referringLinksCountries) {
  ...
  public PageSummary putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.firstSeen, pageSummary.firstSeen) &&
        Objects.equals(this.lostDate, pageSummary.lostDate) &&
        Objects.equals(this.rank, pageSummary.rank) &&
        Objects.equals(this.backlinks, pageSummary.backlinks) &&
        Objects.equals(this.backlinksSpamScore, pageSummary.backlinksSpamScore) &&
        Objects.equals(this.brokenBacklinks, pageSummary.brokenBacklinks) &&
        Objects.equals(this.brokenPages, pageSummary.brokenPages) &&
        Objects.equals(this.referringDomains, pageSummary.referringDomains) &&
        Objects.equals(this.referringDomainsNofollow, pageSummary.referringDomainsNofollow) &&
        Objects.equals(this.referringMainDomains, pageSummary.referringMainDomains) &&
        Objects.equals(this.referringMainDomainsNofollow, pageSummary.referringMainDomainsNofollow) &&
        Objects.equals(this.referringIps, pageSummary.referringIps) &&
        Objects.equals(this.referringSubnets, pageSummary.referringSubnets) &&
        Objects.equals(this.referringPages, pageSummary.referringPages) &&
        Objects.equals(this.referringPagesNofollow, pageSummary.referringPagesNofollow) &&
        Objects.equals(this.referringLinksTld, pageSummary.referringLinksTld) &&
        Objects.equals(this.referringLinksTypes, pageSummary.referringLinksTypes) &&
        Objects.equals(this.referringLinksAttributes, pageSummary.referringLinksAttributes) &&
        Objects.equals(this.referringLinksPlatformTypes, pageSummary.referringLinksPlatformTypes) &&
        Objects.equals(this.referringLinksSemanticLocations, pageSummary.referringLinksSemanticLocations) &&
        Objects.equals(this.referringLinksCountries, pageSummary.referringLinksCountries);  
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PageSummary>() {
           ...
           public PageSummary read(JsonReader in) throws IOException {
             ...
             PageSummary instance = thisAdapter.fromJsonTree(jsonObj);
