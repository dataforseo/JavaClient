...
public class MerchantAmazonProductsTaskPostRequestInfo {
   ...
   * @return the MerchantAmazonProductsTaskPostRequestInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyword, merchantAmazonProductsTaskPostRequestInfo.keyword) &&
        ...
        Objects.equals(this.additionalProperties, merchantAmazonProductsTaskPostRequestInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keyword, url, priority, locationName, locationCode, locationCoordinate, languageName, languageCode, seDomain, depth, maxCrawlPages, department, searchParam, priceMin, priceMax, sortBy, tag, postbackUrl, postbackData, pingbackUrl, additionalProperties);
  }
