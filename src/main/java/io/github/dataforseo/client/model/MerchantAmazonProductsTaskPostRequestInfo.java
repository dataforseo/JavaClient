...
public class MerchantAmazonProductsTaskPostRequestInfo {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keyword, url, priority, locationName, locationCode, locationCoordinate, languageName, languageCode, seDomain, depth, maxCrawlPages, searchParam, priceMin, priceMax, sortBy, tag, postbackUrl, postbackData, pingbackUrl, department, additionalProperties);
  }
