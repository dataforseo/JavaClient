...
public class WaterfallResourceInfo  {
  ...
  public WaterfallResourceInfo durationTime(Integer durationTime) {
  ...
  public WaterfallResourceInfo fetchStart(Integer fetchStart) {
...
* the amount of time the browser needs to start downloading a resource
  ...
  public WaterfallResourceInfo fetchEnd(Integer fetchEnd) {
...
* parameters defining the location of the specific resource within the document’s HTML
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.resourceType, waterfallResourceInfo.resourceType) &&
  ...
  @Override
  public int hashCode() {
  return Objects.hash(resourceType, url, initiator, durationTime, fetchStart, fetchEnd, location, isRenderBlocking);
  }
