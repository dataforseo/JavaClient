...
public class LlmMentionsAggregatedMetricsInfo  {
  ...
  public LlmMentionsAggregatedMetricsInfo location(List<AggregatedMetricsItemInfo> location) {
...
* array of objects containing mention metrics segmented by geographical location
  ...
  public LlmMentionsAggregatedMetricsInfo language(List<AggregatedMetricsItemInfo> language) {
...
* array of objects containing mention metrics segmented by content language
  ...
  public LlmMentionsAggregatedMetricsInfo platform(List<AggregatedMetricsItemInfo> platform) {
...
* array of group elements containing mention metrics segmented by AI platform
  ...
  public LlmMentionsAggregatedMetricsInfo sourcesDomain(List<AggregatedMetricsItemInfo> sourcesDomain) {
...
* learn more about the sources and how to retrieve LLM citation data at our Help Center
  ...
  public LlmMentionsAggregatedMetricsInfo searchResultsDomain(List<AggregatedMetricsItemInfo> searchResultsDomain) {
...
* array of objects containing data on top domains that appear in search results related to LLM queries
  ...
  public LlmMentionsAggregatedMetricsInfo brandEntitiesTitle(List<AggregatedMetricsItemInfo> brandEntitiesTitle) {
...
* array of objects containing data on brand entity titles that appear in search results related to LLM queries
  ...
  public LlmMentionsAggregatedMetricsInfo brandEntitiesCategory(List<AggregatedMetricsItemInfo> brandEntitiesCategory) {
...
* array of objects containing data on brand entity categories that appear in search results related to LLM queries
  ...
  public LlmMentionsAggregatedMetricsInfo total(AggregatedMetricsInfoTotalInfo total) {
    this.total = total;
    return this;
  }
...
* contains overall aggregated LLM mention metrics across all found domains
  ...
  public LlmMentionsAggregatedMetricsInfo() {
  }
  ...
  public LlmMentionsAggregatedMetricsInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LlmMentionsAggregatedMetricsInfo llmMentionsAggregatedMetricsInfo = (LlmMentionsAggregatedMetricsInfo) o;
    return

        Objects.equals(this.location, llmMentionsAggregatedMetricsInfo.location) &&
        Objects.equals(this.language, llmMentionsAggregatedMetricsInfo.language) &&
        Objects.equals(this.platform, llmMentionsAggregatedMetricsInfo.platform) &&
        Objects.equals(this.sourcesDomain, llmMentionsAggregatedMetricsInfo.sourcesDomain) &&
        Objects.equals(this.searchResultsDomain, llmMentionsAggregatedMetricsInfo.searchResultsDomain) &&
        Objects.equals(this.brandEntitiesTitle, llmMentionsAggregatedMetricsInfo.brandEntitiesTitle) &&
        Objects.equals(this.brandEntitiesCategory, llmMentionsAggregatedMetricsInfo.brandEntitiesCategory) &&
        Objects.equals(this.total, llmMentionsAggregatedMetricsInfo.total);  
  ...
  @Override
  public int hashCode() {
  return Objects.hash(location, language, platform, sourcesDomain, searchResultsDomain, brandEntitiesTitle, brandEntitiesCategory, total);
  }
  ...
  public String toString() {
    ...
    sb.append("class LlmMentionsAggregatedMetricsInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LlmMentionsAggregatedMetricsInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LlmMentionsAggregatedMetricsInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LlmMentionsAggregatedMetricsInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LlmMentionsAggregatedMetricsInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LlmMentionsAggregatedMetricsInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<LlmMentionsAggregatedMetricsInfo>() {
           @Override
           public void write(JsonWriter out, LlmMentionsAggregatedMetricsInfo value) throws IOException {
           ...
           @Override
           public LlmMentionsAggregatedMetricsInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             LlmMentionsAggregatedMetricsInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static LlmMentionsAggregatedMetricsInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LlmMentionsAggregatedMetricsInfo.class);
  }
