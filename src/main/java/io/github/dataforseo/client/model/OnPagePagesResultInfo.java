...
public class OnPagePagesResultInfo  {
  ...
  public OnPagePagesResultInfo crawlProgress(String crawlProgress) {
...
* possible values: in_progress, finished
  ...
  public OnPagePagesResultInfo crawlStatus(CrawlStatusInfo crawlStatus) {
  ...
  public OnPagePagesResultInfo currentOffset(Integer currentOffset) {
  ...
  public OnPagePagesResultInfo items(List<BaseOnPageResourceItem> items) {
    this.items = items;
    return this;
  }
  ...
  public OnPagePagesResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.crawlProgress, onPagePagesResultInfo.crawlProgress) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to OnPagePagesResultInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OnPagePagesResultInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OnPagePagesResultInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OnPagePagesResultInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OnPagePagesResultInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<OnPagePagesResultInfo>() {
           @Override
           public void write(JsonWriter out, OnPagePagesResultInfo value) throws IOException {
           ...
           @Override
           public OnPagePagesResultInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             OnPagePagesResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static OnPagePagesResultInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OnPagePagesResultInfo.class);
  }
