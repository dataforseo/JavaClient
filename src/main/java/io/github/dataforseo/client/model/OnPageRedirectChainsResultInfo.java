...
* possible values: in_progress, finished
  ...
  public OnPageRedirectChainsResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.crawlProgress, onPageRedirectChainsResultInfo.crawlProgress) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OnPageRedirectChainsResultInfo>() {
           ...
           public OnPageRedirectChainsResultInfo read(JsonReader in) throws IOException {
             ...
             OnPageRedirectChainsResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
