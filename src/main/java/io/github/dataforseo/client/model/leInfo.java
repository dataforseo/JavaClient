...
public class leInfo  {
  ...
  public leInfo adPosition(String adPosition) {
...
* MainLine4: The fourth ad to appear at the top of the search results page
  ...
  public leInfo clicks(Integer clicks) {
    this.clicks = clicks;
    return this;
  }
...
* the number of clicks that the keyword and match type generated during the last month
  ...
  public leInfo impressions(Integer impressions) {
...
* the number of impressions that the keyword and match type generated during the last month
  ...
  public leInfo averageCpc(Double averageCpc) {
...
* calculated by dividing the number of clicks by the number of impressions and multiplying the result by 100
  ...
  public leInfo totalCost(Double totalCost) {
...
* the cost of using the specified keyword and match type during the last month
  ...
  public leInfo averageBid(Double averageBid) {
  ...
  public leInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    leInfo leInfo = (leInfo) o;
    return

        Objects.equals(this.adPosition, leInfo.adPosition) &&
        Objects.equals(this.clicks, leInfo.clicks) &&
        Objects.equals(this.impressions, leInfo.impressions) &&
        Objects.equals(this.averageCpc, leInfo.averageCpc) &&
        Objects.equals(this.ctr, leInfo.ctr) &&
        Objects.equals(this.totalCost, leInfo.totalCost) &&
        Objects.equals(this.averageBid, leInfo.averageBid);  
   ...
   * @throws IOException if the JSON Element is invalid with respect to leInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!leInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'leInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<leInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(leInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<leInfo>() {
           @Override
           public void write(JsonWriter out, leInfo value) throws IOException {
           ...
           @Override
           public leInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             leInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static leInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, leInfo.class);
  }
