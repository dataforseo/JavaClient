...
public class BacklinksErrorsRequestInfo  {
  ...
  public BacklinksErrorsRequestInfo limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public BacklinksErrorsRequestInfo offset(Integer offset) {
    this.offset = offset;
    return this;
  }
  ...
  public BacklinksErrorsRequestInfo datetimeFrom(String datetimeFrom) {
  ...
  public BacklinksErrorsRequestInfo datetimeTo(String datetimeTo) {
  ...
  public BacklinksErrorsRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BacklinksErrorsRequestInfo backlinksErrorsRequestInfo = (BacklinksErrorsRequestInfo) o;
    return

        Objects.equals(this.limit, backlinksErrorsRequestInfo.limit) &&
        Objects.equals(this.offset, backlinksErrorsRequestInfo.offset) &&
        Objects.equals(this.filteredFunction, backlinksErrorsRequestInfo.filteredFunction) &&
        Objects.equals(this.datetimeFrom, backlinksErrorsRequestInfo.datetimeFrom) &&
        Objects.equals(this.datetimeTo, backlinksErrorsRequestInfo.datetimeTo);  
  ...
  public String toString() {
    ...
    sb.append("class BacklinksErrorsRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BacklinksErrorsRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BacklinksErrorsRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BacklinksErrorsRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BacklinksErrorsRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BacklinksErrorsRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<BacklinksErrorsRequestInfo>() {
           @Override
           public void write(JsonWriter out, BacklinksErrorsRequestInfo value) throws IOException {
           ...
           @Override
           public BacklinksErrorsRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             BacklinksErrorsRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static BacklinksErrorsRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BacklinksErrorsRequestInfo.class);
  }
