...
public class KeywordsDataGoogleAdsKeywordsForKeywordsLiveResultInfo  {
  ...
  public KeywordsDataGoogleAdsKeywordsForKeywordsLiveResultInfo spell(String spell) {
    this.spell = spell;
    return this;
  }
  ...
  /**
   * <em>competition</em><br>represents the relative level of competition associated with the given keyword in paid SERP only<br>possible values: <code>LOW</code>, <code>MEDIUM</code>, <code>HIGH</code><br>if competition level is unknown, the value is <code>null</code>;<br>learn more about the metric in <a href='https://dataforseo.com/help-center/what-is-competition' target='_blank' rel='noopener noreferrer'>this help center article</a>
   * @return competition
   */
  @javax.annotation.Nullable
  ...
  public KeywordsDataGoogleAdsKeywordsForKeywordsLiveResultInfo lowTopOfPageBid(Double lowTopOfPageBid) {
  ...
  public KeywordsDataGoogleAdsKeywordsForKeywordsLiveResultInfo highTopOfPageBid(Double highTopOfPageBid) {
  ...
  public KeywordsDataGoogleAdsKeywordsForKeywordsLiveResultInfo cpc(Double cpc) {
    this.cpc = cpc;
    return this;
  }
  ...
  public KeywordsDataGoogleAdsKeywordsForKeywordsLiveResultInfo monthlySearches(List<MonthlySearchesInfo> monthlySearches) {
  ...
  public KeywordsDataGoogleAdsKeywordsForKeywordsLiveResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.keyword, keywordsDataGoogleAdsKeywordsForKeywordsLiveResultInfo.keyword) &&
        Objects.equals(this.spell, keywordsDataGoogleAdsKeywordsForKeywordsLiveResultInfo.spell) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<KeywordsDataGoogleAdsKeywordsForKeywordsLiveResultInfo>() {
           ...
           public KeywordsDataGoogleAdsKeywordsForKeywordsLiveResultInfo read(JsonReader in) throws IOException {
             ...
             KeywordsDataGoogleAdsKeywordsForKeywordsLiveResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
