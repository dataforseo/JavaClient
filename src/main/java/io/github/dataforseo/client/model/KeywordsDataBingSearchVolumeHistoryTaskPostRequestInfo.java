...
* you can receive the list of available languages of the search engines with their language_code by making a separate request to https://api.dataforseo.com/v3/keywords_data/bing/search_volume_history/locations_and_languages
  ...
  public KeywordsDataBingSearchVolumeHistoryTaskPostRequestInfo device(List<String> device) {
    this.device = device;
    return this;
  }
...
* you will find the specified tag value in the data object of the response
  ...
  public KeywordsDataBingSearchVolumeHistoryTaskPostRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.keywords, keywordsDataBingSearchVolumeHistoryTaskPostRequestInfo.keywords) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<KeywordsDataBingSearchVolumeHistoryTaskPostRequestInfo>() {
           ...
           public KeywordsDataBingSearchVolumeHistoryTaskPostRequestInfo read(JsonReader in) throws IOException {
             ...
             KeywordsDataBingSearchVolumeHistoryTaskPostRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
