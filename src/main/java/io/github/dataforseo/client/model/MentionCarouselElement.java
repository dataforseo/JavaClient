...
public class MentionCarouselElement  {
  ...
  public MentionCarouselElement rating(RatingElement rating) {
    this.rating = rating;
    return this;
  }
...
* the popularity rate based on reviews and displayed in SERP
  ...
  public MentionCarouselElement putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.type, mentionCarouselElement.type) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MentionCarouselElement>() {
           ...
           public MentionCarouselElement read(JsonReader in) throws IOException {
             ...
             MentionCarouselElement instance = thisAdapter.fromJsonTree(jsonObj);
