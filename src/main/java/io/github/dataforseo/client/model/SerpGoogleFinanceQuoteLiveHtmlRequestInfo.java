...
public class SerpGoogleFinanceQuoteLiveHtmlRequestInfo  {
  ...
  public SerpGoogleFinanceQuoteLiveHtmlRequestInfo keyword(String keyword) {
  ...
  public SerpGoogleFinanceQuoteLiveHtmlRequestInfo locationCode(Integer locationCode) {
  ...
  public SerpGoogleFinanceQuoteLiveHtmlRequestInfo languageCode(String languageCode) {
  ...
  public SerpGoogleFinanceQuoteLiveHtmlRequestInfo device(String device) {
    this.device = device;
    return this;
  }
  ...
  public SerpGoogleFinanceQuoteLiveHtmlRequestInfo os(String os) {
    this.os = os;
    return this;
  }
  ...
  public SerpGoogleFinanceQuoteLiveHtmlRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  /**
   * <p><em>time window for <code>google_finance_quote</code> graph</em><p>optional field<p>possible values: <code>1D</code>, <code>5D</code>, <code>1M</code>, <code>6M</code>, <code>YTD</code>, <code>1Y</code>, <code>5Y</code>, <code>MAX</code><p>default value: <code>1D</code></p>
   * @return window
   */
  @javax.annotation.Nullable
  ...
  public SerpGoogleFinanceQuoteLiveHtmlRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SerpGoogleFinanceQuoteLiveHtmlRequestInfo serpGoogleFinanceQuoteLiveHtmlRequestInfo = (SerpGoogleFinanceQuoteLiveHtmlRequestInfo) o;
    return
   ...
   * @throws IOException if the JSON Element is invalid with respect to SerpGoogleFinanceQuoteLiveHtmlRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SerpGoogleFinanceQuoteLiveHtmlRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SerpGoogleFinanceQuoteLiveHtmlRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SerpGoogleFinanceQuoteLiveHtmlRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SerpGoogleFinanceQuoteLiveHtmlRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SerpGoogleFinanceQuoteLiveHtmlRequestInfo>() {
           @Override
           public void write(JsonWriter out, SerpGoogleFinanceQuoteLiveHtmlRequestInfo value) throws IOException {
           ...
           @Override
           public SerpGoogleFinanceQuoteLiveHtmlRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SerpGoogleFinanceQuoteLiveHtmlRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static SerpGoogleFinanceQuoteLiveHtmlRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SerpGoogleFinanceQuoteLiveHtmlRequestInfo.class);
  }
