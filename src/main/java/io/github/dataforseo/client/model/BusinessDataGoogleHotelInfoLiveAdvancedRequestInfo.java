...
* you will find the specified tag value in the data object of the response
  ...
  public BusinessDataGoogleHotelInfoLiveAdvancedRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.hotelIdentifier, businessDataGoogleHotelInfoLiveAdvancedRequestInfo.hotelIdentifier) &&
  ...
  @Override
  public int hashCode() {
  return Objects.hash(hotelIdentifier, locationName, locationCode, locationCoordinate, languageName, languageCode, checkIn, checkOut, currency, adults, children, loadPricesByDates, pricesStartDate, pricesEndDate, pricesDateRange, tag);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BusinessDataGoogleHotelInfoLiveAdvancedRequestInfo>() {
           ...
           public BusinessDataGoogleHotelInfoLiveAdvancedRequestInfo read(JsonReader in) throws IOException {
             ...
             BusinessDataGoogleHotelInfoLiveAdvancedRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
