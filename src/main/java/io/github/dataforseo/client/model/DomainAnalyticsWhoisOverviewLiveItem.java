...
public class DomainAnalyticsWhoisOverviewLiveItem  {
  ...
  public DomainAnalyticsWhoisOverviewLiveItem domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public DomainAnalyticsWhoisOverviewLiveItem createdDatetime(String createdDatetime) {
...
* '1997-03-29 03:00:00 +00:00'
  ...
  public DomainAnalyticsWhoisOverviewLiveItem changedDatetime(String changedDatetime) {
...
* '2021-01-14 08:36:28 +00:00'
  ...
  public DomainAnalyticsWhoisOverviewLiveItem expirationDatetime(String expirationDatetime) {
...
* '2022-11-26 17:21:23 +00:00'
  ...
  public DomainAnalyticsWhoisOverviewLiveItem updatedDatetime(String updatedDatetime) {
...
* '2021-01-29 13:59:38 +00:00'
  ...
  public DomainAnalyticsWhoisOverviewLiveItem firstSeen(String firstSeen) {
...
* '2019-11-15 12:57:46 +00:00'
  ...
  public DomainAnalyticsWhoisOverviewLiveItem eppStatusCodes(List<String> eppStatusCodes) {
...
* the status of a domain name registration as defined by ICANN
  ...
  public DomainAnalyticsWhoisOverviewLiveItem tld(String tld) {
    this.tld = tld;
    return this;
  }
...
* top-level domain in the DNS root zone
  ...
  public DomainAnalyticsWhoisOverviewLiveItem registered(Boolean registered) {
...
* Note: expired domains will remain in the database for only a short period of time
  ...
  public DomainAnalyticsWhoisOverviewLiveItem registrar(String registrar) {
...
* NameCheap, Inc.
  ...
  private MetricsBundleInfo metrics;

  public DomainAnalyticsWhoisOverviewLiveItem metrics(MetricsBundleInfo metrics) {
   ...
   */
  @javax.annotation.Nullable
  public MetricsBundleInfo getMetrics() {
    return metrics;
  }

  public void setMetrics(MetricsBundleInfo metrics) {
    this.metrics = metrics;
  }
  ...
  public DomainAnalyticsWhoisOverviewLiveItem backlinksInfo(BacklinksInfo backlinksInfo) {
  ...
  public DomainAnalyticsWhoisOverviewLiveItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DomainAnalyticsWhoisOverviewLiveItem domainAnalyticsWhoisOverviewLiveItem = (DomainAnalyticsWhoisOverviewLiveItem) o;
    return

        Objects.equals(this.domain, domainAnalyticsWhoisOverviewLiveItem.domain) &&
        Objects.equals(this.createdDatetime, domainAnalyticsWhoisOverviewLiveItem.createdDatetime) &&
        Objects.equals(this.changedDatetime, domainAnalyticsWhoisOverviewLiveItem.changedDatetime) &&
        Objects.equals(this.expirationDatetime, domainAnalyticsWhoisOverviewLiveItem.expirationDatetime) &&
        Objects.equals(this.updatedDatetime, domainAnalyticsWhoisOverviewLiveItem.updatedDatetime) &&
        Objects.equals(this.firstSeen, domainAnalyticsWhoisOverviewLiveItem.firstSeen) &&
        Objects.equals(this.eppStatusCodes, domainAnalyticsWhoisOverviewLiveItem.eppStatusCodes) &&
        Objects.equals(this.tld, domainAnalyticsWhoisOverviewLiveItem.tld) &&
        Objects.equals(this.registered, domainAnalyticsWhoisOverviewLiveItem.registered) &&
        Objects.equals(this.registrar, domainAnalyticsWhoisOverviewLiveItem.registrar) &&
        Objects.equals(this.metrics, domainAnalyticsWhoisOverviewLiveItem.metrics) &&
        Objects.equals(this.backlinksInfo, domainAnalyticsWhoisOverviewLiveItem.backlinksInfo);  
  ...
  @Override
  public int hashCode() {
  return Objects.hash(domain, createdDatetime, changedDatetime, expirationDatetime, updatedDatetime, firstSeen, eppStatusCodes, tld, registered, registrar, metrics, backlinksInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class DomainAnalyticsWhoisOverviewLiveItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DomainAnalyticsWhoisOverviewLiveItem
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainAnalyticsWhoisOverviewLiveItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainAnalyticsWhoisOverviewLiveItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainAnalyticsWhoisOverviewLiveItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainAnalyticsWhoisOverviewLiveItem.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainAnalyticsWhoisOverviewLiveItem>() {
           @Override
           public void write(JsonWriter out, DomainAnalyticsWhoisOverviewLiveItem value) throws IOException {
           ...
           @Override
           public DomainAnalyticsWhoisOverviewLiveItem read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DomainAnalyticsWhoisOverviewLiveItem instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static DomainAnalyticsWhoisOverviewLiveItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainAnalyticsWhoisOverviewLiveItem.class);
  }
