...
import io.github.dataforseo.client.model.MetricsBundleInfo;
...
public class DomainAnalyticsWhoisOverviewLiveItem {
  ...
  public DomainAnalyticsWhoisOverviewLiveItem addEppStatusCodesItem(String eppStatusCodesItem) {
   ...
   * @return the DomainAnalyticsWhoisOverviewLiveItem instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.domain, domainAnalyticsWhoisOverviewLiveItem.domain) &&
        ...
        Objects.equals(this.additionalProperties, domainAnalyticsWhoisOverviewLiveItem.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(domain, createdDatetime, changedDatetime, expirationDatetime, updatedDatetime, firstSeen, eppStatusCodes, tld, registered, registrar, metrics, backlinksInfo, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DomainAnalyticsWhoisOverviewLiveItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainAnalyticsWhoisOverviewLiveItem is not found in the empty JSON string", DomainAnalyticsWhoisOverviewLiveItem.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("metrics") != null && !jsonObj.get("metrics").isJsonNull()) {
        MetricsBundleInfo.validateJsonElement(jsonObj.get("metrics"));
      }
  ...
  /**
   * Create an instance of DomainAnalyticsWhoisOverviewLiveItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DomainAnalyticsWhoisOverviewLiveItem
   * @throws IOException if the JSON string is invalid with respect to DomainAnalyticsWhoisOverviewLiveItem
   */
  ...
  /**
   * Convert an instance of DomainAnalyticsWhoisOverviewLiveItem to an JSON string
   *
   * @return JSON string
   */
