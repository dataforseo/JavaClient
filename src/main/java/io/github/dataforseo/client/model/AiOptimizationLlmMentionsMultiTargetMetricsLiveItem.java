...
public class AiOptimizationLlmMentionsMultiTargetMetricsLiveItem  {
  ...
  public AiOptimizationLlmMentionsMultiTargetMetricsLiveItem key(String key) {
    this.key = key;
    return this;
  }
...
* the specific identifier for the group dimension
  ...
  public AiOptimizationLlmMentionsMultiTargetMetricsLiveItem location(List<AggregatedMetricsItemInfo> location) {
...
* array of objects containing mention metrics segmented by geographical location
  ...
  public AiOptimizationLlmMentionsMultiTargetMetricsLiveItem language(List<AggregatedMetricsItemInfo> language) {
...
* array of objects containing mention metrics segmented by content language
  ...
  public AiOptimizationLlmMentionsMultiTargetMetricsLiveItem platform(List<AggregatedMetricsItemInfo> platform) {
...
* array of group elements containing mention metrics segmented by AI platform
  ...
  public AiOptimizationLlmMentionsMultiTargetMetricsLiveItem sourcesDomain(List<AggregatedMetricsItemInfo> sourcesDomain) {
...
* learn more about the sources and how to retrieve LLM citation data at our Help Center
  ...
  public AiOptimizationLlmMentionsMultiTargetMetricsLiveItem searchResultsDomain(List<AggregatedMetricsItemInfo> searchResultsDomain) {
...
* array of objects containing data on top domains that appear in search results related to LLM queries
  ...
  public AiOptimizationLlmMentionsMultiTargetMetricsLiveItem brandEntitiesTitle(List<AggregatedMetricsItemInfo> brandEntitiesTitle) {
...
* array of objects containing data on brand entity titles that appear in search results related to LLM queries
  ...
  public AiOptimizationLlmMentionsMultiTargetMetricsLiveItem brandEntitiesCategory(List<AggregatedMetricsItemInfo> brandEntitiesCategory) {
...
* array of objects containing data on brand entity categories that appear in search results related to LLM queries
  ...
  public AiOptimizationLlmMentionsMultiTargetMetricsLiveItem total(AggregatedMetricsInfoTotalInfo total) {
    this.total = total;
    return this;
  }
  ...
  public AiOptimizationLlmMentionsMultiTargetMetricsLiveItem() {
  }
  ...
  public AiOptimizationLlmMentionsMultiTargetMetricsLiveItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiOptimizationLlmMentionsMultiTargetMetricsLiveItem aiOptimizationLlmMentionsMultiTargetMetricsLiveItem = (AiOptimizationLlmMentionsMultiTargetMetricsLiveItem) o;
    return

        Objects.equals(this.key, aiOptimizationLlmMentionsMultiTargetMetricsLiveItem.key) &&
        Objects.equals(this.location, aiOptimizationLlmMentionsMultiTargetMetricsLiveItem.location) &&
        Objects.equals(this.language, aiOptimizationLlmMentionsMultiTargetMetricsLiveItem.language) &&
        Objects.equals(this.platform, aiOptimizationLlmMentionsMultiTargetMetricsLiveItem.platform) &&
        Objects.equals(this.sourcesDomain, aiOptimizationLlmMentionsMultiTargetMetricsLiveItem.sourcesDomain) &&
        Objects.equals(this.searchResultsDomain, aiOptimizationLlmMentionsMultiTargetMetricsLiveItem.searchResultsDomain) &&
        Objects.equals(this.brandEntitiesTitle, aiOptimizationLlmMentionsMultiTargetMetricsLiveItem.brandEntitiesTitle) &&
        Objects.equals(this.brandEntitiesCategory, aiOptimizationLlmMentionsMultiTargetMetricsLiveItem.brandEntitiesCategory) &&
        Objects.equals(this.total, aiOptimizationLlmMentionsMultiTargetMetricsLiveItem.total);  
  ...
  @Override
  public int hashCode() {
  return Objects.hash(key, location, language, platform, sourcesDomain, searchResultsDomain, brandEntitiesTitle, brandEntitiesCategory, total);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiOptimizationLlmMentionsMultiTargetMetricsLiveItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiOptimizationLlmMentionsMultiTargetMetricsLiveItem
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiOptimizationLlmMentionsMultiTargetMetricsLiveItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiOptimizationLlmMentionsMultiTargetMetricsLiveItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiOptimizationLlmMentionsMultiTargetMetricsLiveItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiOptimizationLlmMentionsMultiTargetMetricsLiveItem.class));

       return (TypeAdapter<T>) new TypeAdapter<AiOptimizationLlmMentionsMultiTargetMetricsLiveItem>() {
           @Override
           public void write(JsonWriter out, AiOptimizationLlmMentionsMultiTargetMetricsLiveItem value) throws IOException {
           ...
           @Override
           public AiOptimizationLlmMentionsMultiTargetMetricsLiveItem read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiOptimizationLlmMentionsMultiTargetMetricsLiveItem instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AiOptimizationLlmMentionsMultiTargetMetricsLiveItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiOptimizationLlmMentionsMultiTargetMetricsLiveItem.class);
  }
