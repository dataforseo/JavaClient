...
public class SerpNaverOrganicTaskPostRequestInfo  {
  ...
  /**
   * <em>direct URL of the search query</em><br>optional field<br>you can specify a direct URL and we will sort it out to the necessary fields<br>in most cases, we wouldn’t recommend using this method;<br>example:<br><code class='long-string'>https://search.naver.com/search.naver?where=nexearch&sm=top_hty&fbm=1&ie=utf8&query=iphone</code>
   * @return url
   */
  @javax.annotation.Nullable
  ...
  /**
   * <em>search engine domain</em><br>optional field<br>we choose the relevant search engine domain automatically<br>however, you can set a custom search engine domain in this field<br>example:<br><code><code></code></code><em>search.naver.com</em>
   * @return seDomain
   */
  @javax.annotation.Nullable
  ...
  public SerpNaverOrganicTaskPostRequestInfo stopCrawlOnMatch(List<SerpApiStopCrawlOnMatchInfo> stopCrawlOnMatch) {
...
* Your account will be billed per each SERP crawled through the specified targets
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.stopCrawlOnMatch, serpNaverOrganicTaskPostRequestInfo.stopCrawlOnMatch) &&
  ...
  @Override
  public int hashCode() {
  return Objects.hash(keyword, url, priority, depth, maxCrawlPages, device, os, seDomain, searchParam, stopCrawlOnMatch, tag, postbackUrl, postbackData, pingbackUrl);
  }
