...
public class AiOptimizationClaudeLlmResponsesTaskGetResultInfo  {
  ...
  public AiOptimizationClaudeLlmResponsesTaskGetResultInfo modelName(String modelName) {
  ...
  public AiOptimizationClaudeLlmResponsesTaskGetResultInfo inputTokens(Integer inputTokens) {
...
* total count of tokens processed
  ...
  public AiOptimizationClaudeLlmResponsesTaskGetResultInfo outputTokens(Integer outputTokens) {
...
* total count of tokens generated in the AI response
  ...
  public AiOptimizationClaudeLlmResponsesTaskGetResultInfo webSearch(Boolean webSearch) {
  ...
  public AiOptimizationClaudeLlmResponsesTaskGetResultInfo moneySpent(Double moneySpent) {
...
* the price charged by the third-party AI model provider for according to its Pricing
  ...
  public AiOptimizationClaudeLlmResponsesTaskGetResultInfo datetime(String datetime) {
...
* contains related search queries derived from the main query to provide a more comprehensive response
  ...
  public AiOptimizationClaudeLlmResponsesTaskGetResultInfo() {
  }
  ...
  public AiOptimizationClaudeLlmResponsesTaskGetResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiOptimizationClaudeLlmResponsesTaskGetResultInfo aiOptimizationClaudeLlmResponsesTaskGetResultInfo = (AiOptimizationClaudeLlmResponsesTaskGetResultInfo) o;
    return
        ...
        Objects.equals(this.items, aiOptimizationClaudeLlmResponsesTaskGetResultInfo.items) &&
        Objects.equals(this.fanOutQueries, aiOptimizationClaudeLlmResponsesTaskGetResultInfo.fanOutQueries);  
  ...
  public String toString() {
    ...
    sb.append("class AiOptimizationClaudeLlmResponsesTaskGetResultInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiOptimizationClaudeLlmResponsesTaskGetResultInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiOptimizationClaudeLlmResponsesTaskGetResultInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiOptimizationClaudeLlmResponsesTaskGetResultInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiOptimizationClaudeLlmResponsesTaskGetResultInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiOptimizationClaudeLlmResponsesTaskGetResultInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AiOptimizationClaudeLlmResponsesTaskGetResultInfo>() {
           @Override
           public void write(JsonWriter out, AiOptimizationClaudeLlmResponsesTaskGetResultInfo value) throws IOException {
           ...
           @Override
           public AiOptimizationClaudeLlmResponsesTaskGetResultInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiOptimizationClaudeLlmResponsesTaskGetResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AiOptimizationClaudeLlmResponsesTaskGetResultInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiOptimizationClaudeLlmResponsesTaskGetResultInfo.class);
  }
