...
public class ContentAnalysisLanguagesResultInfo  {
  ...
  public ContentAnalysisLanguagesResultInfo locationCode(Integer locationCode) {
  ...
  public ContentAnalysisLanguagesResultInfo locationCodeParent(Integer locationCodeParent) {
  ...
  public ContentAnalysisLanguagesResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.locationCode, contentAnalysisLanguagesResultInfo.locationCode) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContentAnalysisLanguagesResultInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContentAnalysisLanguagesResultInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContentAnalysisLanguagesResultInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContentAnalysisLanguagesResultInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContentAnalysisLanguagesResultInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<ContentAnalysisLanguagesResultInfo>() {
           @Override
           public void write(JsonWriter out, ContentAnalysisLanguagesResultInfo value) throws IOException {
           ...
           @Override
           public ContentAnalysisLanguagesResultInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ContentAnalysisLanguagesResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static ContentAnalysisLanguagesResultInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContentAnalysisLanguagesResultInfo.class);
  }
