...
public class AppDataAppleLocationsResultInfo  {
  ...
  public AppDataAppleLocationsResultInfo locationName(String locationName) {
  ...
  public AppDataAppleLocationsResultInfo locationCodeParent(Integer locationCodeParent) {
  ...
  public AppDataAppleLocationsResultInfo countryIsoCode(String countryIsoCode) {
  ...
  public AppDataAppleLocationsResultInfo locationType(String locationType) {
  ...
  public AppDataAppleLocationsResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.locationCode, appDataAppleLocationsResultInfo.locationCode) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppDataAppleLocationsResultInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppDataAppleLocationsResultInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppDataAppleLocationsResultInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppDataAppleLocationsResultInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppDataAppleLocationsResultInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AppDataAppleLocationsResultInfo>() {
           @Override
           public void write(JsonWriter out, AppDataAppleLocationsResultInfo value) throws IOException {
           ...
           @Override
           public AppDataAppleLocationsResultInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AppDataAppleLocationsResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AppDataAppleLocationsResultInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppDataAppleLocationsResultInfo.class);
  }
