...
public class AppDataAppleAppInfoTasksReadyResultInfo {
  ...
  /**
   * URL for collecting the results of the Apple app_info HTML task if HTML tasks are not supported in the specified endpoint, the value will be null
   * @return endpointHtml
   */
  @javax.annotation.Nullable
   ...
   * @return the AppDataAppleAppInfoTasksReadyResultInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, appDataAppleAppInfoTasksReadyResultInfo.id) &&
        ...
        Objects.equals(this.additionalProperties, appDataAppleAppInfoTasksReadyResultInfo.additionalProperties);
  }
