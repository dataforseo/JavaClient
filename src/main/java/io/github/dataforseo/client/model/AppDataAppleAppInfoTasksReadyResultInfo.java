...
* unique task identifier in our system in the UUID format
  ...
  public AppDataAppleAppInfoTasksReadyResultInfo seType(String seType) {
    this.seType = seType;
    return this;
  }
...
* if HTML tasks are not supported in the specified endpoint, the value will be null
  ...
  public AppDataAppleAppInfoTasksReadyResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.id, appDataAppleAppInfoTasksReadyResultInfo.id) &&
        Objects.equals(this.se, appDataAppleAppInfoTasksReadyResultInfo.se) &&
        Objects.equals(this.seType, appDataAppleAppInfoTasksReadyResultInfo.seType) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AppDataAppleAppInfoTasksReadyResultInfo>() {
           ...
           public AppDataAppleAppInfoTasksReadyResultInfo read(JsonReader in) throws IOException {
             ...
             AppDataAppleAppInfoTasksReadyResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
