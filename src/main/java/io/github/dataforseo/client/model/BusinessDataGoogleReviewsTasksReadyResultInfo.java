...
* can take the following values: google
  ...
  public BusinessDataGoogleReviewsTasksReadyResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.id, businessDataGoogleReviewsTasksReadyResultInfo.id) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BusinessDataGoogleReviewsTasksReadyResultInfo>() {
           ...
           public BusinessDataGoogleReviewsTasksReadyResultInfo read(JsonReader in) throws IOException {
             ...
             BusinessDataGoogleReviewsTasksReadyResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
