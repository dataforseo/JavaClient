...
public class HotelAmenityInfo  {
  ...
  public HotelAmenityInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.category, hotelAmenityInfo.category) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<HotelAmenityInfo>() {
           ...
           public HotelAmenityInfo read(JsonReader in) throws IOException {
             ...
             HotelAmenityInfo instance = thisAdapter.fromJsonTree(jsonObj);
