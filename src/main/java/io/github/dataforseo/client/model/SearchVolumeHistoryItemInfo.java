...
public class SearchVolumeHistoryItemInfo  {
  ...
  public SearchVolumeHistoryItemInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.year, searchVolumeHistoryItemInfo.year) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SearchVolumeHistoryItemInfo>() {
           ...
           public SearchVolumeHistoryItemInfo read(JsonReader in) throws IOException {
             ...
             SearchVolumeHistoryItemInfo instance = thisAdapter.fromJsonTree(jsonObj);
