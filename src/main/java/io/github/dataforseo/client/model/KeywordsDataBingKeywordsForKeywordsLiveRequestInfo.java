...
public class KeywordsDataBingKeywordsForKeywordsLiveRequestInfo {
  ...
  public KeywordsDataBingKeywordsForKeywordsLiveRequestInfo addKeywordsItem(String keywordsItem) {
  ...
  public KeywordsDataBingKeywordsForKeywordsLiveRequestInfo addKeywordsNegativeItem(String keywordsNegativeItem) {
  ...
  /**
   * starting date of the time range optional field you can specify a date from the past 24 months if you don’t specify this field, data will be provided for the last 12 months date format: \&quot;yyyy-mm-dd\&quot; example: \&quot;2020-01-01\&quot; Note: we do not recommend using a custom time range for the past year’s dates
   * @return dateFrom
   */
  @javax.annotation.Nullable
   ...
   * @return the KeywordsDataBingKeywordsForKeywordsLiveRequestInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keywords, keywordsDataBingKeywordsForKeywordsLiveRequestInfo.keywords) &&
        ...
        Objects.equals(this.additionalProperties, keywordsDataBingKeywordsForKeywordsLiveRequestInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keywords, locationName, locationCode, locationCoordinate, languageName, languageCode, sortBy, keywordsNegative, device, dateFrom, dateTo, searchPartners, tag, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KeywordsDataBingKeywordsForKeywordsLiveRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KeywordsDataBingKeywordsForKeywordsLiveRequestInfo is not found in the empty JSON string", KeywordsDataBingKeywordsForKeywordsLiveRequestInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of KeywordsDataBingKeywordsForKeywordsLiveRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of KeywordsDataBingKeywordsForKeywordsLiveRequestInfo
   * @throws IOException if the JSON string is invalid with respect to KeywordsDataBingKeywordsForKeywordsLiveRequestInfo
   */
  ...
  /**
   * Convert an instance of KeywordsDataBingKeywordsForKeywordsLiveRequestInfo to an JSON string
   *
   * @return JSON string
   */
