...
public class DataforseoLabsErrorsRequestInfo  {
  ...
  public DataforseoLabsErrorsRequestInfo limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public DataforseoLabsErrorsRequestInfo offset(Integer offset) {
    this.offset = offset;
    return this;
  }
  ...
  public DataforseoLabsErrorsRequestInfo datetimeFrom(String datetimeFrom) {
  ...
  public DataforseoLabsErrorsRequestInfo datetimeTo(String datetimeTo) {
  ...
  public DataforseoLabsErrorsRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DataforseoLabsErrorsRequestInfo dataforseoLabsErrorsRequestInfo = (DataforseoLabsErrorsRequestInfo) o;
    return

        Objects.equals(this.limit, dataforseoLabsErrorsRequestInfo.limit) &&
        Objects.equals(this.offset, dataforseoLabsErrorsRequestInfo.offset) &&
        Objects.equals(this.filteredFunction, dataforseoLabsErrorsRequestInfo.filteredFunction) &&
        Objects.equals(this.datetimeFrom, dataforseoLabsErrorsRequestInfo.datetimeFrom) &&
        Objects.equals(this.datetimeTo, dataforseoLabsErrorsRequestInfo.datetimeTo);  
  ...
  public String toString() {
    ...
    sb.append("class DataforseoLabsErrorsRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataforseoLabsErrorsRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataforseoLabsErrorsRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataforseoLabsErrorsRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataforseoLabsErrorsRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataforseoLabsErrorsRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<DataforseoLabsErrorsRequestInfo>() {
           @Override
           public void write(JsonWriter out, DataforseoLabsErrorsRequestInfo value) throws IOException {
           ...
           @Override
           public DataforseoLabsErrorsRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DataforseoLabsErrorsRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static DataforseoLabsErrorsRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataforseoLabsErrorsRequestInfo.class);
  }
