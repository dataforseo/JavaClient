...
public class BusinessDataTripadvisorReviewsTaskGetResultInfo  {
  ...
  /**
   * <em>URL path received in a POST array</em>
   * @return urlPath
   */
  ...
  /**
   * <em>location of the local establishment</em><br>address of the local establishment for which the reviews are collected
   * @return location
   */
  @javax.annotation.Nullable
  ...
  private List<TripadvisorReviewSearch> items;

  public BusinessDataTripadvisorReviewsTaskGetResultInfo items(List<TripadvisorReviewSearch> items) {
    this.items = items;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<TripadvisorReviewSearch> getItems() {
    return items;
  }

  public void setItems(List<TripadvisorReviewSearch> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.urlPath, businessDataTripadvisorReviewsTaskGetResultInfo.urlPath) &&
