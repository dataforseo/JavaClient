...
public class SerpYahooOrganicLiveRegularRequestInfo {
   ...
   * @return the SerpYahooOrganicLiveRegularRequestInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, serpYahooOrganicLiveRegularRequestInfo.url) &&
        ...
        Objects.equals(this.additionalProperties, serpYahooOrganicLiveRegularRequestInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(url, keyword, locationName, locationCode, locationCoordinate, languageName, languageCode, device, os, seDomain, depth, maxCrawlPages, searchParam, tag, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SerpYahooOrganicLiveRegularRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SerpYahooOrganicLiveRegularRequestInfo is not found in the empty JSON string", SerpYahooOrganicLiveRegularRequestInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of SerpYahooOrganicLiveRegularRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SerpYahooOrganicLiveRegularRequestInfo
   * @throws IOException if the JSON string is invalid with respect to SerpYahooOrganicLiveRegularRequestInfo
   */
  ...
  /**
   * Convert an instance of SerpYahooOrganicLiveRegularRequestInfo to an JSON string
   *
   * @return JSON string
   */
