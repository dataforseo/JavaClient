...
public class SerpYahooOrganicLiveRegularRequestInfo  {
  ...
  public SerpYahooOrganicLiveRegularRequestInfo url(String url) {
    this.url = url;
    return this;
  }
...
* https://search.yahoo.com/search?p=rank+checker&n=100&vl=lang_en&vc=us&ei=UTF-8
  ...
  public SerpYahooOrganicLiveRegularRequestInfo keyword(String keyword) {
...
* learn more about rules and limitations of keyword and keywords fields in DataForSEO APIs in this Help Center article
  ...
  public SerpYahooOrganicLiveRegularRequestInfo locationName(String locationName) {
...
* London,England,United Kingdom
  ...
  public SerpYahooOrganicLiveRegularRequestInfo locationCode(Integer locationCode) {
...
* 2840
  ...
  public SerpYahooOrganicLiveRegularRequestInfo locationCoordinate(String locationCoordinate) {
...
* 53.476225,-2.243572,200
  ...
  public SerpYahooOrganicLiveRegularRequestInfo languageName(String languageName) {
...
* English
  ...
  public SerpYahooOrganicLiveRegularRequestInfo languageCode(String languageCode) {
...
* en
  ...
  public SerpYahooOrganicLiveRegularRequestInfo device(String device) {
    this.device = device;
    return this;
  }
...
* default value: desktop
  ...
  public SerpYahooOrganicLiveRegularRequestInfo os(String os) {
    this.os = os;
    return this;
  }
...
* default value: android
  ...
  public SerpYahooOrganicLiveRegularRequestInfo seDomain(String seDomain) {
...
* au.search.yahoo.com, uk.search.yahoo.com, ca.search.yahoo.com, etc.
  ...
  public SerpYahooOrganicLiveRegularRequestInfo depth(Integer depth) {
    this.depth = depth;
    return this;
  }
...
* The cost can be calculated on the Pricing page.
  ...
  public SerpYahooOrganicLiveRegularRequestInfo maxCrawlPages(Integer maxCrawlPages) {
...
* example.com/example-page*  – returns results for all domain’s URLs that start with the specified string
  ...
  public SerpYahooOrganicLiveRegularRequestInfo searchParam(String searchParam) {
...
* get the list of available parameters and additional details here
  ...
  public SerpYahooOrganicLiveRegularRequestInfo stopCrawlOnMatch(List<SerpApiStopCrawlOnMatchInfo> stopCrawlOnMatch) {
...
* example: dataforseo.com
  ...
  public SerpYahooOrganicLiveRegularRequestInfo matchType(List<String> matchType) {
...
* possible values: domain, with_subdomains, wildcard
  ...
  public SerpYahooOrganicLiveRegularRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
...
* you will find the specified tag value in the data object of the response
  ...
  public SerpYahooOrganicLiveRegularRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SerpYahooOrganicLiveRegularRequestInfo serpYahooOrganicLiveRegularRequestInfo = (SerpYahooOrganicLiveRegularRequestInfo) o;
    return

        Objects.equals(this.url, serpYahooOrganicLiveRegularRequestInfo.url) &&
        Objects.equals(this.keyword, serpYahooOrganicLiveRegularRequestInfo.keyword) &&
        Objects.equals(this.locationName, serpYahooOrganicLiveRegularRequestInfo.locationName) &&
        Objects.equals(this.locationCode, serpYahooOrganicLiveRegularRequestInfo.locationCode) &&
        Objects.equals(this.locationCoordinate, serpYahooOrganicLiveRegularRequestInfo.locationCoordinate) &&
        Objects.equals(this.languageName, serpYahooOrganicLiveRegularRequestInfo.languageName) &&
        Objects.equals(this.languageCode, serpYahooOrganicLiveRegularRequestInfo.languageCode) &&
        Objects.equals(this.device, serpYahooOrganicLiveRegularRequestInfo.device) &&
        Objects.equals(this.os, serpYahooOrganicLiveRegularRequestInfo.os) &&
  ...
  public String toString() {
    ...
    sb.append("class SerpYahooOrganicLiveRegularRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SerpYahooOrganicLiveRegularRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SerpYahooOrganicLiveRegularRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SerpYahooOrganicLiveRegularRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SerpYahooOrganicLiveRegularRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SerpYahooOrganicLiveRegularRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SerpYahooOrganicLiveRegularRequestInfo>() {
           @Override
           public void write(JsonWriter out, SerpYahooOrganicLiveRegularRequestInfo value) throws IOException {
           ...
           @Override
           public SerpYahooOrganicLiveRegularRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SerpYahooOrganicLiveRegularRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static SerpYahooOrganicLiveRegularRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SerpYahooOrganicLiveRegularRequestInfo.class);
  }
