...
* text of the review
  ...
  public OtherSitesReviewsInfo rating(RatingElement rating) {
    this.rating = rating;
    return this;
  }
...
* information about the rating enclosed in the review on a third-party site
  ...
  public OtherSitesReviewsInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.title, otherSitesReviewsInfo.title) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OtherSitesReviewsInfo>() {
           ...
           public OtherSitesReviewsInfo read(JsonReader in) throws IOException {
             ...
             OtherSitesReviewsInfo instance = thisAdapter.fromJsonTree(jsonObj);
