...
public class ContentParsingElement  {
  ...
  /**
   * <em>date and time when the content was fethced</em><br>            example:<br>            <code>'2022-11-01 10:02:52 +00:00'</code>
   * @return fetchTime
   */
  @javax.annotation.Nullable
  ...
  /**
   * <em>parsed content of the page</em><br>
   * @return pageContent
   */
  @javax.annotation.Nullable
  ...
  /**
   * <em>page content in the markdown format</em><br>            page content in the <a href='https://daringfireball.net/projects/markdown/' target='_blank'>text-to-HTML markdown format</a><br>            specify <code>markdown_view</code> as <code>true</code> in the request to return the value
