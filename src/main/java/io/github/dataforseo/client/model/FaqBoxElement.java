...
public class FaqBoxElement  {
  ...
  public FaqBoxElement putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.type, faqBoxElement.type) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FaqBoxElement>() {
           ...
           public FaqBoxElement read(JsonReader in) throws IOException {
             ...
             FaqBoxElement instance = thisAdapter.fromJsonTree(jsonObj);
