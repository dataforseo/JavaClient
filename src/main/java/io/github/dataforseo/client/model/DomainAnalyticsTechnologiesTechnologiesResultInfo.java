...
public class DomainAnalyticsTechnologiesTechnologiesResultInfo  {
  ...
  public DomainAnalyticsTechnologiesTechnologiesResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.groups, domainAnalyticsTechnologiesTechnologiesResultInfo.groups);  
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DomainAnalyticsTechnologiesTechnologiesResultInfo>() {
           ...
           public DomainAnalyticsTechnologiesTechnologiesResultInfo read(JsonReader in) throws IOException {
             ...
             DomainAnalyticsTechnologiesTechnologiesResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
