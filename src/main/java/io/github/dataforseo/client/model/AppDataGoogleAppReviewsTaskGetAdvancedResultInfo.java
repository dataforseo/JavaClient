...
public class AppDataGoogleAppReviewsTaskGetAdvancedResultInfo  {
  ...
  /**
   * <em>application id received in a POST array</em>
   * @return appId
   */
  ...
  /**
   * <em>title of the app</em><br>title of the application for which the reviews are collected
   * @return title
   */
  @javax.annotation.Nullable
  ...
  /**
   * <em>rating of the app</em><br>rating of the application for which the reviews are collected
   * @return rating
   */
  @javax.annotation.Nullable
  ...
  private List<GooglePlayReviewsSearch> items;

  public AppDataGoogleAppReviewsTaskGetAdvancedResultInfo items(List<GooglePlayReviewsSearch> items) {
    this.items = items;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<GooglePlayReviewsSearch> getItems() {
    return items;
  }

  public void setItems(List<GooglePlayReviewsSearch> items) {
    this.items = items;
  }
  ...
  public AppDataGoogleAppReviewsTaskGetAdvancedResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.appId, appDataGoogleAppReviewsTaskGetAdvancedResultInfo.appId) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AppDataGoogleAppReviewsTaskGetAdvancedResultInfo>() {
           ...
           public AppDataGoogleAppReviewsTaskGetAdvancedResultInfo read(JsonReader in) throws IOException {
             ...
             AppDataGoogleAppReviewsTaskGetAdvancedResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
