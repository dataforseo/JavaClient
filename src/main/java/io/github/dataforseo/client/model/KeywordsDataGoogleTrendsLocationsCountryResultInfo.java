...
public class KeywordsDataGoogleTrendsLocationsCountryResultInfo  {
  ...
  public KeywordsDataGoogleTrendsLocationsCountryResultInfo locationName(String locationName) {
  ...
  public KeywordsDataGoogleTrendsLocationsCountryResultInfo countryIsoCode(String countryIsoCode) {
  ...
  public KeywordsDataGoogleTrendsLocationsCountryResultInfo locationType(String locationType) {
  ...
  public KeywordsDataGoogleTrendsLocationsCountryResultInfo geoId(String geoId) {
    this.geoId = geoId;
    return this;
  }
  ...
  public KeywordsDataGoogleTrendsLocationsCountryResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    KeywordsDataGoogleTrendsLocationsCountryResultInfo keywordsDataGoogleTrendsLocationsCountryResultInfo = (KeywordsDataGoogleTrendsLocationsCountryResultInfo) o;
    return

        Objects.equals(this.locationCode, keywordsDataGoogleTrendsLocationsCountryResultInfo.locationCode) &&
        Objects.equals(this.locationName, keywordsDataGoogleTrendsLocationsCountryResultInfo.locationName) &&
  ...
  public String toString() {
    ...
    sb.append("class KeywordsDataGoogleTrendsLocationsCountryResultInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to KeywordsDataGoogleTrendsLocationsCountryResultInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KeywordsDataGoogleTrendsLocationsCountryResultInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KeywordsDataGoogleTrendsLocationsCountryResultInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KeywordsDataGoogleTrendsLocationsCountryResultInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KeywordsDataGoogleTrendsLocationsCountryResultInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<KeywordsDataGoogleTrendsLocationsCountryResultInfo>() {
           @Override
           public void write(JsonWriter out, KeywordsDataGoogleTrendsLocationsCountryResultInfo value) throws IOException {
           ...
           @Override
           public KeywordsDataGoogleTrendsLocationsCountryResultInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             KeywordsDataGoogleTrendsLocationsCountryResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static KeywordsDataGoogleTrendsLocationsCountryResultInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KeywordsDataGoogleTrendsLocationsCountryResultInfo.class);
  }
