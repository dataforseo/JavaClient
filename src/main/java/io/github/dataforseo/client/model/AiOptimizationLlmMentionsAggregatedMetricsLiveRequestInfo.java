...
public class AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo  {
  ...
  public AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo target(List<BaseAiOptimizationLLmMentionsTargetElement> target) {
    this.target = target;
    return this;
  }
...
* default value: word_match
  ...
  public AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo locationName(String locationName) {
...
* Note: chat_gpt data is available for United States only
  ...
  public AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo locationCode(Integer locationCode) {
...
* Note: chat_gpt data is available for 2840 only
  ...
  public AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo languageName(String languageName) {
...
* Note: chat_gpt data is available for English only
  ...
  public AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo languageCode(String languageCode) {
...
* Note: chat_gpt data is available for en only
  ...
  public AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo platform(String platform) {
...
* The full list of possible filters is available here.
  ...
  public AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo internalListLimit(Integer internalListLimit) {
...
* default value: 5
  ...
  public AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
...
* you will find the specified tag value in the data object of the response
  ...
  public AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo() {
  }
  ...
  public AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo aiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo = (AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo) o;
    return
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo>() {
           @Override
           public void write(JsonWriter out, AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo value) throws IOException {
           ...
           @Override
           public AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiOptimizationLlmMentionsAggregatedMetricsLiveRequestInfo.class);
  }
