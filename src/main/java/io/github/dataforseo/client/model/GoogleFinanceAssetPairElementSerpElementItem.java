...
public class GoogleFinanceAssetPairElementSerpElementItem extends BaseGoogleFinanceSerpElementItem {
  ...
  public GoogleFinanceAssetPairElementSerpElementItem() {
  }

  public GoogleFinanceAssetPairElementSerpElementItem baseSymbol(String baseSymbol) {
  ...
  public GoogleFinanceAssetPairElementSerpElementItem quoteSymbol(String quoteSymbol) {
  ...
  public GoogleFinanceAssetPairElementSerpElementItem baseDisplayName(String baseDisplayName) {
  ...
  public GoogleFinanceAssetPairElementSerpElementItem quoteDisplayName(String quoteDisplayName) {
  ...
  public GoogleFinanceAssetPairElementSerpElementItem price(Float price) {
    this.price = price;
    return this;
  }
  ...
  public GoogleFinanceAssetPairElementSerpElementItem priceDelta(Float priceDelta) {
  ...
  public GoogleFinanceAssetPairElementSerpElementItem identifier(String identifier) {
  ...
  public GoogleFinanceAssetPairElementSerpElementItem displayedName(String displayedName) {
  ...
  public GoogleFinanceAssetPairElementSerpElementItem url(String url) {
    this.url = url;
    return this;
  }
  ...
  public GoogleFinanceAssetPairElementSerpElementItem location(String location) {
  ...
  public GoogleFinanceAssetPairElementSerpElementItem trend(String trend) {
    this.trend = trend;
    return this;
  }
  ...
  public GoogleFinanceAssetPairElementSerpElementItem timestamp(String timestamp) {
  ...
  public GoogleFinanceAssetPairElementSerpElementItem percentageDelta(Float percentageDelta) {
   ...
   * @return the GoogleFinanceAssetPairElementSerpElementItem instance itself
   */
  public GoogleFinanceAssetPairElementSerpElementItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleFinanceAssetPairElementSerpElementItem googleFinanceAssetPairElementSerpElementItem = (GoogleFinanceAssetPairElementSerpElementItem) o;
    return Objects.equals(this.baseSymbol, googleFinanceAssetPairElementSerpElementItem.baseSymbol) &&
        Objects.equals(this.quoteSymbol, googleFinanceAssetPairElementSerpElementItem.quoteSymbol) &&
        Objects.equals(this.baseDisplayName, googleFinanceAssetPairElementSerpElementItem.baseDisplayName) &&
        Objects.equals(this.quoteDisplayName, googleFinanceAssetPairElementSerpElementItem.quoteDisplayName) &&
        Objects.equals(this.price, googleFinanceAssetPairElementSerpElementItem.price) &&
        Objects.equals(this.priceDelta, googleFinanceAssetPairElementSerpElementItem.priceDelta) &&
        Objects.equals(this.identifier, googleFinanceAssetPairElementSerpElementItem.identifier) &&
        Objects.equals(this.displayedName, googleFinanceAssetPairElementSerpElementItem.displayedName) &&
        Objects.equals(this.url, googleFinanceAssetPairElementSerpElementItem.url) &&
        Objects.equals(this.location, googleFinanceAssetPairElementSerpElementItem.location) &&
        Objects.equals(this.trend, googleFinanceAssetPairElementSerpElementItem.trend) &&
        Objects.equals(this.timestamp, googleFinanceAssetPairElementSerpElementItem.timestamp) &&
        Objects.equals(this.percentageDelta, googleFinanceAssetPairElementSerpElementItem.percentageDelta)&&
        Objects.equals(this.additionalProperties, googleFinanceAssetPairElementSerpElementItem.additionalProperties) &&
        super.equals(o);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(baseSymbol, quoteSymbol, baseDisplayName, quoteDisplayName, price, priceDelta, identifier, displayedName, url, location, trend, timestamp, percentageDelta, super.hashCode(), additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleFinanceAssetPairElementSerpElementItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleFinanceAssetPairElementSerpElementItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleFinanceAssetPairElementSerpElementItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleFinanceAssetPairElementSerpElementItem is not found in the empty JSON string", GoogleFinanceAssetPairElementSerpElementItem.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleFinanceAssetPairElementSerpElementItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleFinanceAssetPairElementSerpElementItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleFinanceAssetPairElementSerpElementItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleFinanceAssetPairElementSerpElementItem.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleFinanceAssetPairElementSerpElementItem>() {
           @Override
           public void write(JsonWriter out, GoogleFinanceAssetPairElementSerpElementItem value) throws IOException {
           ...
           @Override
           public GoogleFinanceAssetPairElementSerpElementItem read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             GoogleFinanceAssetPairElementSerpElementItem instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of GoogleFinanceAssetPairElementSerpElementItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleFinanceAssetPairElementSerpElementItem
   * @throws IOException if the JSON string is invalid with respect to GoogleFinanceAssetPairElementSerpElementItem
   */
  public static GoogleFinanceAssetPairElementSerpElementItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleFinanceAssetPairElementSerpElementItem.class);
  }

  /**
   * Convert an instance of GoogleFinanceAssetPairElementSerpElementItem to an JSON string
   *
   * @return JSON string
   */
