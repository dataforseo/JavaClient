...
* data is provided in separate objects corresponding to domains, subdomains or pages specified in the targets object
  ...
  public BacklinksDomainIntersectionLiveItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.domainIntersection, backlinksDomainIntersectionLiveItem.domainIntersection) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BacklinksDomainIntersectionLiveItem>() {
           ...
           public BacklinksDomainIntersectionLiveItem read(JsonReader in) throws IOException {
             ...
             BacklinksDomainIntersectionLiveItem instance = thisAdapter.fromJsonTree(jsonObj);
