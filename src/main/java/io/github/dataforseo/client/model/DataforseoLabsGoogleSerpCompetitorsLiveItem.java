...
public class DataforseoLabsGoogleSerpCompetitorsLiveItem  {
  ...
  public DataforseoLabsGoogleSerpCompetitorsLiveItem seType(String seType) {
    this.seType = seType;
    return this;
  }
  ...
  public DataforseoLabsGoogleSerpCompetitorsLiveItem domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public DataforseoLabsGoogleSerpCompetitorsLiveItem avgPosition(Float avgPosition) {
...
* the arithmetic mean of values in the keywords_positions array
  ...
  public DataforseoLabsGoogleSerpCompetitorsLiveItem medianPosition(Double medianPosition) {
...
* the median of the values in the keywords_positions array
  ...
  public DataforseoLabsGoogleSerpCompetitorsLiveItem rating(Double rating) {
    this.rating = rating;
    return this;
  }
...
* calculated as sum(100-keywords_positions)
  ...
  public DataforseoLabsGoogleSerpCompetitorsLiveItem etv(Double etv) {
    this.etv = etv;
    return this;
  }
...
* learn more about how the metric is calculated in this help center article
  ...
  public DataforseoLabsGoogleSerpCompetitorsLiveItem keywordsCount(Long keywordsCount) {
  ...
  public DataforseoLabsGoogleSerpCompetitorsLiveItem visibility(Double visibility) {
...
* keywords with positions from 20 to 100 have the visibility index equal to 0
  ...
  public DataforseoLabsGoogleSerpCompetitorsLiveItem relevantSerpItems(Integer relevantSerpItems) {
...
* represents the number of search results in SERP relevant to the domain for the specified keywords
  ...
  public DataforseoLabsGoogleSerpCompetitorsLiveItem keywordsPositions(Map<String, List<Integer>> keywordsPositions) {
...
* SERP positions the related domain holds in SERP for the specified keywords
  ...
  public DataforseoLabsGoogleSerpCompetitorsLiveItem() {
  }
  ...
  public DataforseoLabsGoogleSerpCompetitorsLiveItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DataforseoLabsGoogleSerpCompetitorsLiveItem dataforseoLabsGoogleSerpCompetitorsLiveItem = (DataforseoLabsGoogleSerpCompetitorsLiveItem) o;
    return

        Objects.equals(this.seType, dataforseoLabsGoogleSerpCompetitorsLiveItem.seType) &&
        Objects.equals(this.domain, dataforseoLabsGoogleSerpCompetitorsLiveItem.domain) &&
        Objects.equals(this.avgPosition, dataforseoLabsGoogleSerpCompetitorsLiveItem.avgPosition) &&
        Objects.equals(this.medianPosition, dataforseoLabsGoogleSerpCompetitorsLiveItem.medianPosition) &&
        Objects.equals(this.rating, dataforseoLabsGoogleSerpCompetitorsLiveItem.rating) &&
        Objects.equals(this.etv, dataforseoLabsGoogleSerpCompetitorsLiveItem.etv) &&
        Objects.equals(this.keywordsCount, dataforseoLabsGoogleSerpCompetitorsLiveItem.keywordsCount) &&
        Objects.equals(this.visibility, dataforseoLabsGoogleSerpCompetitorsLiveItem.visibility) &&
        Objects.equals(this.relevantSerpItems, dataforseoLabsGoogleSerpCompetitorsLiveItem.relevantSerpItems) &&
        Objects.equals(this.keywordsPositions, dataforseoLabsGoogleSerpCompetitorsLiveItem.keywordsPositions);  
  ...
  public String toString() {
    ...
    sb.append("class DataforseoLabsGoogleSerpCompetitorsLiveItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataforseoLabsGoogleSerpCompetitorsLiveItem
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataforseoLabsGoogleSerpCompetitorsLiveItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataforseoLabsGoogleSerpCompetitorsLiveItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataforseoLabsGoogleSerpCompetitorsLiveItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataforseoLabsGoogleSerpCompetitorsLiveItem.class));

       return (TypeAdapter<T>) new TypeAdapter<DataforseoLabsGoogleSerpCompetitorsLiveItem>() {
           @Override
           public void write(JsonWriter out, DataforseoLabsGoogleSerpCompetitorsLiveItem value) throws IOException {
           ...
           @Override
           public DataforseoLabsGoogleSerpCompetitorsLiveItem read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DataforseoLabsGoogleSerpCompetitorsLiveItem instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static DataforseoLabsGoogleSerpCompetitorsLiveItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataforseoLabsGoogleSerpCompetitorsLiveItem.class);
  }
