...
public class MerchantGoogleProductSpecTaskPostRequestInfo {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(productId, priority, locationName, locationCode, locationCoordinate, languageName, languageCode, seDomain, additionalSpecifications, tag, postbackUrl, postbackData, pingbackUrl, additionalProperties);
  }
