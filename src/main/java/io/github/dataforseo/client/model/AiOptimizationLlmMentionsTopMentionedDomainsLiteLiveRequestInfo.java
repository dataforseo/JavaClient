...
public class AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo  {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo target(List<BaseAiOptimizationLLmMentionsTargetElement> target) {
    this.target = target;
    return this;
  }
...
* target array with a domain entity
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo locationName(String locationName) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo locationCode(Integer locationCode) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo languageName(String languageName) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo languageCode(String languageCode) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo platform(String platform) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo linksScope(String linksScope) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo filters(List<Object> filters) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo initialDatasetFilters(List<Object> initialDatasetFilters) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo internalListLimit(Integer internalListLimit) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo orderBy(List<String> orderBy) {
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo offset(Integer offset) {
    this.offset = offset;
    return this;
  }
  ...
  public static final String SERIALIZED_NAME_INCLUDE_DOMAINS = "include_domains";
  @SerializedName(SERIALIZED_NAME_INCLUDE_DOMAINS)
  private List<String> includeDomains;

  public AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo includeDomains(List<String> includeDomains) {
    this.includeDomains = includeDomains;
    return this;
  }

  /**
   * <em>array of domains to include in the response</em><br>optional field<br>if specified, only the listed domains will be returned in the <code>items</code> array<br>example:<br><code>['dataforseo.com','seoinsider.com']</code>
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo excludeDomains(List<String> excludeDomains) {
    this.excludeDomains = excludeDomains;
    return this;
  }

  /**
   * <em>array of domains to exclude from the response</em><br>optional field<br>if specified, the listed domains will be omitted from the <code>items</code> array<br>example:<br><code>['google.com','bing.com']</code>
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo() {
  }
  ...
  public AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo aiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo = (AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo) o;
    return

        Objects.equals(this.target, aiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo.target) &&
        Objects.equals(this.locationName, aiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo.locationName) &&
        Objects.equals(this.locationCode, aiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo.locationCode) &&
        Objects.equals(this.languageName, aiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo.languageName) &&
        Objects.equals(this.languageCode, aiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo.languageCode) &&
        Objects.equals(this.platform, aiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo.platform) &&
        Objects.equals(this.linksScope, aiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo.linksScope) &&
        Objects.equals(this.filters, aiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo.filters) &&
        Objects.equals(this.initialDatasetFilters, aiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo.initialDatasetFilters) &&
        Objects.equals(this.limit, aiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo.limit) &&
        Objects.equals(this.internalListLimit, aiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo.internalListLimit) &&
        Objects.equals(this.orderBy, aiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo.orderBy) &&
        Objects.equals(this.offset, aiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo.offset) &&
        Objects.equals(this.includeDomains, aiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo.includeDomains) &&
        Objects.equals(this.excludeDomains, aiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo.excludeDomains) &&
        Objects.equals(this.tag, aiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo.tag);  
  ...
  @Override
  public int hashCode() {
  return Objects.hash(target, locationName, locationCode, languageName, languageCode, platform, linksScope, filters, initialDatasetFilters, limit, internalListLimit, orderBy, offset, includeDomains, excludeDomains, tag);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo {\n");
  ...
  static {
    ...
    openapiFields.add("include_domains");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo>() {
           @Override
           public void write(JsonWriter out, AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo value) throws IOException {
           ...
           @Override
           public AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo.class);
  }
