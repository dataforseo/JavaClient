...
* you will find the specified tag value in the data object of the response
  ...
  public KeywordsDataBingKeywordsForKeywordsTaskPostRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.keywords, keywordsDataBingKeywordsForKeywordsTaskPostRequestInfo.keywords) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<KeywordsDataBingKeywordsForKeywordsTaskPostRequestInfo>() {
           ...
           public KeywordsDataBingKeywordsForKeywordsTaskPostRequestInfo read(JsonReader in) throws IOException {
             ...
             KeywordsDataBingKeywordsForKeywordsTaskPostRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
