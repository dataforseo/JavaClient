...
public class PositiveConnotationDistribution  {
  ...
  public PositiveConnotationDistribution putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.positive, positiveConnotationDistribution.positive) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PositiveConnotationDistribution>() {
           ...
           public PositiveConnotationDistribution read(JsonReader in) throws IOException {
             ...
             PositiveConnotationDistribution instance = thisAdapter.fromJsonTree(jsonObj);
