...
public class ContentAnalysisSummaryInfo  {
  ...
  /**
   * <em>rank of all URLs citing the <code>keyword</code></em><br>normalized sum of ranks of all URLs citing the target <code>keyword</code>
   * @return rank
   */
  @javax.annotation.Nullable
  ...
  /**
   * <em>top domains citing the target keyword</em><br>contains objects with top domains citing the target keword and citation count per each domain
   * @return topDomains
   */
  @javax.annotation.Nullable
  ...
  /**
   * <em>sentiment connotations</em><br>contains sentiments (emotional reactions) related to the target keyword citation and the number of citations per each sentiment<br>possible sentiment connotations: <code>anger</code>, <code>happiness</code>, <code>love</code>, <code>sadness</code>, <code>share</code>, <code>fun</code>
  ...
  /**
   * <em>connotation types</em><br>contains types of sentiments (sentiment polarity) related to the keyword citation and citation count per each sentiment type<br>possible sentiment connotation types: <code>positive</code>, <code>negative</code>, <code>neutral</code>
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.type, contentAnalysisSummaryInfo.type) &&
  ...
  @Override
  public int hashCode() {
  return Objects.hash(type, totalCount, rank, topDomains, sentimentConnotations, connotationTypes, textCategories, pageCategories, pageTypes, countries, languages);
  }
