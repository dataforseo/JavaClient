...
public class AiOptimizationClaudeLlmResponsesLiveRequestInfo  {
  ...
  public AiOptimizationClaudeLlmResponsesLiveRequestInfo userPrompt(String userPrompt) {
...
* you can specify up to 500 characters in the user_prompt field
  ...
  public AiOptimizationClaudeLlmResponsesLiveRequestInfo modelName(String modelName) {
...
* you can receive the list of available LLM models by making a separate request to the https://api.dataforseo.com/v3/ai_optimization/claude/llm_responses/models
  ...
  public AiOptimizationClaudeLlmResponsesLiveRequestInfo maxOutputTokens(Integer maxOutputTokens) {
...
* Note: when web_search is set to true, the output token count may exceed the specified max_output_tokens limit
  ...
  public AiOptimizationClaudeLlmResponsesLiveRequestInfo temperature(Double temperature) {
...
* default value: 0.7
  ...
  public AiOptimizationClaudeLlmResponsesLiveRequestInfo topP(Double topP) {
    this.topP = topP;
    return this;
  }
...
* default value: null
  ...
  public AiOptimizationClaudeLlmResponsesLiveRequestInfo webSearch(Boolean webSearch) {
...
* The cost of the parameter can be calculated on the Pricing page
  ...
  public AiOptimizationClaudeLlmResponsesLiveRequestInfo forceWebSearch(Boolean forceWebSearch) {
...
* Note: even if the parameter is set to true, there is no guarantee web sources will be cited in the response
  ...
  public AiOptimizationClaudeLlmResponsesLiveRequestInfo webSearchCountryIsoCode(String webSearchCountryIsoCode) {
...
* possible values: 'AR','AT','AU','BE','BR','CA','CH','CL','CN','DE','DK','ES','FI','FR','GB','HK','ID','IN','IT','JP','KR','MX','MY','NL','NO','NZ','PH','PL','PT','RU','SA','SE','TR','TW','US','ZA'
  ...
  public AiOptimizationClaudeLlmResponsesLiveRequestInfo webSearchCity(String webSearchCity) {
...
* Note: specify web_search_country_iso_code to use this parameter
  ...
  public AiOptimizationClaudeLlmResponsesLiveRequestInfo systemMessage(String systemMessage) {
...
* you can specify up to 500 characters in the system_message field
  ...
  public AiOptimizationClaudeLlmResponsesLiveRequestInfo messageChain(List<LlmMessageChainItem> messageChain) {
...
* 'message_chain': [{'role':'user','message':'Hello, what’s up?'},{'role':'ai','message':'Hello! I’m doing well, thank you. How can I assist you today?'}]
  ...
  public AiOptimizationClaudeLlmResponsesLiveRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
...
* you will find the specified tag value in the data object of the response
  ...
  public AiOptimizationClaudeLlmResponsesLiveRequestInfo() {
  }
  ...
  public AiOptimizationClaudeLlmResponsesLiveRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiOptimizationClaudeLlmResponsesLiveRequestInfo aiOptimizationClaudeLlmResponsesLiveRequestInfo = (AiOptimizationClaudeLlmResponsesLiveRequestInfo) o;
    return

        Objects.equals(this.userPrompt, aiOptimizationClaudeLlmResponsesLiveRequestInfo.userPrompt) &&
        Objects.equals(this.modelName, aiOptimizationClaudeLlmResponsesLiveRequestInfo.modelName) &&
        Objects.equals(this.maxOutputTokens, aiOptimizationClaudeLlmResponsesLiveRequestInfo.maxOutputTokens) &&
        Objects.equals(this.temperature, aiOptimizationClaudeLlmResponsesLiveRequestInfo.temperature) &&
        Objects.equals(this.topP, aiOptimizationClaudeLlmResponsesLiveRequestInfo.topP) &&
        Objects.equals(this.webSearch, aiOptimizationClaudeLlmResponsesLiveRequestInfo.webSearch) &&
        Objects.equals(this.forceWebSearch, aiOptimizationClaudeLlmResponsesLiveRequestInfo.forceWebSearch) &&
        Objects.equals(this.webSearchCountryIsoCode, aiOptimizationClaudeLlmResponsesLiveRequestInfo.webSearchCountryIsoCode) &&
  ...
  public String toString() {
    ...
    sb.append("class AiOptimizationClaudeLlmResponsesLiveRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiOptimizationClaudeLlmResponsesLiveRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiOptimizationClaudeLlmResponsesLiveRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiOptimizationClaudeLlmResponsesLiveRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiOptimizationClaudeLlmResponsesLiveRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiOptimizationClaudeLlmResponsesLiveRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AiOptimizationClaudeLlmResponsesLiveRequestInfo>() {
           @Override
           public void write(JsonWriter out, AiOptimizationClaudeLlmResponsesLiveRequestInfo value) throws IOException {
           ...
           @Override
           public AiOptimizationClaudeLlmResponsesLiveRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiOptimizationClaudeLlmResponsesLiveRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AiOptimizationClaudeLlmResponsesLiveRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiOptimizationClaudeLlmResponsesLiveRequestInfo.class);
  }
