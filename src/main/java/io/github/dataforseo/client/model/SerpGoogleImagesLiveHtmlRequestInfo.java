...
public class SerpGoogleImagesLiveHtmlRequestInfo  {
  ...
  public SerpGoogleImagesLiveHtmlRequestInfo keyword(String keyword) {
  ...
  public SerpGoogleImagesLiveHtmlRequestInfo locationCode(Integer locationCode) {
  ...
  public SerpGoogleImagesLiveHtmlRequestInfo languageCode(String languageCode) {
  ...
  public SerpGoogleImagesLiveHtmlRequestInfo depth(Integer depth) {
    this.depth = depth;
    return this;
  }
  ...
  public SerpGoogleImagesLiveHtmlRequestInfo locationName(String locationName) {
  ...
  public SerpGoogleImagesLiveHtmlRequestInfo languageName(String languageName) {
  ...
  public SerpGoogleImagesLiveHtmlRequestInfo os(String os) {
    this.os = os;
    return this;
  }
  ...
  public SerpGoogleImagesLiveHtmlRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public SerpGoogleImagesLiveHtmlRequestInfo maxCrawlPages(Integer maxCrawlPages) {
  ...
  public SerpGoogleImagesLiveHtmlRequestInfo searchParam(String searchParam) {
  ...
  public SerpGoogleImagesLiveHtmlRequestInfo url(String url) {
    this.url = url;
    return this;
  }
  ...
  public SerpGoogleImagesLiveHtmlRequestInfo locationCoordinate(String locationCoordinate) {
  ...
  public SerpGoogleImagesLiveHtmlRequestInfo seDomain(String seDomain) {
    this.seDomain = seDomain;
    return this;
  }

  /**
   * <p><em>search engine domain</em><p>optional field<p>we choose the relevant search engine domain automatically according to the location and language you specify<p>however, you can set a custom search engine domain in this field<p>example:<p><code><code></code></code><em>google.co.uk</em>, <code><code></code></code><em>google.com.au</em>, <code><code></code></code><em>google.de</em>, etc.</p>
   * @return seDomain
   */
  @javax.annotation.Nullable
  ...
  public SerpGoogleImagesLiveHtmlRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SerpGoogleImagesLiveHtmlRequestInfo serpGoogleImagesLiveHtmlRequestInfo = (SerpGoogleImagesLiveHtmlRequestInfo) o;
    return

        Objects.equals(this.keyword, serpGoogleImagesLiveHtmlRequestInfo.keyword) &&
        Objects.equals(this.locationCode, serpGoogleImagesLiveHtmlRequestInfo.locationCode) &&
        Objects.equals(this.languageCode, serpGoogleImagesLiveHtmlRequestInfo.languageCode) &&
        Objects.equals(this.depth, serpGoogleImagesLiveHtmlRequestInfo.depth) &&
        Objects.equals(this.locationName, serpGoogleImagesLiveHtmlRequestInfo.locationName) &&
        Objects.equals(this.languageName, serpGoogleImagesLiveHtmlRequestInfo.languageName) &&
        Objects.equals(this.os, serpGoogleImagesLiveHtmlRequestInfo.os) &&
        Objects.equals(this.tag, serpGoogleImagesLiveHtmlRequestInfo.tag) &&
        Objects.equals(this.maxCrawlPages, serpGoogleImagesLiveHtmlRequestInfo.maxCrawlPages) &&
        Objects.equals(this.searchParam, serpGoogleImagesLiveHtmlRequestInfo.searchParam) &&
        Objects.equals(this.url, serpGoogleImagesLiveHtmlRequestInfo.url) &&
        Objects.equals(this.locationCoordinate, serpGoogleImagesLiveHtmlRequestInfo.locationCoordinate) &&
        Objects.equals(this.seDomain, serpGoogleImagesLiveHtmlRequestInfo.seDomain);  
  ...
  public String toString() {
    ...
    sb.append("class SerpGoogleImagesLiveHtmlRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SerpGoogleImagesLiveHtmlRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SerpGoogleImagesLiveHtmlRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SerpGoogleImagesLiveHtmlRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SerpGoogleImagesLiveHtmlRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SerpGoogleImagesLiveHtmlRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SerpGoogleImagesLiveHtmlRequestInfo>() {
           @Override
           public void write(JsonWriter out, SerpGoogleImagesLiveHtmlRequestInfo value) throws IOException {
           ...
           @Override
           public SerpGoogleImagesLiveHtmlRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SerpGoogleImagesLiveHtmlRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static SerpGoogleImagesLiveHtmlRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SerpGoogleImagesLiveHtmlRequestInfo.class);
  }
