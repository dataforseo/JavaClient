...
public class SerpTaskRequestInfo {
  ...
  public SerpTaskRequestInfo keyword(String keyword) {
  ...
  public SerpTaskRequestInfo url(String url) {
    this.url = url;
    return this;
  }
  ...
  public SerpTaskRequestInfo priority(Integer priority) {
  ...
  public SerpTaskRequestInfo depth(Integer depth) {
    this.depth = depth;
    return this;
  }
  ...
  public SerpTaskRequestInfo maxCrawlPages(Integer maxCrawlPages) {
  ...
  public SerpTaskRequestInfo locationName(String locationName) {
  ...
  public SerpTaskRequestInfo locationCode(Integer locationCode) {
  ...
  public SerpTaskRequestInfo locationCoordinate(String locationCoordinate) {
  ...
  public SerpTaskRequestInfo languageName(String languageName) {
  ...
  public SerpTaskRequestInfo languageCode(String languageCode) {
  ...
  public SerpTaskRequestInfo seDomain(String seDomain) {
  ...
  public SerpTaskRequestInfo device(String device) {
    this.device = device;
    return this;
  }
  ...
  public SerpTaskRequestInfo os(String os) {
    this.os = os;
    return this;
  }
  ...
  public SerpTaskRequestInfo groupOrganicResults(Boolean groupOrganicResults) {
  ...
  public SerpTaskRequestInfo calculateRectangles(Boolean calculateRectangles) {
  ...
  public SerpTaskRequestInfo browserScreenWidth(Long browserScreenWidth) {
    this.browserScreenWidth = browserScreenWidth;
    return this;
  }

  /**
   * browser screen width optional field you can set a custom browser screen width to calculate pixel rankings for a particular device; by default, the parameter is set to: 1920 for desktop; 360 for mobile on android; 375 for mobile on iOS; Note: to use this parameter, set calculate_rectangles to true
  ...
  public SerpTaskRequestInfo browserScreenHeight(Integer browserScreenHeight) {
    this.browserScreenHeight = browserScreenHeight;
    return this;
  }

  /**
   * browser screen height optional field you can set a custom browser screen height to calculate pixel rankings for a particular device; by default, the parameter is set to: 1080 for desktop; 640 for mobile on android; 812 for mobile on iOS; Note: to use this parameter, set calculate_rectangles to true
  ...
  public SerpTaskRequestInfo browserScreenResolutionRatio(Integer browserScreenResolutionRatio) {
  ...
  public SerpTaskRequestInfo peopleAlsoAskClickDepth(Integer peopleAlsoAskClickDepth) {
  ...
  public SerpTaskRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public SerpTaskRequestInfo postbackUrl(String postbackUrl) {
  ...
  public SerpTaskRequestInfo postbackData(String postbackData) {
  ...
  public SerpTaskRequestInfo pingbackUrl(String pingbackUrl) {
   ...
   * @return the SerpTaskRequestInfo instance itself
   */
  public SerpTaskRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SerpTaskRequestInfo serpTaskRequestInfo = (SerpTaskRequestInfo) o;
    return Objects.equals(this.keyword, serpTaskRequestInfo.keyword) &&
        Objects.equals(this.url, serpTaskRequestInfo.url) &&
        Objects.equals(this.priority, serpTaskRequestInfo.priority) &&
        Objects.equals(this.depth, serpTaskRequestInfo.depth) &&
        Objects.equals(this.maxCrawlPages, serpTaskRequestInfo.maxCrawlPages) &&
        Objects.equals(this.locationName, serpTaskRequestInfo.locationName) &&
        Objects.equals(this.locationCode, serpTaskRequestInfo.locationCode) &&
        Objects.equals(this.locationCoordinate, serpTaskRequestInfo.locationCoordinate) &&
        Objects.equals(this.languageName, serpTaskRequestInfo.languageName) &&
        Objects.equals(this.languageCode, serpTaskRequestInfo.languageCode) &&
        Objects.equals(this.seDomain, serpTaskRequestInfo.seDomain) &&
        Objects.equals(this.device, serpTaskRequestInfo.device) &&
        Objects.equals(this.os, serpTaskRequestInfo.os) &&
        Objects.equals(this.groupOrganicResults, serpTaskRequestInfo.groupOrganicResults) &&
        Objects.equals(this.calculateRectangles, serpTaskRequestInfo.calculateRectangles) &&
        Objects.equals(this.browserScreenWidth, serpTaskRequestInfo.browserScreenWidth) &&
        ...
        Objects.equals(this.postbackData, serpTaskRequestInfo.postbackData) &&
        Objects.equals(this.pingbackUrl, serpTaskRequestInfo.pingbackUrl)&&
        Objects.equals(this.additionalProperties, serpTaskRequestInfo.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SerpTaskRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SerpTaskRequestInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SerpTaskRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SerpTaskRequestInfo is not found in the empty JSON string", SerpTaskRequestInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SerpTaskRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SerpTaskRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SerpTaskRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SerpTaskRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SerpTaskRequestInfo>() {
           @Override
           public void write(JsonWriter out, SerpTaskRequestInfo value) throws IOException {
           ...
           @Override
           public SerpTaskRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SerpTaskRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of SerpTaskRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SerpTaskRequestInfo
   * @throws IOException if the JSON string is invalid with respect to SerpTaskRequestInfo
   */
  public static SerpTaskRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SerpTaskRequestInfo.class);
  }

  /**
   * Convert an instance of SerpTaskRequestInfo to an JSON string
   *
   * @return JSON string
   */
