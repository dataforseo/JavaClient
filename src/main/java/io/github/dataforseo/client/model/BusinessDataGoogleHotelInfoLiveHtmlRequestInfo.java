...
public class BusinessDataGoogleHotelInfoLiveHtmlRequestInfo  {
  ...
  /**
   * <em>check-in date</em><br>optional field<br>if you don't specify this field, tomorrow's date will be used by default;<br>date format: <code>'yyyy-mm-dd'</code><br>example:<br><code>'2019-01-15'</code>
   * @return checkIn
   */
  @javax.annotation.Nullable
  ...
  /**
   * <em>check-out date</em><br>optional field<br>if you don't specify this field, our system will apply the date of two days from now by default;<br>date format: <code>'yyyy-mm-dd'</code><br>example:<br><code>'2019-01-15'</code>
   * @return checkOut
   */
  @javax.annotation.Nullable
