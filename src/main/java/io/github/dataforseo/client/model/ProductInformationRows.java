...
public class ProductInformationRows  {
  ...
  private List<BaseMerchantAmazonProductInformationRowElementItem> rows;

  public ProductInformationRows rows(List<BaseMerchantAmazonProductInformationRowElementItem> rows) {
    this.rows = rows;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<BaseMerchantAmazonProductInformationRowElementItem> getRows() {
    return rows;
  }

  public void setRows(List<BaseMerchantAmazonProductInformationRowElementItem> rows) {
    this.rows = rows;
  }
  ...
  public ProductInformationRows putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.type, productInformationRows.type) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProductInformationRows>() {
           ...
           public ProductInformationRows read(JsonReader in) throws IOException {
             ...
             ProductInformationRows instance = thisAdapter.fromJsonTree(jsonObj);
