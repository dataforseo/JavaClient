...
public class AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo  {
  ...
  public AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo target(List<BaseAiOptimizationLLmMentionsTargetElement> target) {
    this.target = target;
    return this;
  }
...
* target array with a domain entity
  ...
  public AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo locationName(String locationName) {
...
* Note: chat_gpt data is available for United States only
  ...
  public AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo locationCode(Integer locationCode) {
...
* Note: chat_gpt data is available for 2840 only
  ...
  public AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo languageName(String languageName) {
...
* Note: chat_gpt data is available for English only
  ...
  public AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo languageCode(String languageCode) {
...
* Note: chat_gpt data is available for en only
  ...
  public AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo platform(String platform) {
...
* Note #2:chat_gpt data is available for the United States and English only
  ...
  public AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo initialDatasetFilters(List<Object> initialDatasetFilters) {
...
* learn more about the initial dataset filters in this help center article.
  ...
  public AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo internalListLimit(Integer internalListLimit) {
...
* default value: 10
  ...
  public AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
...
* you will find the specified tag value in the data object of the response
  ...
  public AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo() {
  }
  ...
  public AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo aiOptimizationLlmMentionsTargetMetricsLiveRequestInfo = (AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo) o;
    return

        Objects.equals(this.target, aiOptimizationLlmMentionsTargetMetricsLiveRequestInfo.target) &&
        Objects.equals(this.locationName, aiOptimizationLlmMentionsTargetMetricsLiveRequestInfo.locationName) &&
        Objects.equals(this.locationCode, aiOptimizationLlmMentionsTargetMetricsLiveRequestInfo.locationCode) &&
        Objects.equals(this.languageName, aiOptimizationLlmMentionsTargetMetricsLiveRequestInfo.languageName) &&
        Objects.equals(this.languageCode, aiOptimizationLlmMentionsTargetMetricsLiveRequestInfo.languageCode) &&
        Objects.equals(this.platform, aiOptimizationLlmMentionsTargetMetricsLiveRequestInfo.platform) &&
        Objects.equals(this.initialDatasetFilters, aiOptimizationLlmMentionsTargetMetricsLiveRequestInfo.initialDatasetFilters) &&
        Objects.equals(this.internalListLimit, aiOptimizationLlmMentionsTargetMetricsLiveRequestInfo.internalListLimit) &&
        Objects.equals(this.tag, aiOptimizationLlmMentionsTargetMetricsLiveRequestInfo.tag);  
  ...
  public String toString() {
    ...
    sb.append("class AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo>() {
           @Override
           public void write(JsonWriter out, AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo value) throws IOException {
           ...
           @Override
           public AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo.class);
  }
