...
import io.github.dataforseo.client.model.GoogleFinanceMarketTrendsElement;
...
public class SerpGoogleFinanceExploreAdvancedItem {
  ...
  public SerpGoogleFinanceExploreAdvancedItem addMostActiveItem(GoogleFinanceMarketTrendsElement mostActiveItem) {
    if (this.mostActive == null) {
      this.mostActive = new ArrayList<>();
    }
    this.mostActive.add(mostActiveItem);
    return this;
  }
  ...
  public SerpGoogleFinanceExploreAdvancedItem addGainersItem(GoogleFinanceMarketTrendsElement gainersItem) {
  ...
  public SerpGoogleFinanceExploreAdvancedItem addLosersItem(GoogleFinanceMarketTrendsElement losersItem) {
    if (this.losers == null) {
   ...
   * @return the SerpGoogleFinanceExploreAdvancedItem instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.mostActive, serpGoogleFinanceExploreAdvancedItem.mostActive) &&
        ...
        Objects.equals(this.additionalProperties, serpGoogleFinanceExploreAdvancedItem.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(mostActive, gainers, losers, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SerpGoogleFinanceExploreAdvancedItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SerpGoogleFinanceExploreAdvancedItem is not found in the empty JSON string", SerpGoogleFinanceExploreAdvancedItem.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (jsonObj.get("most_active") != null && !jsonObj.get("most_active").isJsonNull()) {
        JsonArray jsonArraymostActive = jsonObj.getAsJsonArray("most_active");
        if (jsonArraymostActive != null) {
          // ensure the json data is an array
          if (!jsonObj.get("most_active").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `most_active` to be an array in the JSON string but got `%s`", jsonObj.get("most_active").toString()));
          }

          // validate the optional field `most_active` (array)
          for (int i = 0; i < jsonArraymostActive.size(); i++) {
            GoogleFinanceMarketTrendsElement.validateJsonElement(jsonArraymostActive.get(i));
          };
        }
      }
      if (jsonObj.get("gainers") != null && !jsonObj.get("gainers").isJsonNull()) {
        JsonArray jsonArraygainers = jsonObj.getAsJsonArray("gainers");
        if (jsonArraygainers != null) {
          // ensure the json data is an array
          ...
          // validate the optional field `gainers` (array)
          for (int i = 0; i < jsonArraygainers.size(); i++) {
            GoogleFinanceMarketTrendsElement.validateJsonElement(jsonArraygainers.get(i));
          };
        }
      }
      if (jsonObj.get("losers") != null && !jsonObj.get("losers").isJsonNull()) {
        JsonArray jsonArraylosers = jsonObj.getAsJsonArray("losers");
        if (jsonArraylosers != null) {
          // ensure the json data is an array
          ...
          // validate the optional field `losers` (array)
          for (int i = 0; i < jsonArraylosers.size(); i++) {
            GoogleFinanceMarketTrendsElement.validateJsonElement(jsonArraylosers.get(i));
          };
        }
      }
  }
  ...
  /**
   * Create an instance of SerpGoogleFinanceExploreAdvancedItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SerpGoogleFinanceExploreAdvancedItem
   * @throws IOException if the JSON string is invalid with respect to SerpGoogleFinanceExploreAdvancedItem
   */
  ...
  /**
   * Convert an instance of SerpGoogleFinanceExploreAdvancedItem to an JSON string
   *
   * @return JSON string
   */
