...
public class Contacts  {
  ...
  public Contacts telephones(List<String> telephones) {
  ...
  public Contacts putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.telephones, contacts.telephones) &&
  ...
  @Override
  public int hashCode() {
  return Objects.hash(telephones, emails);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Contacts>() {
           ...
           public Contacts read(JsonReader in) throws IOException {
             ...
             Contacts instance = thisAdapter.fromJsonTree(jsonObj);
