...
public class KeywordsDataBingLocationsResultInfo  {
  ...
  /**
   * <em>the code of the superordinate location</em><br>example:<br><code>'location_code': 9041134,<br>'location_name': 'Vienna International Airport,Lower Austria,Austria',<br>'location_code_parent': 20044</code>where <code>location_code_parent</code> corresponds to:<p><code>'location_code': 20044,<br>'location_name': 'Lower Austria,Austria'</code>
