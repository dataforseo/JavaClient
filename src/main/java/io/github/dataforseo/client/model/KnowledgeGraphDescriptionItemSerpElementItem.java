...
* text snippet from the page that was used to generate the ai_overview_element
  ...
  public KnowledgeGraphDescriptionItemSerpElementItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.rankGroup, knowledgeGraphDescriptionItemSerpElementItem.rankGroup) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<KnowledgeGraphDescriptionItemSerpElementItem>() {
           ...
           public KnowledgeGraphDescriptionItemSerpElementItem read(JsonReader in) throws IOException {
             ...
             KnowledgeGraphDescriptionItemSerpElementItem instance = thisAdapter.fromJsonTree(jsonObj);
