...
public class BusinessDataGoogleLocationsResultInfo  {
  ...
  public BusinessDataGoogleLocationsResultInfo locationName(String locationName) {
  ...
  public BusinessDataGoogleLocationsResultInfo countryIsoCode(String countryIsoCode) {
  ...
  public BusinessDataGoogleLocationsResultInfo locationType(String locationType) {
  ...
  public BusinessDataGoogleLocationsResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.locationCode, businessDataGoogleLocationsResultInfo.locationCode) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to BusinessDataGoogleLocationsResultInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BusinessDataGoogleLocationsResultInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BusinessDataGoogleLocationsResultInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BusinessDataGoogleLocationsResultInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BusinessDataGoogleLocationsResultInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<BusinessDataGoogleLocationsResultInfo>() {
           @Override
           public void write(JsonWriter out, BusinessDataGoogleLocationsResultInfo value) throws IOException {
           ...
           @Override
           public BusinessDataGoogleLocationsResultInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             BusinessDataGoogleLocationsResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static BusinessDataGoogleLocationsResultInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BusinessDataGoogleLocationsResultInfo.class);
  }
