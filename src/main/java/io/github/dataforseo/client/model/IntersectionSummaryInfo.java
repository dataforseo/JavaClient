...
public class IntersectionSummaryInfo  {
  ...
  public IntersectionSummaryInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.intersectionsCount, intersectionSummaryInfo.intersectionsCount);  
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IntersectionSummaryInfo>() {
           ...
           public IntersectionSummaryInfo read(JsonReader in) throws IOException {
             ...
             IntersectionSummaryInfo instance = thisAdapter.fromJsonTree(jsonObj);
