...
public class FoundOnWebElement  {
  ...
  public FoundOnWebElement putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.type, foundOnWebElement.type) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FoundOnWebElement>() {
           ...
           public FoundOnWebElement read(JsonReader in) throws IOException {
             ...
             FoundOnWebElement instance = thisAdapter.fromJsonTree(jsonObj);
