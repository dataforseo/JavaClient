...
* you will find the specified tag value in the data object of the response
  ...
  public SerpGoogleAutocompleteLiveAdvancedRequestInfo putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SerpGoogleAutocompleteLiveAdvancedRequestInfo>() {
           ...
           public SerpGoogleAutocompleteLiveAdvancedRequestInfo read(JsonReader in) throws IOException {
             ...
             SerpGoogleAutocompleteLiveAdvancedRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
