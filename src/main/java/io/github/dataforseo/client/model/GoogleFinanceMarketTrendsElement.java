...
public class GoogleFinanceMarketTrendsElement {
  ...
  private GoogleFinanceAssetPairElement quote;
  ...
  public GoogleFinanceMarketTrendsElement quote(GoogleFinanceAssetPairElement quote) {
    this.quote = quote;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public GoogleFinanceAssetPairElement getQuote() {
    return quote;
  }

  public void setQuote(GoogleFinanceAssetPairElement quote) {
    this.quote = quote;
  }
  ...
  public GoogleFinanceMarketTrendsElement addNewsItem(GoogleFinanceNewsElement newsItem) {
    if (this.news == null) {
   ...
   * @return the GoogleFinanceMarketTrendsElement instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, googleFinanceMarketTrendsElement.type) &&
        ...
        Objects.equals(this.additionalProperties, googleFinanceMarketTrendsElement.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, quote, news, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleFinanceMarketTrendsElement.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleFinanceMarketTrendsElement is not found in the empty JSON string", GoogleFinanceMarketTrendsElement.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("quote") != null && !jsonObj.get("quote").isJsonNull()) {
        GoogleFinanceAssetPairElement.validateJsonElement(jsonObj.get("quote"));
      }
      if (jsonObj.get("news") != null && !jsonObj.get("news").isJsonNull()) {
        ...
        if (jsonArraynews != null) {
          ...
          for (int i = 0; i < jsonArraynews.size(); i++) {
            GoogleFinanceNewsElement.validateJsonElement(jsonArraynews.get(i));
          };
        }
      }
  }
  ...
  /**
   * Create an instance of GoogleFinanceMarketTrendsElement given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleFinanceMarketTrendsElement
   * @throws IOException if the JSON string is invalid with respect to GoogleFinanceMarketTrendsElement
   */
  ...
  /**
   * Convert an instance of GoogleFinanceMarketTrendsElement to an JSON string
   *
   * @return JSON string
   */
