...
public class SerpBingLocalPackLiveHtmlRequestInfo {
   ...
   * @return the SerpBingLocalPackLiveHtmlRequestInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, serpBingLocalPackLiveHtmlRequestInfo.url) &&
        ...
        Objects.equals(this.additionalProperties, serpBingLocalPackLiveHtmlRequestInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(url, keyword, locationName, locationCode, locationCoordinate, languageName, languageCode, device, os, depth, maxCrawlPages, searchParam, tag, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SerpBingLocalPackLiveHtmlRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SerpBingLocalPackLiveHtmlRequestInfo is not found in the empty JSON string", SerpBingLocalPackLiveHtmlRequestInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of SerpBingLocalPackLiveHtmlRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SerpBingLocalPackLiveHtmlRequestInfo
   * @throws IOException if the JSON string is invalid with respect to SerpBingLocalPackLiveHtmlRequestInfo
   */
  ...
  /**
   * Convert an instance of SerpBingLocalPackLiveHtmlRequestInfo to an JSON string
   *
   * @return JSON string
   */
