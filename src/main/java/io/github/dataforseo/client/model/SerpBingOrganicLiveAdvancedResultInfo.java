...
public class SerpBingOrganicLiveAdvancedResultInfo  {
  ...
  public SerpBingOrganicLiveAdvancedResultInfo keyword(String keyword) {
  ...
  public SerpBingOrganicLiveAdvancedResultInfo type(String type) {
    this.type = type;
    return this;
  }
  ...
  public SerpBingOrganicLiveAdvancedResultInfo seDomain(String seDomain) {
  ...
  public SerpBingOrganicLiveAdvancedResultInfo locationCode(Integer locationCode) {
  ...
  public SerpBingOrganicLiveAdvancedResultInfo languageCode(String languageCode) {
  ...
  public SerpBingOrganicLiveAdvancedResultInfo checkUrl(String checkUrl) {
  ...
  public SerpBingOrganicLiveAdvancedResultInfo datetime(String datetime) {
  ...
  public SerpBingOrganicLiveAdvancedResultInfo spell(SpellInfo spell) {
    this.spell = spell;
    return this;
  }

  /**
   * <em>autocorrection of the search engine</em><br>            if the search engine provided results for a keyword that was corrected, we will specify the keyword corrected by the search engine and the type of autocorrection<br>            equals <code>null</code>
   * @return spell
   */
  @javax.annotation.Nullable
  ...
  public SerpBingOrganicLiveAdvancedResultInfo refinementChips(RefinementChipsInfo refinementChips) {
  ...
  public SerpBingOrganicLiveAdvancedResultInfo seResultsCount(Long seResultsCount) {
  ...
  public SerpBingOrganicLiveAdvancedResultInfo itemsCount(Long itemsCount) {
  ...
  public SerpBingOrganicLiveAdvancedResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SerpBingOrganicLiveAdvancedResultInfo serpBingOrganicLiveAdvancedResultInfo = (SerpBingOrganicLiveAdvancedResultInfo) o;
    return

        Objects.equals(this.keyword, serpBingOrganicLiveAdvancedResultInfo.keyword) &&
        Objects.equals(this.type, serpBingOrganicLiveAdvancedResultInfo.type) &&
        Objects.equals(this.seDomain, serpBingOrganicLiveAdvancedResultInfo.seDomain) &&
        Objects.equals(this.locationCode, serpBingOrganicLiveAdvancedResultInfo.locationCode) &&
        Objects.equals(this.languageCode, serpBingOrganicLiveAdvancedResultInfo.languageCode) &&
        Objects.equals(this.checkUrl, serpBingOrganicLiveAdvancedResultInfo.checkUrl) &&
        Objects.equals(this.datetime, serpBingOrganicLiveAdvancedResultInfo.datetime) &&
        Objects.equals(this.spell, serpBingOrganicLiveAdvancedResultInfo.spell) &&
  ...
  public String toString() {
    ...
    sb.append("class SerpBingOrganicLiveAdvancedResultInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SerpBingOrganicLiveAdvancedResultInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SerpBingOrganicLiveAdvancedResultInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SerpBingOrganicLiveAdvancedResultInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SerpBingOrganicLiveAdvancedResultInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SerpBingOrganicLiveAdvancedResultInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SerpBingOrganicLiveAdvancedResultInfo>() {
           @Override
           public void write(JsonWriter out, SerpBingOrganicLiveAdvancedResultInfo value) throws IOException {
           ...
           @Override
           public SerpBingOrganicLiveAdvancedResultInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SerpBingOrganicLiveAdvancedResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static SerpBingOrganicLiveAdvancedResultInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SerpBingOrganicLiveAdvancedResultInfo.class);
  }
