...
* action:listen_artist
  ...
  public KnowledgeGraphHotelsBookingItemSerpElementItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.rankGroup, knowledgeGraphHotelsBookingItemSerpElementItem.rankGroup) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<KnowledgeGraphHotelsBookingItemSerpElementItem>() {
           ...
           public KnowledgeGraphHotelsBookingItemSerpElementItem read(JsonReader in) throws IOException {
             ...
             KnowledgeGraphHotelsBookingItemSerpElementItem instance = thisAdapter.fromJsonTree(jsonObj);
