...
public class BacklinksDomainIntersection {
  ...
  private Map<String, BigDecimal> referringLinksTld;
  ...
  private Map<String, BigDecimal> referringLinksTypes;
  ...
  private Map<String, BigDecimal> referringLinksAttributes;
  ...
  private Map<String, BigDecimal> referringLinksPlatformTypes;
  ...
  private Map<String, BigDecimal> referringLinksSemanticLocations;
  ...
  public BacklinksDomainIntersection rank(BigDecimal rank) {
    this.rank = rank;
    return this;
  }
  ...
  public BacklinksDomainIntersection backlinks(BigDecimal backlinks) {
  ...
  public BacklinksDomainIntersection backlinksSpamScore(BigDecimal backlinksSpamScore) {
  ...
  public BacklinksDomainIntersection brokenBacklinks(BigDecimal brokenBacklinks) {
  ...
  public BacklinksDomainIntersection brokenPages(BigDecimal brokenPages) {
  ...
  public BacklinksDomainIntersection referringDomains(BigDecimal referringDomains) {
  ...
  public BacklinksDomainIntersection referringDomainsNofollow(BigDecimal referringDomainsNofollow) {
  ...
  public BacklinksDomainIntersection referringMainDomains(BigDecimal referringMainDomains) {
  ...
  public BacklinksDomainIntersection referringMainDomainsNofollow(BigDecimal referringMainDomainsNofollow) {
  ...
  public BacklinksDomainIntersection referringIps(BigDecimal referringIps) {
  ...
  public BacklinksDomainIntersection referringSubnets(BigDecimal referringSubnets) {
  ...
  public BacklinksDomainIntersection referringPages(BigDecimal referringPages) {
  ...
  public BacklinksDomainIntersection referringPagesNofollow(BigDecimal referringPagesNofollow) {
  ...
  public BacklinksDomainIntersection referringLinksTld(Map<String, BigDecimal> referringLinksTld) {
    this.referringLinksTld = referringLinksTld;
    return this;
  }

  public BacklinksDomainIntersection putReferringLinksTldItem(String key, BigDecimal referringLinksTldItem) {
   ...
   */
  @javax.annotation.Nullable
  public Map<String, BigDecimal> getReferringLinksTld() {
    return referringLinksTld;
  }

  public void setReferringLinksTld(Map<String, BigDecimal> referringLinksTld) {
    this.referringLinksTld = referringLinksTld;
  }


  public BacklinksDomainIntersection referringLinksTypes(Map<String, BigDecimal> referringLinksTypes) {
    this.referringLinksTypes = referringLinksTypes;
    return this;
  }

  public BacklinksDomainIntersection putReferringLinksTypesItem(String key, BigDecimal referringLinksTypesItem) {
   ...
   */
  @javax.annotation.Nullable
  public Map<String, BigDecimal> getReferringLinksTypes() {
    return referringLinksTypes;
  }

  public void setReferringLinksTypes(Map<String, BigDecimal> referringLinksTypes) {
    this.referringLinksTypes = referringLinksTypes;
  }


  public BacklinksDomainIntersection referringLinksAttributes(Map<String, BigDecimal> referringLinksAttributes) {
    this.referringLinksAttributes = referringLinksAttributes;
    return this;
  }

  public BacklinksDomainIntersection putReferringLinksAttributesItem(String key, BigDecimal referringLinksAttributesItem) {
   ...
   */
  @javax.annotation.Nullable
  public Map<String, BigDecimal> getReferringLinksAttributes() {
    return referringLinksAttributes;
  }

  public void setReferringLinksAttributes(Map<String, BigDecimal> referringLinksAttributes) {
    this.referringLinksAttributes = referringLinksAttributes;
  }


  public BacklinksDomainIntersection referringLinksPlatformTypes(Map<String, BigDecimal> referringLinksPlatformTypes) {
    this.referringLinksPlatformTypes = referringLinksPlatformTypes;
    return this;
  }

  public BacklinksDomainIntersection putReferringLinksPlatformTypesItem(String key, BigDecimal referringLinksPlatformTypesItem) {
   ...
   */
  @javax.annotation.Nullable
  public Map<String, BigDecimal> getReferringLinksPlatformTypes() {
    return referringLinksPlatformTypes;
  }

  public void setReferringLinksPlatformTypes(Map<String, BigDecimal> referringLinksPlatformTypes) {
    this.referringLinksPlatformTypes = referringLinksPlatformTypes;
  }


  public BacklinksDomainIntersection referringLinksSemanticLocations(Map<String, BigDecimal> referringLinksSemanticLocations) {
    this.referringLinksSemanticLocations = referringLinksSemanticLocations;
    return this;
  }

  public BacklinksDomainIntersection putReferringLinksSemanticLocationsItem(String key, BigDecimal referringLinksSemanticLocationsItem) {
   ...
   */
  @javax.annotation.Nullable
  public Map<String, BigDecimal> getReferringLinksSemanticLocations() {
    return referringLinksSemanticLocations;
  }

  public void setReferringLinksSemanticLocations(Map<String, BigDecimal> referringLinksSemanticLocations) {
    this.referringLinksSemanticLocations = referringLinksSemanticLocations;
  }
   ...
   * @return the BacklinksDomainIntersection instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, backlinksDomainIntersection.type) &&
        ...
        Objects.equals(this.additionalProperties, backlinksDomainIntersection.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BacklinksDomainIntersection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BacklinksDomainIntersection is not found in the empty JSON string", BacklinksDomainIntersection.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of BacklinksDomainIntersection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BacklinksDomainIntersection
   * @throws IOException if the JSON string is invalid with respect to BacklinksDomainIntersection
   */
  ...
  /**
   * Convert an instance of BacklinksDomainIntersection to an JSON string
   *
   * @return JSON string
   */
