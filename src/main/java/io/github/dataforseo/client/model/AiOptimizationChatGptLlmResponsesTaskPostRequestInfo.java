...
public class AiOptimizationChatGptLlmResponsesTaskPostRequestInfo  {
  ...
  public AiOptimizationChatGptLlmResponsesTaskPostRequestInfo userPrompt(String userPrompt) {
...
* you can specify up to 500 characters in the user_prompt field
  ...
  public AiOptimizationChatGptLlmResponsesTaskPostRequestInfo modelName(String modelName) {
...
* you can receive the list of available LLM models by making a separate request to the https://api.dataforseo.com/v3/ai_optimization/chat_gpt/llm_responses/models
  ...
  public AiOptimizationChatGptLlmResponsesTaskPostRequestInfo maxOutputTokens(Integer maxOutputTokens) {
...
* default value for both reasoning and non-reasoning models: 2048;
  ...
  public AiOptimizationChatGptLlmResponsesTaskPostRequestInfo temperature(Double temperature) {
...
* Note: not supported in reasoning models
  ...
  public AiOptimizationChatGptLlmResponsesTaskPostRequestInfo topP(Double topP) {
    this.topP = topP;
    return this;
  }
...
* Note: not supported in reasoning models
  ...
  public AiOptimizationChatGptLlmResponsesTaskPostRequestInfo systemMessage(String systemMessage) {
...
* you can specify up to 500 characters in the system_message field
  ...
  public AiOptimizationChatGptLlmResponsesTaskPostRequestInfo messageChain(List<LlmMessageChainItem> messageChain) {
...
* you will find the specified tag value in the data array of the response
  ...
  public AiOptimizationChatGptLlmResponsesTaskPostRequestInfo postbackUrl(String postbackUrl) {
...
* learn more on our Help Center
  ...
  public AiOptimizationChatGptLlmResponsesTaskPostRequestInfo pingbackUrl(String pingbackUrl) {
...
* learn more on our Help Center
  ...
  public AiOptimizationChatGptLlmResponsesTaskPostRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiOptimizationChatGptLlmResponsesTaskPostRequestInfo aiOptimizationChatGptLlmResponsesTaskPostRequestInfo = (AiOptimizationChatGptLlmResponsesTaskPostRequestInfo) o;
    return

        Objects.equals(this.userPrompt, aiOptimizationChatGptLlmResponsesTaskPostRequestInfo.userPrompt) &&
        Objects.equals(this.modelName, aiOptimizationChatGptLlmResponsesTaskPostRequestInfo.modelName) &&
  ...
  public String toString() {
    ...
    sb.append("class AiOptimizationChatGptLlmResponsesTaskPostRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiOptimizationChatGptLlmResponsesTaskPostRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiOptimizationChatGptLlmResponsesTaskPostRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiOptimizationChatGptLlmResponsesTaskPostRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiOptimizationChatGptLlmResponsesTaskPostRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiOptimizationChatGptLlmResponsesTaskPostRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AiOptimizationChatGptLlmResponsesTaskPostRequestInfo>() {
           @Override
           public void write(JsonWriter out, AiOptimizationChatGptLlmResponsesTaskPostRequestInfo value) throws IOException {
           ...
           @Override
           public AiOptimizationChatGptLlmResponsesTaskPostRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiOptimizationChatGptLlmResponsesTaskPostRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AiOptimizationChatGptLlmResponsesTaskPostRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiOptimizationChatGptLlmResponsesTaskPostRequestInfo.class);
  }
