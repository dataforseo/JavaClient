...
public class SerpYahooOrganicLiveHtmlRequestInfo {
   ...
   * @return the SerpYahooOrganicLiveHtmlRequestInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, serpYahooOrganicLiveHtmlRequestInfo.url) &&
        ...
        Objects.equals(this.additionalProperties, serpYahooOrganicLiveHtmlRequestInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(url, keyword, locationName, locationCode, locationCoordinate, languageName, languageCode, device, os, seDomain, depth, maxCrawlPages, searchParam, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SerpYahooOrganicLiveHtmlRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SerpYahooOrganicLiveHtmlRequestInfo is not found in the empty JSON string", SerpYahooOrganicLiveHtmlRequestInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of SerpYahooOrganicLiveHtmlRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SerpYahooOrganicLiveHtmlRequestInfo
   * @throws IOException if the JSON string is invalid with respect to SerpYahooOrganicLiveHtmlRequestInfo
   */
  ...
  /**
   * Convert an instance of SerpYahooOrganicLiveHtmlRequestInfo to an JSON string
   *
   * @return JSON string
   */
