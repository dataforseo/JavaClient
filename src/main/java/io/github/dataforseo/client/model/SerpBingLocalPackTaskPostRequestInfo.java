...
public class SerpBingLocalPackTaskPostRequestInfo {
   ...
   * @return the SerpBingLocalPackTaskPostRequestInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, serpBingLocalPackTaskPostRequestInfo.url) &&
        ...
        Objects.equals(this.additionalProperties, serpBingLocalPackTaskPostRequestInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(url, keyword, priority, locationName, locationCode, locationCoordinate, languageName, languageCode, os, depth, maxCrawlPages, searchParam, tag, postbackUrl, postbackData, pingbackUrl, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SerpBingLocalPackTaskPostRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SerpBingLocalPackTaskPostRequestInfo is not found in the empty JSON string", SerpBingLocalPackTaskPostRequestInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of SerpBingLocalPackTaskPostRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SerpBingLocalPackTaskPostRequestInfo
   * @throws IOException if the JSON string is invalid with respect to SerpBingLocalPackTaskPostRequestInfo
   */
  ...
  /**
   * Convert an instance of SerpBingLocalPackTaskPostRequestInfo to an JSON string
   *
   * @return JSON string
   */
