...
public class GoogleBusinessAnswerElement  {
  ...
  public GoogleBusinessAnswerElement putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.type, googleBusinessAnswerElement.type) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GoogleBusinessAnswerElement>() {
           ...
           public GoogleBusinessAnswerElement read(JsonReader in) throws IOException {
             ...
             GoogleBusinessAnswerElement instance = thisAdapter.fromJsonTree(jsonObj);
