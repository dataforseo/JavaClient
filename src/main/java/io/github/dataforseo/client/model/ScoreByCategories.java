...
public class ScoreByCategories {
   ...
   * @return the ScoreByCategories instance itself
   */
  public ScoreByCategories putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.overall, scoreByCategories.overall) &&
        ...
        Objects.equals(this.additionalProperties, scoreByCategories.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(overall, thingsToDo, restaurants, transit, airportAccess, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ScoreByCategories>() {
           ...
           public ScoreByCategories read(JsonReader in) throws IOException {
             ...
             ScoreByCategories instance = thisAdapter.fromJsonTree(jsonObj);
