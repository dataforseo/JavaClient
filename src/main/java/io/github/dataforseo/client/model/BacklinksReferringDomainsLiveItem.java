...
public class BacklinksReferringDomainsLiveItem  {
  ...
  public BacklinksReferringDomainsLiveItem type(String type) {
    this.type = type;
    return this;
  }
  ...
  public BacklinksReferringDomainsLiveItem domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public BacklinksReferringDomainsLiveItem rank(Integer rank) {
    this.rank = rank;
    return this;
  }
...
* learn more about the metric and how it is calculated in this help center article
  ...
  public BacklinksReferringDomainsLiveItem backlinks(Long backlinks) {
  ...
  public BacklinksReferringDomainsLiveItem firstSeen(String firstSeen) {
...
* 2019-11-15 12:57:46 +00:00
  ...
  public BacklinksReferringDomainsLiveItem lostDate(String lostDate) {
...
* 2017-01-24 13:20:59 +00:00
  ...
  public BacklinksReferringDomainsLiveItem backlinksSpamScore(Long backlinksSpamScore) {
...
* learn more about how the metric is calculated on this help center page
  ...
  public BacklinksReferringDomainsLiveItem brokenBacklinks(Long brokenBacklinks) {
...
* number of broken backlinks pointing to the domain
  ...
  public BacklinksReferringDomainsLiveItem brokenPages(Integer brokenPages) {
...
* number of pages that respond with 4xx or 5xx status codes where backlinks are pointing to
  ...
  public BacklinksReferringDomainsLiveItem referringDomains(Long referringDomains) {
...
* note that we calculate main domains (root domains, like example.com) and their subdomains (e.g. blog.example.com) separately for this metric
  ...
  public BacklinksReferringDomainsLiveItem referringDomainsNofollow(Long referringDomainsNofollow) {
  ...
  public BacklinksReferringDomainsLiveItem referringMainDomains(Long referringMainDomains) {
...
* the number of primary (root) domains referring to your target
  ...
  public BacklinksReferringDomainsLiveItem referringMainDomainsNofollow(Long referringMainDomainsNofollow) {
  ...
  public BacklinksReferringDomainsLiveItem referringIps(Long referringIps) {
...
* number of IP addresses pointing to this page
  ...
  public BacklinksReferringDomainsLiveItem referringSubnets(Long referringSubnets) {
  ...
  public BacklinksReferringDomainsLiveItem referringPages(Long referringPages) {
  ...
  public BacklinksReferringDomainsLiveItem referringPagesNofollow(Long referringPagesNofollow) {
  ...
  public BacklinksReferringDomainsLiveItem referringLinksTld(Map<String, Long> referringLinksTld) {
...
* contains top level domains and referring link count per each
  ...
  public BacklinksReferringDomainsLiveItem referringLinksTypes(Map<String, Long> referringLinksTypes) {
...
* anchor, image, link, meta, canonical, alternate, redirect
  ...
  public BacklinksReferringDomainsLiveItem referringLinksAttributes(Map<String, Long> referringLinksAttributes) {
...
* indicates link attributes of the referring links and link count per each attribute
  ...
  public BacklinksReferringDomainsLiveItem referringLinksPlatformTypes(Map<String, Long> referringLinksPlatformTypes) {
...
* possible values: cms, blogs, ecommerce, message-boards, wikis, news, organization
  ...
  public BacklinksReferringDomainsLiveItem referringLinksSemanticLocations(Map<String, Long> referringLinksSemanticLocations) {
...
* article, section, summary
  ...
  public BacklinksReferringDomainsLiveItem referringLinksCountries(Map<String, Long> referringLinksCountries) {
...
* indicates ISO country codes of the domains where the referring links are located and the link count per each country
  ...
  public BacklinksReferringDomainsLiveItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BacklinksReferringDomainsLiveItem backlinksReferringDomainsLiveItem = (BacklinksReferringDomainsLiveItem) o;
    return

        Objects.equals(this.type, backlinksReferringDomainsLiveItem.type) &&
        Objects.equals(this.domain, backlinksReferringDomainsLiveItem.domain) &&
        Objects.equals(this.rank, backlinksReferringDomainsLiveItem.rank) &&
        Objects.equals(this.backlinks, backlinksReferringDomainsLiveItem.backlinks) &&
        Objects.equals(this.firstSeen, backlinksReferringDomainsLiveItem.firstSeen) &&
        Objects.equals(this.lostDate, backlinksReferringDomainsLiveItem.lostDate) &&
        Objects.equals(this.backlinksSpamScore, backlinksReferringDomainsLiveItem.backlinksSpamScore) &&
        Objects.equals(this.brokenBacklinks, backlinksReferringDomainsLiveItem.brokenBacklinks) &&
        Objects.equals(this.brokenPages, backlinksReferringDomainsLiveItem.brokenPages) &&
        Objects.equals(this.referringDomains, backlinksReferringDomainsLiveItem.referringDomains) &&
        Objects.equals(this.referringDomainsNofollow, backlinksReferringDomainsLiveItem.referringDomainsNofollow) &&
        Objects.equals(this.referringMainDomains, backlinksReferringDomainsLiveItem.referringMainDomains) &&
        Objects.equals(this.referringMainDomainsNofollow, backlinksReferringDomainsLiveItem.referringMainDomainsNofollow) &&
        Objects.equals(this.referringIps, backlinksReferringDomainsLiveItem.referringIps) &&
        Objects.equals(this.referringSubnets, backlinksReferringDomainsLiveItem.referringSubnets) &&
        Objects.equals(this.referringPages, backlinksReferringDomainsLiveItem.referringPages) &&
        Objects.equals(this.referringPagesNofollow, backlinksReferringDomainsLiveItem.referringPagesNofollow) &&
        Objects.equals(this.referringLinksTld, backlinksReferringDomainsLiveItem.referringLinksTld) &&
        Objects.equals(this.referringLinksTypes, backlinksReferringDomainsLiveItem.referringLinksTypes) &&
        Objects.equals(this.referringLinksAttributes, backlinksReferringDomainsLiveItem.referringLinksAttributes) &&
        Objects.equals(this.referringLinksPlatformTypes, backlinksReferringDomainsLiveItem.referringLinksPlatformTypes) &&
        Objects.equals(this.referringLinksSemanticLocations, backlinksReferringDomainsLiveItem.referringLinksSemanticLocations) &&
        Objects.equals(this.referringLinksCountries, backlinksReferringDomainsLiveItem.referringLinksCountries);  
  ...
  public String toString() {
    ...
    sb.append("class BacklinksReferringDomainsLiveItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BacklinksReferringDomainsLiveItem
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BacklinksReferringDomainsLiveItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BacklinksReferringDomainsLiveItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BacklinksReferringDomainsLiveItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BacklinksReferringDomainsLiveItem.class));

       return (TypeAdapter<T>) new TypeAdapter<BacklinksReferringDomainsLiveItem>() {
           @Override
           public void write(JsonWriter out, BacklinksReferringDomainsLiveItem value) throws IOException {
           ...
           @Override
           public BacklinksReferringDomainsLiveItem read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             BacklinksReferringDomainsLiveItem instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static BacklinksReferringDomainsLiveItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BacklinksReferringDomainsLiveItem.class);
  }
