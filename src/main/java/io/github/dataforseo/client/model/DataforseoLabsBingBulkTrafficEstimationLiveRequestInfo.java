...
* you will find the specified tag value in the data object of the response
  ...
  public DataforseoLabsBingBulkTrafficEstimationLiveRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.targets, dataforseoLabsBingBulkTrafficEstimationLiveRequestInfo.targets) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DataforseoLabsBingBulkTrafficEstimationLiveRequestInfo>() {
           ...
           public DataforseoLabsBingBulkTrafficEstimationLiveRequestInfo read(JsonReader in) throws IOException {
             ...
             DataforseoLabsBingBulkTrafficEstimationLiveRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
