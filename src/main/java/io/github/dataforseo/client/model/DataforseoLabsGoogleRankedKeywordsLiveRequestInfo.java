...
public class DataforseoLabsGoogleRankedKeywordsLiveRequestInfo  {
  ...
  public DataforseoLabsGoogleRankedKeywordsLiveRequestInfo target(String target) {
    this.target = target;
    return this;
  }
  ...
  public DataforseoLabsGoogleRankedKeywordsLiveRequestInfo locationName(String locationName) {
  ...
  public DataforseoLabsGoogleRankedKeywordsLiveRequestInfo locationCode(Integer locationCode) {
  ...
  public DataforseoLabsGoogleRankedKeywordsLiveRequestInfo languageName(String languageName) {
  ...
  public DataforseoLabsGoogleRankedKeywordsLiveRequestInfo languageCode(String languageCode) {
  ...
  public DataforseoLabsGoogleRankedKeywordsLiveRequestInfo ignoreSynonyms(Boolean ignoreSynonyms) {
  ...
  public DataforseoLabsGoogleRankedKeywordsLiveRequestInfo itemTypes(List<String> itemTypes) {
    this.itemTypes = itemTypes;
    return this;
  }

  /**
   * <em>display results by item type</em><br>optional field<br>indicates the type of search results included in the response<p><strong>Note:</strong> if the <code>item_types</code> array contains item types that are different from <code>organic</code>, the results will be ordered by the first item type in the array; you will not be able to sort and filter results by the types of search results not included in the response;<p>possible values: <br><code>['organic', 'paid', 'featured_snippet', 'local_pack', 'ai_overview_reference']</code><br>default value: <br><code>['organic', 'paid']</code>
   * @return itemTypes
   */
  @javax.annotation.Nullable
  ...
  public DataforseoLabsGoogleRankedKeywordsLiveRequestInfo limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public DataforseoLabsGoogleRankedKeywordsLiveRequestInfo offset(Integer offset) {
    this.offset = offset;
    return this;
  }
  ...
  public DataforseoLabsGoogleRankedKeywordsLiveRequestInfo historicalSerpMode(String historicalSerpMode) {
    this.historicalSerpMode = historicalSerpMode;
    return this;
  }

  /**
   * <em>data collection mode</em><br>optional field<br>you can use this field to filter the results;<br>possible types of filtering:<br><code>live</code> — return keywords for which the specified <code>target</code> currently has ranking results in SERP;<br><code>lost</code> — return keywords for which the specified <code>target</code> had previously had ranking results in SERP, but didn't have them during the last check;<br><code>all</code> — return both types of keywords.<br>default value: <code>live</code>
  ...
  public DataforseoLabsGoogleRankedKeywordsLiveRequestInfo filters(List<Object> filters) {
  ...
  public DataforseoLabsGoogleRankedKeywordsLiveRequestInfo orderBy(List<String> orderBy) {
  ...
  public DataforseoLabsGoogleRankedKeywordsLiveRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public DataforseoLabsGoogleRankedKeywordsLiveRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DataforseoLabsGoogleRankedKeywordsLiveRequestInfo dataforseoLabsGoogleRankedKeywordsLiveRequestInfo = (DataforseoLabsGoogleRankedKeywordsLiveRequestInfo) o;
    return

        Objects.equals(this.target, dataforseoLabsGoogleRankedKeywordsLiveRequestInfo.target) &&
        Objects.equals(this.locationName, dataforseoLabsGoogleRankedKeywordsLiveRequestInfo.locationName) &&
        Objects.equals(this.locationCode, dataforseoLabsGoogleRankedKeywordsLiveRequestInfo.locationCode) &&
        Objects.equals(this.languageName, dataforseoLabsGoogleRankedKeywordsLiveRequestInfo.languageName) &&
        ...
        Objects.equals(this.historicalSerpMode, dataforseoLabsGoogleRankedKeywordsLiveRequestInfo.historicalSerpMode) &&
        Objects.equals(this.filters, dataforseoLabsGoogleRankedKeywordsLiveRequestInfo.filters) &&
        Objects.equals(this.orderBy, dataforseoLabsGoogleRankedKeywordsLiveRequestInfo.orderBy) &&
        Objects.equals(this.tag, dataforseoLabsGoogleRankedKeywordsLiveRequestInfo.tag);  
  ...
  public String toString() {
    ...
    sb.append("class DataforseoLabsGoogleRankedKeywordsLiveRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataforseoLabsGoogleRankedKeywordsLiveRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataforseoLabsGoogleRankedKeywordsLiveRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataforseoLabsGoogleRankedKeywordsLiveRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataforseoLabsGoogleRankedKeywordsLiveRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataforseoLabsGoogleRankedKeywordsLiveRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<DataforseoLabsGoogleRankedKeywordsLiveRequestInfo>() {
           @Override
           public void write(JsonWriter out, DataforseoLabsGoogleRankedKeywordsLiveRequestInfo value) throws IOException {
           ...
           @Override
           public DataforseoLabsGoogleRankedKeywordsLiveRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DataforseoLabsGoogleRankedKeywordsLiveRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static DataforseoLabsGoogleRankedKeywordsLiveRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataforseoLabsGoogleRankedKeywordsLiveRequestInfo.class);
  }
