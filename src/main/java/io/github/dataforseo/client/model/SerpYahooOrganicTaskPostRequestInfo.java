...
public class SerpYahooOrganicTaskPostRequestInfo  {
  ...
  public SerpYahooOrganicTaskPostRequestInfo stopCrawlOnMatch(List<SerpApiStopCrawlOnMatchInfo> stopCrawlOnMatch) {
...
* Your account will be billed per each SERP crawled through the specified targets
  ...
  /**
   * <em>postback_url datatype</em><br><strong>required field if you specify <code>postback_url</code></strong><br>corresponds to the datatype that will be sent to your server<br>possible values:<br><code>regular</code>, <code>html</code>
   * @return postbackData
   */
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.url, serpYahooOrganicTaskPostRequestInfo.url) &&
  ...
  @Override
  public int hashCode() {
  return Objects.hash(url, keyword, priority, locationName, locationCode, locationCoordinate, languageName, languageCode, device, os, seDomain, depth, maxCrawlPages, searchParam, stopCrawlOnMatch, tag, postbackUrl, postbackData, pingbackUrl);
  }
