...
public class AppDataGoogleAppReviewsTaskPostRequestInfo {
  ...
  /**
   * parsing depth optional field number of reviews to be returned in the API response; we strongly recommend setting the parsing depth in the multiples of 150, because our system processes 150 reviews in a row; default value: 150; maximum value: 100000
   * @return depth
   */
  @javax.annotation.Nullable
   ...
   * @return the AppDataGoogleAppReviewsTaskPostRequestInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.appId, appDataGoogleAppReviewsTaskPostRequestInfo.appId) &&
        ...
        Objects.equals(this.additionalProperties, appDataGoogleAppReviewsTaskPostRequestInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(appId, locationName, locationCode, languageName, languageCode, priority, depth, rating, sortBy, tag, postbackUrl, postbackData, pingbackUrl, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppDataGoogleAppReviewsTaskPostRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppDataGoogleAppReviewsTaskPostRequestInfo is not found in the empty JSON string", AppDataGoogleAppReviewsTaskPostRequestInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of AppDataGoogleAppReviewsTaskPostRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppDataGoogleAppReviewsTaskPostRequestInfo
   * @throws IOException if the JSON string is invalid with respect to AppDataGoogleAppReviewsTaskPostRequestInfo
   */
  ...
  /**
   * Convert an instance of AppDataGoogleAppReviewsTaskPostRequestInfo to an JSON string
   *
   * @return JSON string
   */
