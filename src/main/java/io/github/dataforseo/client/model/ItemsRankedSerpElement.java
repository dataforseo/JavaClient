...
public class ItemsRankedSerpElement {
  ...
  public ItemsRankedSerpElement seType(String seType) {
    this.seType = seType;
    return this;
  }
  ...
  public ItemsRankedSerpElement serpItem(AppDataAppStoreSearchOrganicSerpElementItem serpItem) {
  ...
  public ItemsRankedSerpElement checkUrl(String checkUrl) {
  ...
  public ItemsRankedSerpElement seResultsCount(String seResultsCount) {
  ...
  public ItemsRankedSerpElement lastUpdatedTime(String lastUpdatedTime) {
  ...
  public ItemsRankedSerpElement previousUpdatedTime(String previousUpdatedTime) {
   ...
   * @return the ItemsRankedSerpElement instance itself
   */
  public ItemsRankedSerpElement putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ItemsRankedSerpElement itemsRankedSerpElement = (ItemsRankedSerpElement) o;
    return Objects.equals(this.seType, itemsRankedSerpElement.seType) &&
        Objects.equals(this.serpItem, itemsRankedSerpElement.serpItem) &&
        Objects.equals(this.checkUrl, itemsRankedSerpElement.checkUrl) &&
        Objects.equals(this.seResultsCount, itemsRankedSerpElement.seResultsCount) &&
        Objects.equals(this.lastUpdatedTime, itemsRankedSerpElement.lastUpdatedTime) &&
        Objects.equals(this.previousUpdatedTime, itemsRankedSerpElement.previousUpdatedTime)&&
        Objects.equals(this.additionalProperties, itemsRankedSerpElement.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ItemsRankedSerpElement {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ItemsRankedSerpElement
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ItemsRankedSerpElement.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ItemsRankedSerpElement is not found in the empty JSON string", ItemsRankedSerpElement.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ItemsRankedSerpElement.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ItemsRankedSerpElement' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ItemsRankedSerpElement> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ItemsRankedSerpElement.class));

       return (TypeAdapter<T>) new TypeAdapter<ItemsRankedSerpElement>() {
           @Override
           public void write(JsonWriter out, ItemsRankedSerpElement value) throws IOException {
           ...
           @Override
           public ItemsRankedSerpElement read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ItemsRankedSerpElement instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of ItemsRankedSerpElement given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ItemsRankedSerpElement
   * @throws IOException if the JSON string is invalid with respect to ItemsRankedSerpElement
   */
  public static ItemsRankedSerpElement fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ItemsRankedSerpElement.class);
  }

  /**
   * Convert an instance of ItemsRankedSerpElement to an JSON string
   *
   * @return JSON string
   */
