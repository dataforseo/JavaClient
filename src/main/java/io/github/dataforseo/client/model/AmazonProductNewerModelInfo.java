...
public class AmazonProductNewerModelInfo  {
  ...
  public AmazonProductNewerModelInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.title, amazonProductNewerModelInfo.title) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AmazonProductNewerModelInfo>() {
           ...
           public AmazonProductNewerModelInfo read(JsonReader in) throws IOException {
             ...
             AmazonProductNewerModelInfo instance = thisAdapter.fromJsonTree(jsonObj);
