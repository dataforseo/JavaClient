...
public class KeywordsDataDataforseoTrendsExploreLiveRequestInfo  {
  ...
  /**
   * <em>keywords</em><br><strong>required field</strong><br>the maximum number of keywords you can specify: 5<p>learn more about rules and limitations of <code>keyword</code> and <code>keywords</code> fields in DataForSEO APIs in this <a href='https://dataforseo.com/help-center/rules-and-limitations-of-keyword-and-keywords-fields-in-dataforseo-apis' rel='noopener noreferrer' target='_blank'>Help Center article</a>
   * @return keywords
   */
  ...
  public KeywordsDataDataforseoTrendsExploreLiveRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.keywords, keywordsDataDataforseoTrendsExploreLiveRequestInfo.keywords) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<KeywordsDataDataforseoTrendsExploreLiveRequestInfo>() {
           ...
           public KeywordsDataDataforseoTrendsExploreLiveRequestInfo read(JsonReader in) throws IOException {
             ...
             KeywordsDataDataforseoTrendsExploreLiveRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
