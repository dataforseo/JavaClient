...
public class BacklinksAnchorsLiveItem  {
  ...
  /**
   * <em>date and time when our crawler found the backlink with this anchor for the first time</em><br>in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”<br>example:<br><code>2019-11-15 12:57:46 +00:00</code>
   * @return firstSeen
   */
  @javax.annotation.Nullable
  ...
  /**
   * <em>average spam score of all backlinks with this anchor</em><br>learn more about how the metric is calculated on <a href='https://dataforseo.com/help-center/what-is-spam-score-and-how-is-it-calculated' rel='noopener noreferrer' target='_blank'>this help center page</a>
  ...
  /**
   * <em>indicates the number of referring domains</em>
  ...
  /**
   * <em>indicates the number of pages pointing to <code>target</code> with this anchor</em>
  ...
  /**
   * <em>number of referring pages pointing at least one nofollow link to the <code>target</code> with this anchor</em>
  ...
  public BacklinksAnchorsLiveItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.type, backlinksAnchorsLiveItem.type) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BacklinksAnchorsLiveItem>() {
           ...
           public BacklinksAnchorsLiveItem read(JsonReader in) throws IOException {
             ...
             BacklinksAnchorsLiveItem instance = thisAdapter.fromJsonTree(jsonObj);
