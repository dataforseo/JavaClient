...
* 'message_chain': [{'role':'user','message':'Hello, what’s up?'},{'role':'ai','message':'Hello! I’m doing well, thank you. How can I assist you today?'}]
  ...
  public AiOptimizationClaudeLlmResponsesTaskPostRequestInfo useReasoning(Boolean useReasoning) {
...
* learn more on our Help Center
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.useReasoning, aiOptimizationClaudeLlmResponsesTaskPostRequestInfo.useReasoning) &&
  ...
  @Override
  public int hashCode() {
  return Objects.hash(userPrompt, modelName, maxOutputTokens, temperature, topP, webSearch, forceWebSearch, webSearchCountryIsoCode, webSearchCity, systemMessage, messageChain, useReasoning, tag, postbackUrl, pingbackUrl);
  }
