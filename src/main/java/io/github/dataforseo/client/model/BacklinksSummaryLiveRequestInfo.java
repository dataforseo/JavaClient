...
public class BacklinksSummaryLiveRequestInfo {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(target, includeSubdomains, includeIndirectLinks, excludeInternalBacklinks, internalListLimit, backlinksStatusType, backlinksFilters, tag, additionalProperties);
  }
