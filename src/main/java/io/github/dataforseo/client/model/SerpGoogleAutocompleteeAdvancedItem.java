...
public class SerpGoogleAutocompleteeAdvancedItem {
  ...
  public SerpGoogleAutocompleteeAdvancedItem type(String type) {
    this.type = type;
    return this;
  }
  ...
  public SerpGoogleAutocompleteeAdvancedItem rankGroup(Integer rankGroup) {
  ...
  public SerpGoogleAutocompleteeAdvancedItem rankAbsolute(Integer rankAbsolute) {
  ...
  public SerpGoogleAutocompleteeAdvancedItem relevance(Integer relevance) {
  ...
  public SerpGoogleAutocompleteeAdvancedItem suggestion(String suggestion) {
  ...
  public SerpGoogleAutocompleteeAdvancedItem suggestionType(String suggestionType) {
  ...
  public SerpGoogleAutocompleteeAdvancedItem searchQueryUrl(String searchQueryUrl) {
  ...
  public SerpGoogleAutocompleteeAdvancedItem thumbnailUrl(String thumbnailUrl) {
  ...
  public SerpGoogleAutocompleteeAdvancedItem highlighted(List<String> highlighted) {
    this.highlighted = highlighted;
    return this;
  }

  public SerpGoogleAutocompleteeAdvancedItem addHighlightedItem(String highlightedItem) {
   ...
   * @return the SerpGoogleAutocompleteeAdvancedItem instance itself
   */
  public SerpGoogleAutocompleteeAdvancedItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SerpGoogleAutocompleteeAdvancedItem serpGoogleAutocompleteeAdvancedItem = (SerpGoogleAutocompleteeAdvancedItem) o;
    return Objects.equals(this.type, serpGoogleAutocompleteeAdvancedItem.type) &&
        Objects.equals(this.rankGroup, serpGoogleAutocompleteeAdvancedItem.rankGroup) &&
        Objects.equals(this.rankAbsolute, serpGoogleAutocompleteeAdvancedItem.rankAbsolute) &&
        Objects.equals(this.relevance, serpGoogleAutocompleteeAdvancedItem.relevance) &&
        Objects.equals(this.suggestion, serpGoogleAutocompleteeAdvancedItem.suggestion) &&
        Objects.equals(this.suggestionType, serpGoogleAutocompleteeAdvancedItem.suggestionType) &&
        Objects.equals(this.searchQueryUrl, serpGoogleAutocompleteeAdvancedItem.searchQueryUrl) &&
        Objects.equals(this.thumbnailUrl, serpGoogleAutocompleteeAdvancedItem.thumbnailUrl) &&
        Objects.equals(this.highlighted, serpGoogleAutocompleteeAdvancedItem.highlighted)&&
        Objects.equals(this.additionalProperties, serpGoogleAutocompleteeAdvancedItem.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SerpGoogleAutocompleteeAdvancedItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SerpGoogleAutocompleteeAdvancedItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SerpGoogleAutocompleteeAdvancedItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SerpGoogleAutocompleteeAdvancedItem is not found in the empty JSON string", SerpGoogleAutocompleteeAdvancedItem.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SerpGoogleAutocompleteeAdvancedItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SerpGoogleAutocompleteeAdvancedItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SerpGoogleAutocompleteeAdvancedItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SerpGoogleAutocompleteeAdvancedItem.class));

       return (TypeAdapter<T>) new TypeAdapter<SerpGoogleAutocompleteeAdvancedItem>() {
           @Override
           public void write(JsonWriter out, SerpGoogleAutocompleteeAdvancedItem value) throws IOException {
           ...
           @Override
           public SerpGoogleAutocompleteeAdvancedItem read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SerpGoogleAutocompleteeAdvancedItem instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of SerpGoogleAutocompleteeAdvancedItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SerpGoogleAutocompleteeAdvancedItem
   * @throws IOException if the JSON string is invalid with respect to SerpGoogleAutocompleteeAdvancedItem
   */
  public static SerpGoogleAutocompleteeAdvancedItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SerpGoogleAutocompleteeAdvancedItem.class);
  }

  /**
   * Convert an instance of SerpGoogleAutocompleteeAdvancedItem to an JSON string
   *
   * @return JSON string
   */
