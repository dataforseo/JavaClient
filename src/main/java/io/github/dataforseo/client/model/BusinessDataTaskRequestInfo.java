...
public class BusinessDataTaskRequestInfo {
  ...
  public BusinessDataTaskRequestInfo keyword(String keyword) {
  ...
  public BusinessDataTaskRequestInfo priority(Integer priority) {
  ...
  public BusinessDataTaskRequestInfo locationName(String locationName) {
  ...
  public BusinessDataTaskRequestInfo locationCode(Integer locationCode) {
  ...
  public BusinessDataTaskRequestInfo locationCoordinate(String locationCoordinate) {
  ...
  public BusinessDataTaskRequestInfo languageName(String languageName) {
  ...
  public BusinessDataTaskRequestInfo languageCode(String languageCode) {
  ...
  public BusinessDataTaskRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public BusinessDataTaskRequestInfo postbackUrl(String postbackUrl) {
  ...
  public BusinessDataTaskRequestInfo pingbackUrl(String pingbackUrl) {
   ...
   * @return the BusinessDataTaskRequestInfo instance itself
   */
  public BusinessDataTaskRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BusinessDataTaskRequestInfo businessDataTaskRequestInfo = (BusinessDataTaskRequestInfo) o;
    return Objects.equals(this.keyword, businessDataTaskRequestInfo.keyword) &&
        Objects.equals(this.priority, businessDataTaskRequestInfo.priority) &&
        Objects.equals(this.locationName, businessDataTaskRequestInfo.locationName) &&
        Objects.equals(this.locationCode, businessDataTaskRequestInfo.locationCode) &&
        Objects.equals(this.locationCoordinate, businessDataTaskRequestInfo.locationCoordinate) &&
        Objects.equals(this.languageName, businessDataTaskRequestInfo.languageName) &&
        Objects.equals(this.languageCode, businessDataTaskRequestInfo.languageCode) &&
        Objects.equals(this.tag, businessDataTaskRequestInfo.tag) &&
        Objects.equals(this.postbackUrl, businessDataTaskRequestInfo.postbackUrl) &&
        Objects.equals(this.pingbackUrl, businessDataTaskRequestInfo.pingbackUrl)&&
        Objects.equals(this.additionalProperties, businessDataTaskRequestInfo.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BusinessDataTaskRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BusinessDataTaskRequestInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BusinessDataTaskRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BusinessDataTaskRequestInfo is not found in the empty JSON string", BusinessDataTaskRequestInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BusinessDataTaskRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BusinessDataTaskRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BusinessDataTaskRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BusinessDataTaskRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<BusinessDataTaskRequestInfo>() {
           @Override
           public void write(JsonWriter out, BusinessDataTaskRequestInfo value) throws IOException {
           ...
           @Override
           public BusinessDataTaskRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             BusinessDataTaskRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of BusinessDataTaskRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BusinessDataTaskRequestInfo
   * @throws IOException if the JSON string is invalid with respect to BusinessDataTaskRequestInfo
   */
  public static BusinessDataTaskRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BusinessDataTaskRequestInfo.class);
  }

  /**
   * Convert an instance of BusinessDataTaskRequestInfo to an JSON string
   *
   * @return JSON string
   */
