...
public class BacklinksDomainIntersectionInfo {
  ...
  public BacklinksDomainIntersectionInfo type(String type) {
    this.type = type;
    return this;
  }
  ...
  public BacklinksDomainIntersectionInfo target(String target) {
    this.target = target;
    return this;
  }
  ...
  public BacklinksDomainIntersectionInfo rank(Integer rank) {
    this.rank = rank;
    return this;
  }
  ...
  public BacklinksDomainIntersectionInfo backlinks(Long backlinks) {
  ...
  public BacklinksDomainIntersectionInfo firstSeen(String firstSeen) {
  ...
  public BacklinksDomainIntersectionInfo lostDate(Integer lostDate) {
  ...
  public BacklinksDomainIntersectionInfo backlinksSpamScore(Long backlinksSpamScore) {
    this.backlinksSpamScore = backlinksSpamScore;
    return this;
  }

  /**
   * average spam score of the backlinks pointing to the target learn more about how the metric is calculated on this help center page
  ...
  public BacklinksDomainIntersectionInfo brokenBacklinks(Long brokenBacklinks) {
  ...
  public BacklinksDomainIntersectionInfo brokenPages(Integer brokenPages) {
  ...
  public BacklinksDomainIntersectionInfo referringDomains(Long referringDomains) {
  ...
  public BacklinksDomainIntersectionInfo referringDomainsNofollow(Long referringDomainsNofollow) {
  ...
  public BacklinksDomainIntersectionInfo referringMainDomains(Long referringMainDomains) {
  ...
  public BacklinksDomainIntersectionInfo referringMainDomainsNofollow(Long referringMainDomainsNofollow) {
  ...
  public BacklinksDomainIntersectionInfo referringIps(Long referringIps) {
  ...
  public BacklinksDomainIntersectionInfo referringSubnets(Long referringSubnets) {
  ...
  public BacklinksDomainIntersectionInfo referringPages(Long referringPages) {
  ...
  public BacklinksDomainIntersectionInfo referringPagesNofollow(Long referringPagesNofollow) {
  ...
  public BacklinksDomainIntersectionInfo referringLinksTld(Map<String, Long> referringLinksTld) {
    this.referringLinksTld = referringLinksTld;
    return this;
  }

  public BacklinksDomainIntersectionInfo putReferringLinksTldItem(String key, Long referringLinksTldItem) {
  ...
  public BacklinksDomainIntersectionInfo referringLinksTypes(Map<String, Long> referringLinksTypes) {
    this.referringLinksTypes = referringLinksTypes;
    return this;
  }

  public BacklinksDomainIntersectionInfo putReferringLinksTypesItem(String key, Long referringLinksTypesItem) {
  ...
  public BacklinksDomainIntersectionInfo referringLinksAttributes(Map<String, Long> referringLinksAttributes) {
    this.referringLinksAttributes = referringLinksAttributes;
    return this;
  }

  public BacklinksDomainIntersectionInfo putReferringLinksAttributesItem(String key, Long referringLinksAttributesItem) {
  ...
  public BacklinksDomainIntersectionInfo referringLinksPlatformTypes(Map<String, Long> referringLinksPlatformTypes) {
    this.referringLinksPlatformTypes = referringLinksPlatformTypes;
    return this;
  }

  public BacklinksDomainIntersectionInfo putReferringLinksPlatformTypesItem(String key, Long referringLinksPlatformTypesItem) {
  ...
  /**
   * types of referring platforms indicates referring platform types and link count per each platform
  ...
  public BacklinksDomainIntersectionInfo referringLinksSemanticLocations(Map<String, Long> referringLinksSemanticLocations) {
    this.referringLinksSemanticLocations = referringLinksSemanticLocations;
    return this;
  }

  public BacklinksDomainIntersectionInfo putReferringLinksSemanticLocationsItem(String key, Long referringLinksSemanticLocationsItem) {
  ...
  /**
   * semantic locations of the referring links indicates semantic elements in HTML where the referring links are located and the link count per each semantic location you can get the full list of semantic elements here
  ...
  public BacklinksDomainIntersectionInfo referringLinksCountries(Map<String, Long> referringLinksCountries) {
    this.referringLinksCountries = referringLinksCountries;
    return this;
  }

  public BacklinksDomainIntersectionInfo putReferringLinksCountriesItem(String key, Long referringLinksCountriesItem) {
   ...
   * @return the BacklinksDomainIntersectionInfo instance itself
   */
  public BacklinksDomainIntersectionInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BacklinksDomainIntersectionInfo backlinksDomainIntersectionInfo = (BacklinksDomainIntersectionInfo) o;
    return Objects.equals(this.type, backlinksDomainIntersectionInfo.type) &&
        Objects.equals(this.target, backlinksDomainIntersectionInfo.target) &&
        Objects.equals(this.rank, backlinksDomainIntersectionInfo.rank) &&
        Objects.equals(this.backlinks, backlinksDomainIntersectionInfo.backlinks) &&
        Objects.equals(this.firstSeen, backlinksDomainIntersectionInfo.firstSeen) &&
        Objects.equals(this.lostDate, backlinksDomainIntersectionInfo.lostDate) &&
        Objects.equals(this.backlinksSpamScore, backlinksDomainIntersectionInfo.backlinksSpamScore) &&
        Objects.equals(this.brokenBacklinks, backlinksDomainIntersectionInfo.brokenBacklinks) &&
        Objects.equals(this.brokenPages, backlinksDomainIntersectionInfo.brokenPages) &&
        Objects.equals(this.referringDomains, backlinksDomainIntersectionInfo.referringDomains) &&
        Objects.equals(this.referringDomainsNofollow, backlinksDomainIntersectionInfo.referringDomainsNofollow) &&
        Objects.equals(this.referringMainDomains, backlinksDomainIntersectionInfo.referringMainDomains) &&
        Objects.equals(this.referringMainDomainsNofollow, backlinksDomainIntersectionInfo.referringMainDomainsNofollow) &&
        Objects.equals(this.referringIps, backlinksDomainIntersectionInfo.referringIps) &&
        Objects.equals(this.referringSubnets, backlinksDomainIntersectionInfo.referringSubnets) &&
        Objects.equals(this.referringPages, backlinksDomainIntersectionInfo.referringPages) &&
        Objects.equals(this.referringPagesNofollow, backlinksDomainIntersectionInfo.referringPagesNofollow) &&
        Objects.equals(this.referringLinksTld, backlinksDomainIntersectionInfo.referringLinksTld) &&
        Objects.equals(this.referringLinksTypes, backlinksDomainIntersectionInfo.referringLinksTypes) &&
        Objects.equals(this.referringLinksAttributes, backlinksDomainIntersectionInfo.referringLinksAttributes) &&
        Objects.equals(this.referringLinksPlatformTypes, backlinksDomainIntersectionInfo.referringLinksPlatformTypes) &&
        Objects.equals(this.referringLinksSemanticLocations, backlinksDomainIntersectionInfo.referringLinksSemanticLocations) &&
        Objects.equals(this.referringLinksCountries, backlinksDomainIntersectionInfo.referringLinksCountries)&&
        Objects.equals(this.additionalProperties, backlinksDomainIntersectionInfo.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BacklinksDomainIntersectionInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BacklinksDomainIntersectionInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BacklinksDomainIntersectionInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BacklinksDomainIntersectionInfo is not found in the empty JSON string", BacklinksDomainIntersectionInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BacklinksDomainIntersectionInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BacklinksDomainIntersectionInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BacklinksDomainIntersectionInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BacklinksDomainIntersectionInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<BacklinksDomainIntersectionInfo>() {
           @Override
           public void write(JsonWriter out, BacklinksDomainIntersectionInfo value) throws IOException {
           ...
           @Override
           public BacklinksDomainIntersectionInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             BacklinksDomainIntersectionInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of BacklinksDomainIntersectionInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BacklinksDomainIntersectionInfo
   * @throws IOException if the JSON string is invalid with respect to BacklinksDomainIntersectionInfo
   */
  public static BacklinksDomainIntersectionInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BacklinksDomainIntersectionInfo.class);
  }

  /**
   * Convert an instance of BacklinksDomainIntersectionInfo to an JSON string
   *
   * @return JSON string
   */
