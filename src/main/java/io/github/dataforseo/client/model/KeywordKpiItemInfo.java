...
public class KeywordKpiItemInfo  {
  ...
  public KeywordKpiItemInfo adPosition(String adPosition) {
...
* MainLine4: The fourth ad to appear at the top of the search results page
  ...
  public KeywordKpiItemInfo clicks(Integer clicks) {
    this.clicks = clicks;
    return this;
  }
...
* the number of clicks that the keyword and match type generated during the last month
  ...
  public KeywordKpiItemInfo impressions(Integer impressions) {
...
* the number of impressions that the keyword and match type generated during the last month
  ...
  public KeywordKpiItemInfo averageCpc(Double averageCpc) {
...
* calculated by dividing the cost of all clicks by the number of clicks
  ...
  public KeywordKpiItemInfo ctr(Double ctr) {
    this.ctr = ctr;
    return this;
  }
...
* calculated by dividing the number of clicks by the number of impressions and multiplying the result by 100
  ...
  public KeywordKpiItemInfo totalCost(Double totalCost) {
...
* the cost of using the specified keyword and match type during the last month
  ...
  public KeywordKpiItemInfo averageBid(Double averageBid) {
  ...
  public KeywordKpiItemInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    KeywordKpiItemInfo keywordKpiItemInfo = (KeywordKpiItemInfo) o;
    return

        Objects.equals(this.adPosition, keywordKpiItemInfo.adPosition) &&
        Objects.equals(this.clicks, keywordKpiItemInfo.clicks) &&
        Objects.equals(this.impressions, keywordKpiItemInfo.impressions) &&
        Objects.equals(this.averageCpc, keywordKpiItemInfo.averageCpc) &&
        Objects.equals(this.ctr, keywordKpiItemInfo.ctr) &&
        Objects.equals(this.totalCost, keywordKpiItemInfo.totalCost) &&
        Objects.equals(this.averageBid, keywordKpiItemInfo.averageBid);  
  ...
  public String toString() {
    ...
    sb.append("class KeywordKpiItemInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to KeywordKpiItemInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KeywordKpiItemInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KeywordKpiItemInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KeywordKpiItemInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KeywordKpiItemInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<KeywordKpiItemInfo>() {
           @Override
           public void write(JsonWriter out, KeywordKpiItemInfo value) throws IOException {
           ...
           @Override
           public KeywordKpiItemInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             KeywordKpiItemInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static KeywordKpiItemInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KeywordKpiItemInfo.class);
  }
