...
public class SerpGoogleLiteTaskPostRequestInfo  {
  ...
  public SerpGoogleLiteTaskPostRequestInfo keyword(String keyword) {
...
* learn more about rules and limitations of keyword and keywords fields in DataForSEO APIs in this Help Center article
  ...
  public SerpGoogleLiteTaskPostRequestInfo url(String url) {
    this.url = url;
    return this;
  }
...
* https://www.google.co.uk/search?q=%20rank%20tracker%20api&hl=en&gl=GB&uule=w+CAIQIFISCXXeIa8LoNhHEZkq1d1aOpZS
  ...
  public SerpGoogleLiteTaskPostRequestInfo priority(Integer priority) {
...
* The cost can be calculated on the Pricing page.
  ...
  public SerpGoogleLiteTaskPostRequestInfo depth(Integer depth) {
    this.depth = depth;
    return this;
  }
...
* The cost can be calculated on the Pricing page.
  ...
  public SerpGoogleLiteTaskPostRequestInfo maxCrawlPages(Integer maxCrawlPages) {
...
* learn more at our help center
  ...
  public SerpGoogleLiteTaskPostRequestInfo locationName(String locationName) {
...
* London,England,United Kingdom
  ...
  public SerpGoogleLiteTaskPostRequestInfo locationCode(Integer locationCode) {
...
* 2840
  ...
  public SerpGoogleLiteTaskPostRequestInfo locationCoordinate(String locationCoordinate) {
...
* 53.476225,-2.243572,200
  ...
  public SerpGoogleLiteTaskPostRequestInfo languageName(String languageName) {
...
* English
  ...
  public SerpGoogleLiteTaskPostRequestInfo languageCode(String languageCode) {
...
* en
  ...
  public SerpGoogleLiteTaskPostRequestInfo seDomain(String seDomain) {
...
* google.co.uk, google.com.au, google.de, etc.
  ...
  public SerpGoogleLiteTaskPostRequestInfo device(String device) {
    this.device = device;
    return this;
  }
...
* default value: desktop
  ...
  public SerpGoogleLiteTaskPostRequestInfo os(String os) {
    this.os = os;
    return this;
  }
...
* default value: android
  ...
  public SerpGoogleLiteTaskPostRequestInfo calculateRectangles(Boolean calculateRectangles) {
...
* Note: you will be charged extra $0.0006 for using this parameter
  ...
  public SerpGoogleLiteTaskPostRequestInfo browserScreenWidth(Long browserScreenWidth) {
...
* Note: to use this parameter, set calculate_rectangles to true
  ...
  public SerpGoogleLiteTaskPostRequestInfo browserScreenHeight(Integer browserScreenHeight) {
...
* Note: to use this parameter, set calculate_rectangles to true
  ...
  public SerpGoogleLiteTaskPostRequestInfo browserScreenResolutionRatio(Integer browserScreenResolutionRatio) {
...
* Note: to use this parameter, set calculate_rectangles to true
  ...
  public SerpGoogleLiteTaskPostRequestInfo searchParam(String searchParam) {
...
* get the list of available parameters and additional details here
  ...
  public SerpGoogleLiteTaskPostRequestInfo removeFromUrl(List<String> removeFromUrl) {
...
* 'remove_from_url': ['srsltid']
  ...
  public SerpGoogleLiteTaskPostRequestInfo stopCrawlOnMatch(List<String> stopCrawlOnMatch) {
...
* Your account will be billed per each SERP crawled through the specified targets;
  ...
  public SerpGoogleLiteTaskPostRequestInfo matchValue(String matchValue) {
...
* example: dataforseo.com
  ...
  public SerpGoogleLiteTaskPostRequestInfo matchType(List<String> matchType) {
...
* possible values: domain, with_subdomains, wildcard
  ...
  public SerpGoogleLiteTaskPostRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
...
* you will find the specified tag value in the data object of the response
  ...
  public SerpGoogleLiteTaskPostRequestInfo postbackUrl(String postbackUrl) {
...
* learn more on our Help Center
  ...
  public SerpGoogleLiteTaskPostRequestInfo postbackData(String postbackData) {
...
* advanced, html
  ...
  public SerpGoogleLiteTaskPostRequestInfo pingbackUrl(String pingbackUrl) {
...
* learn more on our Help Center
  ...
  public SerpGoogleLiteTaskPostRequestInfo() {
  }
  ...
  public SerpGoogleLiteTaskPostRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SerpGoogleLiteTaskPostRequestInfo serpGoogleLiteTaskPostRequestInfo = (SerpGoogleLiteTaskPostRequestInfo) o;
    return

        Objects.equals(this.keyword, serpGoogleLiteTaskPostRequestInfo.keyword) &&
        Objects.equals(this.url, serpGoogleLiteTaskPostRequestInfo.url) &&
        Objects.equals(this.priority, serpGoogleLiteTaskPostRequestInfo.priority) &&
        Objects.equals(this.depth, serpGoogleLiteTaskPostRequestInfo.depth) &&
        Objects.equals(this.maxCrawlPages, serpGoogleLiteTaskPostRequestInfo.maxCrawlPages) &&
        Objects.equals(this.locationName, serpGoogleLiteTaskPostRequestInfo.locationName) &&
        Objects.equals(this.locationCode, serpGoogleLiteTaskPostRequestInfo.locationCode) &&
        Objects.equals(this.locationCoordinate, serpGoogleLiteTaskPostRequestInfo.locationCoordinate) &&
        Objects.equals(this.languageName, serpGoogleLiteTaskPostRequestInfo.languageName) &&
        Objects.equals(this.languageCode, serpGoogleLiteTaskPostRequestInfo.languageCode) &&
        Objects.equals(this.seDomain, serpGoogleLiteTaskPostRequestInfo.seDomain) &&
        Objects.equals(this.device, serpGoogleLiteTaskPostRequestInfo.device) &&
        Objects.equals(this.os, serpGoogleLiteTaskPostRequestInfo.os) &&
        Objects.equals(this.calculateRectangles, serpGoogleLiteTaskPostRequestInfo.calculateRectangles) &&
        Objects.equals(this.browserScreenWidth, serpGoogleLiteTaskPostRequestInfo.browserScreenWidth) &&
        Objects.equals(this.browserScreenHeight, serpGoogleLiteTaskPostRequestInfo.browserScreenHeight) &&
        Objects.equals(this.browserScreenResolutionRatio, serpGoogleLiteTaskPostRequestInfo.browserScreenResolutionRatio) &&
        Objects.equals(this.searchParam, serpGoogleLiteTaskPostRequestInfo.searchParam) &&
        Objects.equals(this.removeFromUrl, serpGoogleLiteTaskPostRequestInfo.removeFromUrl) &&
        Objects.equals(this.stopCrawlOnMatch, serpGoogleLiteTaskPostRequestInfo.stopCrawlOnMatch) &&
        Objects.equals(this.matchValue, serpGoogleLiteTaskPostRequestInfo.matchValue) &&
        Objects.equals(this.matchType, serpGoogleLiteTaskPostRequestInfo.matchType) &&
        Objects.equals(this.tag, serpGoogleLiteTaskPostRequestInfo.tag) &&
        Objects.equals(this.postbackUrl, serpGoogleLiteTaskPostRequestInfo.postbackUrl) &&
        Objects.equals(this.postbackData, serpGoogleLiteTaskPostRequestInfo.postbackData) &&
        Objects.equals(this.pingbackUrl, serpGoogleLiteTaskPostRequestInfo.pingbackUrl);  
  ...
  @Override
  public int hashCode() {
  return Objects.hash(keyword, url, priority, depth, maxCrawlPages, locationName, locationCode, locationCoordinate, languageName, languageCode, seDomain, device, os, calculateRectangles, browserScreenWidth, browserScreenHeight, browserScreenResolutionRatio, searchParam, removeFromUrl, stopCrawlOnMatch, matchValue, matchType, tag, postbackUrl, postbackData, pingbackUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class SerpGoogleLiteTaskPostRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SerpGoogleLiteTaskPostRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SerpGoogleLiteTaskPostRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SerpGoogleLiteTaskPostRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SerpGoogleLiteTaskPostRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SerpGoogleLiteTaskPostRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SerpGoogleLiteTaskPostRequestInfo>() {
           @Override
           public void write(JsonWriter out, SerpGoogleLiteTaskPostRequestInfo value) throws IOException {
           ...
           @Override
           public SerpGoogleLiteTaskPostRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SerpGoogleLiteTaskPostRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static SerpGoogleLiteTaskPostRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SerpGoogleLiteTaskPostRequestInfo.class);
  }
