...
public class AppendixBusinessDataDayLimitsRatesDataInfo  {
  ...
  public AppendixBusinessDataDayLimitsRatesDataInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.reviews, appendixBusinessDataDayLimitsRatesDataInfo.reviews) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AppendixBusinessDataDayLimitsRatesDataInfo>() {
           ...
           public AppendixBusinessDataDayLimitsRatesDataInfo read(JsonReader in) throws IOException {
             ...
             AppendixBusinessDataDayLimitsRatesDataInfo instance = thisAdapter.fromJsonTree(jsonObj);
