...
public class AppendixBusinessDataDayStatisticsMoneyData {
  ...
  public AppendixBusinessDataDayStatisticsMoneyData google(AppendixBusinessDataGoogleInfo google) {
    this.google = google;
    return this;
  }
  ...
  public AppendixBusinessDataDayStatisticsMoneyData locations(Double locations) {
  ...
  public AppendixBusinessDataDayStatisticsMoneyData languages(Double languages) {
  ...
  public AppendixBusinessDataDayStatisticsMoneyData errors(Double errors) {
    this.errors = errors;
    return this;
  }
  ...
  public AppendixBusinessDataDayStatisticsMoneyData yelp(AppendixBusinessDataDayLimitsRatesDataInfo yelp) {
    this.yelp = yelp;
    return this;
  }
  ...
  public AppendixBusinessDataDayStatisticsMoneyData socialMedia(AppendixSocialMediaBusinessDataLimitsRatesDataInfo socialMedia) {
  ...
  public AppendixBusinessDataDayStatisticsMoneyData tripadvisor(AppendixBusinessDataDayLimitsRatesDataInfo tripadvisor) {
  ...
  public AppendixBusinessDataDayStatisticsMoneyData trustpilot(AppendixBusinessDataDayLimitsRatesDataInfo trustpilot) {
  ...
  public AppendixBusinessDataDayStatisticsMoneyData businessListings(AppendixBusinessListingsBusinessDataLimitsRatesDataInfo businessListings) {
  ...
  public AppendixBusinessDataDayStatisticsMoneyData tasksReady(Double tasksReady) {
  ...
  public AppendixBusinessDataDayStatisticsMoneyData refundMoney(Double refundMoney) {
   ...
   * @return the AppendixBusinessDataDayStatisticsMoneyData instance itself
   */
  public AppendixBusinessDataDayStatisticsMoneyData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AppendixBusinessDataDayStatisticsMoneyData appendixBusinessDataDayStatisticsMoneyData = (AppendixBusinessDataDayStatisticsMoneyData) o;
    return Objects.equals(this.google, appendixBusinessDataDayStatisticsMoneyData.google) &&
        Objects.equals(this.locations, appendixBusinessDataDayStatisticsMoneyData.locations) &&
        Objects.equals(this.languages, appendixBusinessDataDayStatisticsMoneyData.languages) &&
        Objects.equals(this.errors, appendixBusinessDataDayStatisticsMoneyData.errors) &&
        Objects.equals(this.yelp, appendixBusinessDataDayStatisticsMoneyData.yelp) &&
        Objects.equals(this.socialMedia, appendixBusinessDataDayStatisticsMoneyData.socialMedia) &&
        Objects.equals(this.tripadvisor, appendixBusinessDataDayStatisticsMoneyData.tripadvisor) &&
        Objects.equals(this.trustpilot, appendixBusinessDataDayStatisticsMoneyData.trustpilot) &&
        Objects.equals(this.businessListings, appendixBusinessDataDayStatisticsMoneyData.businessListings) &&
        Objects.equals(this.tasksReady, appendixBusinessDataDayStatisticsMoneyData.tasksReady) &&
        Objects.equals(this.refundMoney, appendixBusinessDataDayStatisticsMoneyData.refundMoney)&&
        Objects.equals(this.additionalProperties, appendixBusinessDataDayStatisticsMoneyData.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppendixBusinessDataDayStatisticsMoneyData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppendixBusinessDataDayStatisticsMoneyData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppendixBusinessDataDayStatisticsMoneyData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppendixBusinessDataDayStatisticsMoneyData is not found in the empty JSON string", AppendixBusinessDataDayStatisticsMoneyData.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppendixBusinessDataDayStatisticsMoneyData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppendixBusinessDataDayStatisticsMoneyData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppendixBusinessDataDayStatisticsMoneyData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppendixBusinessDataDayStatisticsMoneyData.class));

       return (TypeAdapter<T>) new TypeAdapter<AppendixBusinessDataDayStatisticsMoneyData>() {
           @Override
           public void write(JsonWriter out, AppendixBusinessDataDayStatisticsMoneyData value) throws IOException {
           ...
           @Override
           public AppendixBusinessDataDayStatisticsMoneyData read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AppendixBusinessDataDayStatisticsMoneyData instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AppendixBusinessDataDayStatisticsMoneyData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppendixBusinessDataDayStatisticsMoneyData
   * @throws IOException if the JSON string is invalid with respect to AppendixBusinessDataDayStatisticsMoneyData
   */
  public static AppendixBusinessDataDayStatisticsMoneyData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppendixBusinessDataDayStatisticsMoneyData.class);
  }

  /**
   * Convert an instance of AppendixBusinessDataDayStatisticsMoneyData to an JSON string
   *
   * @return JSON string
   */
