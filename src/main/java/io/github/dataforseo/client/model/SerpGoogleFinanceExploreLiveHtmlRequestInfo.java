...
public class SerpGoogleFinanceExploreLiveHtmlRequestInfo  {
  ...
  /**
   * <p><em>financial news filters</em><p>optional field<p>possible values: <code>top_stories</code>, <code>local_market</code>, <code>world_markets</code><p>default value: <code>top_stories</code></p>
   * @return newsType
   */
  @javax.annotation.Nullable
