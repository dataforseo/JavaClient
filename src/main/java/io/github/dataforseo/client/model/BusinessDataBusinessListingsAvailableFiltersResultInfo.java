...
public class BusinessDataBusinessListingsAvailableFiltersResultInfo  {
  ...
  public BusinessDataBusinessListingsAvailableFiltersResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.search, businessDataBusinessListingsAvailableFiltersResultInfo.search) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BusinessDataBusinessListingsAvailableFiltersResultInfo>() {
           ...
           public BusinessDataBusinessListingsAvailableFiltersResultInfo read(JsonReader in) throws IOException {
             ...
             BusinessDataBusinessListingsAvailableFiltersResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
