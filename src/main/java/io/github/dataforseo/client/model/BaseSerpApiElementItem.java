...
public class BaseSerpApiElementItem  {
  ...
  public BaseSerpApiElementItem type(String type) {
    this.type = type;
    return this;
  }
...
* indicates the number of the SERP page on which the element is located
  ...
  public BaseSerpApiElementItem position(String position) {
...
* left, right
  ...
  public BaseSerpApiElementItem xpath(String xpath) {
    this.xpath = xpath;
    return this;
  }
...
* equals null if calculate_rectangles in the POST request is not set to true
  ...
  public boolean equals(Object o) {
    ...
    BaseSerpApiElementItem baseSerpApiElementItem = (BaseSerpApiElementItem) o;
    return
  ...
  public static BaseSerpApiElementItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BaseSerpApiElementItem.class);
  }
