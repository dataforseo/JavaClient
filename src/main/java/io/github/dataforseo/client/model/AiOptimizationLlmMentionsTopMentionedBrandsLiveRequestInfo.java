...
public class AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo  {
  ...
  public AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo target(List<BaseAiOptimizationLLmMentionsTargetElement> target) {
    this.target = target;
    return this;
  }
...
* target array with a domain entity
  ...
  public AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo locationName(String locationName) {
  ...
  public AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo locationCode(Integer locationCode) {
  ...
  public AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo languageName(String languageName) {
  ...
  public AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo languageCode(String languageCode) {
  ...
  public AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo platform(String platform) {
  ...
  public AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo filters(List<Object> filters) {
  ...
  public AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo initialDatasetFilters(List<Object> initialDatasetFilters) {
  ...
  public AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo internalListLimit(Integer internalListLimit) {
  ...
  public AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo orderBy(List<String> orderBy) {
  ...
  public AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo offset(Integer offset) {
    this.offset = offset;
    return this;
  }
  ...
  public AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo includeBrands(List<String> includeBrands) {
    this.includeBrands = includeBrands;
    return this;
  }

  /**
   * <em>array of brands to include in the response</em><br>optional field<br>if specified, only the listed brands will be returned in the <code>items</code> array<br>example:<br><code>'include_brands': ['Audi']</code>
  ...
  public AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo excludeBrands(List<String> excludeBrands) {
    this.excludeBrands = excludeBrands;
    return this;
  }

  /**
   * <em>array of brands to exclude from the response</em><br>optional field<br>if specified, the listed brands will be omitted from the <code>items</code> array<br>example:<br><code>'exclude_brands': ['Audi']</code>
  ...
  public AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo() {
  }
  ...
  public AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo aiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo = (AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo) o;
    return

        Objects.equals(this.target, aiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo.target) &&
        Objects.equals(this.locationName, aiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo.locationName) &&
        Objects.equals(this.locationCode, aiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo.locationCode) &&
        Objects.equals(this.languageName, aiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo.languageName) &&
        Objects.equals(this.languageCode, aiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo.languageCode) &&
        Objects.equals(this.platform, aiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo.platform) &&
        Objects.equals(this.filters, aiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo.filters) &&
        Objects.equals(this.initialDatasetFilters, aiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo.initialDatasetFilters) &&
        Objects.equals(this.limit, aiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo.limit) &&
        Objects.equals(this.internalListLimit, aiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo.internalListLimit) &&
        Objects.equals(this.orderBy, aiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo.orderBy) &&
        Objects.equals(this.offset, aiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo.offset) &&
        Objects.equals(this.includeBrands, aiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo.includeBrands) &&
        Objects.equals(this.excludeBrands, aiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo.excludeBrands) &&
        Objects.equals(this.tag, aiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo.tag);  
  ...
  public String toString() {
    ...
    sb.append("class AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo>() {
           @Override
           public void write(JsonWriter out, AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo value) throws IOException {
           ...
           @Override
           public AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo.class);
  }
