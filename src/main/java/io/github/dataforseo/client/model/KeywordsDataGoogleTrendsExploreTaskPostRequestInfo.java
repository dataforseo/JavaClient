...
public class KeywordsDataGoogleTrendsExploreTaskPostRequestInfo {
  ...
  public KeywordsDataGoogleTrendsExploreTaskPostRequestInfo addKeywordsItem(String keywordsItem) {
  ...
  /**
   * keywords required field the maximum number of keywords you can specify: 5 the minimum number of symbols must be greater than 1 comma characters (,) in the specified keywords will be unset and ignored Note: keywords cannot consist of a combination of the following characters: &lt; &gt; | \\ \&quot; - + &#x3D; ~ ! : * ( ) [ ] { } Note: to obtain google_trends_topics_list and google_trends_queries_list items, specify no more than 1 keyword learn more about rules and limitations of keyword and keywords fields in DataForSEO APIs in this Help Center article
   * @return keywords
   */
  ...
  public KeywordsDataGoogleTrendsExploreTaskPostRequestInfo locationName(List<String> locationName) {
    this.locationName = locationName;
    return this;
  }

  public KeywordsDataGoogleTrendsExploreTaskPostRequestInfo addLocationNameItem(String locationNameItem) {
  ...
  public KeywordsDataGoogleTrendsExploreTaskPostRequestInfo locationCode(List<Integer> locationCode) {
    this.locationCode = locationCode;
    return this;
  }

  public KeywordsDataGoogleTrendsExploreTaskPostRequestInfo addLocationCodeItem(Integer locationCodeItem) {
  ...
  public KeywordsDataGoogleTrendsExploreTaskPostRequestInfo addItemTypesItem(String itemTypesItem) {
   ...
   * @return the KeywordsDataGoogleTrendsExploreTaskPostRequestInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keywords, keywordsDataGoogleTrendsExploreTaskPostRequestInfo.keywords) &&
        ...
        Objects.equals(this.additionalProperties, keywordsDataGoogleTrendsExploreTaskPostRequestInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keywords, locationName, locationCode, languageName, languageCode, type, categoryCode, dateFrom, dateTo, timeRange, itemTypes, postbackUrl, pingbackUrl, tag, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KeywordsDataGoogleTrendsExploreTaskPostRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KeywordsDataGoogleTrendsExploreTaskPostRequestInfo is not found in the empty JSON string", KeywordsDataGoogleTrendsExploreTaskPostRequestInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of KeywordsDataGoogleTrendsExploreTaskPostRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of KeywordsDataGoogleTrendsExploreTaskPostRequestInfo
   * @throws IOException if the JSON string is invalid with respect to KeywordsDataGoogleTrendsExploreTaskPostRequestInfo
   */
  ...
  /**
   * Convert an instance of KeywordsDataGoogleTrendsExploreTaskPostRequestInfo to an JSON string
   *
   * @return JSON string
   */
