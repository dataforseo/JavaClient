...
public class HotelInfoPriceOffer {
  ...
  public HotelInfoPriceOffer addOfferImagesItem(String offerImagesItem) {
   ...
   * @return the HotelInfoPriceOffer instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, hotelInfoPriceOffer.type) &&
        ...
        Objects.equals(this.additionalProperties, hotelInfoPriceOffer.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, title, price, currency, url, maxVisitors, offerImages, freeCancellationUntil, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HotelInfoPriceOffer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HotelInfoPriceOffer is not found in the empty JSON string", HotelInfoPriceOffer.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("offer_images") != null && !jsonObj.get("offer_images").isJsonNull() && !jsonObj.get("offer_images").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `offer_images` to be an array in the JSON string but got `%s`", jsonObj.get("offer_images").toString()));
      }
  ...
  /**
   * Create an instance of HotelInfoPriceOffer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HotelInfoPriceOffer
   * @throws IOException if the JSON string is invalid with respect to HotelInfoPriceOffer
   */
  ...
  /**
   * Convert an instance of HotelInfoPriceOffer to an JSON string
   *
   * @return JSON string
   */
