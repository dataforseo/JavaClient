...
* only google and bing are currently available
  ...
  public AvailableLanguages putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.availableSources, availableLanguages.availableSources) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AvailableLanguages>() {
           ...
           public AvailableLanguages read(JsonReader in) throws IOException {
             ...
             AvailableLanguages instance = thisAdapter.fromJsonTree(jsonObj);
