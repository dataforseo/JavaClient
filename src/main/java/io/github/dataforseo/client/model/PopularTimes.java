...
* information about busy hours of the local establishment on each day of the week
  ...
  public PopularTimes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.popularTimesByDays, popularTimes.popularTimesByDays);  
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PopularTimes>() {
           ...
           public PopularTimes read(JsonReader in) throws IOException {
             ...
             PopularTimes instance = thisAdapter.fromJsonTree(jsonObj);
