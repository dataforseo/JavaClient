...
public class MerchantAmazonAsinLiveAdvancedRequestInfo  {
  ...
  public MerchantAmazonAsinLiveAdvancedRequestInfo locationName(String locationName) {
  ...
  public MerchantAmazonAsinLiveAdvancedRequestInfo locationCode(Integer locationCode) {
  ...
  public MerchantAmazonAsinLiveAdvancedRequestInfo locationCoordinate(String locationCoordinate) {
  ...
  public MerchantAmazonAsinLiveAdvancedRequestInfo languageName(String languageName) {
  ...
  public MerchantAmazonAsinLiveAdvancedRequestInfo languageCode(String languageCode) {
  ...
  public MerchantAmazonAsinLiveAdvancedRequestInfo seDomain(String seDomain) {
  ...
  public MerchantAmazonAsinLiveAdvancedRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public MerchantAmazonAsinLiveAdvancedRequestInfo() {
  }
  ...
  public MerchantAmazonAsinLiveAdvancedRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MerchantAmazonAsinLiveAdvancedRequestInfo merchantAmazonAsinLiveAdvancedRequestInfo = (MerchantAmazonAsinLiveAdvancedRequestInfo) o;
    return

        Objects.equals(this.asin, merchantAmazonAsinLiveAdvancedRequestInfo.asin) &&
        Objects.equals(this.locationName, merchantAmazonAsinLiveAdvancedRequestInfo.locationName) &&
        Objects.equals(this.locationCode, merchantAmazonAsinLiveAdvancedRequestInfo.locationCode) &&
        Objects.equals(this.locationCoordinate, merchantAmazonAsinLiveAdvancedRequestInfo.locationCoordinate) &&
        Objects.equals(this.languageName, merchantAmazonAsinLiveAdvancedRequestInfo.languageName) &&
        Objects.equals(this.languageCode, merchantAmazonAsinLiveAdvancedRequestInfo.languageCode) &&
        Objects.equals(this.seDomain, merchantAmazonAsinLiveAdvancedRequestInfo.seDomain) &&
        Objects.equals(this.tag, merchantAmazonAsinLiveAdvancedRequestInfo.tag);  
  ...
  public String toString() {
    ...
    sb.append("class MerchantAmazonAsinLiveAdvancedRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MerchantAmazonAsinLiveAdvancedRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MerchantAmazonAsinLiveAdvancedRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MerchantAmazonAsinLiveAdvancedRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MerchantAmazonAsinLiveAdvancedRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MerchantAmazonAsinLiveAdvancedRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<MerchantAmazonAsinLiveAdvancedRequestInfo>() {
           @Override
           public void write(JsonWriter out, MerchantAmazonAsinLiveAdvancedRequestInfo value) throws IOException {
           ...
           @Override
           public MerchantAmazonAsinLiveAdvancedRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             MerchantAmazonAsinLiveAdvancedRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static MerchantAmazonAsinLiveAdvancedRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MerchantAmazonAsinLiveAdvancedRequestInfo.class);
  }
