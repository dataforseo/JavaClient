...
public class SerpGoogleImagesTaskPostRequestInfo  {
  ...
  public SerpGoogleImagesTaskPostRequestInfo keyword(String keyword) {
  ...
  public SerpGoogleImagesTaskPostRequestInfo locationCode(Integer locationCode) {
  ...
  public SerpGoogleImagesTaskPostRequestInfo languageCode(String languageCode) {
  ...
  public SerpGoogleImagesTaskPostRequestInfo depth(Integer depth) {
    this.depth = depth;
    return this;
  }
  ...
  public SerpGoogleImagesTaskPostRequestInfo postbackUrl(String postbackUrl) {
  ...
  public SerpGoogleImagesTaskPostRequestInfo postbackData(String postbackData) {
  ...
  public SerpGoogleImagesTaskPostRequestInfo putAdditionalProperty(String key, Object value) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to SerpGoogleImagesTaskPostRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SerpGoogleImagesTaskPostRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SerpGoogleImagesTaskPostRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SerpGoogleImagesTaskPostRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SerpGoogleImagesTaskPostRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SerpGoogleImagesTaskPostRequestInfo>() {
           @Override
           public void write(JsonWriter out, SerpGoogleImagesTaskPostRequestInfo value) throws IOException {
           ...
           @Override
           public SerpGoogleImagesTaskPostRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SerpGoogleImagesTaskPostRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static SerpGoogleImagesTaskPostRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SerpGoogleImagesTaskPostRequestInfo.class);
  }
