...
public class SerpGoogleImagesTaskPostRequestInfo {
   ...
   * @return the SerpGoogleImagesTaskPostRequestInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, serpGoogleImagesTaskPostRequestInfo.url) &&
        ...
        Objects.equals(this.additionalProperties, serpGoogleImagesTaskPostRequestInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(url, keyword, priority, locationName, locationCode, locationCoordinate, languageName, languageCode, os, seDomain, depth, maxCrawlPages, searchParam, tag, postbackUrl, postbackData, pingbackUrl, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SerpGoogleImagesTaskPostRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SerpGoogleImagesTaskPostRequestInfo is not found in the empty JSON string", SerpGoogleImagesTaskPostRequestInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of SerpGoogleImagesTaskPostRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SerpGoogleImagesTaskPostRequestInfo
   * @throws IOException if the JSON string is invalid with respect to SerpGoogleImagesTaskPostRequestInfo
   */
  ...
  /**
   * Convert an instance of SerpGoogleImagesTaskPostRequestInfo to an JSON string
   *
   * @return JSON string
   */
