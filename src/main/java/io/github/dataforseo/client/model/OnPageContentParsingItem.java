...
public class OnPageContentParsingItem {
   ...
   * @return the OnPageContentParsingItem instance itself
   */
  public OnPageContentParsingItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, onPageContentParsingItem.type) &&
        ...
        Objects.equals(this.additionalProperties, onPageContentParsingItem.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OnPageContentParsingItem>() {
           ...
           public OnPageContentParsingItem read(JsonReader in) throws IOException {
             ...
             OnPageContentParsingItem instance = thisAdapter.fromJsonTree(jsonObj);
