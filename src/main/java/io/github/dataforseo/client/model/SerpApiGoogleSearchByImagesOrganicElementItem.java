...
public class SerpApiGoogleSearchByImagesOrganicElementItem  extends BaseSerpApiGoogleSearchByImagesElementItem  {
  ...
  /**
   * <em>indicates whether the element is marked as Google web story</em>
   * @return isWebStory
   */
  @javax.annotation.Nullable
  ...
  public SerpApiGoogleSearchByImagesOrganicElementItem images(List<AiModeImagesElementInfo> images) {
    this.images = images;
    return this;
  }
  ...
  public SerpApiGoogleSearchByImagesOrganicElementItem rating(RatingInfo rating) {
    this.rating = rating;
    return this;
  }
  ...
  /**
   * <em>frequently asked questions</em><br>            questions and answers extension shown below some of Google's search results<br>            if there are none, equals <code>null</code>
   * @deprecated
   * @return faq
   */
  @javax.annotation.Nullable
