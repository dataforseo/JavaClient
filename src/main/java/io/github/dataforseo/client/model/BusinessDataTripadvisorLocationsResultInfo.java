...
public class BusinessDataTripadvisorLocationsResultInfo  {
  ...
  public BusinessDataTripadvisorLocationsResultInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.locationCode, businessDataTripadvisorLocationsResultInfo.locationCode) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BusinessDataTripadvisorLocationsResultInfo>() {
           ...
           public BusinessDataTripadvisorLocationsResultInfo read(JsonReader in) throws IOException {
             ...
             BusinessDataTripadvisorLocationsResultInfo instance = thisAdapter.fromJsonTree(jsonObj);
