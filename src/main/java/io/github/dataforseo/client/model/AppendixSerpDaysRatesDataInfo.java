...
public class AppendixSerpDaysRatesDataInfo  {
  ...
  public AppendixSerpDaysRatesDataInfo taskPost(Double taskPost) {
  ...
  public AppendixSerpDaysRatesDataInfo taskGet(AppendixFunctionTypeInfo taskGet) {
  ...
  public AppendixSerpDaysRatesDataInfo tasksReady(Double tasksReady) {
  ...
  public AppendixSerpDaysRatesDataInfo locations(Double locations) {
  ...
  public AppendixSerpDaysRatesDataInfo languages(Double languages) {
  ...
  public AppendixSerpDaysRatesDataInfo live(AppendixFunctionTypeInfo live) {
    this.live = live;
    return this;
  }
  ...
  public AppendixSerpDaysRatesDataInfo errors(Double errors) {
    this.errors = errors;
    return this;
  }
  ...
  public AppendixSerpDaysRatesDataInfo tasksFixed(Double tasksFixed) {
  ...
  public AppendixSerpDaysRatesDataInfo jobs(AppendixJobsSerpLimitsRatesDataInfo jobs) {
    this.jobs = jobs;
    return this;
  }
  ...
  public AppendixSerpDaysRatesDataInfo screenshot(Double screenshot) {
  ...
  public AppendixSerpDaysRatesDataInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AppendixSerpDaysRatesDataInfo appendixSerpDaysRatesDataInfo = (AppendixSerpDaysRatesDataInfo) o;
    return

        Objects.equals(this.taskPost, appendixSerpDaysRatesDataInfo.taskPost) &&
        Objects.equals(this.taskGet, appendixSerpDaysRatesDataInfo.taskGet) &&
        Objects.equals(this.tasksReady, appendixSerpDaysRatesDataInfo.tasksReady) &&
        Objects.equals(this.locations, appendixSerpDaysRatesDataInfo.locations) &&
        Objects.equals(this.languages, appendixSerpDaysRatesDataInfo.languages) &&
        Objects.equals(this.live, appendixSerpDaysRatesDataInfo.live) &&
  ...
  public String toString() {
    ...
    sb.append("class AppendixSerpDaysRatesDataInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppendixSerpDaysRatesDataInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppendixSerpDaysRatesDataInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppendixSerpDaysRatesDataInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppendixSerpDaysRatesDataInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppendixSerpDaysRatesDataInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AppendixSerpDaysRatesDataInfo>() {
           @Override
           public void write(JsonWriter out, AppendixSerpDaysRatesDataInfo value) throws IOException {
           ...
           @Override
           public AppendixSerpDaysRatesDataInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AppendixSerpDaysRatesDataInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AppendixSerpDaysRatesDataInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppendixSerpDaysRatesDataInfo.class);
  }
