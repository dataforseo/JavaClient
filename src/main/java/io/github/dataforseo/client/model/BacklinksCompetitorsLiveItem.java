...
* learn more about the metric and how it is calculated in this help center article
  ...
  public BacklinksCompetitorsLiveItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.type, backlinksCompetitorsLiveItem.type) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BacklinksCompetitorsLiveItem>() {
           ...
           public BacklinksCompetitorsLiveItem read(JsonReader in) throws IOException {
             ...
             BacklinksCompetitorsLiveItem instance = thisAdapter.fromJsonTree(jsonObj);
