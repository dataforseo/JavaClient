...
* you will find the specified tag value in the data object of the response
  ...
  public DataforseoLabsAmazonProductRankOverviewLiveRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.asins, dataforseoLabsAmazonProductRankOverviewLiveRequestInfo.asins) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DataforseoLabsAmazonProductRankOverviewLiveRequestInfo>() {
           ...
           public DataforseoLabsAmazonProductRankOverviewLiveRequestInfo read(JsonReader in) throws IOException {
             ...
             DataforseoLabsAmazonProductRankOverviewLiveRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
