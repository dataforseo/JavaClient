...
public class BacklinksDomainPagesSummaryLiveRequestInfo  {
  ...
  public BacklinksDomainPagesSummaryLiveRequestInfo target(String target) {
    this.target = target;
    return this;
  }

  /**
   * <em>domain, subdomain or webpage to get summary data for</em><br><strong>required field</strong><br>a domain or a subdomain should be specified without <code>https://</code> and <code>www.</code><br>a page should be specified with absolute URL (including <code>http://</code> or <code>https://</code>)
   * @return target
   */
  ...
  public BacklinksDomainPagesSummaryLiveRequestInfo limit(Integer limit) {
    this.limit = limit;
    return this;
  }

  /**
   * <em>the maximum number of returned anchors</em><br>optional field<br>default value: <code>100</code><br>maximum value: <code>1000</code>
   * @return limit
   */
  @javax.annotation.Nullable
  ...
  public BacklinksDomainPagesSummaryLiveRequestInfo offset(Integer offset) {
    this.offset = offset;
    return this;
  }

  /**
   * <em>offset in the results array of returned anchors</em><br>optional field<br>default value: <code>0</code><br>if you specify the <code>10</code> value, the first ten anchors in the results array will be omitted and the data will be provided for the successive anchors
   * @return offset
   */
  @javax.annotation.Nullable
  ...
  public BacklinksDomainPagesSummaryLiveRequestInfo internalListLimit(Integer internalListLimit) {
  ...
  public BacklinksDomainPagesSummaryLiveRequestInfo backlinksStatusType(String backlinksStatusType) {
  ...
  public BacklinksDomainPagesSummaryLiveRequestInfo orderBy(List<String> orderBy) {
  ...
  public BacklinksDomainPagesSummaryLiveRequestInfo backlinksFilters(List<Object> backlinksFilters) {
  ...
  public BacklinksDomainPagesSummaryLiveRequestInfo includeSubdomains(Boolean includeSubdomains) {
    this.includeSubdomains = includeSubdomains;
    return this;
  }

  /**
   * <em>indicates if the subdomains of the <code>target</code> domain will be included in the search</em><br>optional field<br>if set to <code>false</code>, the subdomains will be ignored<br>default value: <code>true</code>
  ...
  public BacklinksDomainPagesSummaryLiveRequestInfo includeIndirectLinks(Boolean includeIndirectLinks) {
  ...
  public BacklinksDomainPagesSummaryLiveRequestInfo excludeInternalBacklinks(Boolean excludeInternalBacklinks) {
    this.excludeInternalBacklinks = excludeInternalBacklinks;
    return this;
  }

  /**
   * <em>indicates whether the backlinks from subdomains of the <code>target</code> are excluded</em><br>optional field<br>if set to <code>false</code>, backlinks from the subdomains of the <code>target</code> domain will be ommited and you won't receive the same domain in the response;<br>default value: <code>true</code>
  ...
  public BacklinksDomainPagesSummaryLiveRequestInfo rankScale(String rankScale) {
  ...
  public BacklinksDomainPagesSummaryLiveRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public BacklinksDomainPagesSummaryLiveRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BacklinksDomainPagesSummaryLiveRequestInfo backlinksDomainPagesSummaryLiveRequestInfo = (BacklinksDomainPagesSummaryLiveRequestInfo) o;
    return

        Objects.equals(this.target, backlinksDomainPagesSummaryLiveRequestInfo.target) &&
        Objects.equals(this.limit, backlinksDomainPagesSummaryLiveRequestInfo.limit) &&
        Objects.equals(this.offset, backlinksDomainPagesSummaryLiveRequestInfo.offset) &&
        Objects.equals(this.internalListLimit, backlinksDomainPagesSummaryLiveRequestInfo.internalListLimit) &&
        Objects.equals(this.backlinksStatusType, backlinksDomainPagesSummaryLiveRequestInfo.backlinksStatusType) &&
        Objects.equals(this.filters, backlinksDomainPagesSummaryLiveRequestInfo.filters) &&
        Objects.equals(this.orderBy, backlinksDomainPagesSummaryLiveRequestInfo.orderBy) &&
        Objects.equals(this.backlinksFilters, backlinksDomainPagesSummaryLiveRequestInfo.backlinksFilters) &&
        Objects.equals(this.includeSubdomains, backlinksDomainPagesSummaryLiveRequestInfo.includeSubdomains) &&
        Objects.equals(this.includeIndirectLinks, backlinksDomainPagesSummaryLiveRequestInfo.includeIndirectLinks) &&
        Objects.equals(this.excludeInternalBacklinks, backlinksDomainPagesSummaryLiveRequestInfo.excludeInternalBacklinks) &&
        Objects.equals(this.rankScale, backlinksDomainPagesSummaryLiveRequestInfo.rankScale) &&
        Objects.equals(this.tag, backlinksDomainPagesSummaryLiveRequestInfo.tag);  
  ...
  public String toString() {
    ...
    sb.append("class BacklinksDomainPagesSummaryLiveRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BacklinksDomainPagesSummaryLiveRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BacklinksDomainPagesSummaryLiveRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BacklinksDomainPagesSummaryLiveRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BacklinksDomainPagesSummaryLiveRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BacklinksDomainPagesSummaryLiveRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<BacklinksDomainPagesSummaryLiveRequestInfo>() {
           @Override
           public void write(JsonWriter out, BacklinksDomainPagesSummaryLiveRequestInfo value) throws IOException {
           ...
           @Override
           public BacklinksDomainPagesSummaryLiveRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             BacklinksDomainPagesSummaryLiveRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static BacklinksDomainPagesSummaryLiveRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BacklinksDomainPagesSummaryLiveRequestInfo.class);
  }
