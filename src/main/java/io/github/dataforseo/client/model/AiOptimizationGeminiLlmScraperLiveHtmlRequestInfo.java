...
public class AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo  {
  ...
  public AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo keyword(String keyword) {
  ...
  public AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo locationName(String locationName) {
  ...
  public AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo locationCode(Integer locationCode) {
  ...
  public AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo locationCoordinate(String locationCoordinate) {
  ...
  public AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo languageName(String languageName) {
  ...
  public AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo expandCitations(Boolean expandCitations) {
    this.expandCitations = expandCitations;
    return this;
  }

  /**
   * <em>return expanded citation bar in HTML results</em><br>optional field<br>when enabled, the endpoint will return HTML data from the expanded citation bar;<br>default value: <code>false</code>
  ...
  public AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo() {
  }
  ...
  public AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo aiOptimizationGeminiLlmScraperLiveHtmlRequestInfo = (AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo) o;
    return

        Objects.equals(this.keyword, aiOptimizationGeminiLlmScraperLiveHtmlRequestInfo.keyword) &&
        Objects.equals(this.locationName, aiOptimizationGeminiLlmScraperLiveHtmlRequestInfo.locationName) &&
        Objects.equals(this.locationCode, aiOptimizationGeminiLlmScraperLiveHtmlRequestInfo.locationCode) &&
        Objects.equals(this.locationCoordinate, aiOptimizationGeminiLlmScraperLiveHtmlRequestInfo.locationCoordinate) &&
        Objects.equals(this.languageName, aiOptimizationGeminiLlmScraperLiveHtmlRequestInfo.languageName) &&
        Objects.equals(this.languageCode, aiOptimizationGeminiLlmScraperLiveHtmlRequestInfo.languageCode) &&
        Objects.equals(this.expandCitations, aiOptimizationGeminiLlmScraperLiveHtmlRequestInfo.expandCitations) &&
        Objects.equals(this.tag, aiOptimizationGeminiLlmScraperLiveHtmlRequestInfo.tag);  
  ...
  @Override
  public int hashCode() {
  return Objects.hash(keyword, locationName, locationCode, locationCoordinate, languageName, languageCode, expandCitations, tag);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo>() {
           @Override
           public void write(JsonWriter out, AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo value) throws IOException {
           ...
           @Override
           public AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AiOptimizationGeminiLlmScraperLiveHtmlRequestInfo.class);
  }
