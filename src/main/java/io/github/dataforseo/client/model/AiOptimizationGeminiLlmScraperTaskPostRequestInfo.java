...
public class AiOptimizationGeminiLlmScraperTaskPostRequestInfo  {
  ...
  public AiOptimizationGeminiLlmScraperTaskPostRequestInfo locationCoordinate(String locationCoordinate) {
  ...
  /**
   * <em>return expanded citation bar in HTML results</em><br>optional field<br>when enabled, the HTML endpoint will return data from the expanded citation bar;<br>default value: <code>false</code>
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.locationCoordinate, aiOptimizationGeminiLlmScraperTaskPostRequestInfo.locationCoordinate) &&
  ...
  @Override
  public int hashCode() {
  return Objects.hash(keyword, priority, locationName, locationCode, locationCoordinate, languageName, languageCode, expandCitations, tag, postbackUrl, postbackData, pingbackUrl);
  }
