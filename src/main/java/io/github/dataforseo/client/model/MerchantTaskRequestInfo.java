...
public class MerchantTaskRequestInfo {
  ...
  public MerchantTaskRequestInfo keyword(String keyword) {
  ...
  public MerchantTaskRequestInfo url(String url) {
    this.url = url;
    return this;
  }
  ...
  public MerchantTaskRequestInfo priority(Integer priority) {
  ...
  public MerchantTaskRequestInfo locationName(String locationName) {
  ...
  public MerchantTaskRequestInfo locationCode(Integer locationCode) {
  ...
  public MerchantTaskRequestInfo locationCoordinate(String locationCoordinate) {
  ...
  public MerchantTaskRequestInfo languageName(String languageName) {
  ...
  public MerchantTaskRequestInfo languageCode(String languageCode) {
  ...
  public MerchantTaskRequestInfo seDomain(String seDomain) {
  ...
  public MerchantTaskRequestInfo depth(Integer depth) {
    this.depth = depth;
    return this;
  }
  ...
  public MerchantTaskRequestInfo maxCrawlPages(Integer maxCrawlPages) {
  ...
  public MerchantTaskRequestInfo searchParam(String searchParam) {
  ...
  public MerchantTaskRequestInfo priceMin(Integer priceMin) {
  ...
  public MerchantTaskRequestInfo priceMax(Integer priceMax) {
  ...
  public MerchantTaskRequestInfo sortBy(String sortBy) {
    this.sortBy = sortBy;
    return this;
  }
  ...
  public MerchantTaskRequestInfo tag(String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public MerchantTaskRequestInfo postbackUrl(String postbackUrl) {
  ...
  public MerchantTaskRequestInfo postbackData(String postbackData) {
  ...
  public MerchantTaskRequestInfo pingbackUrl(String pingbackUrl) {
   ...
   * @return the MerchantTaskRequestInfo instance itself
   */
  public MerchantTaskRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MerchantTaskRequestInfo merchantTaskRequestInfo = (MerchantTaskRequestInfo) o;
    return Objects.equals(this.keyword, merchantTaskRequestInfo.keyword) &&
        Objects.equals(this.url, merchantTaskRequestInfo.url) &&
        Objects.equals(this.priority, merchantTaskRequestInfo.priority) &&
        Objects.equals(this.locationName, merchantTaskRequestInfo.locationName) &&
        Objects.equals(this.locationCode, merchantTaskRequestInfo.locationCode) &&
        Objects.equals(this.locationCoordinate, merchantTaskRequestInfo.locationCoordinate) &&
        Objects.equals(this.languageName, merchantTaskRequestInfo.languageName) &&
        Objects.equals(this.languageCode, merchantTaskRequestInfo.languageCode) &&
        Objects.equals(this.seDomain, merchantTaskRequestInfo.seDomain) &&
        Objects.equals(this.depth, merchantTaskRequestInfo.depth) &&
        Objects.equals(this.maxCrawlPages, merchantTaskRequestInfo.maxCrawlPages) &&
        Objects.equals(this.searchParam, merchantTaskRequestInfo.searchParam) &&
        Objects.equals(this.priceMin, merchantTaskRequestInfo.priceMin) &&
        Objects.equals(this.priceMax, merchantTaskRequestInfo.priceMax) &&
        Objects.equals(this.sortBy, merchantTaskRequestInfo.sortBy) &&
        Objects.equals(this.tag, merchantTaskRequestInfo.tag) &&
        Objects.equals(this.postbackUrl, merchantTaskRequestInfo.postbackUrl) &&
        Objects.equals(this.postbackData, merchantTaskRequestInfo.postbackData) &&
        Objects.equals(this.pingbackUrl, merchantTaskRequestInfo.pingbackUrl)&&
        Objects.equals(this.additionalProperties, merchantTaskRequestInfo.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MerchantTaskRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MerchantTaskRequestInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MerchantTaskRequestInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MerchantTaskRequestInfo is not found in the empty JSON string", MerchantTaskRequestInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MerchantTaskRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MerchantTaskRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MerchantTaskRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MerchantTaskRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<MerchantTaskRequestInfo>() {
           @Override
           public void write(JsonWriter out, MerchantTaskRequestInfo value) throws IOException {
           ...
           @Override
           public MerchantTaskRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             MerchantTaskRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of MerchantTaskRequestInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MerchantTaskRequestInfo
   * @throws IOException if the JSON string is invalid with respect to MerchantTaskRequestInfo
   */
  public static MerchantTaskRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MerchantTaskRequestInfo.class);
  }

  /**
   * Convert an instance of MerchantTaskRequestInfo to an JSON string
   *
   * @return JSON string
   */
