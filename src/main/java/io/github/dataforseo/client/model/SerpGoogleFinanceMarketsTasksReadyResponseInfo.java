...
import io.github.dataforseo.client.model.SerpGoogleFinanceMarketsTasksReadyTaskInfo;
...
public class SerpGoogleFinanceMarketsTasksReadyResponseInfo {
  ...
  public SerpGoogleFinanceMarketsTasksReadyResponseInfo addTasksItem(SerpGoogleFinanceMarketsTasksReadyTaskInfo tasksItem) {
    if (this.tasks == null) {
   ...
   * @return the SerpGoogleFinanceMarketsTasksReadyResponseInfo instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.version, serpGoogleFinanceMarketsTasksReadyResponseInfo.version) &&
        ...
        Objects.equals(this.additionalProperties, serpGoogleFinanceMarketsTasksReadyResponseInfo.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SerpGoogleFinanceMarketsTasksReadyResponseInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SerpGoogleFinanceMarketsTasksReadyResponseInfo is not found in the empty JSON string", SerpGoogleFinanceMarketsTasksReadyResponseInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("tasks") != null && !jsonObj.get("tasks").isJsonNull()) {
        ...
        if (jsonArraytasks != null) {
          ...
          for (int i = 0; i < jsonArraytasks.size(); i++) {
            SerpGoogleFinanceMarketsTasksReadyTaskInfo.validateJsonElement(jsonArraytasks.get(i));
          };
        }
      }
  }
  ...
  /**
   * Create an instance of SerpGoogleFinanceMarketsTasksReadyResponseInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SerpGoogleFinanceMarketsTasksReadyResponseInfo
   * @throws IOException if the JSON string is invalid with respect to SerpGoogleFinanceMarketsTasksReadyResponseInfo
   */
  ...
  /**
   * Convert an instance of SerpGoogleFinanceMarketsTasksReadyResponseInfo to an JSON string
   *
   * @return JSON string
   */
