...
* learn more on our Help Center
  ...
  @Override
  public int hashCode() {
  return Objects.hash(keyword, priority, locationName, locationCode, locationCoordinate, languageName, languageCode, device, os, depth, minRating, timeFilter, tag, postbackUrl, postbackData, pingbackUrl);
  }
