...
public class SerpGoogleLocalFinderTaskPostRequestInfo  {
  ...
  public SerpGoogleLocalFinderTaskPostRequestInfo keyword(String keyword) {
  ...
  public SerpGoogleLocalFinderTaskPostRequestInfo locationCode(Integer locationCode) {
  ...
  public SerpGoogleLocalFinderTaskPostRequestInfo languageCode(String languageCode) {
  ...
  public SerpGoogleLocalFinderTaskPostRequestInfo depth(Integer depth) {
    this.depth = depth;
    return this;
  }
  ...
  public SerpGoogleLocalFinderTaskPostRequestInfo priority(Integer priority) {
  ...
  public SerpGoogleLocalFinderTaskPostRequestInfo device(String device) {
    this.device = device;
    return this;
  }
  ...
  public SerpGoogleLocalFinderTaskPostRequestInfo pingbackUrl(String pingbackUrl) {
  ...
  public SerpGoogleLocalFinderTaskPostRequestInfo postbackUrl(String postbackUrl) {
  ...
  public SerpGoogleLocalFinderTaskPostRequestInfo postbackData(String postbackData) {
    this.postbackData = postbackData;
    return this;
  }

  /**
   * <p><em>postback_url datatype</em><p><strong>required field if you specify <code>postback_url</code></strong><p>corresponds to the function you used for setting a task<p>possible values:<p><code>advanced</code>, <code>html</code></p>
   * @return postbackData
   */
  @javax.annotation.Nullable
  ...
  public SerpGoogleLocalFinderTaskPostRequestInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SerpGoogleLocalFinderTaskPostRequestInfo serpGoogleLocalFinderTaskPostRequestInfo = (SerpGoogleLocalFinderTaskPostRequestInfo) o;
    return

        Objects.equals(this.keyword, serpGoogleLocalFinderTaskPostRequestInfo.keyword) &&
        Objects.equals(this.locationCode, serpGoogleLocalFinderTaskPostRequestInfo.locationCode) &&
        Objects.equals(this.languageCode, serpGoogleLocalFinderTaskPostRequestInfo.languageCode) &&
        Objects.equals(this.depth, serpGoogleLocalFinderTaskPostRequestInfo.depth) &&
        Objects.equals(this.priority, serpGoogleLocalFinderTaskPostRequestInfo.priority) &&
  ...
  public String toString() {
    ...
    sb.append("class SerpGoogleLocalFinderTaskPostRequestInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SerpGoogleLocalFinderTaskPostRequestInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SerpGoogleLocalFinderTaskPostRequestInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SerpGoogleLocalFinderTaskPostRequestInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SerpGoogleLocalFinderTaskPostRequestInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SerpGoogleLocalFinderTaskPostRequestInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SerpGoogleLocalFinderTaskPostRequestInfo>() {
           @Override
           public void write(JsonWriter out, SerpGoogleLocalFinderTaskPostRequestInfo value) throws IOException {
           ...
           @Override
           public SerpGoogleLocalFinderTaskPostRequestInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SerpGoogleLocalFinderTaskPostRequestInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static SerpGoogleLocalFinderTaskPostRequestInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SerpGoogleLocalFinderTaskPostRequestInfo.class);
  }
