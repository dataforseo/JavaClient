...
* if false, the version is not used by default and should be specified in the corresponding field of the POST request if necessary
  ...
  public AvailibleVersions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return
        ...
        Objects.equals(this.version, availibleVersions.version) &&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AvailibleVersions>() {
           ...
           public AvailibleVersions read(JsonReader in) throws IOException {
             ...
             AvailibleVersions instance = thisAdapter.fromJsonTree(jsonObj);
