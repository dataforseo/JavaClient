...
public class AppendixGoogleAdsKeywordsDataLimitsRatesDataInfo  {
  ...
  public AppendixGoogleAdsKeywordsDataLimitsRatesDataInfo status(Double status) {
    this.status = status;
    return this;
  }
  ...
  public AppendixGoogleAdsKeywordsDataLimitsRatesDataInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AppendixGoogleAdsKeywordsDataLimitsRatesDataInfo appendixGoogleAdsKeywordsDataLimitsRatesDataInfo = (AppendixGoogleAdsKeywordsDataLimitsRatesDataInfo) o;
    return

        Objects.equals(this.status, appendixGoogleAdsKeywordsDataLimitsRatesDataInfo.status) &&
        Objects.equals(this.searchVolume, appendixGoogleAdsKeywordsDataLimitsRatesDataInfo.searchVolume) &&
        Objects.equals(this.keywordsForKeywords, appendixGoogleAdsKeywordsDataLimitsRatesDataInfo.keywordsForKeywords) &&
        Objects.equals(this.keywordsForSite, appendixGoogleAdsKeywordsDataLimitsRatesDataInfo.keywordsForSite) &&
        Objects.equals(this.adTrafficByKeywords, appendixGoogleAdsKeywordsDataLimitsRatesDataInfo.adTrafficByKeywords);  
  ...
  @Override
  public int hashCode() {
  return Objects.hash(status, searchVolume, keywordsForKeywords, keywordsForSite, adTrafficByKeywords);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppendixGoogleAdsKeywordsDataLimitsRatesDataInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppendixGoogleAdsKeywordsDataLimitsRatesDataInfo
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppendixGoogleAdsKeywordsDataLimitsRatesDataInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppendixGoogleAdsKeywordsDataLimitsRatesDataInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppendixGoogleAdsKeywordsDataLimitsRatesDataInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppendixGoogleAdsKeywordsDataLimitsRatesDataInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<AppendixGoogleAdsKeywordsDataLimitsRatesDataInfo>() {
           @Override
           public void write(JsonWriter out, AppendixGoogleAdsKeywordsDataLimitsRatesDataInfo value) throws IOException {
           ...
           @Override
           public AppendixGoogleAdsKeywordsDataLimitsRatesDataInfo read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AppendixGoogleAdsKeywordsDataLimitsRatesDataInfo instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  public static AppendixGoogleAdsKeywordsDataLimitsRatesDataInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppendixGoogleAdsKeywordsDataLimitsRatesDataInfo.class);
  }
