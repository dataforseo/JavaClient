...
import io.github.dataforseo.client.auth.Authentication;
import io.github.dataforseo.client.auth.HttpBasicAuth;
import io.github.dataforseo.client.auth.HttpBearerAuth;
import io.github.dataforseo.client.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.dataforseo.com";
    ...
    private void init() {
        ...
        setUserAgent("java-client/2.0.15");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.dataforseo.com
     ...
     * @return a {@link io.github.dataforseo.client.ApiClient} object
     */
    ...
    */
     ...
     * @throws io.github.dataforseo.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws io.github.dataforseo.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws io.github.dataforseo.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws io.github.dataforseo.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws io.github.dataforseo.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws io.github.dataforseo.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws io.github.dataforseo.client.ApiException If fails to update the parameters
     */
     ...
     * @throws io.github.dataforseo.client.ApiException If fail to serialize the request body object into a string
     */
