...
public class JSON {
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(new io.github.dataforseo.client.model.AiOptimizationResultTotalInfo.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new io.github.dataforseo.client.model.Services.CustomTypeAdapterFactory());
