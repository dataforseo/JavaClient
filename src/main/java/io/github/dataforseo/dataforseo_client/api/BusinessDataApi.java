...
public class BusinessDataApi {
    ...
    /**
     * Build call for businessDataYelpLanguages
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call businessDataYelpLanguagesCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v3/business_data/yelp/languages";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call businessDataYelpLanguagesValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return businessDataYelpLanguagesCall(_callback);
     ...
     */
    public BusinessDataYelpLanguagesResponseInfo businessDataYelpLanguages() throws ApiException {
        ApiResponse<BusinessDataYelpLanguagesResponseInfo> localVarResp = businessDataYelpLanguagesWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     * 
     * You will receive the list of languages by calling this API. for more info please visit &#39;https://docs.dataforseo.com/v3/business_data/yelp/languages/?bash&#39;
     * @return ApiResponse&lt;BusinessDataYelpLanguagesResponseInfo&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BusinessDataYelpLanguagesResponseInfo> businessDataYelpLanguagesWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = businessDataYelpLanguagesValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<BusinessDataYelpLanguagesResponseInfo>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call businessDataYelpLanguagesAsync(final ApiCallback<BusinessDataYelpLanguagesResponseInfo> _callback) throws ApiException {

        okhttp3.Call localVarCall = businessDataYelpLanguagesValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<BusinessDataYelpLanguagesResponseInfo>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for businessDataYelpLocations
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call businessDataYelpLocationsCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v3/business_data/yelp/locations";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call businessDataYelpLocationsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return businessDataYelpLocationsCall(_callback);
     ...
     */
    public BusinessDataYelpLocationsResponseInfo businessDataYelpLocations() throws ApiException {
        ApiResponse<BusinessDataYelpLocationsResponseInfo> localVarResp = businessDataYelpLocationsWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     * 
     * You will receive the list of locations by this API call. You can filter the list of locations by country when setting a task. for more info please visit &#39;https://docs.dataforseo.com/v3/business_data/yelp/locations/?bash&#39;
     * @return ApiResponse&lt;BusinessDataYelpLocationsResponseInfo&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BusinessDataYelpLocationsResponseInfo> businessDataYelpLocationsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = businessDataYelpLocationsValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<BusinessDataYelpLocationsResponseInfo>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call businessDataYelpLocationsAsync(final ApiCallback<BusinessDataYelpLocationsResponseInfo> _callback) throws ApiException {

        okhttp3.Call localVarCall = businessDataYelpLocationsValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<BusinessDataYelpLocationsResponseInfo>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for businessDataYelpLocationsCountry
     * @param country country ISO code optional field specify the ISO code if you want to filter the list of locations by country example: us (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call businessDataYelpLocationsCountryCall(String country, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v3/business_data/yelp/locations/{country}"
            .replace("{" + "country" + "}", localVarApiClient.escapeString(country.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call businessDataYelpLocationsCountryValidateBeforeCall(String country, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'country' is set
        if (country == null) {
            throw new ApiException("Missing the required parameter 'country' when calling businessDataYelpLocationsCountry(Async)");
        }

        return businessDataYelpLocationsCountryCall(country, _callback);
     ...
     */
    public BusinessDataYelpLocationsCountryResponseInfo businessDataYelpLocationsCountry(String country) throws ApiException {
        ApiResponse<BusinessDataYelpLocationsCountryResponseInfo> localVarResp = businessDataYelpLocationsCountryWithHttpInfo(country);
        return localVarResp.getData();
    }
     ...
     * You will receive the list of locations by this API call. You can filter the list of locations by country when setting a task. for more info please visit &#39;https://docs.dataforseo.com/v3/business_data/yelp/locations/?bash&#39;
     * @param country country ISO code optional field specify the ISO code if you want to filter the list of locations by country example: us (required)
     * @return ApiResponse&lt;BusinessDataYelpLocationsCountryResponseInfo&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BusinessDataYelpLocationsCountryResponseInfo> businessDataYelpLocationsCountryWithHttpInfo(String country) throws ApiException {
        okhttp3.Call localVarCall = businessDataYelpLocationsCountryValidateBeforeCall(country, null);
        Type localVarReturnType = new TypeToken<BusinessDataYelpLocationsCountryResponseInfo>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call businessDataYelpLocationsCountryAsync(String country, final ApiCallback<BusinessDataYelpLocationsCountryResponseInfo> _callback) throws ApiException {

        okhttp3.Call localVarCall = businessDataYelpLocationsCountryValidateBeforeCall(country, _callback);
        Type localVarReturnType = new TypeToken<BusinessDataYelpLocationsCountryResponseInfo>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for yelpReviewsTaskGet
     * @param id task identifier unique task identifier in our system in the UUID format you will be able to use it within 30 days to request the results of the task at any time (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call yelpReviewsTaskGetCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v3/business_data/yelp/reviews/task_get/{id}"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call yelpReviewsTaskGetValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling yelpReviewsTaskGet(Async)");
        }

        return yelpReviewsTaskGetCall(id, _callback);
     ...
     */
    public BusinessDataYelpReviewsTaskGetResponseInfo yelpReviewsTaskGet(String id) throws ApiException {
        ApiResponse<BusinessDataYelpReviewsTaskGetResponseInfo> localVarResp = yelpReviewsTaskGetWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     * This endpoint provides reviews published on the Yelp platform. The results are specific to the selected alias and language parameters. for more info please visit &#39;https://docs.dataforseo.com/v3/business_data/yelp/reviews/task_get/?bash&#39;
     * @param id task identifier unique task identifier in our system in the UUID format you will be able to use it within 30 days to request the results of the task at any time (required)
     * @return ApiResponse&lt;BusinessDataYelpReviewsTaskGetResponseInfo&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BusinessDataYelpReviewsTaskGetResponseInfo> yelpReviewsTaskGetWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = yelpReviewsTaskGetValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<BusinessDataYelpReviewsTaskGetResponseInfo>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call yelpReviewsTaskGetAsync(String id, final ApiCallback<BusinessDataYelpReviewsTaskGetResponseInfo> _callback) throws ApiException {

        okhttp3.Call localVarCall = yelpReviewsTaskGetValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<BusinessDataYelpReviewsTaskGetResponseInfo>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for yelpReviewsTaskPost
     * @param businessDataYelpReviewsTaskPostRequestInfo  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call yelpReviewsTaskPostCall(List<BusinessDataYelpReviewsTaskPostRequestInfo> businessDataYelpReviewsTaskPostRequestInfo, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = businessDataYelpReviewsTaskPostRequestInfo;

        // create path and map variables
        String localVarPath = "/v3/business_data/yelp/reviews/task_post";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call yelpReviewsTaskPostValidateBeforeCall(List<BusinessDataYelpReviewsTaskPostRequestInfo> businessDataYelpReviewsTaskPostRequestInfo, final ApiCallback _callback) throws ApiException {
        return yelpReviewsTaskPostCall(businessDataYelpReviewsTaskPostRequestInfo, _callback);
     ...
     */
    public BusinessDataYelpReviewsTaskPostResponseInfo yelpReviewsTaskPost(List<BusinessDataYelpReviewsTaskPostRequestInfo> businessDataYelpReviewsTaskPostRequestInfo) throws ApiException {
        ApiResponse<BusinessDataYelpReviewsTaskPostResponseInfo> localVarResp = yelpReviewsTaskPostWithHttpInfo(businessDataYelpReviewsTaskPostRequestInfo);
        return localVarResp.getData();
    }
     ...
     * ‌‌ This endpoint provides reviews published on the Yelp platform. The results are specific to the selected alias and language (see the List of Languages) parameters. for more info please visit &#39;https://docs.dataforseo.com/v3/business_data/yelp/reviews/task_post/?bash&#39;
     * @param businessDataYelpReviewsTaskPostRequestInfo  (optional)
     * @return ApiResponse&lt;BusinessDataYelpReviewsTaskPostResponseInfo&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BusinessDataYelpReviewsTaskPostResponseInfo> yelpReviewsTaskPostWithHttpInfo(List<BusinessDataYelpReviewsTaskPostRequestInfo> businessDataYelpReviewsTaskPostRequestInfo) throws ApiException {
        okhttp3.Call localVarCall = yelpReviewsTaskPostValidateBeforeCall(businessDataYelpReviewsTaskPostRequestInfo, null);
        Type localVarReturnType = new TypeToken<BusinessDataYelpReviewsTaskPostResponseInfo>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call yelpReviewsTaskPostAsync(List<BusinessDataYelpReviewsTaskPostRequestInfo> businessDataYelpReviewsTaskPostRequestInfo, final ApiCallback<BusinessDataYelpReviewsTaskPostResponseInfo> _callback) throws ApiException {

        okhttp3.Call localVarCall = yelpReviewsTaskPostValidateBeforeCall(businessDataYelpReviewsTaskPostRequestInfo, _callback);
        Type localVarReturnType = new TypeToken<BusinessDataYelpReviewsTaskPostResponseInfo>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for yelpReviewsTasksReady
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call yelpReviewsTasksReadyCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v3/business_data/yelp/reviews/tasks_ready";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call yelpReviewsTasksReadyValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return yelpReviewsTasksReadyCall(_callback);
     ...
     */
    public BusinessDataYelpReviewsTasksReadyResponseInfo yelpReviewsTasksReady() throws ApiException {
        ApiResponse<BusinessDataYelpReviewsTasksReadyResponseInfo> localVarResp = yelpReviewsTasksReadyWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     * 
     * ‌ The ‘Tasks Ready’ endpoint is designed to provide you with the list of completed tasks, which haven’t been collected yet. If you don’t use the postback_url, you can receive the list of id for all completed tasks using this endpoint. Then, you can collect the results using the ‘Task GET’ endpoint. for more info please visit &#39;https://docs.dataforseo.com/v3/business_data/yelp/reviews/tasks_ready/?bash&#39;
     * @return ApiResponse&lt;BusinessDataYelpReviewsTasksReadyResponseInfo&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BusinessDataYelpReviewsTasksReadyResponseInfo> yelpReviewsTasksReadyWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = yelpReviewsTasksReadyValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<BusinessDataYelpReviewsTasksReadyResponseInfo>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call yelpReviewsTasksReadyAsync(final ApiCallback<BusinessDataYelpReviewsTasksReadyResponseInfo> _callback) throws ApiException {

        okhttp3.Call localVarCall = yelpReviewsTasksReadyValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<BusinessDataYelpReviewsTasksReadyResponseInfo>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for yelpSearchTaskGet
     * @param id task identifier unique task identifier in our system in the UUID format you will be able to use it within 30 days to request the results of the task at any time (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call yelpSearchTaskGetCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v3/business_data/yelp/search/task_get/{id}"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call yelpSearchTaskGetValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling yelpSearchTaskGet(Async)");
        }

        return yelpSearchTaskGetCall(id, _callback);
     ...
     */
    public BusinessDataYelpSearchTaskGetResponseInfo yelpSearchTaskGet(String id) throws ApiException {
        ApiResponse<BusinessDataYelpSearchTaskGetResponseInfo> localVarResp = yelpSearchTaskGetWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     * This endpoint will provide you with data on businesses listed on the Yelp platform. The results obtained through this endpoint are specific to the location (see the List of Yelp Locations) and keyword parameters used in the POST request. for more info please visit &#39;https://docs.dataforseo.com/v3/business_data/yelp/search/task_get/?bash&#39;
     * @param id task identifier unique task identifier in our system in the UUID format you will be able to use it within 30 days to request the results of the task at any time (required)
     * @return ApiResponse&lt;BusinessDataYelpSearchTaskGetResponseInfo&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BusinessDataYelpSearchTaskGetResponseInfo> yelpSearchTaskGetWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = yelpSearchTaskGetValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<BusinessDataYelpSearchTaskGetResponseInfo>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call yelpSearchTaskGetAsync(String id, final ApiCallback<BusinessDataYelpSearchTaskGetResponseInfo> _callback) throws ApiException {

        okhttp3.Call localVarCall = yelpSearchTaskGetValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<BusinessDataYelpSearchTaskGetResponseInfo>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for yelpSearchTaskPost
     * @param businessDataYelpSearchTaskPostRequestInfo  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call yelpSearchTaskPostCall(List<BusinessDataYelpSearchTaskPostRequestInfo> businessDataYelpSearchTaskPostRequestInfo, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = businessDataYelpSearchTaskPostRequestInfo;

        // create path and map variables
        String localVarPath = "/v3/business_data/yelp/search/task_post";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call yelpSearchTaskPostValidateBeforeCall(List<BusinessDataYelpSearchTaskPostRequestInfo> businessDataYelpSearchTaskPostRequestInfo, final ApiCallback _callback) throws ApiException {
        return yelpSearchTaskPostCall(businessDataYelpSearchTaskPostRequestInfo, _callback);
     ...
     */
    public BusinessDataYelpSearchTaskPostResponseInfo yelpSearchTaskPost(List<BusinessDataYelpSearchTaskPostRequestInfo> businessDataYelpSearchTaskPostRequestInfo) throws ApiException {
        ApiResponse<BusinessDataYelpSearchTaskPostResponseInfo> localVarResp = yelpSearchTaskPostWithHttpInfo(businessDataYelpSearchTaskPostRequestInfo);
        return localVarResp.getData();
    }
     ...
     * ‌‌ By using this endpoint you can request data on businesses listed on the Yelp platform. The results will be specific to the location (see the List of Yelp Locations) and keyword parameters used in the POST request. for more info please visit &#39;https://docs.dataforseo.com/v3/business_data/yelp/search/task_post/?bash&#39;
     * @param businessDataYelpSearchTaskPostRequestInfo  (optional)
     * @return ApiResponse&lt;BusinessDataYelpSearchTaskPostResponseInfo&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BusinessDataYelpSearchTaskPostResponseInfo> yelpSearchTaskPostWithHttpInfo(List<BusinessDataYelpSearchTaskPostRequestInfo> businessDataYelpSearchTaskPostRequestInfo) throws ApiException {
        okhttp3.Call localVarCall = yelpSearchTaskPostValidateBeforeCall(businessDataYelpSearchTaskPostRequestInfo, null);
        Type localVarReturnType = new TypeToken<BusinessDataYelpSearchTaskPostResponseInfo>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call yelpSearchTaskPostAsync(List<BusinessDataYelpSearchTaskPostRequestInfo> businessDataYelpSearchTaskPostRequestInfo, final ApiCallback<BusinessDataYelpSearchTaskPostResponseInfo> _callback) throws ApiException {

        okhttp3.Call localVarCall = yelpSearchTaskPostValidateBeforeCall(businessDataYelpSearchTaskPostRequestInfo, _callback);
        Type localVarReturnType = new TypeToken<BusinessDataYelpSearchTaskPostResponseInfo>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for yelpSearchTasksReady
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call yelpSearchTasksReadyCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v3/business_data/yelp/search/tasks_ready";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call yelpSearchTasksReadyValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return yelpSearchTasksReadyCall(_callback);
     ...
     */
    public BusinessDataYelpSearchTasksReadyResponseInfo yelpSearchTasksReady() throws ApiException {
        ApiResponse<BusinessDataYelpSearchTasksReadyResponseInfo> localVarResp = yelpSearchTasksReadyWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     * 
     * ‌ The ‘Tasks Ready’ endpoint is designed to provide you with the list of completed tasks, which haven’t been collected yet. If you don’t use the postback_url, you can receive the list of id for all completed tasks using this endpoint. Then, you can collect the results using the ‘Task GET’ endpoint. for more info please visit &#39;https://docs.dataforseo.com/v3/business_data/yelp/search/tasks_ready/?bash&#39;
     * @return ApiResponse&lt;BusinessDataYelpSearchTasksReadyResponseInfo&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BusinessDataYelpSearchTasksReadyResponseInfo> yelpSearchTasksReadyWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = yelpSearchTasksReadyValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<BusinessDataYelpSearchTasksReadyResponseInfo>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call yelpSearchTasksReadyAsync(final ApiCallback<BusinessDataYelpSearchTasksReadyResponseInfo> _callback) throws ApiException {

        okhttp3.Call localVarCall = yelpSearchTasksReadyValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<BusinessDataYelpSearchTasksReadyResponseInfo>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
