...
public class ContentAnalysisRatingDistributionLiveResultInfo {
  ...
  **/
  ...
  public ContentAnalysisRatingDistributionLiveResultInfo min(Float min) {
    this.min = min;
    return this;
  }
  ...
  **/
  ...
  public ContentAnalysisRatingDistributionLiveResultInfo max(Float max) {
    this.max = max;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, contentAnalysisRatingDistributionLiveResultInfo.type) &&
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentAnalysisRatingDistributionLiveResultInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContentAnalysisRatingDistributionLiveResultInfo is not found in the empty JSON string", ContentAnalysisRatingDistributionLiveResultInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentAnalysisRatingDistributionLiveResultInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContentAnalysisRatingDistributionLiveResultInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("metrics") != null && !jsonObj.get("metrics").isJsonNull()) {
        ContentAnalysisSummaryInfo.validateJsonElement(jsonObj.get("metrics"));
      }
  }
 ...
 /**
  * Create an instance of ContentAnalysisRatingDistributionLiveResultInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContentAnalysisRatingDistributionLiveResultInfo
  * @throws IOException if the JSON string is invalid with respect to ContentAnalysisRatingDistributionLiveResultInfo
  */
 ...
 /**
  * Convert an instance of ContentAnalysisRatingDistributionLiveResultInfo to an JSON string
  *
  * @return JSON string
  */
