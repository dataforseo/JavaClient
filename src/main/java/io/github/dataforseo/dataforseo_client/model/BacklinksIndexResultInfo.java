...
import io.github.dataforseo.dataforseo_client.model.IndexHistory;
...
public class BacklinksIndexResultInfo {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(totalBacklinks, totalPages, totalDomains, indexHistory);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BacklinksIndexResultInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BacklinksIndexResultInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
