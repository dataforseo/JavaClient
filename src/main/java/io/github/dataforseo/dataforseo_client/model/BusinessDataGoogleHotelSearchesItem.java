...
import io.github.dataforseo.dataforseo_client.model.GpsCoordinatesLocationInfo;
...
public class BusinessDataGoogleHotelSearchesItem {
  ...
  **/
  ...
  public BusinessDataGoogleHotelSearchesItem addOverviewImagesItem(String overviewImagesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, businessDataGoogleHotelSearchesItem.type) &&
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BusinessDataGoogleHotelSearchesItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BusinessDataGoogleHotelSearchesItem is not found in the empty JSON string", BusinessDataGoogleHotelSearchesItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BusinessDataGoogleHotelSearchesItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BusinessDataGoogleHotelSearchesItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("location") != null && !jsonObj.get("location").isJsonNull()) {
        GpsCoordinatesLocationInfo.validateJsonElement(jsonObj.get("location"));
      }
 ...
 /**
  * Create an instance of BusinessDataGoogleHotelSearchesItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BusinessDataGoogleHotelSearchesItem
  * @throws IOException if the JSON string is invalid with respect to BusinessDataGoogleHotelSearchesItem
  */
 ...
 /**
  * Convert an instance of BusinessDataGoogleHotelSearchesItem to an JSON string
  *
  * @return JSON string
  */
