...
import io.github.dataforseo.dataforseo_client.model.OnPageDuplicateContentItem;
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OnPageDuplicateContentResultInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OnPageDuplicateContentResultInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
