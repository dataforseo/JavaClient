...
import io.github.dataforseo.dataforseo_client.model.AppendixTechnologiesDomainAnalyticsLimitsRatesDataInfo;
import io.github.dataforseo.dataforseo_client.model.AppendixWhoisDomainAnalyticsLimitsRatesDataInfo;
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppendixDomainAnalyticsLimitsRatesDataInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppendixDomainAnalyticsLimitsRatesDataInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
