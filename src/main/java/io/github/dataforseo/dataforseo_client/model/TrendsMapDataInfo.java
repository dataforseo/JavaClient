...
public class TrendsMapDataInfo {
  ...
  **/
  ...
  public TrendsMapDataInfo values(List<Integer> values) {
    this.values = values;
    return this;
  }

  public TrendsMapDataInfo addValuesItem(Integer valuesItem) {
    if (this.values == null) {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrendsMapDataInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrendsMapDataInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
