...
public class BacklinksTimeseriesSummaryLiveItem {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, date, rank, backlinks, backlinksNofollow, referringPages, referringDomains, referringDomainsNofollow, referringMainDomains, referringMainDomainsNofollow, referringIps, referringSubnets);
  }
