...
public class BacklinksHistoryLiveItem {
  ...
  **/
  ...
  public BacklinksHistoryLiveItem newBacklinks(Long newBacklinks) {
   ...
   /**
   * number of new backlinks for the target data is provided based in a comparison with the previous period Note: this data is available from May 2021; if the date range specified in the POST request preceds May 2021, the field will equal 0
   * @return newBacklinks
  **/
  @javax.annotation.Nullable
  ...
  public BacklinksHistoryLiveItem lostBacklinks(Long lostBacklinks) {
   ...
   /**
   * number of lost backlinks for the target data is provided based in a comparison with the previous period Note: this data is available from May 2021; if the date range specified in the POST request preceds May 2021, the field will equal 0
  ...
  **/
  ...
  public BacklinksHistoryLiveItem newReferringDomains(Long newReferringDomains) {
   ...
   /**
   * number of new referring domains for the target data is provided based in a comparison with the previous period Note: this data is available from May 2021; if the date range specified in the POST request preceds May 2021, the field will equal 0
  ...
  **/
  ...
  public BacklinksHistoryLiveItem lostReferringDomains(Long lostReferringDomains) {
   ...
   /**
   * number of lost referring domains for the target data is provided based in a comparison with the previous period Note: this data is available from May 2021; if the date range specified in the POST request preceds May 2021, the field will equal 0
