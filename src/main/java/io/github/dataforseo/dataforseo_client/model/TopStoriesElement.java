...
public class TopStoriesElement {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, topStoriesElement.type) &&
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TopStoriesElement.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TopStoriesElement is not found in the empty JSON string", TopStoriesElement.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TopStoriesElement.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TopStoriesElement` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
 ...
 /**
  * Create an instance of TopStoriesElement given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TopStoriesElement
  * @throws IOException if the JSON string is invalid with respect to TopStoriesElement
  */
 ...
 /**
  * Convert an instance of TopStoriesElement to an JSON string
  *
  * @return JSON string
  */
