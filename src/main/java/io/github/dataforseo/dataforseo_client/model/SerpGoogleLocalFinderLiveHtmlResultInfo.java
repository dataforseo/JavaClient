...
public class SerpGoogleLocalFinderLiveHtmlResultInfo {
  ...
  **/
  ...
  public SerpGoogleLocalFinderLiveHtmlResultInfo items(List<HtmlItem> items) {
    this.items = items;
    return this;
  }

  public SerpGoogleLocalFinderLiveHtmlResultInfo addItemsItem(HtmlItem itemsItem) {
    if (this.items == null) {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SerpGoogleLocalFinderLiveHtmlResultInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SerpGoogleLocalFinderLiveHtmlResultInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
