...
public class ShoppingElement {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, title, price, source, description, marketplace, marketplaceUrl, url);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ShoppingElement.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ShoppingElement` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
