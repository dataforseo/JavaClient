...
import io.github.dataforseo.dataforseo_client.model.ContentAnalysisCategoriesInfo;
import io.github.dataforseo.dataforseo_client.model.TopDomainInfo;
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentAnalysisPhraseTrendsLiveResultInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContentAnalysisPhraseTrendsLiveResultInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
