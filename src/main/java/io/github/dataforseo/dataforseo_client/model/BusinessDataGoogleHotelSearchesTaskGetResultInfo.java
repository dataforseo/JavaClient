...
public class BusinessDataGoogleHotelSearchesTaskGetResultInfo {
  ...
  public BusinessDataGoogleHotelSearchesTaskGetResultInfo keyword(String keyword) {
   ...
   /**
   * keyword received in a POST array keyword is returned with decoded %## (plus symbol ‘+’ will be decoded to a space character); in order to obtain accurate search results, the location name is appended to the keyword automatically
   * @return keyword
  **/
  ...
  **/
  ...
  public BusinessDataGoogleHotelSearchesTaskGetResultInfo addItemsItem(BusinessDataGoogleHotelSearchesItem itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyword, businessDataGoogleHotelSearchesTaskGetResultInfo.keyword) &&
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BusinessDataGoogleHotelSearchesTaskGetResultInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BusinessDataGoogleHotelSearchesTaskGetResultInfo is not found in the empty JSON string", BusinessDataGoogleHotelSearchesTaskGetResultInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BusinessDataGoogleHotelSearchesTaskGetResultInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BusinessDataGoogleHotelSearchesTaskGetResultInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
 ...
 /**
  * Create an instance of BusinessDataGoogleHotelSearchesTaskGetResultInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BusinessDataGoogleHotelSearchesTaskGetResultInfo
  * @throws IOException if the JSON string is invalid with respect to BusinessDataGoogleHotelSearchesTaskGetResultInfo
  */
 ...
 /**
  * Convert an instance of BusinessDataGoogleHotelSearchesTaskGetResultInfo to an JSON string
  *
  * @return JSON string
  */
