...
public class AppendixStatisticsRatesDataInfo {
  ...
  public AppendixStatisticsRatesDataInfo serp(AppendixSerpLimitsRatesDataInfo serp) {
    this.serp = serp;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.serp, appendixStatisticsRatesDataInfo.serp) &&
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppendixStatisticsRatesDataInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppendixStatisticsRatesDataInfo is not found in the empty JSON string", AppendixStatisticsRatesDataInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppendixStatisticsRatesDataInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppendixStatisticsRatesDataInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
 ...
 /**
  * Create an instance of AppendixStatisticsRatesDataInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppendixStatisticsRatesDataInfo
  * @throws IOException if the JSON string is invalid with respect to AppendixStatisticsRatesDataInfo
  */
 ...
 /**
  * Convert an instance of AppendixStatisticsRatesDataInfo to an JSON string
  *
  * @return JSON string
  */
