...
import io.github.dataforseo.dataforseo_client.model.AppendixBusinessDataDayLimitsRatesDataInfo;
import io.github.dataforseo.dataforseo_client.model.AppendixBusinessDataGoogleInfo;
import io.github.dataforseo.dataforseo_client.model.AppendixBusinessListingsBusinessDataLimitsRatesDataInfo;
import io.github.dataforseo.dataforseo_client.model.AppendixSocialMediaBusinessDataLimitsRatesDataInfo;
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppendixBusinessDataLimitsRatesDataInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppendixBusinessDataLimitsRatesDataInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
