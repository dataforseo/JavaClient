...
public class OnPageInstantPagesResultInfo {
  ...
  **/
  ...
  public OnPageInstantPagesResultInfo items(List<BaseOnPageResourceItemInfo> items) {
    this.items = items;
    return this;
  }

  public OnPageInstantPagesResultInfo addItemsItem(BaseOnPageResourceItemInfo itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.crawlProgress, onPageInstantPagesResultInfo.crawlProgress) &&
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OnPageInstantPagesResultInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OnPageInstantPagesResultInfo is not found in the empty JSON string", OnPageInstantPagesResultInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OnPageInstantPagesResultInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OnPageInstantPagesResultInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
 ...
 /**
  * Create an instance of OnPageInstantPagesResultInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OnPageInstantPagesResultInfo
  * @throws IOException if the JSON string is invalid with respect to OnPageInstantPagesResultInfo
  */
 ...
 /**
  * Convert an instance of OnPageInstantPagesResultInfo to an JSON string
  *
  * @return JSON string
  */
