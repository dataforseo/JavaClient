...
import io.github.dataforseo.dataforseo_client.model.RankedKeywordsInfo;
import io.github.dataforseo.dataforseo_client.model.Redirect;
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BacklinksBacklinksLiveItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BacklinksBacklinksLiveItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
