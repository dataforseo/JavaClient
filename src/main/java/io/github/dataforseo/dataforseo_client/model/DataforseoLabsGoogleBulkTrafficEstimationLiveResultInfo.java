...
public class DataforseoLabsGoogleBulkTrafficEstimationLiveResultInfo {
  ...
  **/
  ...
  public DataforseoLabsGoogleBulkTrafficEstimationLiveResultInfo items(List<DataforseoLabsBulkTrafficEstimationLiveItem> items) {
    this.items = items;
    return this;
  }

  public DataforseoLabsGoogleBulkTrafficEstimationLiveResultInfo addItemsItem(DataforseoLabsBulkTrafficEstimationLiveItem itemsItem) {
    if (this.items == null) {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataforseoLabsGoogleBulkTrafficEstimationLiveResultInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataforseoLabsGoogleBulkTrafficEstimationLiveResultInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
