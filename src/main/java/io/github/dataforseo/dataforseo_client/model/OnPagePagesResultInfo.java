...
public class OnPagePagesResultInfo {
  ...
  **/
  ...
  public OnPagePagesResultInfo items(List<BaseOnPageResourceItemInfo> items) {
    this.items = items;
    return this;
  }

  public OnPagePagesResultInfo addItemsItem(BaseOnPageResourceItemInfo itemsItem) {
    if (this.items == null) {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OnPagePagesResultInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OnPagePagesResultInfo is not found in the empty JSON string", OnPagePagesResultInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OnPagePagesResultInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OnPagePagesResultInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
 ...
 /**
  * Create an instance of OnPagePagesResultInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OnPagePagesResultInfo
  * @throws IOException if the JSON string is invalid with respect to OnPagePagesResultInfo
  */
 ...
 /**
  * Convert an instance of OnPagePagesResultInfo to an JSON string
  *
  * @return JSON string
  */
