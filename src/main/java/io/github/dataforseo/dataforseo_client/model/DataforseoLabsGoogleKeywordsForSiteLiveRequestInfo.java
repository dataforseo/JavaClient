...
public class DataforseoLabsGoogleKeywordsForSiteLiveRequestInfo {
  ...
  public DataforseoLabsGoogleKeywordsForSiteLiveRequestInfo target(String target) {
   ...
   /**
   * target domain required field the domain name of the target website the domain should be specified without https:// or www.
   * @return target
  **/
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataforseoLabsGoogleKeywordsForSiteLiveRequestInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataforseoLabsGoogleKeywordsForSiteLiveRequestInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
