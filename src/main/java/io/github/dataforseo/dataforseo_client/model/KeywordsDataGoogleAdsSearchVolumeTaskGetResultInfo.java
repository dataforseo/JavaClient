...
public class KeywordsDataGoogleAdsSearchVolumeTaskGetResultInfo {
  ...
  **/
  ...
  public KeywordsDataGoogleAdsSearchVolumeTaskGetResultInfo spell(SpellInfo spell) {
    this.spell = spell;
    return this;
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KeywordsDataGoogleAdsSearchVolumeTaskGetResultInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KeywordsDataGoogleAdsSearchVolumeTaskGetResultInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
