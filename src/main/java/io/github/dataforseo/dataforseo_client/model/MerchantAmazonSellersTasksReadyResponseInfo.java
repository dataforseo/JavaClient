...
import io.github.dataforseo.dataforseo_client.model.MerchantAmazonSellersTasksReadyTaskInfo;
...
public class MerchantAmazonSellersTasksReadyResponseInfo {
  ...
  **/
  ...
  public MerchantAmazonSellersTasksReadyResponseInfo addTasksItem(MerchantAmazonSellersTasksReadyTaskInfo tasksItem) {
    if (this.tasks == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.version, merchantAmazonSellersTasksReadyResponseInfo.version) &&
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MerchantAmazonSellersTasksReadyResponseInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MerchantAmazonSellersTasksReadyResponseInfo is not found in the empty JSON string", MerchantAmazonSellersTasksReadyResponseInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MerchantAmazonSellersTasksReadyResponseInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MerchantAmazonSellersTasksReadyResponseInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("tasks") != null && !jsonObj.get("tasks").isJsonNull()) {
        ...
        if (jsonArraytasks != null) {
          ...
          for (int i = 0; i < jsonArraytasks.size(); i++) {
            MerchantAmazonSellersTasksReadyTaskInfo.validateJsonElement(jsonArraytasks.get(i));
          };
        }
      }
  }
 ...
 /**
  * Create an instance of MerchantAmazonSellersTasksReadyResponseInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MerchantAmazonSellersTasksReadyResponseInfo
  * @throws IOException if the JSON string is invalid with respect to MerchantAmazonSellersTasksReadyResponseInfo
  */
 ...
 /**
  * Convert an instance of MerchantAmazonSellersTasksReadyResponseInfo to an JSON string
  *
  * @return JSON string
  */
