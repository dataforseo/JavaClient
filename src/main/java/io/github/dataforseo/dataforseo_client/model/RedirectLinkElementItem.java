...
public class RedirectLinkElementItem extends BaseOnPageLinkItemInfo {
  ...
  public RedirectLinkElementItem domainFrom(String domainFrom) {
  ...
  **/
  ...
  public RedirectLinkElementItem domainTo(String domainTo) {
  ...
  **/
  ...
  public RedirectLinkElementItem pageFrom(String pageFrom) {
  ...
  **/
  ...
  public RedirectLinkElementItem pageTo(String pageTo) {
    this.pageTo = pageTo;
    return this;
  }
  ...
  **/
  ...
  public RedirectLinkElementItem linkFrom(String linkFrom) {
  ...
  **/
  ...
  public RedirectLinkElementItem linkTo(String linkTo) {
    this.linkTo = linkTo;
    return this;
  }
  ...
  **/
  ...
  public RedirectLinkElementItem dofollow(Boolean dofollow) {
  ...
  **/
  ...
  public RedirectLinkElementItem pageFromScheme(String pageFromScheme) {
  ...
  **/
  ...
  public RedirectLinkElementItem pageToScheme(String pageToScheme) {
  ...
  **/
  ...
  public RedirectLinkElementItem direction(String direction) {
  ...
  **/
  ...
  public RedirectLinkElementItem isBroken(Boolean isBroken) {
  ...
  **/
  ...
  public RedirectLinkElementItem isLinkRelationConflict(Boolean isLinkRelationConflict) {
    this.isLinkRelationConflict = isLinkRelationConflict;
    return this;
  }

   /**
   * indicates that the link may have a conflict with another link if true, at least one link pointing to the URL in link_to has a rel&#x3D;\&quot;nofollow\&quot; attribute and at least one is dofollow
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RedirectLinkElementItem redirectLinkElementItem = (RedirectLinkElementItem) o;
    return Objects.equals(this.domainFrom, redirectLinkElementItem.domainFrom) &&
        Objects.equals(this.domainTo, redirectLinkElementItem.domainTo) &&
        Objects.equals(this.pageFrom, redirectLinkElementItem.pageFrom) &&
        Objects.equals(this.pageTo, redirectLinkElementItem.pageTo) &&
        Objects.equals(this.linkFrom, redirectLinkElementItem.linkFrom) &&
        Objects.equals(this.linkTo, redirectLinkElementItem.linkTo) &&
        Objects.equals(this.dofollow, redirectLinkElementItem.dofollow) &&
        Objects.equals(this.pageFromScheme, redirectLinkElementItem.pageFromScheme) &&
        Objects.equals(this.pageToScheme, redirectLinkElementItem.pageToScheme) &&
        Objects.equals(this.direction, redirectLinkElementItem.direction) &&
        Objects.equals(this.isBroken, redirectLinkElementItem.isBroken) &&
        Objects.equals(this.isLinkRelationConflict, redirectLinkElementItem.isLinkRelationConflict) &&
        super.equals(o);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(domainFrom, domainTo, pageFrom, pageTo, linkFrom, linkTo, dofollow, pageFromScheme, pageToScheme, direction, isBroken, isLinkRelationConflict, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("class RedirectLinkElementItem {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to RedirectLinkElementItem
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RedirectLinkElementItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RedirectLinkElementItem is not found in the empty JSON string", RedirectLinkElementItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RedirectLinkElementItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RedirectLinkElementItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedirectLinkElementItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedirectLinkElementItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedirectLinkElementItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedirectLinkElementItem.class));

       return (TypeAdapter<T>) new TypeAdapter<RedirectLinkElementItem>() {
           @Override
           public void write(JsonWriter out, RedirectLinkElementItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RedirectLinkElementItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RedirectLinkElementItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RedirectLinkElementItem
  * @throws IOException if the JSON string is invalid with respect to RedirectLinkElementItem
  */
  public static RedirectLinkElementItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedirectLinkElementItem.class);
  }

 /**
  * Convert an instance of RedirectLinkElementItem to an JSON string
  *
  * @return JSON string
  */
