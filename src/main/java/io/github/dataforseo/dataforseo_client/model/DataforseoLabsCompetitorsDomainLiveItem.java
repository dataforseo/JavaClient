...
public class DataforseoLabsCompetitorsDomainLiveItem {
  ...
  **/
  ...
  public DataforseoLabsCompetitorsDomainLiveItem putFullDomainMetricsItem(String key, MetricsInfo fullDomainMetricsItem) {
    ...
    this.fullDomainMetrics.put(key, fullDomainMetricsItem);
    return this;
  }
  ...
  **/
  ...
  public DataforseoLabsCompetitorsDomainLiveItem putCompetitorMetricsItem(String key, MetricsInfo competitorMetricsItem) {
    ...
    this.competitorMetrics.put(key, competitorMetricsItem);
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.seType, dataforseoLabsCompetitorsDomainLiveItem.seType) &&
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataforseoLabsCompetitorsDomainLiveItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataforseoLabsCompetitorsDomainLiveItem is not found in the empty JSON string", DataforseoLabsCompetitorsDomainLiveItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataforseoLabsCompetitorsDomainLiveItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataforseoLabsCompetitorsDomainLiveItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
 ...
 /**
  * Create an instance of DataforseoLabsCompetitorsDomainLiveItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DataforseoLabsCompetitorsDomainLiveItem
  * @throws IOException if the JSON string is invalid with respect to DataforseoLabsCompetitorsDomainLiveItem
  */
 ...
 /**
  * Convert an instance of DataforseoLabsCompetitorsDomainLiveItem to an JSON string
  *
  * @return JSON string
  */
