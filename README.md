...
- AI Optimization API ([source docs](https://github.com/dataforseo/JavaClient/tree/master/docs/AiOptimizationApi.md) | [api docs](https://docs.dataforseo.com/v3/ai_optimization/overview/))
