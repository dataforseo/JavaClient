...
**searchPartners** | **Boolean** | <em>include Google search partners</em><br>the value is always <code>false</code> |[optional]|
...
**impressions** | **Integer** | <em>projected number of ad impressions</em><br>number of impressions an ad is projected to get within the specified time period<br><strong>Note:</strong> parameter deprecated, the value is always_<code>null</code>n |[optional]|
