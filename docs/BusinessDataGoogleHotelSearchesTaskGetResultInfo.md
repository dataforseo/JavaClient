...
**items** | **List<BusinessDataGoogleHotelSearchesItem>** | <em>array of items</em><br><strong>note:</strong> this field always equals <code>null</code>; use it to facilitate integration and ensure interoperability with the <a href='/v3/business_data/google/hotel_info/live/advanced/'>Hotel Info</a> endpoint |[optional]|