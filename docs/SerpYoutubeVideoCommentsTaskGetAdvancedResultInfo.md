...
**itemTypes** | **List<String>** | <em>types of search results in SERP</em><br>contains types of search results (<code>items</code>) found in SERP.<br>possible item:<br><code>youtube_comment</code> |[optional]|
...
**items** | **List<YoutubeComment>** | <em>elements of search results found in SERP</em> |[optional]|