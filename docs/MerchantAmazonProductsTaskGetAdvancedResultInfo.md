...
**categories** | **List<String>** | <em>amazon product departments and subcategories</em> |[optional]|
**itemsCount** | **Long** | <em>the number of results returned in the <strong><code>items</code></strong> array</em> |[optional]|
**items** | **List<BaseMerchantAmazonElementItem>** | <em>Amazon product items within the <code>editorial_recommendations</code> element</em> |[optional]|