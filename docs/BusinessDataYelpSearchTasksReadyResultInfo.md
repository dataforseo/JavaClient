...
|**se** | **String** | search engine specified when setting the task can take the following values: yelp |  [optional] |
|**seType** | **String** | type of search engine can take the following values: search |  [optional] |
