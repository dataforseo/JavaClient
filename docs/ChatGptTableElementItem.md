...
|------------ | ------------- | ------------- | -------------|
**text** | **String** | <em>text of the element</em> |[optional]|
...
**brandEntities** | **List<ChatGptBrandEntity>** | <em>array of brand entities</em><br>contains information on brands mentioned in the text |[optional]|