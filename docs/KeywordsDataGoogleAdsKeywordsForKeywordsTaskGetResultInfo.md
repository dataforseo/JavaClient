...
|**searchVolume** | **Long** | monthly average search volume rate represents the (approximate) number of searches for the given keyword idea either on google.com or google.com and partners, depending on the user’s targeting if there is no data, the value is null |  [optional] |
...
|**keywordAnnotations** | [**KeywordAnnotations**](KeywordAnnotations.md) |  |  [optional] |
