...
**asins** | **Map<String, String>** | <em>ASINs in a POST array</em> |[optional]|
...
**items** | **List<DataforseoLabsAmazonProductKeywordIntersectionsLiveItem>** | <em>contains detected Amazon product competitors and related data</em> |[optional]|