...
**relatedImageSearches** | **List<RelatedImageSearchesElement>** | contains keywords and images related to the specified search term<br>Note: this array is deprecated and always returns null |[optional]|