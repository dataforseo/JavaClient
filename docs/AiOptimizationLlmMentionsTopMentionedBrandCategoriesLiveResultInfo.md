...
**items** | **List<AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiveItem>** | individual brand categories results<br>array containing detailed mention metrics for each of the found brand categories |[optional]|