...
**categories** | **List<Categories>** | contains related product categories |[optional]|
...
**topLocalReviews** | **List<AmazonReviewItem>** | array of objects with top reviews from target location |[optional]|
