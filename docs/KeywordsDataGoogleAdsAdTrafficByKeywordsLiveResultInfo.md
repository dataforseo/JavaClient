...
**searchPartners** | **Boolean** | include Google search partners<br>the value you specified when setting the task<br>Note: parameter deprecated, the value is always false |[optional]|
