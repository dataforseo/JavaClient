...
**isClaimed** | **Boolean** | <i>indicates whether ownership of this local establishment is claimed</i> |[optional]|
**localJustifications** | **List<LocalJustificationInfo>** | <i>Google local justifications</i><br>snippets of text that 'justify' why the business is showing up for search query |[optional]|
**isDirectoryItem** | **Boolean** | <i>indicates whether this local establishment is a directory </i> |[optional]|