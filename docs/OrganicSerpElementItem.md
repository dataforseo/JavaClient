...
**isFeaturedSnippet** | **Boolean** | indicates whether the element is a featured_snippet<br>Note: this check no longer appears in SERP |[optional]|
**isMalicious** | **Boolean** | indicates whether the element is marked as malicious<br>Note: this check no longer appears in SERP |[optional]|
**isWebStory** | **Boolean** | indicates whether the element is marked as Google web story<br>Note: this check no longer appears in SERP |[optional]|
