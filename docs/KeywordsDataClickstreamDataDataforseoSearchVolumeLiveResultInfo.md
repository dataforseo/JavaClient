...
**useClickstream** | **Boolean** | <em>indicates if the <code>use_clickstream</code> parameter is active</em><br>possible values: <code>true</code>, <code>false</code> |[optional]|
**itemsCount** | **Integer** | <em>ithe number of results returned in the <code>items</code> array</em> |[optional]|
**items** | **List<KeywordsDataClickstreamDataSearchVolumeLiveItem>** | <em>array of keywords</em><br>contains keywords and their search volume rates |[optional]|