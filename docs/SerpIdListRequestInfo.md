...
**limit** | **Integer** | <em>the maximum number of returned task IDs</em><br>optional field<br>default value: <code>1000</code><br>maximum value: <code>1000</code><br>minimum value: <code>1</code> |[optional]|
**offset** | **Integer** | <em>offset in the results array of returned task IDs</em><br>optional field<br>if you specify the <code>10</code> value, the first ten tasks in the results array will be omitted;<br>minimum and default value: <code>0</code>;<br>maximum value: <code>100M</code> (100 million) |[optional]|
...
**includeMetadata** | **Boolean** | <em>include task metadata in the response</em><br>optional field<br>if set to <code>true</code>, the <code>metadata</code> object containing parameters specified in the POST request will be provided in the response;<br>default value: <code>false</code> |[optional]|