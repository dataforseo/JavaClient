...
**itemTypes** | **List<String>** | <em>types of search results in SERP</em><br>contains types of search results (<code>items</code>) found in SERP.<br>possible item types:<br><code>maps_search</code>, <code>maps_paid_item</code> |[optional]|
...
**items** | **List<BaseSerpApiGoogleMapsElementItem>** | <em>items of the element</em> |[optional]|