...
**blockRank** | **Integer** | <em>block rank in SERP</em><br>position among all the blocks in SERP |[optional]|
**blockName** | **String** | <em>name of the block in SERP</em><br>example:<br><code>'People also watched'</code> |[optional]|
