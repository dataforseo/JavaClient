...
**itemTypes** | **List<String>** | <em>types of search results in SERP</em><br>contains types of search results (<code>items</code>) found in SERP.<br>possible item types:<br><code>ai_overview</code> |[optional]|
...
**items** | **List<AiModeAiOverviewInfo>** | <em>items present in the element</em> |[optional]|