...
public class Example {
  ...
  try {
    ...
    MerchantApi apiInstance = new MerchantApi(defaultClient);
    String id = "00000000-0000-0000-0000-000000000000";
    MerchantGoogleSellersTaskGetHtmlResponseInfo response = apiInstance.googleSellersTaskGetHtml(id);
    System.out.println(result);
  } catch (ApiException e) {
...
public class Example {
  ...
  try {
    ...
    basicAuth.setPassword("PASSWORD");
    MerchantApi apiInstance = new MerchantApi(defaultClient);
    MerchantGoogleProductSpecTaskPostRequestInfo model = new MerchantGoogleProductSpecTaskPostRequestInfo()
           .productId("1113158713975221117")
           .locationCode(2840)
           .languageCode("en");
    MerchantGoogleProductSpecTaskPostResponseInfo response = apiInstance.googleProductSpecTaskPost(List.of(model));
    System.out.println(result);
  } catch (ApiException e) {
...
### Parameters
    ...
    | Name | Type | Description  | Notes |
    |------------- | ------------- | ------------- | -------------|
    | **** | [**List&lt;List<MerchantGoogleProductSpecTaskPostRequestInfo>&gt;**](List<MerchantGoogleProductSpecTaskPostRequestInfo>.md)|  | [optional] |
...
public class Example {
  ...
  try {
    ...
    MerchantGoogleProductSpecTasksReadyResponseInfo response = apiInstance.googleProductSpecTasksReady();
    System.out.println(result);
  } catch (ApiException e) {
...
public class Example {
  ...
  try {
    ...
    MerchantApi apiInstance = new MerchantApi(defaultClient);
    String id = "00000000-0000-0000-0000-000000000000";
    MerchantGoogleProductSpecTaskGetHtmlResponseInfo response = apiInstance.googleProductSpecTaskGetHtml(id);
    System.out.println(result);
  } catch (ApiException e) {
