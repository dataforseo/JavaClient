...
**labels** | **List<AmazonLabelElement>** | product labels<br>array containing an object with main Amazon labels’ information<br>if the product contains no labels, the value will be null |[optional]|