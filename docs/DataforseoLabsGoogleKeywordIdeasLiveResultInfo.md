...
|**totalCount** | **BigDecimal** | total number of results relevant to your request in our database |  [optional] |
|**itemsCount** | **BigDecimal** | number of results returned in the items array |  [optional] |
