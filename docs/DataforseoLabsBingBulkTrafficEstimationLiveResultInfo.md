...
|**items** | [**List&lt;DataforseoLabsBingBulkTrafficEstimationLiveItem&gt;**](DataforseoLabsBingBulkTrafficEstimationLiveItem.md) | array of items with relevant traffic estimation data |  [optional] |
