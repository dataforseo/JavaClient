...
**scoreByCategories** | **Map<String, Double>** | <em>category scores of the hotel location</em><br>the scores of the hotel's location tied to the categories that indicate the proximity to nearby things to do, restaurants, transportation, and airports; |[optional]|
...
**locationChain** | **List<LocationChain>** | <em>elements of the location chain</em><br>additional parameters of each element of the location chain |[optional]|