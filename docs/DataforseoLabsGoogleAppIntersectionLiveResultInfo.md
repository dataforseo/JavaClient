...
**appIds** | **Map<String, String>** | <em>ids of the apps in a POST array</em> |[optional]|
...
**items** | **List<DataforseoLabsleAppIntersectionLiveItem>** | <em>contains data related to the ranking keywords for the app specified in the <code>app_id</code> field</em> |[optional]|