...
**rankGroup** | **Integer** | <em>position within a group of elements with identical <code>type</code> values</em><br>positions of elements with different <code>type</code> values are omitted from the <code>rank_group</code> |[optional]|
...
**localJustifications** | **List<String>** | <em>Google local justifications</em><br>snippets of text that “justify” why the business is showing up for search query |[optional]|
