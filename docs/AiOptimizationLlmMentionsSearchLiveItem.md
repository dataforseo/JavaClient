...
**sources** | **List<Sources>** | array of sourcesthe sources the model cited or relied on in its final answerlearn more about the sources and how to retrieve LLM citation data at our Help Center |[optional]|
