...
**missingData** | **Boolean** | <em>indicates whether the data is unavailable<em><br>if <code>true<code> the data on the graph in the Google Trends interface is missing and thus labelled with a dotted line |[optional]|
